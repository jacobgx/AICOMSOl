/*
 * bracket_fatigue_optimization.java
 */
...
public class bracket_fatigue_optimization {
  ...
  public static Model run2(Model model) {
    ...
    model.result().evaluationGroup("eg1").label("\u521d\u59cb\u67d4\u5ea6");
    model.result().evaluationGroup("eg1").setIndex("looplevelinput", "last", 0);
    model.result().evaluationGroup("eg1").create("gev1", "EvalGlobal");
    model.result().evaluationGroup("eg1").feature("gev1").set("expr", new String[]{"solid.Ws_tot"});
    model.result().evaluationGroup("eg1").feature("gev1")
         .set("descr", new String[]{"\u603b\u5f39\u6027\u5e94\u53d8\u80fd"});
    model.result().evaluationGroup("eg1").run();

    model.param().set("pExp", "50");
    model.param().descr("pExp", "P \u6a21\u6307\u6570");
    model.param().set("sigmaMax", "100[MPa]");
    model.param().descr("sigmaMax", "\u6700\u5927\u5e94\u529b");
    model.param().set("Ws0", "0.69[J]");
    model.param().descr("Ws0", "\u7279\u6027\u521a\u5ea6");

    model.component("comp1").selection().create("sel7", "Explicit");
    model.component("comp1").selection("sel7").label("\u81ea\u7531\u8fb9\u754c");
    model.component("comp1").selection("sel7").geom(2);
    model.component("comp1").selection("sel7").set(24, 25, 28, 29);
    model.component("comp1").selection().duplicate("sel8", "sel7");
    model.component("comp1").selection("sel8").label("\u5bf9\u79f0\u8fb9\u754c");
    model.component("comp1").selection("sel8").set(15, 65);
    model.component("comp1").selection().create("adj2", "Adjacent");
    model.component("comp1").selection("adj2").label("\u81ea\u7531\u57df");
    model.component("comp1").selection("adj2").set("entitydim", 2);
    model.component("comp1").selection("adj2").set("outputdim", 3);
    model.component("comp1").selection("adj2").set("input", new String[]{"sel7"});
    model.component("comp1").selection().create("sel9", "Explicit");
    model.component("comp1").selection("sel9").label("\u5bf9\u79f0\u57df");
    model.component("comp1").selection("sel9").set(8);

    model.component("comp1").cpl().create("aveop1", "Average");
    model.component("comp1").cpl("aveop1").set("axisym", true);
    model.component("comp1").cpl("aveop1").selection().named("adj2");

    model.component("comp1").variable().create("var1");
    model.component("comp1").variable("var1").label("\u76ee\u6807\u51fd\u6570");
    model.component("comp1").variable("var1").set("obj", "aveop1((solid.mises/sigmaMax)^pExp)^(1/pExp)");
    ...
    model.component("comp1").common("fsd1").selection().named("adj2");
    model.component("comp1").common().create("fsb1", "FreeShapeBoundary");
    model.component("comp1").common("fsb1").selection().named("sel7");
    model.component("comp1").common("fsb1").set("maximumDisplacement", "3[mm]");
    model.component("comp1").common().create("fsr1", "FreeShapeSymmetry");
    model.component("comp1").common("fsr1").selection().named("sel8");
    model.component("comp1").common().create("mss1", "MirrorShape");
    model.component("comp1").common("mss1").selection().named("sel9");
    ...
    model.study("std3").feature().copy("stat", "std1/stat");
    ...
    model.study("std3").feature("sho").set("optobj", new String[]{"comp1.obj"});
    model.study("std3").feature("sho").set("descr", new String[]{"\u76ee\u6807\u51fd\u6570"});
    ...
    model.study("std3").feature("sho")
         .set("constraintExpression", new String[]{"comp1.fsd1.relVolume", "comp1.solid.Ws_tot"});
    ...
    model.result().dataset("dset3g1")
         .label("\u7814\u7a76 3\uff1a\u4f18\u5316\u540e\u7684\u8bbe\u8ba1/\u89e3 3 (3) - \u51e0\u4f55");
    ...
    model.result("pg4").feature("arws1").set("expr", new String[]{"fsd1.dXg", "fsd1.dYg", "fsd1.dZg"});
    ...
    model.study("std2").label("\u7814\u7a76 2\uff1a\u521d\u59cb\u75b2\u52b3");
    model.study("std4").label("\u7814\u7a76 4\uff1a\u4f18\u5316\u540e\u7684\u75b2\u52b3");
    model.study("std4").feature().copy("param", "std2/param");
    model.study("std4").feature().copy("ftge", "std2/ftge");
    ...
    model.result().dataset("dset4g1")
         .label("\u7814\u7a76 4\uff1a\u4f18\u5316\u540e\u7684\u75b2\u52b3/\u89e3 4 (4) - \u51e0\u4f55");
    model.result().dataset("dset4g1").set("frametype", "geometry");
    model.result("pg6").label("\u5f62\u72b6\u4f18\u5316 1");
    ...
    model.result("pg5").run();
    model.result("pg5").label("\u5931\u6548\u5faa\u73af\u6b21\u6570\uff0c\u4f18\u5316\u540e");
    ...
    model.result().evaluationGroup("eg2").label("\u75b2\u52b3\u6bd4\u8f83");
    ...
    model.result().evaluationGroup("eg2").feature("min1").set("expr", new String[]{"ftg.ctf"});
    model.result().evaluationGroup("eg2").feature("min1")
    ...
    model.result().create("pg6", "PlotGroup3D");
    model.result("pg6").run();
    model.result("pg6").label("\u5f62\u72b6\u4f18\u5316\uff0c\u4f53\u79ef");
    ...
    model.result("pg6").run();
    model.result("pg6").feature("vol2").feature("def1")
         .label("\u53d8\u5f62 1 - \u6df1\u5ea6\u51b2\u7a81\u6270\u52a8\u4fee\u6b63");
    model.result("pg6").feature("vol2").feature("def1").set("expr", new String[]{"-(Xg+0.0975)*5e-4", "v", "w"});
    ...
    model.title("\u652f\u67b6 - \u5e26\u75b2\u52b3\u8bc4\u4f30\u7684\u5e94\u529b\u4f18\u5316");

    model
         .description("\u5c3d\u7ba1\u76ee\u524d\u5c1a\u4e0d\u652f\u6301\u4e0e\u75b2\u52b3\u5c5e\u6027\u6709\u5173\u7684\u5f62\u72b6\u4f18\u5316\uff0c\u4f46\u75b2\u52b3\u5c5e\u6027\u4e0e\u6700\u5927\u5e94\u529b\u5bc6\u5207\u76f8\u5173\u3002\u672c\u6a21\u578b\u6f14\u793a\u5982\u4f55\u5728\u4e0d\u589e\u52a0\u8d28\u91cf\u6216\u964d\u4f4e\u521a\u5ea6\u7684\u60c5\u51b5\u4e0b\uff0c\u4f7f\u7528\u4e0e von\u00a0Mises \u5e94\u529b\u7684 p \u6a21\u6709\u5173\u7684\u4f18\u5316\u6765\u6539\u5584\u75b2\u52b3\u5c5e\u6027\u3002");
