/*
 * biased_resonator_3d_modes.java
 */
...
public class biased_resonator_3d_modes {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").feature("mir1").selection("input").set("blk1", "ext1");
    ...
    model.component("comp1").func("int1").set("filename", "biased_resonator_3d_modes_experiment.txt");
    ...
    model.component("comp1").func("int1").set("extrapvalue", Double.NaN);
    ...
    model.study("std2").label("\u65e0\u504f\u538b\u60c5\u51b5\u4e0b\u7684\u7279\u5f81\u9891\u7387");
  ...
  public static Model run2(Model model) {
    ...
    model.study("std3").label("\u5b58\u5728\u504f\u538b\u60c5\u51b5\u4e0b\u7684\u7279\u5f81\u9891\u7387");
    ...
    model.result("pg6").feature("ptgr1").setIndex("legends", "COMSOL \u89e3", 0);
    ...
    model.result("pg6").feature("glob1").setIndex("looplevel", new int[]{2, 3, 4, 5, 6, 7, 8, 9}, 1);
    ...
    model.result("pg6").feature("glob1").setIndex("legends", "\u5b9e\u9a8c\uff1aBannon \u7b49\u4eba", 0);
    model.result("pg6").run();
    model.result("pg6").set("titletype", "manual");
    model.result("pg6").set("title", "\u7279\u5f81\u9891\u7387 vs. \u76f4\u6d41\u7535\u538b");
    model.result("pg6").set("xlabelactive", true);
    model.result("pg6").set("xlabel", "\u76f4\u6d41\u504f\u538b (V)");
    model.result("pg6").set("ylabelactive", true);
    model.result("pg6").set("ylabel", "\u8c10\u632f\u9891\u7387 (Hz)");
    model.result("pg6").label("\u7279\u5f81\u9891\u7387 vs. \u76f4\u6d41\u7535\u538b");

    model.title("\u504f\u538b\u8c10\u632f\u5668\u7684\u56fa\u6709\u6a21\u6001 - \u4e09\u7ef4");
