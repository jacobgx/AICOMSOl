/*
 * residual_stress_resonator_3d.java
 */
...
public class residual_stress_resonator_3d {
...
//    model.param().loadFile("FILENAME");
    ...
    model.component("comp1").geom("geom1").insertFile("residual_stress_resonator_3d_geom_sequence.mph", "geom1");
    ...
    model.component("comp1").physics("solid").feature("fix1").selection().set(7, 15, 21, 29);
    ...
    model.component("comp1").mesh("mesh1").feature("map1").selection().set(4, 9, 14, 23, 28);
    model.component("comp1").mesh("mesh1").feature("map1").create("dis1", "Distribution");
    model.component("comp1").mesh("mesh1").feature("map1").feature("dis1").selection().set(16, 21, 44, 49);
    ...
    model.component("comp2").geom("geom2").insertFile("residual_stress_resonator_3d_geom_sequence.mph", "geom2");
    ...
    model.component("comp2").physics("solid2").feature("lemm1").create("te1", "ThermalExpansion", 3);
    ...
    model.component("comp2").physics("solid2").feature("fix1").selection().set(46, 48, 68, 70);
    ...
    model.component("comp2").mesh("mesh2").feature("map1").selection()
         .set(4, 9, 13, 18, 22, 27, 36, 41, 45, 50, 54, 63, 67, 72, 76, 81, 88, 93, 97, 102, 106);
    ...
    model.component("comp2").mesh("mesh2").feature("map1").feature("dis1").selection()
         .set(12, 21, 26, 30, 73, 78, 104, 113, 118, 122, 161, 166);
    ...
    model.component("comp2").mesh("mesh2").feature("swe1").feature("dis1").set("numelem", 2);
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg4").feature("surf1").feature("def").set("expr", new String[]{"u2", "v2", "w2"});
    ...
    model.title("\u8584\u819c\u8c10\u632f\u5668\u4e2d\u7684\u6b8b\u4f59\u5e94\u529b - \u4e09\u7ef4");

    model
         .description("\u8868\u9762\u5fae\u52a0\u5de5\u8584\u819c\u901a\u5e38\u53d7\u5230\u6b8b\u4f59\u5e94\u529b\u7684\u5f71\u54cd\u3002\u672c\u4f8b\u5c06\u70ed\u6b8b\u4f59\u5e94\u529b\u6dfb\u52a0\u5230\u7ed3\u6784\u529b\u5b66\u6a21\u578b\uff0c\u4ece\u800c\u6539\u53d8\u7ed3\u6784\u7684\u5171\u632f\u9891\u7387\u3002\u5176\u4e2d\u91c7\u7528\u4e09\u7ef4\u6a21\u578b\uff0c\u63cf\u8ff0\u4e00\u79cd\u5177\u6709\u6298\u53e0\u60ac\u81c2\u6881\u5f26\u7684\u8584\u819c\u8c10\u632f\u5668\u3002\u6298\u53e0\u6320\u66f2\u53ef\u4ee5\u51cf\u5c0f\u8f74\u5411\u5e94\u529b\u3002");
