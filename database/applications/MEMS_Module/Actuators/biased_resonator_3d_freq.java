...
public class biased_resonator_3d_freq {
  ...
  public static Model run() {
    ...
    model.param().descr("Q", "\u8c10\u632f\u5668\u54c1\u8d28\u56e0\u5b50");
    model.param().set("f0", "8[MHz]");
    model.param().descr("f0", "\u8fd1\u4f3c\u8c10\u632f\u9891\u7387");
    model.param().set("alpha", "4*pi*f0/(3*Q)");
    model.param().descr("alpha", "\u963b\u5c3c\u53c2\u6570");
    model.param().set("beta", "1/(6*pi*f0*Q)");
    model.param().descr("beta", "\u963b\u5c3c\u53c2\u6570");
    ...
    model.component("comp1").physics("es").feature("term2").feature("hp1").set("V0", "3[mV]");
    ...
    model.result("pg5").run();
    model.result("pg5").label("\u9891\u57df");

    model.title("\u504f\u538b\u8c10\u632f\u5668\u7684\u9891\u7387\u54cd\u5e94 - \u4e09\u7ef4");

    model
         .description("\u672c\u4f8b\u6a21\u62df\u4e00\u4e2a\u9759\u7535\u9a71\u52a8\u7684 MEMS \u8c10\u632f\u5668\u3002\u8be5\u88c5\u7f6e\u7531\u5e73\u884c\u677f\u7535\u5bb9\u5668\u4e0a\u65bd\u52a0\u7684\u4ea4\u6d41 + \u76f4\u6d41\u504f\u538b\u9a71\u52a8\u3002\u5176\u4e2d\u8ba1\u7b97\u504f\u538b\u8c10\u632f\u5668\u7684\u9891\u7387\u54cd\u5e94\u3002");
