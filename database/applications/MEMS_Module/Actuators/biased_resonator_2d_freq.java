...
public class biased_resonator_2d_freq {
  ...
  public static Model run() {
    ...
    model.param().descr("alpha", "\u963b\u5c3c\u53c2\u6570 - alpha");
    model.param().set("beta", "8.29e-13[s]");
    model.param().descr("beta", "\u963b\u5c3c\u53c2\u6570 - beta");
    ...
    model.component("comp1").physics("es").feature("pot1").create("hp1", "HarmonicPerturbation", 1);
    model.component("comp1").physics("es").feature("pot1").feature("hp1").set("V0", 0.1);
