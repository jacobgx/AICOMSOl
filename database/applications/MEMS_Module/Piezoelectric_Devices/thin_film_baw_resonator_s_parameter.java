/*
 * thin_film_baw_resonator_s_parameter.java
 */
...
public class thin_film_baw_resonator_s_parameter {
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").physics("es").feature("term2").set("TerminalType", "Terminated");
    model.component("comp1").physics("es").feature("term2").set("P0", 0.1);

    model.study("std1").feature("eig").set("useadvanceddisable", true);
    model.study("std1").feature("eig").set("disabledphysics", new String[]{"es/term2"});
    model.study("std2").feature("freq").set("useadvanceddisable", true);
    model.study("std2").feature("freq").set("disabledphysics", new String[]{"es/term2"});
    model.study().create("std3");
    model.study("std3").feature().copy("freq", "std2/freq");
    model.study("std3").feature("freq").set("useadvanceddisable", false);
    ...
    model.result("pg12").feature("glob1").setIndex("descr", "S \u53c2\u6570", 0);
    model.result("pg12").feature("glob1").setIndex("expr", "imag(es.S22)", 1);
    model.result("pg12").feature("glob1").setIndex("descr", "\u865a\u90e8", 1);

    model.component("comp1").variable().create("var1");
    model.component("comp1").variable("var1")
         .set("S11", "(1-es.Y11*50[ohm])/ (1+es.Y11*50[ohm])", "S \u53c2\u6570\uff0c11 \u5206\u91cf");
    model.component("comp1").variable("var1").descr("S11", "\u7814\u7a76 2 \u4e2d\u7684 S \u53c2\u6570");
    ...
    model.result("pg12").feature("glob2").setIndex("descr", "\u865a\u90e8", 1);
    ...
    model.result("pg13").label("S \u53c2\u6570\uff0c\u5206\u8d1d\u523b\u5ea6");
    ...
    model.title("\u8584\u819c\u4f53\u58f0\u6ce2\u8c10\u632f\u5668\u7684 S \u53c2\u6570");

    model
         .description("\u672c\u6a21\u578b\u5bf9\u201c\u590d\u5408\u8584\u819c\u4f53\u58f0\u6ce2\u8c10\u632f\u5668\u201d\u6559\u7a0b\u8fdb\u884c\u6269\u5c55\uff0c\u6f14\u793a\u5982\u4f55\u8ba1\u7b97\u538b\u7535 MEMS \u5668\u4ef6\u7684 S \u53c2\u6570\u3002S \u53c2\u6570\u7684\u6d4b\u91cf\u503c\u901a\u5e38\u7528\u4e8e\u63cf\u8ff0\u6b64\u7c7b\u5668\u4ef6\u5728\u5c04\u9891\u5e94\u7528\u4e2d\u7684\u7279\u5f81\u3002\u201c\u9759\u7535\u201d\u7269\u7406\u573a\u63a5\u53e3\u4e2d\u7684\u7ec8\u7aef\u7279\u5f81\u652f\u6301\u60a8\u76f4\u63a5\u8bbf\u95ee\u9891\u57df\u7814\u7a76\u7c7b\u578b\u7684 S \u53c2\u6570\u8ba1\u7b97\u7ed3\u679c\u3002");
