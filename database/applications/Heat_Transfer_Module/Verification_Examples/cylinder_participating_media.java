/*
 * cylinder_participating_media.java
 */
...
public class cylinder_participating_media {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("rpm").prop("ParticipatingMediaSettingsProperty").set("PerfIndex", 0.3);
    model.component("comp1").physics("rpm").prop("ParticipatingMediaSettingsProperty")
         .set("DiscreteOrdinatesMethod", 6);
    ...
    model.param().descr("a1", "\u52d2\u8ba9\u5fb7\u7cfb\u6570");

    model.component("comp1").physics("rpm").feature("rpm1").set("ScatteringType", "LinearAnisotropic");
    model.component("comp1").physics("rpm").feature("rpm1").set("a1", "a1");
    ...
    model.title("\u6709\u9650\u5706\u67f1\u5f62\u4ecb\u8d28\u4e2d\u7684\u8f90\u5c04\u4f20\u70ed");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u79bb\u6563\u5750\u6807\u6cd5 (DOM) \u6c42\u89e3\u4e00\u4e2a\u5b58\u5728\u53d1\u6563\u3001\u5438\u6536\u548c\u7ebf\u6027\u5404\u5411\u5f02\u6027\u6563\u5c04\u7684\u6709\u9650\u67f1\u72b6\u4ecb\u8d28\u5185\u7684\u4e09\u7ef4\u8f90\u5c04\u4f20\u70ed\u95ee\u9898\u3002\u4f7f\u7528 DOM S6 \u5206\u91cf\uff0c\u53ef\u4ee5\u5feb\u901f\u7cbe\u786e\u5730\u5b9e\u73b0\u6c42\u89e3\uff0c\u8fd9\u5bf9\u4e8e\u6df7\u5408\u7684\u4f20\u70ed\u6a21\u5f0f\u975e\u5e38\u6709\u7528\u3002\u8ba1\u7b97\u83b7\u5f97\u7684\u5165\u5c04\u8f90\u5c04\u548c\u70ed\u901a\u91cf\u4e0e\u53d1\u5e03\u7684\u5229\u7528\u53d8\u6362\u79ef\u5206\u6cd5\u83b7\u5f97\u7684\u7ed3\u679c\u975e\u5e38\u543b\u5408\u3002COMSOL Multiphysics \u4e2d\u7684 DOM \u516c\u5f0f\u4e5f\u53ef\u4ee5\u65b9\u4fbf\u5730\u5904\u7406\u8fb9\u754c\u53d1\u6563\u548c\u53cd\u5c04\u6548\u5e94\u3002");
