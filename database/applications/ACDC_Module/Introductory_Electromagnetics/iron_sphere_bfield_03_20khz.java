/*
 * iron_sphere_bfield_03_20khz.java
 */
...
public class iron_sphere_bfield_03_20khz {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("mf").feature("fsp1")
         .set("sigma_stab", new int[]{50, 0, 0, 0, 50, 0, 0, 0, 50});
    ...
    model.component("comp1").mesh("mesh1").feature("bl1").feature("blp").set("blhmin", "8[um]");
    ...
    model.result("pg1").feature("arwv1").set("ynumber", 15);
    model.result("pg1").feature("arwv1").set("znumber", 15);
    ...
    model.result("pg1").feature("arwv1").feature("sel1").selection().set(9);
    model.result("pg1").run();
    ...
    model.result("pg3").feature("slc1").set("descr", "\u7535\u6d41\u5bc6\u5ea6\u6a21");
    ...
    model.result("pg3").feature("surf1").set("descr", "\u6750\u6599\u8bbe\u7f6e");
    ...
    model.title("\u78c1\u573a\u4e2d\u7684\u94c1\u7403 - 20\u00a0kHz");

    model
         .description("\u4e00\u4e2a\u94c1\u7403\u66b4\u9732\u5728\u7a7a\u95f4\u5747\u5300\u5e76\u4ee5 20\u00a0kHz \u7684\u9891\u7387\u6b63\u5f26\u65f6\u53d8\u7684\u80cc\u666f\u78c1\u573a\u4e2d\uff0c\u8fd9\u79cd\u9891\u7387\u7684\u96c6\u80a4\u6df1\u5ea6\u5c0f\u4e8e\u7403\u4f53\u534a\u5f84\u3002\u672c\u4f8b\u8ba1\u7b97\u7403\u4f53\u4e2d\u7684\u611f\u5e94\u7535\u6d41\u4ee5\u53ca\u5bf9\u80cc\u666f\u573a\u7684\u6270\u52a8\uff0c\u6b64\u5916\uff0c\u8fd8\u8ba8\u8bba\u4e86\u5982\u4f55\u6b63\u786e\u5730\u5bf9\u5177\u6709\u660e\u663e\u96c6\u80a4\u6548\u5e94\u7684\u57df\u8fdb\u884c\u7f51\u683c\u5212\u5206\u3002");
