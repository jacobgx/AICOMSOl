/*
 * iron_sphere_bfield_02_60hz.java
 */
...
public class iron_sphere_bfield_02_60hz {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("mf").feature("fsp1").set("freqType", "user_defined");
    model.component("comp1").physics("mf").feature("fsp1").set("sigma_stab_mat", "userdef");
    model.component("comp1").physics("mf").feature("fsp1")
         .set("sigma_stab", new String[]{"sigma_air", "0", "0", "0", "sigma_air", "0", "0", "0", "sigma_air"});

    model.component("comp1").mesh("mesh1").autoMeshSize(4);
    model.component("comp1").mesh("mesh1").run();

    model.study("std1").label("\u7814\u7a76 1 - \u4e0d\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d");
    ...
    model.result().dataset("dset1").label("\u7814\u7a76 1 - \u4e0d\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d");
    ...
    model.result("pg2").label("\u7535\u6d41\u5bc6\u5ea6 - \u4e0d\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d");
    ...
    model.result("pg2").feature("slc1").set("descr", "\u7535\u6d41\u5bc6\u5ea6\u6a21");
    ...
    model.result("pg2").feature("arwv1").set("expr", new String[]{"mf.Jx", "mf.Jy", "mf.Jz"});
    model.result("pg2").feature("arwv1").set("descr", "\u7535\u6d41\u5bc6\u5ea6");
    ...
    model.result().numerical("max1").label("\u96c6\u80a4\u6df1\u5ea6 - \u94c1\u7403");
    model.result().numerical("max1").selection().named("sel1");
    model.result().numerical("max1").set("expr", new String[]{"mf.deltaS"});
    model.result().numerical("max1").set("descr", new String[]{"\u96c6\u80a4\u6df1\u5ea6"});
    model.result().numerical("max1").set("unit", new String[]{"mm"});
    model.result().table().create("tbl1", "Table");
    model.result().table("tbl1").comments("\u96c6\u80a4\u6df1\u5ea6 - \u94c1\u7403");
    ...
    model.result().numerical("max2")
         .label("\u96c6\u80a4\u6df1\u5ea6 - \u7a7a\u6c14\uff08\u4e0d\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d\uff09");
    model.result().numerical("max2").selection().named("com1");
    model.result().numerical("max2").set("expr", new String[]{"mf.deltaS"});
    model.result().numerical("max2").set("descr", new String[]{"\u96c6\u80a4\u6df1\u5ea6"});
    model.result().numerical("max2").set("unit", new String[]{"mm"});
    model.result().table().create("tbl2", "Table");
    model.result().table("tbl2")
         .comments("\u96c6\u80a4\u6df1\u5ea6 - \u7a7a\u6c14\uff08\u4e0d\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d\uff09");
    ...
    model.result().numerical("int1").label("\u78c1\u8017\u6563 - \u94c1\u7403");
    ...
    model.study("std1").feature("freq").set("disabledphysics", new String[]{"mf/gfa1"});
    ...
    model.study("std2").feature("freq").setIndex("plistarr_aux", 10, 0);
    model.study("std2").label("\u7814\u7a76 2 - \u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg4").label("\u7535\u6d41\u5bc6\u5ea6 - \u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d");
    model.result("pg4").set("data", "dset2");
    model.result("pg4").run();
    model.result().numerical().create("max3", "MaxVolume");
    model.result().numerical("max3")
         .label("\u96c6\u80a4\u6df1\u5ea6 - \u7a7a\u6c14\uff08\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d\uff09");
    model.result().numerical("max3").set("data", "dset2");
    model.result().numerical("max3").selection().named("com1");
    model.result().numerical("max3").set("expr", new String[]{"mf.deltaS"});
    model.result().numerical("max3").set("descr", new String[]{"\u96c6\u80a4\u6df1\u5ea6"});
    model.result().numerical("max3").set("unit", new String[]{"mm"});
    model.result().table().create("tbl5", "Table");
    model.result().table("tbl5")
         .comments("\u96c6\u80a4\u6df1\u5ea6 - \u7a7a\u6c14\uff08\u4f7f\u7528\u201c\u89c4\u8303\u56fa\u5b9a\u201d\uff09");
    ...
    model.result().numerical("int3").set("expr", new String[]{"mf.Qrh"});
    model.result().numerical("int3").set("descr", new String[]{"\u4f53\u79ef\u635f\u8017\u5bc6\u5ea6\uff0c\u7535"});
    ...
    model.result("pg4").feature("mslc2").set("titletype", "auto");
    model.result("pg4").feature("mslc2").set("multiplanexmethod", "coord");
    model.result("pg4").feature("mslc2").set("multiplaneymethod", "coord");
    model.result("pg4").feature("mslc2").set("multiplanezmethod", "coord");
    model.result("pg4").feature("mslc2").set("coloring", "colortable");
    model.result("pg3").run();
    ...
    model.result("pg4").feature("strmsl2").set("multiplanexmethod", "coord");
    model.result("pg4").feature("strmsl2").set("multiplaneymethod", "coord");
    model.result("pg4").feature("strmsl2").set("multiplanezmethod", "coord");
    model.result("pg4").feature("strmsl2").set("titletype", "none");
    model.result("pg4").feature("strmsl2").set("posmethod", "uniform");
    model.result("pg4").feature("strmsl2").set("uadv", "automatic");
    model.result("pg4").feature("strmsl2").set("posmethod", "uniform");
    model.result("pg4").feature("strmsl2").set("madv", "automatic");
    model.result("pg4").feature("strmsl2").set("linetype", "line");
    model.result("pg4").feature("strmsl2").set("arrowlength", "normalized");
    model.result("pg4").run();
    ...
    model.result("pg4").feature("surf1").set("descr", "\u6750\u6599\u8bbe\u7f6e");
    ...
    model.title("\u78c1\u573a\u4e2d\u7684\u94c1\u7403 - 60 Hz");

    model
         .description("\u4e00\u4e2a\u94c1\u7403\u66b4\u9732\u5728\u7a7a\u95f4\u5747\u5300\u5e76\u4ee5 60 Hz \u7684\u9891\u7387\u6b63\u5f26\u65f6\u53d8\u7684\u80cc\u666f\u78c1\u573a\u4e2d\uff0c\u7531\u4e8e\u9891\u7387\u8db3\u591f\u4f4e\uff0c\u56e0\u6b64\u96c6\u80a4\u6df1\u5ea6\u5927\u4e8e\u7403\u4f53\u534a\u5f84\u3002\u672c\u4f8b\u8ba1\u7b97\u7403\u4f53\u4e2d\u7684\u611f\u5e94\u7535\u6d41\u4ee5\u53ca\u5bf9\u80cc\u666f\u573a\u7684\u6270\u52a8\uff0c\u4f7f\u7528\u4e24\u79cd\u65b9\u6cd5\u6765\u8fdb\u884c\u6c42\u89e3\uff0c\u5e76\u901a\u8fc7\u6bd4\u8f83\u6a21\u578b\u4e0d\u540c\u57df\u4e2d\u7684\u78c1\u8017\u6563\u6765\u8bc4\u4f30\u5b83\u4eec\u7684\u6027\u80fd\u3002");
