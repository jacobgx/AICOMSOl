...
//    model.param().loadFile("FILENAME");
    ...
    model.geom("part3").feature("sel1").label("\u4e0a\u90e8\u94c1\u82af");
    ...
    model.component("comp1").selection("int2").label("\u79fb\u52a8\u8fb9\u754c");
    ...
    model.component("comp1").selection("adj4").label("\u5916\u90e8\u8fb9\u754c\u5230\u94c1\u82af");
    ...
    model.component("comp1").physics("mf").create("ge1", "GlobalEquations", -1);
    model.component("comp1").physics("mf").feature("ge1").setIndex("name", "vv", 0, 0);
    model.component("comp1").physics("mf").feature("ge1")
         .setIndex("equation", "vvt-if(at_bottom,0,min(mf.Forcez_0+k0*(x0-disp),0)/mass)", 0, 0);
    model.component("comp1").physics("mf").feature("ge1")
         .setIndex("description", "\u94c1\u67f1\u585e\u7684\u5782\u76f4\u901f\u5ea6", 0, 0);
    model.component("comp1").physics("mf").feature("ge1").set("DependentVariableQuantity", "velocity");
    model.component("comp1").physics("mf").feature("ge1").set("SourceTermQuantity", "acceleration");
    model.component("comp1").physics("mf").create("ge2", "GlobalEquations", -1);
    model.component("comp1").physics("mf").feature("ge2").setIndex("name", "dd", 0, 0);
    model.component("comp1").physics("mf").feature("ge2").setIndex("equation", "vv-ddt", 0, 0);
    model.component("comp1").physics("mf").feature("ge2")
         .setIndex("description", "\u94c1\u67f1\u585e\u7684\u5782\u76f4\u4f4d\u79fb", 0, 0);
    model.component("comp1").physics("mf").feature("ge2").set("DependentVariableQuantity", "displacement");
    model.component("comp1").physics("mf").feature("ge2").set("SourceTermQuantity", "velocity");

    model.component("comp1").variable().create("var1");
    model.component("comp1").variable("var1").set("at_bottom", "dd<(-maxdisp)");
    model.component("comp1").variable("var1")
         .descr("at_bottom", "\u903b\u8f91\u53d8\u91cf\uff0c\u5f53\u94c1\u67f1\u585e\u4f4d\u4e8e\u5e95\u90e8\u65f6\u5176\u503c\u4e3a 1");
    model.component("comp1").variable("var1").set("disp", "if(at_bottom, -maxdisp, dd)");
    model.component("comp1").variable("var1").descr("disp", "\u94c1\u67f1\u585e\u7684\u4f4d\u79fb");
    model.component("comp1").variable("var1").set("vel", "if(at_bottom, 0, vv)");
    model.component("comp1").variable("var1").descr("vel", "\u94c1\u67f1\u585e\u7684\u901f\u5ea6");
    ...
    model.component("comp1").common("pres1").selection().named("uni1");
    model.component("comp1").common("pres1").set("prescribedDeformation", new String[]{"0", "0", "disp"});
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg3").feature("mesh1").feature("sel1").selection()
    ...
    model.result("pg4").label("\u9762\u5916\u7535\u6d41\u5bc6\u5ea6\u548c\u78c1\u901a\u7ebf");
    ...
    model.result("pg4").feature("str1").set("expr", new String[]{"mf.Bx", "mf.Bz"});
    ...
    model.result("pg5").feature("str1").set("expr", new String[]{"mf.Jx", "mf.Jy", "mf.Jz"});
    ...
    model.result("pg5").feature("vol1").set("rangecolormax", 60);
    ...
    model.result("pg5").feature("vol2").create("trn1", "Transformation");
    model.result("pg5").run();
    model.result("pg5").feature("vol2").feature("trn1").set("move", new double[]{-0.1, 0, 0});
    model.result("pg5").run();
    ...
    model.result("pg5").run();
    model.result("pg5").feature("vol3").feature("trn1").set("move", new double[]{-0.2, 0, 0});
    model.result("pg5").run();
    ...
    model.result("pg6").label("\u5207\u6362\u524d\u7cfb\u7edf\u7684\u52a8\u529b\u5b66");
    ...
    model.result("pg6").feature("glob1").setIndex("descr", "\u5f52\u4e00\u5316\u7684\u95f4\u9699\u5927\u5c0f", 1);
    ...
    model.result("pg7").label("\u5207\u6362\u8fc7\u7a0b\u4e2d\u7cfb\u7edf\u7684\u52a8\u529b\u5b66");
    model.result("pg7").run();
    ...
    model.result("pg8").label("\u5b8c\u6574\u7cfb\u7edf\u7684\u52a8\u529b\u5b66");
    ...
    model.title("\u7535\u6e90\u5f00\u5173\u7684\u7535\u52a8\u529b\u5b66");

    model
         .description("\u8fc7\u7535\u6d41\u6216\u8fc7\u8f7d\u7b49\u7535\u6c14\u6545\u969c\u4f1a\u4e25\u91cd\u7834\u574f\u7535\u8def\u6216\u8f93\u7535\u7ebf\u3002\u4e3a\u4e86\u907f\u514d\u5173\u952e\u96f6\u4ef6\u66f4\u6362\u4ea7\u751f\u7684\u9ad8\u6210\u672c\u8d39\u7528\uff0c\u53ef\u4ee5\u5b89\u88c5\u7535\u5f00\u5173\u65ad\u8def\u5668\u3002\u53ea\u8981\u7535\u6d41\u8fbe\u5230\u4e34\u754c\u503c\uff0c\u65ad\u8def\u5668\u7acb\u5373\u79fb\u52a8\u67f1\u585e\uff0c\u4ece\u800c\u4ee5\u673a\u68b0\u65b9\u5f0f\u5207\u65ad\u5f3a\u5927\u7684\u7535\u6d41\u3002\u4fdd\u9669\u4e1d\u89e6\u53d1\u540e\u5fc5\u987b\u66f4\u6362\u4ee5\u4fdd\u62a4\u5468\u56f4\u7684\u7535\u6c14\u90e8\u4ef6\uff0c\u76f8\u6bd4\u4e4b\u4e0b\uff0c\u65ad\u8def\u5668\u53ef\u4ee5\u91cd\u7f6e\u3002\n\n\u672c\u6559\u5b66\u6a21\u578b\u7684\u4e3b\u8981\u76ee\u7684\u662f\u63a2\u8ba8\u4ee5\u4e0b\u4e00\u7c7b\u65ad\u8def\u5668\u5efa\u6a21\u7684\u5de5\u4f5c\u539f\u7406\u53ca\u53ef\u80fd\u7684\u89e3\uff1a\u78c1\u529b\u5f00\u5173\u3002\u6b64\u673a\u7535\u88c5\u7f6e\u4e2d\uff0c\u7ed5\u5728\u94c1\u67f1\u585e\u4e0a\u7684\u7ebf\u5708\u4e2d\u6d41\u8fc7\u7535\u6d41\uff0c\u4ea7\u751f\u78c1\u5f15\u529b\uff0c\u4ece\u800c\u79fb\u52a8\u94c1\u67f1\u585e\u3002\u5207\u65ad\u9a71\u52a8\u7535\u6d41\u53ef\u4ee5\u4f7f\u5f00\u5173\u91cd\u7f6e\u56de\u5176\u521d\u59cb\u72b6\u6001\u3002\n\n\u6b64\u6a21\u578b\u6a21\u62df\u53d7\u4ee5\u4e0b\u5404\u8981\u7d20\u5f71\u54cd\u7684\u521a\u4f53\u52a8\u529b\u5b66\uff1a\u78c1\u529b\u3001\u611f\u5e94\u7535\u6d41\u4ee5\u53ca\u5c06\u67f1\u585e\u4fdd\u6301\u5728\u5e73\u8861\u4f4d\u7f6e\u7684\u5f39\u7c27/\u7ea6\u675f\u88c5\u7f6e\u3002\u94dc\u7ebf\u5708\u7ed5\u5728\u4fdd\u6301\u56fa\u5b9a\u7684\u4e0b\u65b9 E \u78c1\u82af\u7684\u4e2d\u5fc3\u652f\u67f1\u4e0a\u3002\u5f53\u7535\u6d41\u6d41\u7ecf\u7ebf\u5708\u65f6\uff0c\u5728\u4e0a\u65b9 E \u78c1\u82af\uff08\u53ef\u79fb\u52a8\u67f1\u585e\uff09\u4e2d\u4ea7\u751f\u5438\u5f15\u529b\uff0c\u9884\u5e94\u529b\u5f39\u7c27\u4f7f\u5176\u4fdd\u6301\u5728\u539f\u4f4d\u3002\u5f53\u78c1\u5f15\u529b\u8fbe\u5230\u9608\u503c\u65f6\uff0c\u67f1\u585e\u79fb\u5411\u4e0b\u65b9\u7684 E \u78c1\u82af\uff0c\u4f7f\u7a7a\u6c14\u95f4\u9699\u95ed\u5408\u3002\u6a21\u578b\u9610\u660e\u5982\u4f55\u6b63\u786e\u6a21\u62df\u4e0e\u5f39\u7c27\u521a\u5ea6\u76f8\u5173\u7684\u79fb\u52a8\u548c\u95ed\u5408\u65f6\u95f4\u3002");
