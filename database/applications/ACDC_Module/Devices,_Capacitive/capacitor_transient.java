...
public class capacitor_transient {
  ...
  public static Model run() {
    ...
    model.param().descr("R", "\u5916\u63a5\u7535\u963b\u7684\u963b\u6297");
    model.param().set("C", "43.4[pF]");
    model.param().descr("C", "\u5668\u4ef6\u7535\u5bb9");
    ...
    model.component("comp1").physics("cir").feature("R1").set("R", "R");
    ...
    model.component("comp1").material("mat1").propertyGroup("def")
         .set("electricconductivity", new String[]{"5e-15[S/m]"});
    ...
    model.result("pg2").feature("glob1").set("expr", new String[]{"ec.I0_1"});
    ...
    model.result("pg2").feature("glob2").setIndex("descr", "\u89e3\u6790\u8fd1\u4f3c\u503c", 0);
    model.result("pg2").run();
    ...
    model.result("pg3").feature("ptgr1").setIndex("legends", "\u611f\u5e94\u4f20\u5bfc\u7535\u6d41\u5bc6\u5ea6", 0);
    model.result("pg3").run();
    model.result("pg3").feature().duplicate("ptgr2", "ptgr1");
    model.result("pg3").run();
    model.result("pg3").feature("ptgr2").set("expr", "-ec.Jdz");
    model.result("pg3").feature("ptgr2").setIndex("legends", "\u4f4d\u79fb\u7535\u6d41\u5bc6\u5ea6", 0);
    model.result("pg3").run();
    ...
    model.title("\u7535\u8def\u4e2d\u7535\u5bb9\u5668\u7684\u77ac\u6001\u5efa\u6a21");

    model
         .description("\u672c\u4f8b\u6c42\u89e3\u4e0e\u5916\u52a0\u7535\u8def\u8fde\u63a5\u65f6\u7535\u5bb9\u5668\u7684\u77ac\u6001\u6a21\u578b\u3002\u7535\u5bb9\u5668\u7684\u6709\u9650\u5143\u6a21\u578b\u4e0e\u5305\u542b\u7535\u538b\u6e90\u548c\u7535\u963b\u7684\u7535\u8def\u6a21\u578b\u76f8\u7ec4\u5408\u3002\u65bd\u52a0\u7684\u7535\u52bf\u5448\u9636\u8dc3\u53d8\u5316\uff0c\u5176\u4e2d\u8ba1\u7b97\u7535\u5bb9\u5668\u4e0a\u7684\u77ac\u6001\u7535\u6d41\u53d8\u5316\uff0c\u5e76\u5c06\u7ed3\u679c\u4e0e\u89e3\u6790\u7ed3\u679c\u8fdb\u884c\u6bd4\u8f83\u3002");
