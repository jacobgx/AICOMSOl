...
public class busbar_terminal {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").insertFile("busbar_terminal_geom_sequence.mph", "geom1");
    ...
    model.component("comp1").selection("sel1").label("\u949b\u87ba\u6813");
    ...
    model.component("comp1").physics("ec").feature("term1").selection().set(43);
    model.component("comp1").physics("ec").feature("term1").set("I0", "I");
    model.component("comp1").physics("ec").create("term2", "Terminal", 2);
    model.component("comp1").physics("ec").feature("term2").selection().set(8, 15);
    model.component("comp1").physics("ec").feature("term2").set("TerminalType", "Voltage");
    model.component("comp1").physics("ec").feature("term2").set("V0", 0);
    ...
    model.result("pg3").feature("mmv1").set("descr", "\u6e29\u5ea6");
    model.result("pg3").run();
    ...
    model.title("\u5e26\u7ec8\u7aef\u7684\u6bcd\u7ebf\u677f\u4e2d\u7684\u7126\u8033\u70ed");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u4f7f\u7528\u7535\u6d41\u7ec8\u7aef\u6765\u8ba1\u7b97\u6bcd\u7ebf\u677f\u7684\u7535\u963b\u70ed\u3002");
