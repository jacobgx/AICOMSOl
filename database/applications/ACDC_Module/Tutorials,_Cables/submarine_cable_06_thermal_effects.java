/*
 * submarine_cable_06_thermal_effects.java
 */
...
public class submarine_cable_06_thermal_effects {
...
//    model.param("par3").loadFile("FILENAME");
  ...
  public static Model run3(Model model) {
    ...
    model.component("comp1").physics("mf").feature("coil3").set("ConductorModel", "Single");
    model.component("comp1").physics("mf").feature().remove("coil4");

    model.param().create("par4");
    model.param("par4").label("\u70ed\u53c2\u6570");

//    To import content from file, use:
//    model.param("par4").loadFile("FILENAME");
    model.param("par4")
         .set("Ntcon", "0.075281", "\u4e3b\u5bfc\u4f53\u70ed\u5305\u88c5\u5bc6\u5ea6\uff08\u76f8\uff09");
    model.param("par4").set("Tmcon", "89.4[degC]", "\u4e3b\u5bfc\u4f53\u5e73\u5747\u6e29\u5ea6\uff08\u76f8\uff09");
    model.param("par4")
         .set("Tmpbs", "82.7[degC]", "\u5c4f\u853d\u5c42\u5e73\u5747\u6e29\u5ea6\uff08\u94c5\u5305\uff09");
    model.param("par4").set("Tmarm", "70.1[degC]", "\u94e0\u88c5\u73af\u5e73\u5747\u6e29\u5ea6");
    model.param("par4").set("Tmext", "20[degC]", "\u5916\u90e8\u6e29\u5ea6\uff08\u6d77\u5e8a\uff09");
    model.param("par4").set("Tmref", "20[degC]", "\u7ebf\u6027\u7535\u963b\u7387\u53c2\u8003\u6e29\u5ea6");
    model.param("par4").set("R0cup", "1/Scup", "\u53c2\u8003\u7535\u963b\u7387\uff0c\u94dc\uff0c20\u00b0C");
    model.param("par4").set("R0pbs", "1/Spbs", "\u53c2\u8003\u7535\u963b\u7387\uff0c\u94c5\u5305\uff0c20\u00b0C");
    model.param("par4")
         .set("R0arm", "1/Sarm", "\u53c2\u8003\u7535\u963b\u7387\uff0c\u94e0\u88c5\u7ebf\uff0c20\u00b0C");
    model.param("par4").set("ALcup", "3.9e-3[1/K]", "\u7535\u963b\u7387\u6e29\u5ea6\u7cfb\u6570\uff0c\u94dc");
    model.param("par4").set("ALpbs", "3.86e-3[1/K]", "\u7535\u963b\u7387\u6e29\u5ea6\u7cfb\u6570\uff0c\u94c5\u5305");
    model.param("par4")
    ...
    model.component("comp1").physics("ht").selection().named("geom1_r1_dom");

    model.component("comp1").multiphysics().create("emh1", "ElectromagneticHeating", 2);
    model.component("comp1").multiphysics("emh1").selection().named("geom1_c22_dom");
    ...
    model.component("comp1").material("mat11").propertyGroup("def")
         .set("thermalconductivity", new String[]{"Ntcon*400[W/(m*K)]"});
    model.component("comp1").material().duplicate("mat14", "mat1");
    model.component("comp1").material("mat14").label("\u70ed\u63a5\u89e6\u5c42");
    model.component("comp1").material("mat14").selection().geom("geom1", 1);
    model.component("comp1").material("mat14").selection().named("adj1");

    model.component("comp1").physics("ht").create("sls1", "SolidLayeredShell", 1);
    model.component("comp1").physics("ht").feature("sls1").selection().named("adj1");
    model.component("comp1").physics("ht").feature("sls1").set("lth_mat", "userdef");
    model.component("comp1").physics("ht").feature("sls1").set("lth", "20[um]");
    model.component("comp1").physics("ht").create("temp1", "TemperatureBoundary", 1);
    model.component("comp1").physics("ht").feature("temp1").selection().set(1, 2, 3, 5, 10, 11);
    model.component("comp1").physics("ht").feature("temp1").set("T0", "Tmext");
    ...
    model.component("comp1").material("mat11").propertyGroup("linzRes").set("rho0", new String[]{"R0cup/Ncon"});
    model.component("comp1").material("mat11").propertyGroup("linzRes").set("alpha", new String[]{"ALcup"});
    model.component("comp1").material("mat11").propertyGroup("linzRes").set("Tref", new String[]{"Tmref"});
    model.component("comp1").material("mat12").propertyGroup("linzRes").set("rho0", new String[]{"R0pbs"});
    model.component("comp1").material("mat12").propertyGroup("linzRes").set("alpha", new String[]{"ALpbs"});
    model.component("comp1").material("mat12").propertyGroup("linzRes").set("Tref", new String[]{"Tmref"});
    model.component("comp1").material("mat13").propertyGroup("linzRes").set("rho0", new String[]{"R0arm"});
    model.component("comp1").material("mat13").propertyGroup("linzRes").set("alpha", new String[]{"ALarm"});
    model.component("comp1").material("mat13").propertyGroup("linzRes").set("Tref", new String[]{"Tmref"});
    ...
    model.result("pg1").run();
    model.result().numerical("int1").setIndex("descr", "\u76f8\u635f\u8017\uff08\u7ebf\u6027\u76f8\uff09", 0);
    model.result().numerical("int1").set("table", "tbl1");
    model.result().numerical("int1").appendResult();
    model.result().numerical("int2")
         .setIndex("descr", "\u5c4f\u853d\u5c42\u635f\u8017\uff08\u7ebf\u6027\u76f8\uff09", 0);
    model.result().numerical("int2").set("table", "tbl2");
    model.result().numerical("int2").appendResult();
    model.result().numerical("int3").setIndex("descr", "\u94e0\u88c5\u635f\u8017\uff08\u7ebf\u6027\u76f8\uff09", 0);
    model.result().numerical("int3").set("table", "tbl3");
    model.result().numerical("int3").appendResult();
    model.result("pg2").run();
    model.result("pg2").run();
    ...
    model.component("comp1").physics("mf").feature("als2").selection().named("geom1_uni3_dom");
    ...
    model.component("comp1").physics("mf").feature("als3").selection().named("geom1_c19_dom");
    ...
    model.result("pg1").run();
    model.result().numerical("int1")
         .setIndex("descr", "\u76f8\u635f\u8017\uff08\u8026\u5408\u611f\u5e94\u52a0\u70ed\uff09", 0);
    model.result().numerical("int1").set("table", "tbl1");
    model.result().numerical("int1").appendResult();
    model.result().numerical("int2")
         .setIndex("descr", "\u5c4f\u853d\u5c42\u635f\u8017\uff08\u8026\u5408\u611f\u5e94\u52a0\u70ed\uff09", 0);
    model.result().numerical("int2").set("table", "tbl2");
    model.result().numerical("int2").appendResult();
    model.result().numerical("int3")
         .setIndex("descr", "\u94e0\u88c5\u635f\u8017\uff08\u8026\u5408\u611f\u5e94\u52a0\u70ed\uff09", 0);
    model.result().numerical("int3").set("table", "tbl3");
    model.result().numerical("int3").appendResult();
    model.result().numerical("gev1").set("data", "dset1");
    model.result().numerical("gev1").setIndex("unit", "mohm/km", 0);
    model.result().numerical("gev1")
         .setIndex("descr", "\u76f8\u4ea4\u6d41\u7535\u963b\uff08\u8026\u5408\u611f\u5e94\u52a0\u70ed\uff09", 0);
    model.result().numerical("gev1").setIndex("expr", "Rcon*(1+ALcup*(Tmcon-Tmref))", 1);
    model.result().numerical("gev1")
         .setIndex("descr", "\u6bcf\u76f8\u4e3b\u5bfc\u4f53\u76f4\u6d41\u7535\u963b\uff0c90\u00b0C\uff08\u89e3\u6790\uff09", 1);
    model.result().numerical("gev1").set("table", "tbl4");
    model.result().numerical("gev1").appendResult();
    model.result().numerical("gev2").set("data", "dset1");
    model.result().numerical("gev2").setIndex("unit", "mH/km", 0);
    model.result().numerical("gev2")
         .setIndex("descr", "\u76f8\u7535\u611f\uff08\u8026\u5408\u611f\u5e94\u52a0\u70ed\uff09", 0);
    model.result().numerical("gev2").set("table", "tbl5");
    model.result().numerical("gev2").appendResult();
    model.result("pg2").run();
    model.result("pg2").run();
    ...
    model.result().numerical("av1").label("\u5e73\u5747\u6e29\u5ea6");
    model.result().numerical("av1").selection().named("uni1");
    model.result().numerical("av1").setIndex("unit", "degC", 0);
    model.result().numerical("av1").setIndex("descr", "\u6e29\u5ea6\uff08\u76f8\uff09", 0);
    model.result().table().create("tbl6", "Table");
    model.result().table("tbl6").comments("\u5e73\u5747\u6e29\u5ea6");
    model.result().numerical("av1").set("table", "tbl6");
    model.result().numerical("av1").setResult();
    model.result().numerical("av1").selection().named("geom1_uni3_dom");
    model.result().numerical("av1").setIndex("descr", "\u6e29\u5ea6\uff08\u5c4f\u853d\u5c42\uff09", 0);
    model.result().numerical("av1").set("table", "tbl6");
    model.result().numerical("av1").appendResult();
    model.result().numerical("av1").selection().named("geom1_c19_dom");
    model.result().numerical("av1").setIndex("descr", "\u6e29\u5ea6\uff08\u94e0\u88c5\uff09", 0);
    model.result().numerical("av1").set("table", "tbl6");
    model.result().numerical("av1").appendResult();

    model.component("comp1").cpl().create("aveop1", "Average");
    model.component("comp1").cpl("aveop1").set("axisym", true);
    model.component("comp1").cpl("aveop1").selection().named("uni1");

    model.component("comp1").func().create("an1", "Analytic");
    model.component("comp1").func("an1").label("\u7ebf\u6027\u7535\u963b");
    model.component("comp1").func("an1").set("funcname", "Rac");
    model.component("comp1").func("an1").set("expr", "1.39*Rcon*(1+ALcup*(T-Tmref))");
    model.component("comp1").func("an1").set("args", "T");
    model.component("comp1").func("an1").setIndex("argunit", "K", 0);
    model.component("comp1").func("an1").set("fununit", "ohm/m");
    model.component("comp1").func("an1").setIndex("plotargs", "80[degC]", 0, 1);
    model.component("comp1").func("an1").setIndex("plotargs", "100[degC]", 0, 2);
    ...
    model.component("comp1").physics("ge").feature("ge1").setIndex("name", "Scup2", 0, 0);
    model.component("comp1").physics("ge").feature("ge1")
         .setIndex("equation", "Rac(aveop1(T))-(mf.RCoil_1/1[m]+mf.RCoil_2/1[m]+mf.RCoil_3/1[m])/3", 0, 0);
    model.component("comp1").physics("ge").feature("ge1").setIndex("initialValueU", "Scup", 0, 0);
    ...
    model.component("comp1").physics("ge").feature("ge1").setIndex("CustomDependentVariableUnit", "S/m", 0, 0);
    ...
    model.component("comp1").physics("ge").feature("ge1").setIndex("CustomSourceTermUnit", "ohm/m", 0, 0);
    model.component("comp1").physics("ge").feature("ge1").set("valueType", "real");
    model.component("comp1").physics("mf").feature("coil1").set("ConstitutiveRelationJcE", "ElectricalConductivity");
    model.component("comp1").physics("mf").feature("coil1").set("ConductorModel", "Multi");
    model.component("comp1").physics("mf").feature("coil1").set("sigmaCoil", "Scup2");
    model.component("comp1").physics("mf").feature("coil2").set("ConstitutiveRelationJcE", "ElectricalConductivity");
    model.component("comp1").physics("mf").feature("coil2").set("ConductorModel", "Multi");
    model.component("comp1").physics("mf").feature("coil2").set("sigmaCoil", "Scup2");
    model.component("comp1").physics("mf").feature("coil3").set("ConstitutiveRelationJcE", "ElectricalConductivity");
    model.component("comp1").physics("mf").feature("coil3").set("ConductorModel", "Multi");
    model.component("comp1").physics("mf").feature("coil3").set("sigmaCoil", "Scup2");

    model.sol("sol1").createAutoSequence("std1");
    model.sol("sol1").feature("s1").create("se1", "Segregated");
    model.sol("sol1").feature("s1").feature("se1").feature("ssDef").set("segvar", new String[]{"comp1_A"});
    model.sol("sol1").feature("s1").feature("se1").create("ss1", "SegregatedStep");
    model.sol("sol1").feature("s1").feature("se1").feature("ss1")
         .set("segvar", new String[]{"comp1_ht_TextFace", "comp1_T", "comp1_ODE1"});
    ...
    model.result("pg2").run();
    model.result("pg2").run();
    model.result().numerical("int1").setIndex("descr", "\u76f8\u635f\u8017\uff08\u9884\u8bbe Rac\uff09", 0);
    model.result().numerical("int1").set("table", "tbl1");
    model.result().numerical("int1").appendResult();
    model.result().numerical("int2")
         .setIndex("descr", "\u5c4f\u853d\u5c42\u635f\u8017\uff08\u9884\u8bbe Rac\uff09", 0);
    model.result().numerical("int2").set("table", "tbl2");
    model.result().numerical("int2").appendResult();
  ...
  public static Model run4(Model model) {
    model.result().numerical("int3").setIndex("descr", "\u94e0\u88c5\u635f\u8017\uff08\u9884\u8bbe Rac\uff09", 0);
    model.result().numerical("int3").set("table", "tbl3");
    model.result().numerical("int3").appendResult();
    ...
    model.result().numerical("gev1").setIndex("unit", "mohm/km", 0);
    model.result().numerical("gev1")
         .setIndex("descr", "\u76f8\u4ea4\u6d41\u7535\u963b\uff08\u9884\u8bbe Rac\uff09", 0);
    model.result().numerical("gev1").set("table", "tbl4");
    model.result().numerical("gev1").appendResult();
    model.result().numerical("gev2").setIndex("descr", "\u76f8\u7535\u611f\uff08\u9884\u8bbe Rac\uff09", 0);
    model.result().numerical("gev2").set("table", "tbl5");
    model.result().numerical("gev2").appendResult();
    model.result("pg2").run();
    model.result("pg2").run();
    ...
    model.title("\u6d77\u5e95\u7535\u7f06 6 - \u70ed\u6548\u5e94");

    model
         .description("\u8fd9\u4e2a\u6559\u7a0b\u4ee5\u672c\u7cfb\u5217\u7684\u201c\u7535\u611f\u6548\u5e94\u201d\u6a21\u578b\u4e3a\u57fa\u7840\uff0c\u5728\u5176\u4e2d\u6dfb\u52a0\u70ed\u6548\u5e94\uff0c\u5305\u62ec\u6e29\u5ea6\u76f8\u5173\u7684\u7535\u5bfc\u7387\uff08\u901a\u8fc7\u7ebf\u6027\u7535\u963b\u7387\uff09\uff1b\u6f14\u793a\u5982\u4f55\u4f7f\u7528\u201c\u9891\u57df-\u7a33\u6001\u201d\u7814\u7a76\u7c7b\u578b\uff08\u611f\u5e94\u52a0\u70ed\uff09\u5b9e\u73b0\u7535\u78c1\u573a\u4e0e\u4f20\u70ed\u4e4b\u95f4\u7684\u591a\u7269\u7406\u573a\u8026\u5408\u3002\n\n\u672c\u4f8b\u7814\u7a76\u9ad8\u6e29\u5bf9\u76f8\u3001\u5c4f\u853d\u5c42\u548c\u94e0\u88c5\u635f\u8017\u7684\u5f71\u54cd\uff08\u5305\u542b\u9a8c\u8bc1\uff09\uff0c\u5f97\u5230\u7684\u6e29\u5ea6\u503c\u5728\u201c\u7535\u611f\u6548\u5e94\u4e09\u7ef4\u6a21\u578b\u201d\u6559\u7a0b\u4e2d\u7528\u4e8e\u5728\u4e09\u7ef4\u4e2d\u5e94\u7528\u4e00\u9636\u6e29\u5ea6\u6821\u6b63\u3002\u6700\u540e\uff0c\u6f14\u793a\u5982\u4f55\u5c06\u4ea7\u751f\u7684\u4ea4\u6d41\u7535\u963b\u4e0e IEC \u7cfb\u5217\u6807\u51c6\u7ed9\u51fa\u7684\u7ed3\u679c\u8fdb\u884c\u5339\u914d\u3002");
