/*
 * submarine_cable_08_inductive_effects_3d.java
 */
...
public class submarine_cable_08_inductive_effects_3d {
...
//    model.param("par5").loadFile("FILENAME");
    ...
    model.component("comp1").view("view1").camera().set("zscale", 1);
    model.component("comp1").view("view2").camera().set("viewscaletype", "manual");
    model.component("comp1").view("view2").camera().set("zscale", 2);
    model.component("comp1").view("view3").camera().set("viewscaletype", "manual");
    model.component("comp1").view("view3").camera().set("zscale", 2);
    model.component("comp1").view("view4").camera().set("viewscaletype", "manual");
    model.component("comp1").view("view4").camera().set("zscale", 2);
    model.component("comp1").view("view5").camera().set("zscale", 1);
    model.component("comp1").view("view5").camera().setIndex("position", "1.8*Dcab", 0);
    model.component("comp1").view("view5").camera().setIndex("position", "0.8*Dcab", 1);

    return model;
  }

  public static Model run5(Model model) {
    model.component("comp1").view("view5").camera().setIndex("position", "Lsec/(2*Nper)+0.5*Dcab", 2);
    model.component("comp1").view("view5").camera().setIndex("up", 0, 0);
    model.component("comp1").view("view5").camera().setIndex("up", 0, 1);
    model.component("comp1").view("view5").camera().set("up", new int[]{0, 0, 1});
    model.component("comp1").view("view5").camera().setIndex("viewoffset", 0, 0);
    model.component("comp1").view("view5").camera().set("viewoffset", new int[]{0, 0});

    model.component("comp1").geom("geom1").feature("wp1").label("\u76f8\u3001\u5c4f\u853d\u5c42\u548c\u6d77\u5e8a");
    model.component("comp1").geom("geom1").feature("wp1").set("quickz", "-Lsec/2+1e-6");
    model.component("comp1").geom("geom1").run("wp1");
    model.component("comp1").geom("geom1").feature("wp1").set("quickz", "-Lsec/2");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature().remove("csol1");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("rot2");
    model.component("comp1").geom("geom1").feature("wp1").geom().create("c2", "Circle");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("c2").set("r", "5*Dcab/2");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("c2");
    model.component("comp1").geom("geom1").feature("wp2").label("\u7535\u7f06\u94e0\u88c5");
    model.component("comp1").geom("geom1").run("wp2");
    model.component("comp1").geom("geom1").feature("wp2").geom().feature().remove("c1");
    model.component("comp1").geom("geom1").feature("wp2").geom().run("rot2");
    model.component("comp1").geom("geom1").feature("wp2").geom().create("csol1", "ConvertToSolid");
    model.component("comp1").geom("geom1").feature("wp2").geom().feature("csol1").selection("input").set("rot2");
    model.component("comp1").geom("geom1").feature("wp2").geom().run("csol1");
    model.component("comp1").geom("geom1").run("wp3");

    model.component("comp1").view("view8").axis().set("xmin", 0.09484034776687622);
    model.component("comp1").view("view8").axis().set("xmax", 0.11075928807258606);
    model.component("comp1").view("view8").axis().set("ymin", -0.006120188627392054);
    model.component("comp1").view("view8").axis().set("ymax", 0.006120188627392054);
    model.component("comp1").view("view8").set("locked", true);
    ...
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("ls6")
         .set("coord1", new String[]{"Darm/2-2*Tarm/3", "0"});
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("ls6").selection("vertex2")
         .set("sca3(35)", 5);
    model.component("comp1").geom("geom1").feature("wp3").geom().run("ls6");
    model.component("comp1").geom("geom1").feature("wp3").geom().create("ls7", "LineSegment");
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("ls7").set("specify1", "coord");
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("ls7")
         .set("coord1", new String[]{"Darm/2+2*Tarm/3", "0"});
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("ls7").selection("vertex2")
         .set("sca3(39)", 5);
    model.component("comp1").geom("geom1").feature("wp3").geom().run("ls7");

    model.component("comp1").view("view8").axis().set("xmin", 0.0868808776140213);
    model.component("comp1").view("view8").axis().set("xmax", 0.11871876567602158);
    model.component("comp1").view("view8").axis().set("ymin", -0.012580492533743382);
    model.component("comp1").view("view8").axis().set("ymax", 0.012580492533743382);
    model.component("comp1").view("view8").set("locked", true);

    model.component("comp1").geom("geom1").feature("wp3").geom().create("rot8", "Rotate");
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("rot8").selection("input")
         .set("ls6", "ls7");
    model.component("comp1").geom("geom1").feature("wp3").geom().feature("rot8")
         .set("rot", "360[deg]*range(1/Narm,1/Narm,1)");
    model.component("comp1").geom("geom1").feature("wp3").geom().run("rot8");
    model.component("comp1").geom("geom1").run("fin");

    model.component("comp1").selection().remove("dif5");
    model.component("comp1").selection().remove("cyl11");
    model.component("comp1").selection().remove("dif6");
    model.component("comp1").selection("cyl13").set("r", "Darm/2+Tarm");
    model.component("comp1").selection().create("cyl17", "Cylinder");

    model.nodeGroup("grp1").add("selection", "cyl17");

    model.component("comp1").selection("cyl17").label("\u590d\u5236\u9762 4");
    model.component("comp1").selection("cyl17").set("entitydim", 2);
    model.component("comp1").selection("cyl17").set("inputent", "selections");
    model.component("comp1").selection("cyl17").set("input", new String[]{"dif4"});
    model.component("comp1").selection("cyl17").set("r", "Darm/2");
    model.component("comp1").selection("cyl17").set("rin", "Darm/2-Tarm");
    model.component("comp1").selection("cyl17").set("condition", "allvertices");
    model.component("comp1").selection().duplicate("cyl18", "cyl17");

    model.nodeGroup("grp1").add("selection", "cyl18");

    model.component("comp1").selection("cyl18").label("\u590d\u5236\u9762 5");
    model.component("comp1").selection("cyl18").set("r", "Darm/2+Tarm");
    model.component("comp1").selection("cyl18").set("rin", "Darm/2");
    model.component("comp1").selection().create("cyl19", "Cylinder");

    model.nodeGroup("grp1").add("selection", "cyl19");

    model.component("comp1").selection("cyl19").label("\u81ea\u7531\u4e09\u89d2\u5f62\u7f51\u683c 3");
    model.component("comp1").selection("cyl19").set("entitydim", 2);
    model.component("comp1").selection("cyl19").set("inputent", "selections");
    model.component("comp1").selection("cyl19").set("input", new String[]{"cyl17", "cyl18"});
    model.component("comp1").selection("cyl19").set("r", "Tarm");
    model.component("comp1").selection("cyl19").set("pos", new String[]{"Darm/2", "Tarm/2", "0"});
    model.component("comp1").selection("cyl19").set("condition", "allvertices");
    model.component("comp1").selection().create("int6", "Intersection");

    model.nodeGroup("grp1").add("selection", "int6");

    model.component("comp1").selection("int6").label("\u590d\u5236\u9762 4\uff0c\u6e90\u8fb9\u754c");
    model.component("comp1").selection("int6").set("entitydim", 2);
    model.component("comp1").selection("int6").set("input", new String[]{"cyl17", "cyl19"});
    model.component("comp1").selection().create("dif5", "Difference");

    model.nodeGroup("grp1").add("selection", "dif5");

    model.component("comp1").selection("dif5").label("\u590d\u5236\u9762 4\uff0c\u76ee\u6807\u8fb9\u754c");
    model.component("comp1").selection("dif5").set("entitydim", 2);
    model.component("comp1").selection("dif5").set("add", new String[]{"cyl17"});
    model.component("comp1").selection("dif5").set("subtract", new String[]{"int6"});
    model.component("comp1").selection().create("int7", "Intersection");

    model.nodeGroup("grp1").add("selection", "int7");

    model.component("comp1").selection("int7").label("\u590d\u5236\u9762 5\uff0c\u6e90\u8fb9\u754c");
    model.component("comp1").selection("int7").set("entitydim", 2);
    model.component("comp1").selection("int7").set("input", new String[]{"cyl18", "cyl19"});
    model.component("comp1").selection().create("dif6", "Difference");

    model.nodeGroup("grp1").add("selection", "dif6");

    model.component("comp1").selection("dif6").label("\u590d\u5236\u9762 5\uff0c\u76ee\u6807\u8fb9\u754c");
    model.component("comp1").selection("dif6").set("entitydim", 2);
    model.component("comp1").selection("dif6").set("add", new String[]{"cyl18"});
    model.component("comp1").selection("dif6").set("subtract", new String[]{"int7"});
    model.component("comp1").selection().create("dif7", "Difference");

    model.nodeGroup("grp1").add("selection", "dif7");

    model.component("comp1").selection("dif7").label("\u81ea\u7531\u4e09\u89d2\u5f62\u7f51\u683c 4");
    model.component("comp1").selection("dif7").set("entitydim", 2);
    model.component("comp1").selection("dif7").set("add", new String[]{"cyl2"});
    model.component("comp1").selection("dif7")
         .set("subtract", new String[]{"int1", "int2", "int3", "cyl10", "cyl17", "cyl18"});

    model.component("comp1").mesh("mesh1").feature("map3").feature("size1").set("hmax", "2*Tpbs");
    model.component("comp1").mesh("mesh1").feature("map3").feature("size1").set("hmin", "2*Tpbs");
    model.component("comp1").mesh("mesh1").run("map3");
    model.component("comp1").mesh("mesh1").feature("ftri3").selection().named("cyl19");
    model.component("comp1").mesh("mesh1").feature("ftri3").feature("size1").selection().named("cyl19");
    model.component("comp1").mesh("mesh1").feature("ftri3").feature("size1").set("hgradactive", false);
    model.component("comp1").mesh("mesh1").run("ftri3");
    ...
    model.component("comp1").mesh("mesh1").feature("cpf4").selection("source").named("int6");
    model.component("comp1").mesh("mesh1").feature("cpf4").selection("destination").named("dif5");
    model.component("comp1").mesh("mesh1").run("cpf4");
    model.component("comp1").mesh("mesh1").run("ftri3");
    model.component("comp1").mesh("mesh1").run("cpf4");
    ...
    model.component("comp1").mesh("mesh1").feature("cpf5").selection("source").named("int7");
    model.component("comp1").mesh("mesh1").feature("cpf5").selection("destination").named("dif6");
    model.component("comp1").mesh("mesh1").run("cpf5");
    model.component("comp1").mesh("mesh1").run("cpf4");
    model.component("comp1").mesh("mesh1").run("cpf5");
    model.component("comp1").mesh("mesh1").run("map4");
    model.component("comp1").mesh("mesh1").feature("map4").selection().set(3232, 3233, 3243, 3244);
    model.component("comp1").mesh("mesh1").feature("map4").selection().named("cyl10");
    model.component("comp1").mesh("mesh1").create("ftri4", "FreeTri");
    model.component("comp1").mesh("mesh1").feature("ftri4").selection().named("dif7");
    ...
    model.component("comp1").mesh("mesh1").feature("ftri4").feature("size1").set("hmin", "Tarm");
    model.component("comp1").mesh("mesh1").feature("ftri4").feature("size1").set("hgradactive", true);
    model.component("comp1").mesh("mesh1").feature("ftri4").feature("size1").set("hgrad", 1.3);
    model.component("comp1").mesh("mesh1").run("ftri4");
    ...
    model.component("comp1").view("view5").set("showaxisorientation", false);
    model.component("comp1").view("view5").set("transparency", true);
    model.component("comp1").view("view5").set("renderwireframe", false);
    model.component("comp1").view("view5").set("showaxisorientation", true);

    model.component("comp1").mesh("mesh1").feature().remove("conv1");
    model.component("comp1").mesh("mesh1").feature("ftet1").set("zscale", 1);
    ...
    model.result("pg4").run();
    model.result().numerical("int1")
         .setIndex("descr", "\u76f8\u635f\u8017\uff08\u7ebf\u6027\u4e09\u7ef4\uff0c\u77ed\u5468\u671f\uff09", 0);
    model.result().numerical("int1").set("table", "tbl1");
    model.result().numerical("int1").appendResult();
    model.result().numerical("int2")
         .setIndex("descr", "\u5c4f\u853d\u5c42\u635f\u8017\uff08\u7ebf\u6027\u4e09\u7ef4\uff0c\u77ed\u5468\u671f\uff09", 0);
    model.result().numerical("int2").set("table", "tbl2");
    model.result().numerical("int2").appendResult();
    model.result().numerical("int3")
         .setIndex("descr", "\u94e0\u88c5\u635f\u8017\uff08\u7ebf\u6027\u4e09\u7ef4\uff0c\u77ed\u5468\u671f\uff09", 0);
    model.result().numerical("int3").set("table", "tbl3");
    model.result().numerical("int3").appendResult();
    model.result().numerical("gev1")
         .setIndex("descr", "\u76f8\u4ea4\u6d41\u7535\u963b\uff08\u7ebf\u6027\u4e09\u7ef4\uff0c\u77ed\u5468\u671f\uff09", 0);
    model.result().numerical("gev1").set("table", "tbl4");
    model.result().numerical("gev1").appendResult();
    model.result().numerical("gev2")
         .setIndex("descr", "\u76f8\u7535\u611f\uff08\u7ebf\u6027\u4e09\u7ef4\uff0c\u77ed\u5468\u671f\uff09", 0);
    model.result().numerical("gev2").set("table", "tbl5");
    model.result().numerical("gev2").appendResult();
    model.result("pg1").run();
    ...
    model.component("comp1").view("view2").set("transparency", false);
    ...
    model.title("\u6d77\u5e95\u7535\u7f06 8 - \u7535\u611f\u6548\u5e94\u4e09\u7ef4\u6a21\u578b");

    model
         .description("\u8fd9\u662f\u672c\u7cfb\u5217\u7684\u6700\u540e\u4e00\u7bc7\u6559\u7a0b\uff0c\u65e8\u5728\u4e3a\u7535\u7f06\u4e09\u7ef4\u5efa\u6a21\u63d0\u4f9b\u201c\u6700\u7ec8\u7684\u7b54\u6848\u201d\u3002\u672c\u6559\u7a0b\u6839\u636e\u4e1a\u5185\u591a\u4f4d\u4e13\u4e1a\u4eba\u58eb\u7684\u53cd\u9988\u800c\u5f00\u53d1\uff0c\u6027\u80fd\u548c\u7ec6\u8282\u6c34\u5e73\u65b9\u9762\u4e0e\u6700\u65b0\u7684\u7814\u7a76 (2020) \u76f8\u5f53\u3002\u5176\u4e2d\u5305\u542b\u9a8c\u8bc1\uff0c\u57fa\u4e8e\u591a\u7bc7\u5b66\u672f\u8bba\u6587\u548c\u7535\u7f06\u5b98\u65b9\u89c4\u683c\u6765\u5206\u6790\u6a21\u578b\u7684\u7279\u6027\u3002\n\n\u672c\u6559\u7a0b\u5206\u4e3a\u4e94\u4e2a\u90e8\u5206\uff1a\u9996\u5148\uff0c\u5bf9\u4e0d\u53d1\u751f\u626d\u8f6c\u7684\u7535\u7f06\u8fdb\u884c\u5efa\u6a21\uff0c\u5e76\u5c06\u5176\u4e0e\u66f4\u8be6\u7ec6\u7684\u4e8c\u7ef4\u6a21\u578b\u8fdb\u884c\u6bd4\u8f83\u3002\u7136\u540e\uff0c\u6dfb\u52a0\u626d\u8f6c\uff0c\u5e76\u518d\u6b21\u6c42\u89e3\u548c\u9a8c\u8bc1\u6a21\u578b\u3002\u7b2c\u4e09\u6b65\u662f\u6dfb\u52a0\u6e29\u5ea6\u6821\u6b63\uff0c\u7b2c\u56db\u6b65\u6f14\u793a\u4e86\u4e00\u79cd\u5b9e\u9a8c\u6570\u503c\u7a33\u5b9a\u6027\u65b9\u6cd5\u3002\u6700\u540e\uff0c\u5207\u6362\u5230\u4e0d\u540c\u7c7b\u578b\u7684\u5468\u671f\uff0c\u4ece\u800c\u5c06\u6a21\u578b\u5927\u5c0f\u51cf\u5c0f\u4e86\u4e00\u767e\u500d\uff0c\u540c\u65f6\u4ecd\u63d0\u4f9b\u76f8\u540c\u7684\u7cbe\u5ea6\u3002");
