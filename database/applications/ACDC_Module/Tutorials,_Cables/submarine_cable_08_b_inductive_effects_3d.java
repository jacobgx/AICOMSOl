/*
 * submarine_cable_08_b_inductive_effects_3d.java
 */
...
public class submarine_cable_08_b_inductive_effects_3d {
...
//    model.param("par3").loadFile("FILENAME");
    model.param("par3")
         .set("LLpha", "18*Dpha3", "\u4e3b\u5bfc\u4f53\u7684\u6577\u8bbe\u957f\u5ea6\uff08\u626d\u8f6c\u4e00\u4e2a\u5468\u671f\uff0c\u987a\u65f6\u9488\uff09");
    model.param("par3")
         .set("LLarm", "-15*Darm", "\u94e0\u88c5\u7ebf\u7684\u6577\u8bbe\u957f\u5ea6\uff08\u626d\u8f6c\u4e00\u4e2a\u5468\u671f\uff0c\u9006\u65f6\u9488\uff09");
    model.param("par3")
         .set("CPcab", "1/(1/LLpha-1/LLarm)", "\u7535\u7f06\u622a\u9762\u626d\u8f6c\u8282\u8ddd\uff08\u76f8\u4f4d\u7ebf\u5173\u4e8e\u94e0\u88c5\u626d\u8f6c\u4e00\u4e2a\u5468\u671f\uff09");
    model.param("par3")
         .set("Nper", "1/10", "\u5f15\u5165\u6a21\u578b\u7684\u5468\u671f\u6570\uff08\u8c03\u6574\u53c2\u6570\uff09");
    model.param("par3")
         .set("Tenab", "round(Nper)==Nper", "\u542f\u7528\u6216\u7981\u7528\u626d\u8f6c\uff1a1 \u6216 0 \uff08\u5f53 'Nper' \u4e3a\u6574\u6570\u65f6\u542f\u7528\uff09");
    model.param("par3")
         .set("Lsec", "CPcab*Nper", "\u5f15\u5165\u6a21\u578b\u7684\u7535\u7f06\u622a\u9762\u957f\u5ea6");
    model.param("par3")
         .set("Tsec", "360[deg]*Tenab*Lsec/LLpha", "\u5f15\u5165\u6a21\u578b\u7684\u7535\u7f06\u626d\u8f6c\u89d2");
    model.param("par3")
...
//    model.param("par4").loadFile("FILENAME");
    ...
    model.component("comp1").view("view8").axis().set("ymin", -0.014350522309541702);
    model.component("comp1").view("view8").axis().set("ymax", 0.014350522309541702);
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").geom("geom1").feature("swe1").selection("face").named("wp1");
    ...
    model.component("comp1").geom("geom1").feature("swe2").selection("face").named("wp2");
