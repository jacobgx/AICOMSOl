...
public class hinge_joint_assembly {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("mbd").feature("fix1").selection().set(133, 134, 135, 136);
    model.component("comp1").physics("mbd").create("rig1", "RigidConnector", 2);
    model.component("comp1").physics("mbd").feature("rig1").selection().set(67, 68);
    model.component("comp1").physics("mbd").feature("rig1").setIndex("Direction", true, 0);
    model.component("comp1").physics("mbd").feature("rig1").create("rf1", "RigidBodyForce", -1);
    model.component("comp1").physics("mbd").feature("rig1").feature("rf1").set("Include_offset", true);
    model.component("comp1").physics("mbd").feature("rig1").feature("rf1").set("x_off", new double[]{0, -0.1, 0});
    model.component("comp1").physics("mbd").feature("rig1").feature("rf1").set("Ft", new String[]{"0", "0", "F"});
    model.component("comp1").physics("mbd").create("att1", "Attachment", 2);
    model.component("comp1").physics("mbd").feature("att1").selection().set(16, 17);
    ...
    model.component("comp1").physics("mbd").feature("att2").selection().set(18, 19);
    ...
    model.component("comp1").physics("mbd").feature("att3").selection().set(75, 76);
    model.component("comp1").physics("mbd").feature("att3").set("ConnectionType", "FlexibleType");
    model.component("comp1").physics("mbd").create("hgj1", "HingeJoint", -1);
    model.component("comp1").physics("mbd").feature("hgj1").set("Source", "att1");
    model.component("comp1").physics("mbd").feature("hgj1").set("Destination", "att3");
    ...
    model.component("comp1").physics("mbd").feature("clj1").set("Source", "att2");
    model.component("comp1").physics("mbd").feature("clj1").set("Destination", "att3");
    model.component("comp1").physics("mbd").feature("clj1").set("e", new int[]{0, 1, 0});
    ...
    model.component("comp1").physics("mbd").feature("rd1").feature("pdr1").feature("crb1").selection().set(67, 68);
    ...
    model.component("comp1").physics("mbd").feature("rd1").feature("af1")
         .set("Xpa", new String[]{"mbd.rd1.pdr1.xcx", "mbd.rd1.pdr1.xcy-0.1", "mbd.rd1.pdr1.xcz"});
    model.component("comp1").physics("mbd").feature("rd1").feature("af1").set("Ft", new String[]{"0", "0", "F"});
    ...
    model.result("pg3").label("\u4f4d\u79fb (mbd) 1");
    ...
    model.study("std1").feature("stat").set("disabledphysics", new String[]{"mbd/rd1"});
    ...
    model
         .description("\u672c\u4f8b\u4f7f\u7528\u201c\u94f0\u94fe\u5173\u8282\u201d\u5bf9\u4e24\u4e2a\u673a\u68b0\u90e8\u4ef6\u4e4b\u95f4\u7684\u94f0\u94fe\u8fdb\u884c\u5efa\u6a21\u3002\u9488\u5bf9\u4e24\u79cd\u60c5\u51b5\u8fdb\u884c\u7ed3\u6784\u5206\u6790\uff1a\u4e00\u79cd\u662f\u4e24\u4e2a\u90e8\u4ef6\u5747\u4e3a\u67d4\u6027\u4ef6\uff0c\u53e6\u4e00\u79cd\u662f\u5176\u4e2d\u4e00\u4e2a\u4e3a\u521a\u6027\u4ef6\u3002");
