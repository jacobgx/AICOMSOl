...
public class crane_link_optimization {
...
//    model.param().loadFile("FILENAME");
    model.param().set("XC", "-0.150[m]", "\u5e95\u5ea7\u4e2d\u5fc3\u7684 X \u4f4d\u7f6e");
    model.param()
         .set("YL1", "-0.950[m]", "\u5e95\u5ea7\u4e0a\u8fde\u6746 1 \u8f74\u7684\u539f\u59cb Y \u5750\u6807");
    model.param().set("ZL1", "1.875[m]", "\u5e95\u5ea7\u4e0a\u8fde\u6746 1 \u8f74\u7684\u539f\u59cb Z \u5750\u6807");
    model.param()
         .set("YL2", "-0.419[m]", "\u60ac\u81c2 1 \u4e0a\u8fde\u6746 2 \u8f74\u7684\u539f\u59cb Y \u5750\u6807");
    model.param()
         .set("ZL2", "1.945[m]", "\u60ac\u81c2 1 \u4e0a\u8fde\u6746 2 \u8f74\u7684\u539f\u59cb Z \u5750\u6807");
    model.param().set("YPE", "-0.471[m]", "\u6d3b\u585e 1 \u7aef\u90e8\u7684\u539f\u59cb Y \u5750\u6807");
    model.param().set("ZPE", "1.832[m]", "\u6d3b\u585e 1 \u7aef\u90e8\u7684\u539f\u59cb Z \u5750\u6807");
    model.param().set("YCE", "-0.385[m]", "\u6cb9\u7f38 1 \u7aef\u90e8\u7684 Y \u5750\u6807");
    model.param().set("ZCE", "0.550[m]", "\u6cb9\u7f38 1 \u7aef\u90e8\u7684 Z \u5750\u6807");
    model.param()
         .set("dYL1", "0[m]", "\u5e95\u5ea7\u4e0a\u8fde\u6746 1 \u8f74\u7684 Y \u5750\u6807\u53d8\u5316\u91cf");
    model.param()
         .set("dZL1", "0[m]", "\u5e95\u5ea7\u4e0a\u8fde\u6746 1 \u8f74\u7684 Z \u5750\u6807\u53d8\u5316\u91cf");
    model.param()
         .set("dYL2", "0[m]", "\u60ac\u81c2 1 \u4e0a\u8fde\u6746 2 \u8f74\u7684 Y \u5750\u6807\u53d8\u5316\u91cf");
    model.param()
         .set("dZL2", "0[m]", "\u60ac\u81c2 1 \u4e0a\u8fde\u6746 2 \u8f74\u7684 Z \u5750\u6807\u53d8\u5316\u91cf");
    model.param().set("dYPE", "0[m]", "\u6d3b\u585e 1 \u7aef\u90e8\u7684 Y \u5750\u6807\u53d8\u5316\u91cf");
    model.param().set("dZPE", "0[m]", "\u6d3b\u585e 1 \u7aef\u90e8\u7684 Y \u5750\u6807\u53d8\u5316\u91cf");
    model.param()
         .set("mYL1", "YL1+dYL1", "\u4fee\u6b63\u540e\u7684\u5e95\u5ea7\u4e0a\u8fde\u6746 1 \u8f74\u7684 Y \u5750\u6807");
    model.param()
         .set("mZL1", "ZL1+dZL1", "\u4fee\u6b63\u540e\u7684\u5e95\u5ea7\u4e0a\u8fde\u6746 1 \u8f74\u7684 Z \u5750\u6807");
    model.param()
         .set("mYL2", "YL2+dYL2", "\u4fee\u6b63\u540e\u7684\u60ac\u81c2 1 \u4e0a\u8fde\u6746 2 \u8f74\u7684 Y \u5750\u6807");
    model.param()
         .set("mZL2", "ZL2+dZL2", "\u4fee\u6b63\u540e\u7684\u60ac\u81c2 1 \u4e0a\u8fde\u6746 2 \u8f74\u7684 Z \u5750\u6807");
    model.param()
         .set("mYPE", "YPE+dYPE", "\u4fee\u6b63\u540e\u7684\u6d3b\u585e 1 \u7aef\u90e8\u7684 Y \u5750\u6807");
    model.param()
         .set("mZPE", "ZPE+dZPE", "\u4fee\u6b63\u540e\u7684\u6d3b\u585e 1 \u7aef\u90e8\u7684 Z \u5750\u6807");
    model.param()
         .set("lCyl", "sqrt((YPE-YCE)^2+(ZPE-ZCE)^2)", "\u6cb9\u7f38 1 \u7aef\u90e8\u548c\u6d3b\u585e 1 \u7aef\u90e8\u4e4b\u95f4\u7684\u539f\u59cb\u957f\u5ea6");
    model.param()
         .set("mlCyl", "sqrt((mYPE-YCE)^2+(mZPE-ZCE)^2)", "\u6cb9\u7f38 1 \u7aef\u90e8\u548c\u6d3b\u585e 1 \u7aef\u90e8\u4e4b\u95f4\u4fee\u6539\u540e\u7684\u957f\u5ea6");
    model.param()
         .set("cylRot", "asin(((YPE-YCE)*(mZPE-ZCE)-(ZPE-ZCE)*(mYPE-YCE))/(lCyl*mlCyl))", "\u6cb9\u7f38 1 \u548c\u6d3b\u585e 1 \u7684\u659c\u7387\u53d8\u5316\u91cf");
    model.param()
         .set("dL2PE", "sqrt((YPE-YL2)^2+(ZPE-ZL2)^2)", "\u8fde\u6746 2 \u4e24\u4e2a\u7aef\u90e8\u4e4b\u95f4\u7684\u539f\u59cb\u8ddd\u79bb");
    model.param()
         .set("mdL2PE", "sqrt((mYPE-mYL2)^2+(mZPE-mZL2)^2)", "\u8fde\u6746 2 \u4e24\u4e2a\u7aef\u90e8\u4e4b\u95f4\u4fee\u6539\u540e\u7684\u8ddd\u79bb");

    model.component("comp1").geom("geom1").run("imp1");
    model.component("comp1").geom("geom1").create("rot1", "Rotate");
    model.component("comp1").geom("geom1").feature("rot1").selection("input").set("imp1(31)", "imp1(32)");
    model.component("comp1").geom("geom1").feature("rot1").set("pos", new String[]{"0", "YCE", "ZCE"});
    model.component("comp1").geom("geom1").feature("rot1").set("rot", "cylRot");
    ...
    model.component("comp1").physics("mbd").feature("hgj3").set("xc", new String[]{"XC", "mYL1", "mZL1"});
    model.component("comp1").physics("mbd").feature("hgj4").set("CenterOfJointType", "UserDefined");
    model.component("comp1").physics("mbd").feature("hgj4").set("xc", new String[]{"XC", "mYL2", "mZL2"});
    model.component("comp1").physics("mbd").feature("slj1").set("CenterOfJointType", "UserDefined");
    model.component("comp1").physics("mbd").feature("slj1").set("xc", new String[]{"XC", "mYPE", "mZPE"});
    model.component("comp1").physics("mbd").feature("slj2").set("CenterOfJointType", "UserDefined");
    model.component("comp1").physics("mbd").feature("slj2").set("xc", new String[]{"XC", "mYPE", "mZPE"});
    ...
    model.study("std1").feature("stat").remove("plistarr", new int[]{2});

    model.sol("sol1").feature("v1").feature("comp1_mbd_rd_rot").set("scaleval", 0.5);
    model.sol("sol1").feature("v1").feature("comp1_mbd_jnt_rot").set("scaleval", 0.5);
    model.sol("sol1").feature("v1").feature("comp1_ODE1").set("scaleval", 0.5);
    ...
    model.result("pg2").feature("glob1").setIndex("descr", "\u4f18\u5316\u540e", 0);
    model.result("pg2").feature().duplicate("glob2", "glob1");
    model.result("pg2").run();
    model.result("pg2").feature("glob2").set("data", "dset2");
    model.result("pg2").feature("glob2").setIndex("descr", "\u539f\u59cb", 0);
    model.result("pg3").run();
    ...
    model.result("pg4").feature("glob1").remove("descr", 2);
    model.result("pg4").feature("glob1").remove("expr", new int[]{2});
    model.result("pg4").feature("glob1").setIndex("descr", "\u4f18\u5316\u540e\u7684\u529b\uff0cy", 0);
    model.result("pg4").feature("glob1").setIndex("descr", "\u4f18\u5316\u540e\u7684\u529b\uff0cz", 1);
    model.result("pg4").feature("glob1").setIndex("expr", "sqrt(mbd.hgj1.Fy^2+mbd.hgj1.Fz^2)", 2);
    model.result("pg4").feature("glob1").setIndex("unit", "kN", 2);
    model.result("pg4").feature("glob1").setIndex("descr", "\u4f18\u5316\u540e\u7684\u603b\u529b", 2);
    model.result("pg4").feature().duplicate("glob2", "glob1");
    model.result("pg4").run();
    model.result("pg4").feature("glob2").set("data", "dset2");
    model.result("pg4").feature("glob2").setIndex("descr", "\u539f\u59cb\u529b\uff0cy", 0);
    model.result("pg4").feature("glob2").setIndex("descr", "\u539f\u59cb\u529b\uff0cz", 1);
    model.result("pg4").feature("glob2").setIndex("descr", "\u539f\u59cb\u7684\u603b\u529b", 2);
    ...
    model.study("std1").feature("opt").setIndex("descr", "\u6cb9\u7f38\u529b\uff08\u5185\u90e8\uff09", 0);
    model.study("std1").feature("opt").set("objectivesolution", "max");
    model.study("std1").feature("opt").set("pname", new String[]{"dYL1", "dZL1", "dYL2", "dZL2", "dYPE", "dZPE"});
    model.study("std1").feature("opt").set("initval", new String[]{"0[m]", "0[m]", "0[m]", "0[m]", "0[m]", "0[m]"});
    model.study("std1").feature("opt").set("scale", new String[]{"0.1", "0.15", "0.05", "0.1", "0.12", "0.1"});
    model.study("std1").feature("opt")
         .set("lbound", new String[]{"-0.10[m]", "-0.15[m]", "-0.05[m]", "-0.05[m]", "-0.05[m]", "-0.10[m]"});
    model.study("std1").feature("opt")
         .set("ubound", new String[]{"0.05[m]", "0.03[m]", "0.05[m]", "0.10[m]", "0.12[m]", "0.02[m]"});
    ...
    model.result("pg6").label("\u4f4d\u79fb (mbd) 1");
    ...
    model.title("\u540a\u673a\u8fde\u6746\u673a\u6784\u7684\u4f18\u5316");

    model
         .description("\u672c\u4f8b\u4f18\u5316\u4e00\u79cd\u8fde\u6746\u673a\u6784\u7684\u51e0\u4f55\u3002\u76ee\u6807\u662f\u5728\u5c06\u7ed9\u5b9a\u7684\u8f7d\u8377\u63d0\u5347\u5230\u6307\u5b9a\u540a\u673a\u4f4d\u7f6e\u65f6\uff0c\u51cf\u5c11\u6db2\u538b\u7f38\u4e2d\u6240\u9700\u7684\u529b\u3002");
