...
public class reciprocating_engine {
  ...
  public static Model run() {
    ...
    model.component("comp1").label("\u70ed\u529b\u5b66\u5206\u6790");
    ...
    model.component("comp1").variable("var1").descr("Pi", "\u529f\u7387\u8f93\u5165");
    model.component("comp1").variable("var1").set("Po", "intop2(p*2*pi*r*d(xp,t)*root.nz)");
    model.component("comp1").variable("var1").descr("Po", "\u529f\u7387\u8f93\u51fa");
    ...
    model.study("std1").label("\u7814\u7a76\uff1a\u70ed\u529b\u5b66\u5206\u6790");
    ...
    model.result("pg1").set("ylabel", "\u538b\u529b (bar)");
    model.result("pg1").set("xlabelactive", true);
    model.result("pg1").set("xlabel", "\u5bb9\u79ef (cc)");
    model.result("pg1").run();
    model.result().duplicate("pg2", "pg1");
    model.result("pg2").run();
    model.result("pg2").label("\u6c14\u7f38\u538b\u529b");
    model.result("pg2").set("xlabel", "\u66f2\u8f74\u65cb\u8f6c (rad)");
    model.result("pg2").run();
    ...
    model.result().numerical("gev1").setIndex("descr", "\u673a\u68b0\u80fd", 0);
    ...
    model.component("comp2").label("\u591a\u4f53\u5206\u6790");
    ...
    model.nodeGroup("grp2").label("\u68f1\u67f1\u5173\u8282\u5bf9");
    ...
    model.component("comp2").selection("sel1").label("\u521a\u6027\u6750\u6599");
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp2").physics("mbd").feature("rd1").label("\u66f2\u8f74");
    model.component("comp2").physics("mbd").feature("rd2").label("\u6d3b\u585e 1");
    model.component("comp2").physics("mbd").feature("rd3").label("\u8fde\u6746 1");
    model.component("comp2").physics("mbd").feature("rd4").label("\u6c14\u7f38 1");
    model.component("comp2").physics("mbd").feature("rd5").label("\u6d3b\u585e 2");
    model.component("comp2").physics("mbd").feature("rd6").label("\u6c14\u7f38 2");
    model.component("comp2").physics("mbd").feature("rd7").label("\u6d3b\u585e 3");
    model.component("comp2").physics("mbd").feature("rd8").label("\u8fde\u6746 3");
    model.component("comp2").physics("mbd").feature("rd9").label("\u6c14\u7f38 3");
    ...
    model.component("comp2").physics("mbd").feature("att1").label("\u8fde\u6746 2\uff1a\u5e95\u7aef");
    model.component("comp2").physics("mbd").feature("att1").set("ConnectionType", "FlexibleType");
    model.component("comp2").physics("mbd").feature("att2").label("\u8fde\u6746 2\uff1a\u9876\u7aef");
    ...
    model.result("pg5").label("\u8fb9\u754c\u8f7d\u8377 (mbd)");
    ...
    model.result("pg5").feature("arws1").label("\u8fb9\u754c\u8f7d\u8377 1");
    ...
    model.result("pg5").feature("arws2").label("\u8fb9\u754c\u8f7d\u8377 2");
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg5").feature("arws3").label("\u8fb9\u754c\u8f7d\u8377 3");
    ...
    model.result("pg6").label("\u6bcf\u5206\u949f\u8f6c\u6570");
    model.result("pg6").set("data", "dset3");
    model.result("pg6").create("glob1", "Global");
    model.result("pg6").feature("glob1").set("markerpos", "datapoints");
    model.result("pg6").feature("glob1").set("linewidth", "preference");
    model.result("pg6").feature("glob1").set("expr", new String[]{"N"});
    model.result("pg6").feature("glob1").set("descr", new String[]{"\u66f2\u8f74\u6bcf\u5206\u949f\u8f6c\u6570"});
    ...
    model.result("pg6").set("xlabel", "\u66f2\u8f74\u65cb\u8f6c\uff08\u5faa\u73af\uff09");
    model.result("pg6").set("ylabelactive", true);
    model.result("pg6").set("ylabel", "\u66f2\u8f74\u6bcf\u5206\u949f\u8f6c\u6570");
    model.result("pg6").run();
    model.result().duplicate("pg7", "pg6");
    model.result("pg7").run();
    model.result("pg7").label("\u4ea7\u751f\u7684\u529f\u7387");
    model.result("pg7").set("ylabel", "\u4ea7\u751f\u7684\u529f\u7387 (HP)");
    model.result("pg7").run();
    model.result("pg7").feature("glob1").set("expr", new String[]{"P1"});
    model.result("pg7").feature("glob1")
         .set("descr", new String[]{"\u6c14\u7f38 1 \u4e2d\u4ea7\u751f\u7684\u529f\u7387 (hp)"});
    model.result("pg7").feature("glob1").set("unit", new String[]{"1"});
    model.result("pg7").feature("glob1").set("expr", new String[]{"P1", "P2"});
    model.result("pg7").feature("glob1")
         .set("descr", new String[]{"\u6c14\u7f38 1 \u4e2d\u4ea7\u751f\u7684\u529f\u7387 (hp)", "\u6c14\u7f38 2 \u4e2d\u4ea7\u751f\u7684\u529f\u7387 (hp)"});
    model.result("pg7").feature("glob1").set("expr", new String[]{"P1", "P2", "P3"});
    model.result("pg7").feature("glob1")
         .set("descr", new String[]{"\u6c14\u7f38 1 \u4e2d\u4ea7\u751f\u7684\u529f\u7387 (hp)", "\u6c14\u7f38 2 \u4e2d\u4ea7\u751f\u7684\u529f\u7387 (hp)", "\u6c14\u7f38 3 \u4e2d\u4ea7\u751f\u7684\u529f\u7387 (hp)"});
    ...
    model.result("pg9").feature("glob1").set("title", "\u8fde\u6746\u4e2d\u7684\u6700\u5927\u5e94\u529b");
    model.result("pg9").run();
    model.result("pg7").run();
    model.result().duplicate("pg10", "pg7");
    model.result("pg10").run();
    model.result("pg10").label("\u5173\u8282\u529b\uff1a\u8fde\u6746-\u66f2\u67c4");
    model.result("pg10").set("ylabel", "\u5173\u8282\u529b (N)");
    model.result("pg10").run();
    model.result("pg10").feature("glob1").set("expr", new String[]{"mbd.hgj2.Fx"});
    model.result("pg10").feature("glob1").set("descr", new String[]{"\u5173\u8282\u529b\uff0cx \u5206\u91cf"});
