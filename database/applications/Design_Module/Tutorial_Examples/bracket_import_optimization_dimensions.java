/*
 * bracket_import_optimization_dimensions.java
 */
...
public class bracket_import_optimization_dimensions {
...
//    model.param().loadFile("FILENAME");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("proj1").set("projectiontype", "edgvtx");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("proj1").setAttribute("construction", "on");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("proj1");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist1").selection("entity2")
         .set("proj1", 79);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist1").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist1").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist1").set("parname", "LY");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad1").selection("edge").set("proj1", 5);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad1").set("radiusconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad1").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad1").set("parname", "RCmp");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("rad1");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("rad1");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist2").selection("entity2")
         .set("proj1", 70);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist2").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist2").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist2").set("parname", "LZ");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist3").selection("entity2")
         .set("proj1", 17);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist3").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist3").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist3").set("parname", "ZOOorig");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist4").selection("entity2")
         .set("proj1", 13);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist4").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist4").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist4").set("parname", "HInd");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist5").selection("entity2")
         .set("proj1", 7);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist5").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist5").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist5").set("parname", "ZCOorig");
    ...
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist6").selection("entity1")
         .set("proj1", 3);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist6").selection("entity2")
         .set("proj1", 16);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist6").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist6").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist6").set("parname", "YOOorig");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist6");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist6");
    model.component("comp1").geom("geom1").feature("wp1").geom().create("dist7", "Distance");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist7").selection("entity1")
         .set("proj1", 74);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist7").selection("entity2")
         .set("proj1", 78);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist7").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist7").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist7").set("parname", "YInd");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist7");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist7");
    model.component("comp1").geom("geom1").feature("wp1").geom().create("dist8", "Distance");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist8").selection("entity1")
         .set("proj1", 22);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist8").selection("entity2")
         .set("proj1", 38);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist8").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist8").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist8").set("parname", "WInd");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist8");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist8");
    model.component("comp1").geom("geom1").feature("wp1").geom().create("dist9", "Distance");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist9").selection("entity1")
         .set("proj1", 73);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist9").selection("entity2")
         .set("proj1", 70);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist9").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist9").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("dist9").set("parname", "THK");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist9");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("dist9");
    model.component("comp1").geom("geom1").feature("wp1").geom().create("rad2", "Radius");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad2").selection("edge").set("proj1", 8);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad2").set("radiusconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad2").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad2").set("parname", "ROorig");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("rad2");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("rad2");
    model.component("comp1").geom("geom1").feature("wp1").geom().create("rad3", "Radius");
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad3").selection("edge").set("proj1", 7);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad3").set("radiusconstr", false);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad3").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp1").geom().feature("rad3").set("parname", "RCorig");
    model.component("comp1").geom("geom1").feature("wp1").geom().run("rad3");
    ...
    model.component("comp1").view("view1").hideObjects("hide1").add("wp1");

    model.component("comp1").geom("geom1").feature("wp2").set("planetype", "circleperpendicular");
    model.component("comp1").geom("geom1").feature("wp2").selection("circedge").set("imp1", 91);
    model.component("comp1").geom("geom1").run("wp2");
    model.component("comp1").geom("geom1").run("wp2");
    model.component("comp1").geom("geom1").create("wp3", "WorkPlane");
    model.component("comp1").geom("geom1").feature("wp3").set("unite", true);
    model.component("comp1").geom("geom1").feature("wp3").set("planetype", "circleperpendicular");
    model.component("comp1").geom("geom1").feature("wp3").selection("circedge").set("imp1", 99);
    model.component("comp1").geom("geom1").feature("wp3").set("reverse", true);
    ...
    model.component("comp1").geom("geom1").feature("wp4").set("planetype", "circleperpendicular");
    model.component("comp1").geom("geom1").feature("wp4").selection("circedge").set("imp1", 81);
    ...
    model.component("comp1").geom("geom1").feature("tf1").set("workplane", "wp2");
    model.component("comp1").geom("geom1").feature("tf1").set("factor", "RC/RCorig");
    model.component("comp1").geom("geom1").feature("tf1")
         .set("displ", new String[]{"ZCO+RC-RCorig-ZCOorig", "0", "0"});
    ...
    model.component("comp1").geom("geom1").feature("off1").set("distance", "RO-ROorig");
    ...
    model.component("comp1").geom("geom1").feature("tf2").set("workplane", "wp3");
    model.component("comp1").geom("geom1").feature("tf2")
         .set("displ", new String[]{"-(ZOO-ZOOorig+RO-ROorig)", "0", "0"});
    model.component("comp1").geom("geom1").feature("tf2").setIndex("displ", "YOO-YOOorig+RO-ROorig", 2);
    ...
    model.component("comp1").geom("geom1").feature("tf3").set("workplane", "wp4");
    model.component("comp1").geom("geom1").feature("tf3")
         .set("displ", new String[]{"-(ZOO-ZOOorig+RO-ROorig)", "0", "0"});
    model.component("comp1").geom("geom1").feature("tf3").setIndex("displ", "YOO-YOOorig+RO-ROorig", 2);
    ...
    model.component("comp1").geom("geom1").feature("wp5").set("quickoffsettype", "vertex");
    model.component("comp1").geom("geom1").feature("wp5").selection("offsetvertex").set("tf3", 18);
    ...
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt1").setIndex("p", "-20[mm]", 0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt1").setIndex("p", "20[mm]", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt1").setAttribute("construction", "on");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("pt1");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("con1", "Concentric");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con1").selection("edge").set("proj1", 3);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con1").selection("vertex").set("pt1", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con1");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con1");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("pt2", "Point");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt2").setIndex("p", "5[mm]", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt2").setAttribute("construction", "on");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("pt2");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("con2", "Concentric");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con2").selection("edge").set("proj1", 6);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con2").selection("vertex").set("pt2", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con2");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con2");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("pt3", "Point");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt3").setIndex("p", "20[mm]", 0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt3").setIndex("p", "20[mm]", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt3").setAttribute("construction", "on");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("pt3");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("con3", "Concentric");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con3").selection("edge").set("proj1", 8);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con3").selection("vertex").set("pt3", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con3");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con3");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("pt4", "Point");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt4").setIndex("p", "50[mm]", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("pt4").setAttribute("construction", "on");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("pt4");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("con4", "Concentric");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con4").selection("edge").set("proj1", 5);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("con4").selection("vertex").set("pt4", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con4");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("con4");
    ...
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist1").selection("entity1").set("pt1", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist1").selection("entity2").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist1").selection("entity2").set("pt4", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist1").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist1").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist1").set("parname", "d_O_Cmp");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist1");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist1");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("dist2", "Distance");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").selection("entity1").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").selection("entity1").set("pt1", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").selection("entity2").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").selection("entity2").set("pt3", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist2").set("parname", "d_O_O");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist2");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist2");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("dist3", "Distance");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").selection("entity1").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").selection("entity1").set("pt1", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").selection("entity2").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").selection("entity2").set("pt2", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist3").set("parname", "d_O_C");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist3");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist3");
    model.component("comp1").geom("geom1").feature("wp6").geom().create("dist4", "Distance");
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").selection("entity1").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").selection("entity1").set("pt4", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").selection("entity2").init(0);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").selection("entity2").set("pt2", 1);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").set("distanceconstr", false);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").set("createpar", true);
    model.component("comp1").geom("geom1").feature("wp6").geom().feature("dist4").set("parname", "d_C_Cmp");
    model.component("comp1").geom("geom1").feature("wp6").geom().run("dist4");
    model.component("comp1").geom("geom1").run("wp6");
    model.component("comp1").geom("geom1").create("pch1", "ParameterCheck");
    model.component("comp1").geom("geom1").feature("pch1").set("condition", "d_O_Cmp<3[mm]+RO+RCmp");
    model.component("comp1").geom("geom1").feature("pch1")
         .set("message", "Distance\u00a0between\u00a0outer\u00a0hole\u00a0and\u00a0component\u00a0smaller\u00a0than\u00a03\u00a0mm");
    model.component("comp1").geom("geom1").run("pch1");
    model.component("comp1").geom("geom1").run("pch1");
    model.component("comp1").geom("geom1").create("pch2", "ParameterCheck");
    model.component("comp1").geom("geom1").feature("pch2").set("condition", "d_O_C<3[mm]+RO+RC");
    model.component("comp1").geom("geom1").feature("pch2")
         .set("message", "Distance\u00a0between\u00a0outer\u00a0hole\u00a0and\u00a0central\u00a0hole\u00a0smaller\u00a0than\u00a03 mm");
    model.component("comp1").geom("geom1").run("pch2");
    model.component("comp1").geom("geom1").run("pch2");
    model.component("comp1").geom("geom1").create("pch3", "ParameterCheck");
    model.component("comp1").geom("geom1").feature("pch3").set("condition", "d_O_O<3[mm]+2*RO");
    model.component("comp1").geom("geom1").feature("pch3")
         .set("message", "Distance\u00a0between\u00a0outer\u00a0holes\u00a0smaller\u00a0than\u00a03 mm");
    model.component("comp1").geom("geom1").run("pch3");
    model.component("comp1").geom("geom1").run("pch3");
    model.component("comp1").geom("geom1").create("pch4", "ParameterCheck");
    model.component("comp1").geom("geom1").feature("pch4").set("condition", "d_C_Cmp<3[mm]+RC+RCmp");
    model.component("comp1").geom("geom1").feature("pch4")
         .set("message", "Distance\u00a0between\u00a0central\u00a0hole\u00a0and\u00a0component\u00a0less\u00a0than\u00a03 mm");
    model.component("comp1").geom("geom1").run("pch4");
    model.component("comp1").geom("geom1").run("pch4");
    ...
    model.component("comp1").geom("geom1").feature("boxsel1").set("ymin", "YInd");
    model.component("comp1").geom("geom1").feature("boxsel1").set("ymax", "WInd");
    model.component("comp1").geom("geom1").feature("boxsel1").set("zmin", "HInd+1[mm]");
    model.component("comp1").geom("geom1").feature("boxsel1").set("zmax", "HInd+10[mm]");
    ...
    model.component("comp1").geom("geom1").feature("boxsel2").set("ymin", "LY-WInd");
    model.component("comp1").geom("geom1").feature("boxsel2").set("ymax", "LY-YInd");
    model.component("comp1").geom("geom1").feature("boxsel2").set("zmin", "HInd+1[mm]");
    model.component("comp1").geom("geom1").feature("boxsel2").set("zmax", "HInd+10[mm]");
    ...
    model.component("comp1").geom("geom1").feature("boxsel3").set("ymin", "LY/2-YInd");
    model.component("comp1").geom("geom1").feature("boxsel3").set("ymax", "LY/2+YInd");
    model.component("comp1").geom("geom1").feature("boxsel3").set("zmin", 0);
    model.component("comp1").geom("geom1").feature("boxsel3").set("zmax", "HInd+1[mm]");
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").geom("geom1").feature("cyl1").set("r", "19[mm]");
    model.component("comp1").geom("geom1").feature("cyl1").set("h", "100[mm]");
    model.component("comp1").geom("geom1").feature("cyl1").set("pos", new String[]{"10[mm]", "36[mm]", "0"});
    model.component("comp1").geom("geom1").feature("cyl1").setIndex("pos", "70[mm]", 2);
  ...
  public static Model run4(Model model) {
    ...
    model.param("default").paramCase("case2").set("RC", "0.0060799[m]");
    model.param("default").paramCase("case2").set("ZCO", "0.0049992[m]");
    model.param("default").paramCase("case2").set("YOO", "0.0030796[m]");
    model.param("default").paramCase("case2").set("ZOO", "0.019725[m]");
    model.param("default").paramCase("case2").set("RO", "0.0099406[m]");
    model.param("default").setFromCase("case2");

    model.component("comp1").geom("geom1").run("ige1");

    model.title("\u4f18\u5316\u5bfc\u5165\u7684\u652f\u67b6\u51e0\u4f55 - \u4f7f\u7528\u6d4b\u91cf\u5c3a\u5bf8");

    model
         .description("\u5728\u672c\u6559\u7a0b\u4e2d\uff0c\u60a8\u5c06\u4f7f\u7528\u201c\u504f\u79fb\u9762\u201d\u548c\u201c\u53d8\u6362\u9762\u201d\u64cd\u4f5c\u65b9\u6cd5\u6765\u91cd\u65b0\u53c2\u6570\u5316\u4ece STEP \u6587\u4ef6\u5bfc\u5165\u7684\u652f\u67b6\u51e0\u4f55\u4e2d\u5df2\u7ed8\u5236\u7684\u5b54\u3002\u652f\u67b6\u7684\u8d28\u91cf\u5728\u4ee5\u4e0b\u9650\u5236\u4e0b\u5b9e\u73b0\u6700\u5c0f\u5316\uff1a\u6700\u4f4e\u56fa\u6709\u9891\u7387\u548c\u9759\u8f7d\u8377\u5de5\u51b5\u4e0b\u7684\u6700\u5927\u5e94\u529b\u3002\n\n\u5728\u672c\u6559\u7a0b\u4e2d\uff0c\u6211\u4eec\u5c06\u5c3a\u5bf8\u7279\u5f81\u6dfb\u52a0\u5230\u51e0\u4f55\u5e8f\u5217\u4e2d\uff0c\u4ee5\u6d4b\u91cf\u5df2\u5bfc\u5165\u548c\u4fee\u6539\u7684\u51e0\u4f55\u3002\u5176\u4e2d\u5728\u53c2\u6570\u68c0\u67e5\u8282\u70b9\u4e2d\u4f7f\u7528\u7531\u6d4b\u91cf\u5c3a\u5bf8\u521b\u5efa\u7684\u53c2\u6570\uff0c\u5e76\u901a\u8fc7\u5728\u4f18\u5316\u8fc7\u7a0b\u4e2d\u5f3a\u5236\u6267\u884c\u51e0\u4f55\u7ea6\u675f\u6765\u4fdd\u6301\u51e0\u4f55\u7684\u8bbe\u8ba1\u610f\u56fe\u3002");
