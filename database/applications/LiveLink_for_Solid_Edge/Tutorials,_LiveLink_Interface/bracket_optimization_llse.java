/*
 * bracket_optimization_llse.java
 */
...
public class bracket_optimization_llse {
...
//    model.param().loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.param("default").paramCase("case1").set("LL_ZOO", "0.018002[m]");
    model.param("default").paramCase("case1").set("LL_YOO", "0.0078100[m]");
    model.param("default").paramCase("case1").set("LL_RC", "0.0055860[m]");
    model.param("default").paramCase("case1").set("LL_ZCO", "0.0028239[m]");
    model.param("default").paramCase("case1").set("LL_RO", "0.010854[m]");
    ...
    model
         .description("\u672c\u4f8b\u5c06\u901a\u8fc7 LiveLink\u2122 \u63a5\u53e3\u4ece Solid Edge\u00ae \u540c\u6b65\u7684\u652f\u67b6\u7684\u8d28\u91cf\u6700\u5c0f\u5316\u3002\n\n\u5728\u9759\u8f7d\u8377\u5de5\u51b5\u4e0b\uff0c\u6700\u4f4e\u56fa\u6709\u9891\u7387\u548c\u6700\u5927\u5e94\u529b\u90fd\u6709\u9650\u5236\u3002\u672c\u4f8b\u66f4\u6539\u4e86\u8bb8\u591a\u51e0\u4f55\u7279\u5f81\u7684\u5927\u5c0f\u548c\u4f4d\u7f6e\u4ee5\u4f18\u5316\u8d28\u91cf\uff0c\u5e76\u5f3a\u5236\u5b9e\u65bd\u591a\u4e2a\u51e0\u4f55\u7ea6\u675f\u4ee5\u4fdd\u6301\u8bbe\u8ba1\u610f\u56fe\u3002");
    ...
    model.label("bracket_optimization_llse.mph");
