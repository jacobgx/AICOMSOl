...
public class pacemaker_electrode_llse {
...
//    model.param().loadFile("FILENAME");
    ...
    model.study("std1").feature("param").setIndex("pname", "LL_V1948", 0);
    ...
    model.label("pacemaker_electrode_llse.mph");
