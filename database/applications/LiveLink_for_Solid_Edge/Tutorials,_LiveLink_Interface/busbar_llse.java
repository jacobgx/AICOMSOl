...
public class busbar_llse {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").feature("adjsel1")
         .set("input", new String[]{"cad1_Copper", "cad1_Titanium_unalloyed"});
...
//    model.param().loadFile("FILENAME");
    ...
    model.component("comp1").material("mat2").selection().named("geom1_cad1_Titanium_unalloyed_dom");
    ...
    model.study("std1").feature("param").setIndex("pname", "LL_connector_width_angle_connector_par", 0);
    model.study("std1").feature("param").setIndex("plistarr", "", 0);
    model.study("std1").feature("param").setIndex("punit", "m", 0);
    model.study("std1").feature("param").setIndex("pname", "LL_connector_width_angle_connector_par", 0);
    model.study("std1").feature("param").setIndex("plistarr", "", 0);
    model.study("std1").feature("param").setIndex("punit", "m", 0);
    model.study("std1").feature("param").setIndex("pname", "LL_rod_diameter_rod_par", 0);
    ...
    model.study("std1").feature("param").setIndex("pname", "LL_connector_width_angle_connector_par", 1);
    ...
    model
         .description("\u672c\u4f8b\u5206\u6790\u6bcd\u7ebf\u677f\u88c5\u914d\u7684\u7535\u963b\u52a0\u70ed\uff08\u7126\u8033\u70ed\uff09\uff0c\u8be5\u88c5\u914d\u7528\u4e8e\u5728\u7535\u89e3\u8fc7\u7a0b\u4e2d\u5c06\u76f4\u6d41\u7535\u4ece\u7535\u6d41\u6e90\u4f20\u5bfc\u81f3\u9633\u6781\u3002\u4e3a\u4e86\u7814\u7a76\u5c3a\u5bf8\u53c2\u6570\u5bf9\u8bbe\u5907\u6e29\u5347\u7684\u5f71\u54cd\uff0c\u5176\u4e2d\u4f7f\u7528\u53c2\u6570\u5316\u6c42\u89e3\u5668\u5bf9\u9009\u5b9a\u5c3a\u5bf8\u7684 Solid Edge\u00ae \u88c5\u914d\u7684\u591a\u79cd\u7ec4\u5408\u8fdb\u884c\u4eff\u771f\u8ba1\u7b97\u3002");
