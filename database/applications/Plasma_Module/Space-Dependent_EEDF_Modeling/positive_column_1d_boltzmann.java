/*
 * positive_column_1d_boltzmann.java
 */
...
public class positive_column_1d_boltzmann {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").feature("i1").setIndex("coord", 0.016, 0);
    model.component("comp1").geom("geom1").feature("i1").setIndex("coord", 0.384, 1);

    model.component("comp1").variable().create("var1");

    model.component("comp1").geom("geom1").run();

    model.component("comp1").variable("var1").set("mueN", "1E24[1/(m*V*s)]");
    model.component("comp1").variable("var1").descr("mueN", "Electron mobility");
    model.component("comp1").variable("var1").set("V0", "200[V]");
    model.component("comp1").variable("var1").descr("V0", "Applied voltage");
    model.component("comp1").variable("var1").set("Wf", "5");
    model.component("comp1").variable("var1").descr("Wf", "Surface work function");
    model.component("comp1").variable("var1").set("p0", "0.1[torr]");
    model.component("comp1").variable("var1").descr("p0", "Gas pressure");
    ...
    model.component("comp1").physics("plas").prop("ShapeProperty").set("Formulation", "FEMLogQuadratic");
    ...
    model.component("comp1").physics("plas").feature("sr1").set("gammai", 0.35);
    ...
    model.component("comp1").physics("plas").feature("sr3").selection().set(1, 2);
    model.component("comp1").physics("plas").create("wall1", "WallDriftDiffusion", 0);
    model.component("comp1").physics("plas").feature("wall1").selection().set(1, 2);
    ...
    model.component("comp1").physics("plas").feature("mct1").selection().set(2);
    model.component("comp1").physics("plas").feature("mct1").set("V0", "V0");
    model.component("comp1").physics("plas").feature("mct1").set("CircuitType", "BallastResistor");
    model.component("comp1").physics("plas").feature("mct1").set("Rb", "10000[ohm]");
    ...
    model.component("comp1").mesh("mesh1").feature("edg1").feature("dis1").set("elemratio", 50);
    ...
    model.title("\u76f4\u6d41\u8f89\u5149\u653e\u7535 - \u4e00\u7ef4");

    model
         .description("\u672c\u6559\u7a0b\u6f14\u793a\u5982\u4f55\u6a21\u62df\u4e00\u7ef4\u76f4\u6d41\u653e\u7535\uff0c\u5176\u4e2d\u4f7f\u7528\u7b80\u5355\u7684\u6c29\u6c14\u5316\u5b66\u53cd\u5e94\uff0c\u6c42\u89e3\u4e2d\u6027\u7269\u8d28\u548c\u5e26\u7535\u7269\u8d28\u7684\u8f93\u8fd0\u65b9\u7a0b\uff0c\u5e76\u4e0e\u6cca\u677e\u65b9\u7a0b\u5b9e\u73b0\u5168\u8026\u5408\u3002\u540c\u65f6\uff0c\u4e5f\u8003\u8651\u4e86\u79bb\u5b50\u51b2\u51fb\u5f15\u8d77\u7684\u7535\u5b50\u4e8c\u6b21\u53d1\u5c04\u73b0\u8c61\u3002\u672c\u6a21\u578b\u662f\u5b66\u4e60\u5982\u4f55\u4f7f\u7528\u201c\u7b49\u79bb\u5b50\u4f53\u201d\u63a5\u53e3\u6784\u5efa\u7b49\u79bb\u5b50\u4f53\u6a21\u578b\u7684\u5165\u95e8\u793a\u4f8b\u3002");
    ...
    model.component("comp1").physics("plas").prop("ShapeProperty").set("Formulation", "FEMLogLinear");
    model.component("comp1").physics("plas").feature("eir2").set("SpecifyReactionUsing", "UseCrossSectionData");
    model.component("comp1").physics("plas").feature("eir2").set("UseTownsendTwoTermsBoltzmann", true);
    model.component("comp1").physics("plas").feature("eir4").set("SpecifyReactionUsing", "UseCrossSectionData");
    model.component("comp1").physics("plas").feature("eir4").set("UseTownsendTwoTermsBoltzmann", true);
    ...
    model.result("pg7").feature("lngr1").set("xdataexpr", new String[]{"atxd1(plas.rcx,plas.xeedf)"});
    ...
    model.result("pg7").feature("lngr1").set("expr", new String[]{"atxd1(plas.rcx,plas.fcap)"});
    model.result("pg7").create("lngr2", "LineGraph");
    model.result("pg7").feature("lngr2").set("xdata", "expr");
    model.result("pg7").feature("lngr2").set("xdataexpr", new String[]{"atxd1(plas.rcx,plas.xeedf)"});
    model.result("pg7").feature("lngr2").selection().all();
    model.result("pg7").feature("lngr2").set("expr", new String[]{"atxd1(plas.rcx,plas.fmax)"});
    ...
    model.result("pg7").feature("lngr3").set("xdataexpr", new String[]{"atxd1(plas.rcx,plas.xeedf)"});
    model.result("pg7").feature("lngr3").selection().all();
    model.result("pg7").feature("lngr3").set("expr", new String[]{"atxd1(plas.rcx,plas.fdruy)"});
    ...
    model.result("pg7").feature("lngr4").set("xdataexpr", new String[]{"atxd1(plas.rcx,plas.xeedf)"});
    model.result("pg7").feature("lngr4").selection().all();
    model.result("pg7").feature("lngr4").set("expr", new String[]{"atxd1(plas.rcx,plas.fgen)"});
    ...
    model.result("pg7").label("\u7535\u5b50\u80fd\u91cf\u5206\u5e03\u51fd\u6570 (plas)");
    model.result("pg7").run();
    model.result("pg7").label("\u7535\u5b50\u80fd\u91cf\u5206\u5e03\u51fd\u6570\uff0cEEDF \u521d\u59cb\u5316");
    ...
    model.result("pg1").feature("lngr1").setIndex("legends", "\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg1").feature("lngr2").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg1").run();
    model.result("pg2").run();
    ...
    model.result("pg2").feature("lngr1").setIndex("legends", "\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg2").feature("lngr2").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg2").run();
    model.result("pg3").run();
    ...
    model.result("pg3").feature("lngr1").setIndex("legends", "\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg3").feature("lngr2").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg3").run();
    model.result("pg4").run();
    ...
    model.result("pg4").feature("lngr1").setIndex("legends", "\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg4").feature("lngr2").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg4").run();
    model.result("pg5").run();
    ...
    model.result("pg5").feature("lngr1").setIndex("legends", "\u9ea6\u514b\u65af\u97e6", 0);
  ...
  public static Model run2(Model model) {
    model.result("pg5").feature("lngr2").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg5").run();
    model.result("pg6").run();
    model.result("pg6").feature("lngr1")
         .setIndex("legends", "\u7535\u5b50\u6d41\u5bc6\u5ea6\uff0c\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg6").feature("lngr4")
         .setIndex("legends", "\u7535\u5b50\u6d41\u5bc6\u5ea6\uff0c\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg6").run();
    model.result("pg6").feature("lngr2")
         .setIndex("legends", "\u79bb\u5b50\u6d41\u5bc6\u5ea6\uff0c\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg6").feature("lngr5")
         .setIndex("legends", "\u79bb\u5b50\u6d41\u5bc6\u5ea6\uff0c\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg6").run();
    model.result("pg6").feature("lngr3")
         .setIndex("legends", "\u603b\u7535\u6d41\u5bc6\u5ea6\uff0c\u9ea6\u514b\u65af\u97e6", 0);
    ...
    model.result("pg6").feature("lngr6")
         .setIndex("legends", "\u603b\u7535\u6d41\u5bc6\u5ea6\uff0c\u4e24\u9879\u73bb\u5c14\u5179\u66fc", 0);
    model.result("pg6").run();
    ...
    model.result("pg8").feature("lngr1").setIndex("legends", "\u8fc1\u79fb\u7387\uff0c\u9ea6\u514b\u65af\u97e6", 0);
    model.result("pg8").run();
    ...
    model.result("pg9").set("xlabel", "\u80fd\u91cf (eV)");
    ...
    model.result("pg9").feature("lngr1").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc x=18 cm", 0);
    ...
    model.result("pg9").feature("lngr2").setIndex("legends", "\u9ea6\u514b\u65af\u97e6 x=18 cm", 0);
    model.result("pg9").run();
    model.result("pg9").run();
    ...
    model.result("pg9").feature("lngr3").setIndex("legends", "\u4e24\u9879\u73bb\u5c14\u5179\u66fc x=1.9 cm", 0);
    model.result("pg9").run();
    ...
    model.result("pg9").feature("lngr4").setIndex("legends", "\u9ea6\u514b\u65af\u97e6 x=1.9 cm", 0);
    model.result("pg9").run();
    model.result("pg9").run();
    model.result("pg1").run();
    model.result("pg2").run();
    ...
    model
         .title("\u4e0e\u4e24\u9879\u73bb\u5c14\u5179\u66fc\u65b9\u7a0b\u8026\u5408\u7684\u76f4\u6d41\u8f89\u5149\u653e\u7535");

    model
         .description("\u672c\u6559\u7a0b\u901a\u8fc7\u6c42\u89e3\u7b49\u79bb\u5b50\u4f53\u6d41\u4f53\u7c7b\u578b\u65b9\u7a0b\u6765\u6a21\u62df\u76f4\u6d41\u8f89\u5149\u653e\u7535\uff0c\u8fd9\u7c7b\u65b9\u7a0b\u4e0e\u91c7\u7528\u7ecf\u5178\u4e24\u9879\u8fd1\u4f3c\u7684\u5b9a\u5e38\u9f50\u6b21\u7535\u5b50\u73bb\u5c14\u5179\u66fc\u65b9\u7a0b\u5b8c\u5168\u8026\u5408\u3002\u6211\u4eec\u5bf9\u6bcf\u4e2a\u7a7a\u95f4\u4f4d\u7f6e\u6c42\u89e3\u8fd1\u4f3c\u73bb\u5c14\u5179\u66fc\u65b9\u7a0b\uff0c\u5e76\u901a\u8fc7\u7535\u5b50\u5e73\u5747\u80fd\u91cf\u7684\u65b9\u5f0f\u5c06\u8be5\u65b9\u7a0b\u4e0e\u6d41\u4f53\u7c7b\u578b\u65b9\u7a0b\u8026\u5408\u3002\u901a\u8fc7\u5c06\u8ba1\u7b97\u5f97\u5230\u7684\u7535\u5b50\u80fd\u91cf\u5206\u5e03\u51fd\u6570\u5728\u7535\u5b50\u6563\u5c04\u622a\u9762\u4e0a\u8fdb\u884c\u9002\u5f53\u79ef\u5206\uff0c\u5f97\u5230\u7535\u5b50\u78b0\u649e\u53cd\u5e94\u7684\u901f\u7387\u5e38\u6570\u548c\u7535\u5b50\u4f20\u8f93\u53c2\u6570\u3002");
