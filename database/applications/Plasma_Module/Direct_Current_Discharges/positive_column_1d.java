...
public class positive_column_1d {
  ...
  public static Model run() {
    ...
    model.component("comp1").variable("var1").descr("mueN", "\u7535\u5b50\u8fc1\u79fb\u7387");
    ...
    model.component("comp1").variable("var1").descr("Wf", "\u8868\u9762\u529f\u51fd\u6570");
    ...
    model.result("pg1").set("xlabel", "\u8ddd\u79bb (m)");
    model.result("pg1").set("ylabelactive", true);
    model.result("pg2").run();
    model.result("pg2").setIndex("looplevelinput", "last", 0);
    model.result("pg2").set("xlabelactive", true);
    model.result("pg2").set("xlabel", "\u8ddd\u79bb (m)");
    model.result("pg2").set("ylabelactive", true);
    model.result("pg2").set("ylabel", "\u7535\u5b50\u6e29\u5ea6 (eV)");
    model.result("pg3").run();
    model.result("pg3").setIndex("looplevelinput", "last", 0);
    model.result("pg3").set("xlabelactive", true);
    model.result("pg3").set("xlabel", "\u8ddd\u79bb (m)");
    model.result("pg3").set("ylabelactive", true);
    model.result().create("pg4", "PlotGroup1D");
    model.result("pg4").run();
    model.result("pg4").label("\u6fc0\u53d1\u6001\u6c29\u7684\u8d28\u91cf\u5206\u6570");
    model.result("pg4").setIndex("looplevelinput", "last", 0);
    model.result("pg4").set("xlabelactive", true);
    model.result("pg4").set("xlabel", "\u8ddd\u79bb (m)");
    model.result("pg4").set("ylabelactive", true);
    model.result("pg4").set("ylabel", "\u6fc0\u53d1\u6001\u6c29\u7684\u8d28\u91cf\u5206\u6570 (1)");
    ...
    model.result("pg4").feature("lngr1").set("descr", "\u8d28\u91cf\u5206\u6570");
    model.result("pg4").run();
    model.result().create("pg5", "PlotGroup1D");
    model.result("pg5").run();
    model.result("pg5").label("\u6c29\u79bb\u5b50\u6570\u5bc6\u5ea6");
    model.result("pg5").setIndex("looplevelinput", "last", 0);
    model.result("pg5").set("xlabelactive", true);
    model.result("pg5").set("xlabel", "\u8ddd\u79bb (m)");
    model.result("pg5").set("ylabelactive", true);
    model.result("pg5").set("ylabel", "\u6c29\u79bb\u5b50\u6570\u5bc6\u5ea6 (1/m<sup>3</sup>)");
    ...
    model.result("pg5").feature("lngr1").set("descr", "\u6570\u5bc6\u5ea6");
    model.result("pg5").run();
    model.result("pg5").run();
    model.result().duplicate("pg6", "pg5");
    model.result("pg6").run();
    model.result("pg6").label("\u7535\u6d41\u5bc6\u5ea6");
    ...
    model.result("pg6").feature("lngr1").set("descr", "\u7535\u5b50\u6d41\u5bc6\u5ea6\uff0cx \u5206\u91cf");
    ...
    model.result("pg6").run();
    model.result("pg6").feature("lngr1").setIndex("legends", "\u7535\u5b50\u6d41\u5bc6\u5ea6", 0);
    model.result("pg6").feature().duplicate("lngr2", "lngr1");
    model.result("pg6").run();
    model.result("pg6").feature("lngr2").set("expr", "plas.Jix_wAr_1p");
    model.result("pg6").feature("lngr2").set("descr", "\u79bb\u5b50\u6d41\u5bc6\u5ea6\uff0cx \u5206\u91cf");
    model.result("pg6").run();
    model.result("pg6").feature("lngr2").setIndex("legends", "\u79bb\u5b50\u6d41\u5bc6\u5ea6", 0);
    model.result("pg6").run();
    model.result("pg6").feature().duplicate("lngr3", "lngr1");
    model.result("pg6").run();
    model.result("pg6").feature("lngr3").set("expr", "plas.Jix_wAr_1p+plas.Jelx");
    model.result("pg6").feature("lngr3").setIndex("legends", "\u603b\u7535\u6d41\u5bc6\u5ea6", 0);
    model.result("pg6").run();
