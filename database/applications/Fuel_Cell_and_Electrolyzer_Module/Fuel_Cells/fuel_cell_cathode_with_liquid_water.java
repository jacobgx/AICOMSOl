/*
 * fuel_cell_cathode_with_liquid_water.java
 */
...
public class fuel_cell_cathode_with_liquid_water {
...
//    model.param().loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg16").label("\u76f8\u5bf9\u6e7f\u5ea6");
    model.result("pg16").selection().geom("geom1", 3);
    model.result("pg16").selection().named("geom1_blk2_dom");
    model.result("pg16").create("vol1", "Volume");
    model.result("pg16").feature("vol1").set("expr", "fc.RH");
    model.result("pg16").feature("vol1").set("descr", "\u76f8\u5bf9\u6e7f\u5ea6");
    model.result("pg16").run();
    model.result().table().duplicate("tbl3", "tbl1");
    model.result().table("tbl3").label("\u8fc7\u9971\u548c\uff0c\u6ca1\u6709\u6db2\u6001\u6c34\u4f20\u8f93");
    ...
    model.component("comp1").physics("phtr").field("volumefraction").component(new String[]{"s_g", "s_l"});

    model.param().rename("eps_gas", "eps_pores");
    model.param().descr("eps_pores", "\u591a\u5b54\u7535\u6781\u4e2d\u7684\u5b54\u9699\u4f53\u79ef\u5206\u6570");
    model.param().set("kce", "5.62e4[mol/m^3/s]");
    model.param().descr("kce", "\u51b7\u51dd\u84b8\u53d1\u7387\u5e38\u6570");
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    model.component("comp1").variable("var1")
         .set("eps_gas", "eps_pores*s_g", "\u6c14\u4f53\u4f53\u79ef\u5206\u6570");
    model.component("comp1").variable("var1").set("pc", "pc(s_l)", "\u6bdb\u7ec6\u538b\u529b");
    model.component("comp1").variable("var1")
         .set("perm_eff_gas", "perm*s_g^2", "\u6709\u6548\u6c14\u76f8\u6e17\u900f\u7387");

    model.component("comp1").func().create("int1", "Interpolation");
    model.component("comp1").func("int1").set("source", "file");
    model.component("comp1").func("int1").set("filename", "fuel_cell_cathode_with_liquid_water_pc.txt");
    model.component("comp1").func("int1").importData();
    model.component("comp1").func("int1").set("funcname", "pc");
    ...
    model.component("comp1").func("int1").set("funcinvname", "s_l");
    ...
    model.component("comp1").physics("fc").feature("o2gasph1").feature("wce1").set("k_ce", "kce");
    model.component("comp1").physics("fc").feature("o2gde1")
         .set("kappag", new String[]{"perm_eff_gas", "0", "0", "0", "perm_eff_gas", "0", "0", "0", "perm_eff_gas"});
    model.component("comp1").physics("phtr").selection().named("geom1_blk2_dom");
    model.component("comp1").physics("phtr").feature("porous1").feature("fluid1").set("minput_pressure", "fc.pA");
    model.component("comp1").physics("phtr").feature("porous1").feature("fluid1").setIndex("pc", "pc", 1);
    ...
    model.component("comp1").physics("phtr").feature("porous1").feature("fluid1")
         .set("rhoint_s_l_mat", "root.comp1.fc.rhoH2O_l");
    model.component("comp1").physics("phtr").feature("porous1").feature("fluid1")
         .set("mu_s_l_mat", "root.comp1.fc.muH2O_l");
    model.component("comp1").physics("phtr").feature("porous1").feature("fluid1").set("kappar_s_l", "s_l^2");
    model.component("comp1").physics("phtr").feature("porous1").feature("pm1").set("epsilon_p_mat", "userdef");
    model.component("comp1").physics("phtr").feature("porous1").feature("pm1").set("epsilon_p", "eps_pores");
    model.component("comp1").physics("phtr").feature("porous1").feature("pm1").set("kappa_mat", "userdef");
    model.component("comp1").physics("phtr").feature("porous1").feature("pm1")
         .set("kappa", new String[]{"perm", "0", "0", "0", "perm", "0", "0", "0", "perm"});
    model.component("comp1").physics("phtr").create("sa1", "VolumeFraction", 2);
    model.component("comp1").physics("phtr").feature("sa1").selection().named("geom1_wp1_bnd");
    model.component("comp1").physics("phtr").feature("sa1").setIndex("phases", true, 1);
    model.component("comp1").physics("phtr").feature("sa1").setIndex("s0", "s_l(0)", 1);
    model.component("comp1").physics("phtr").feature("init1").setIndex("s0", "s_l(0)", 1);
    model.component("comp1").physics("phtr").create("ms1", "MassSource", 3);
    model.component("comp1").physics("phtr").feature("ms1").selection().all();
    model.component("comp1").physics("phtr").feature("ms1").setIndex("qs_s_l_src", "root.comp1.fc.Q_l", 0);

    model.study("std1").create("stat2", "Stationary");
    model.study("std1").feature("stat2").label("\u7a33\u6001 - \u4e0d\u5305\u542b\u76f8\u4f20\u9012");
    model.study("std1").feature("stat2").setSolveFor("/physics/phtr", false);
    model.study("std1").feature().move("stat2", 1);
    model.study("std1").create("stat3", "Stationary");
    model.study("std1").feature("stat3").label("\u7a33\u6001 - \u4ec5\u76f8\u4f20\u9012");
    model.study("std1").feature("stat3").setSolveFor("/physics/fc", false);
    model.study("std1").feature().move("stat3", 2);
    model.study("std1").feature("stat").label("\u7a33\u6001 - \u6240\u6709\u7269\u7406\u573a");
    ...
    model.result("pg17").label("\u6db2\u6001\u6c34\u9971\u548c\u5ea6");
    ...
    model.result("pg17").feature("arws1").set("expr", new String[]{"phtr.ux_s_l", "phtr.uy_s_l", "phtr.uz_s_l"});
    model.result("pg17").feature("arws1").set("descr", "\u4f53\u79ef\u901a\u91cf\uff0c\u76f8 s_l");
    ...
    model.result("pg3").set("window", "window1");
    model.result("pg3").run();
    model.result("pg3").feature("tblp1").setIndex("legends", "\u542b\u6db2\u6001\u6c34", 0);
    model.result("pg3").set("window", "window1");
    model.result("pg3").run();
    model.result("pg3").feature("tblp2").set("table", "tbl3");
    model.result("pg3").feature("tblp2")
         .setIndex("legends", "\u8fc7\u9971\u548c\uff0c\u4e0d\u542b\u6db2\u6001\u6c34", 0);
    model.result("pg3").set("window", "window1");
    model.result("pg3").run();
    model.result().table().remove("tbl2");

    model.component("comp1").func("int1").createPlot("pg19");

    model.result("pg19").run();
    model.result("pg19").set("xlabelactive", true);
    model.result("pg19").set("xlabel", "\u6db2\u4f53\u9971\u548c\u5ea6 (1)");
    model.result("pg19").set("ylabelactive", true);
    model.result("pg19").set("ylabel", "\u6bdb\u7ec6\u538b\u529b (bar)");
    model.result("pg19").set("titletype", "none");
    model.result("pg19").run();
    model.result().remove("pg19");
    model.result().dataset().remove("int1_ds1");
    model.result("pg12").run();
    model.result("pg12").label("\u6c14\u76f8\u538b\u529b");

    model.title("\u542b\u6db2\u6001\u6c34\u7684\u71c3\u6599\u7535\u6c60\u9634\u6781");

    model
         .description("\u672c\u4f8b\u5bf9\u201c\u71c3\u6599\u7535\u6c60\u9634\u6781\u7684\u8d28\u91cf\u4f20\u9012\u548c\u7535\u5316\u5b66\u53cd\u5e94\u201d\u6559\u7a0b\u8fdb\u884c\u6269\u5c55\uff0c\u989d\u5916\u52a0\u5165\u4e86\u6db2\u6001\u6c34\u5728\u6c27\u7535\u6781\u4e2d\u7684\u4f20\u8f93\u3002\n\n\u5176\u4e2d\u6839\u636e\u6c14\u76f8\u4e2d\u7684\u76f8\u5bf9\u6e7f\u5ea6\u6c34\u5e73\uff0c\u901a\u8fc7\u84b8\u6c7d\u51b7\u51dd\u901f\u7387\u8868\u8fbe\u5f0f\u6765\u4ea7\u751f\u6db2\u6001\u6c34\u3002\n\n\u672c\u4f8b\u91c7\u7528\u5b9e\u9a8c\u6bdb\u7ec6\u538b\u529b\u66f2\u7ebf\u6765\u5b9a\u4e49\u6db2\u4f53\u9971\u548c\u6c34\u5e73\u4e0e\u6c14\u6db2\u4e24\u76f8\u538b\u529b\u5dee\u4e4b\u95f4\u7684\u76f8\u5173\u6027\u3002");
