/*
 * soec_thermodynamics_geom_sequence.java
 */
...
public class soec_thermodynamics_geom_sequence {
...
//    model.param().loadFile("FILENAME");
    ...
    model.component("comp1").geom("geom1").feature("blk1").label("\u9633\u6781");
    ...
    model.component("comp1").geom("geom1").feature("blk2").label("\u7535\u89e3\u8d28");
    ...
    model.component("comp1").geom("geom1").feature("blk3").label("\u9634\u6781");
    ...
    model.component("comp1").geom("geom1").feature("ext1").label("\u901a\u9053\u57df");
    ...
    model.component("comp1").geom("geom1").feature("sel3").label("\u9634\u6781\u96c6\u6d41\u4f53");
    ...
    model.component("comp1").geom("geom1").feature("sel4").label("\u9633\u6781\u96c6\u6d41\u4f53");
    ...
    model.component("comp1").geom("geom1").feature("adjsel1").label("\u901a\u9053\u57df\u8fb9\u754c");
    model.component("comp1").geom("geom1").run("adjsel1");
    model.component("comp1").geom("geom1").create("difsel1", "DifferenceSelection");
    model.component("comp1").geom("geom1").feature("difsel1").label("\u8fb9\u754c\u5c42\u8fb9\u754c");
