...
public class cu_trench_deposition_pf {
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    model.component("comp1").variable("var1")
         .set("epsl", "max(pf.Vf1,1e-2)", "\u7535\u89e3\u8d28\u4f53\u79ef\u5206\u6570");
    model.component("comp1").variable("var1")
    ...
    model.component("comp1").physics("tcd").feature("hcpce1").feature("per1").set("Av", "pf.delta");
    ...
    model.component("comp1").physics("pf").feature("pfm1").set("epsilon_pf", "pf.hmax/16");
    model.component("comp1").physics("pf").feature("pfm1").set("chiOption", "velocity");
    model.component("comp1").physics("pf").feature("pfm1").set("U", "max(Vn,eps)");
    model.component("comp1").physics("pf").feature("pfm1")
         .set("u", new String[]{"-Vn*pf.intnormx", "-Vn*pf.intnormy", "0"});
    model.component("comp1").physics("pf").create("inl1", "InletBoundary", 1);
    model.component("comp1").physics("pf").feature("inl1").selection().set(2, 4, 5, 6, 7, 9, 10, 11, 12);
    model.component("comp1").physics("pf").feature("inl1").set("pfcond", "Fluid2pf");
    model.component("comp1").physics("pf").create("out1", "Outlet", 1);
    model.component("comp1").physics("pf").feature("out1").selection().set(1, 3, 8);
    ...
    model.title("\u4f7f\u7528\u76f8\u573a\u6cd5\u6a21\u62df\u6c9f\u69fd\u4e2d\u9540\u94dc");

    model
         .description("\u672c\u4f8b\u8bf4\u660e\u5982\u4f55\u4f7f\u7528\u201c\u76f8\u573a\u201d\u63a5\u53e3\u6a21\u62df\u9634\u6781\u8868\u9762\u53d1\u751f\u7684\u94dc\u7684\u7535\u9540\u8fc7\u7a0b\uff0c\u7ed3\u679c\u518d\u73b0\u4e86\u7531\u4e8e\u6c89\u79ef\u901f\u7387\u4e0d\u5747\u5300\u800c\u4ea7\u751f\u7684\u7a7a\u7a74\u5f62\u6210\u3002\u5176\u4e2d\u65e2\u8003\u8651\u4e86\u6d53\u5ea6\u76f8\u5173\u7535\u6781\u52a8\u529b\u5b66\uff0c\u4e5f\u8003\u8651\u4e86\u901a\u8fc7\u6269\u6563\u548c\u8fc1\u79fb\u5f15\u8d77\u7684\u79bb\u5b50\u4f20\u8f93\uff0c\u56e0\u6b64\uff0c\u8be5\u6a21\u578b\u79f0\u4e3a\u4e09\u6b21\u7535\u6d41\u5bc6\u5ea6\u5206\u5e03\u6a21\u578b\u3002\u6c89\u79ef\u8fb9\u754c\u5904\u7684\u7535\u6781\u52a8\u529b\u5b66\u5b9a\u4e49\u4e3a\u4f7f\u7528\u201c\u76f8\u573a\u201d\u63a5\u53e3\u4e2d\u7684 \u03b4 \u51fd\u6570\u7684\u4e00\u4e2a\u57df\u9879\u3002");
