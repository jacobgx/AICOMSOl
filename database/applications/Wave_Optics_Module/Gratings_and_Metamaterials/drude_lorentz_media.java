...
public class drude_lorentz_media {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("ewt").prop("components").set("components", "inplane");
    model.component("comp1").physics("ewt").feature("wee1")
         .set("DisplacementFieldModel", "DrudeLorentzDispersionModel");
    model.component("comp1").physics("ewt").feature("wee1").set("epsilonInf", new int[]{4, 0, 0, 0, 4, 0, 0, 0, 1});
    model.component("comp1").physics("ewt").feature("wee1").set("omegap", "omega_p");
    model.component("comp1").physics("ewt").feature("wee1").set("mur_mat", "userdef");
    model.component("comp1").physics("ewt").feature("wee1").set("sigma_mat", "userdef");
    model.component("comp1").physics("ewt").feature("wee1").create("dlp1", "DrudeLorentzPolarization", 2);
    model.component("comp1").physics("ewt").feature("wee1").feature("dlp1").set("item.f", 1);
    model.component("comp1").physics("ewt").feature("wee1").feature("dlp1").set("item.omega0", "omega_1");
    model.component("comp1").physics("ewt").feature("wee1").feature("dlp1").set("item.damp", "gamma_1");
    model.component("comp1").physics("ewt").create("wee2", "WaveEquationElectric", 2);
    model.component("comp1").physics("ewt").feature("wee2").selection().set(1, 3, 5);
    model.component("comp1").physics("ewt").feature("wee2").set("n_mat", "userdef");
    ...
    model.component("comp1").physics("ewt").feature("sctr1").set("E0i", new String[]{"0", "E_pulse*E_bnd", "0"});
    model.component("comp1").physics("ewt").create("sctr2", "Scattering", 1);
    model.component("comp1").physics("ewt").feature("sctr2").selection().set(16);
    model.component("comp1").physics("ewt").create("pc1", "PeriodicCondition", 1);
    model.component("comp1").physics("ewt").feature("pc1").selection().set(2, 3, 5, 10, 12, 15);
    ...
    model.component("comp1").probe("var1").set("expr", "intop1(ewt.Ey)");
    model.component("comp1").probe().create("var2", "GlobalVariable");
    model.component("comp1").probe("var2").set("expr", "intop2(ewt.Poscy)");
    model.component("comp1").probe("var2").set("window", "new");
    model.component("comp1").probe().create("var3", "GlobalVariable");
    model.component("comp1").probe("var3").set("expr", "intop3(ewt.Poscy)");
