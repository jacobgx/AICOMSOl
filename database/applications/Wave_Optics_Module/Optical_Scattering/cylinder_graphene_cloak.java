...
public class cylinder_graphene_cloak {
  ...
  public static Model run() {
    ...
    model.component("comp1").variable("var1").set("C_scatt", "intop1(nr*ewfd.relPoavr+nz*ewfd.relPoavz)/I0");
    ...
    model.component("comp1").physics("ewfd").prop("BackgroundField").set("WaveType", "LinearPol");
    model.component("comp1").physics("ewfd").prop("BackgroundField").set("incAngle", "theta");
    model.component("comp1").physics("ewfd").prop("BackgroundField").set("highestMode", 5);
    model.component("comp1").physics("ewfd").prop("BackgroundField").set("fieldAmplitude", "E0");
    ...
    model.component("comp1").physics("ewfd").prop("outofplanewavenumber").set("mFloquet", "modeNum");
    ...
    model.component("comp1").physics("ewfd").feature("trans1").selection().set(8, 10, 16);
    ...
    model.component("comp1").physics("ewfd").feature("trans1").set("sigmabnd", "sigma/d_eff");
    model.component("comp1").physics("ewfd").feature("trans1").set("d", "d_eff");
    ...
    model.study("std2").feature("freq").set("disabledphysics", new String[]{"ewfd/trans1"});
    ...
    model.result("pg2").label("\u6563\u5c04\u573a (ewfd)");
    model.result("pg2").create("surf1", "Surface");
    model.result("pg2").feature("surf1")
         .set("expr", "sum(withsol('sol1',ewfd.relEz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg3").label("\u80cc\u666f\u573a (ewfd)");
    model.result("pg3").create("surf1", "Surface");
    model.result("pg3").feature("surf1")
         .set("expr", "sum(withsol('sol1',ewfd.Ebz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg5").label("\u6563\u5c04\u573a (ewfd) 1");
    model.result("pg5").create("surf1", "Surface");
    model.result("pg5").feature("surf1")
         .set("expr", "sum(withsol('sol2',ewfd.relEz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg6").label("\u80cc\u666f\u573a (ewfd) 1");
    model.result("pg6").create("surf1", "Surface");
    model.result("pg6").feature("surf1")
         .set("expr", "sum(withsol('sol2',ewfd.Ebz,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg7").feature("surf1")
         .set("expr", "sum(withsol('sol1',ewfd.Ez,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg7").feature("surf2")
         .set("expr", "sum(withsol('sol1',ewfd.Ez*exp(-j*modeNum*pi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg8").feature("surf1")
         .set("expr", "sum(withsol('sol2',ewfd.Ez,setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg8").feature("surf2")
         .set("expr", "sum(withsol('sol2',ewfd.Ez*exp(-j*modeNum*pi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg10").feature("slc1")
         .set("expr", "sum(withsol('sol1',ewfd.Ez*exp(-j*modeNum*rev1phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model.result("pg10").feature("slc3")
         .set("expr", "sum(withsol('sol2',ewfd.Ez*exp(-j*modeNum*rev2phi),setval(freq,freq),setind(modeNum,index)),index,1,2*highestMode+1)");
    ...
    model
         .description("\u672c\u6a21\u578b\u4ecb\u7ecd\u4e00\u79cd\u4f7f\u7528\u7535\u8c03\u8c10\u5355\u5c42\u77f3\u58a8\u70ef\u7684\u9690\u8eab\u65b9\u6cd5\u3002\u6211\u4eec\u5c06\u6f14\u793a\uff0c\u5f53\u4e00\u4e2a\u5706\u67f1\u5f62\u7535\u4ecb\u8d28\u6563\u5c04\u4f53\u88ab\u77f3\u58a8\u70ef\u8986\u76d6\u65f6\uff0c\u6563\u5c04\u622a\u9762\u5728\u6307\u5b9a\u9891\u7387\u4e0b\u4f1a\u5927\u5e45\u51cf\u5c0f\uff0c\u4ece\u800c\u4f7f\u5176\u5728\u7535\u78c1\u4e0a\u4e0d\u53ef\u89c1\u3002\u672c\u6a21\u578b\u65e8\u5728\u6f14\u793a\u7ebf\u504f\u632f\u5e73\u9762\u6ce2\u80cc\u666f\u573a\u5728\u4e8c\u7ef4\u8f74\u5bf9\u79f0\u6a21\u578b\u4e2d\u7684\u5e94\u7528\u3002");
