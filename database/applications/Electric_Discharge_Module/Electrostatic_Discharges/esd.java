...
public class esd {
  ...
  public static Model run() {
    ...
    model
         .modelPath("D:\\Program Files\\COMSOL\\COMSOL63\\Multiphysics\\applications\\Electric_Discharge_Module\\Electrostatic_Discharges");
    ...
    model.result("pg2").run();
    model.result("pg2").label("Electron Density");
    ...
    model.param().set("V_ESD", "8[kV]");
    model.param().set("C1", "100[pF]");
    model.param().set("R1", "1500[\u03a9]");
    model.param().set("L1", "5[nH]");

    model.component("comp1").physics().create("cir", "Circuit", "geom1");

    model.study("std1").feature("esi").setSolveFor("/physics/cir", true);
    ...
    model.component("comp1").physics("cir").feature("C1").set("C", "C1");
    model.component("comp1").physics("cir").feature("C1").set("v", "V_ESD");
    ...
    model.component("comp1").physics("cir").feature("L1").set("L", "L1");
    model.component("comp1").physics("cir").create("UvsI1", "ModelDeviceVI", -1);
    model.component("comp1").physics("cir").feature("UvsI1").setIndex("Connections", 3, 0, 0);
    model.component("comp1").physics("cir").feature("UvsI1").setIndex("Connections", 0, 1, 0);
    model.component("comp1").physics("edis").feature("gas1").feature("ece2").set("TerminalType", "CircuitVoltage");
    model.component("comp1").physics("cir").feature("UvsI1").set("I_src", "root.comp1.edis.I0_1");

    model.component("comp1").probe().create("var1", "GlobalVariable");
    model.component("comp1").probe("var1").set("probename", "ic");
    model.component("comp1").probe("var1").set("expr", "edis.I0_1");

    model.component("comp1").geom("geom1").lengthUnit("mm");
    model.component("comp1").geom("geom1").run("fin");

    model.component("comp1").variable("var1")
         .set("N0", "(1e8+1e12*exp(-((z/(1[mm])-0.5)/0.027)^2-(r/(1[mm])/0.021)^2))[cm^-3]");
    ...
    model.study("std2").feature("time").setSolveFor("/physics/edis", true);
    model.study("std2").feature("time").setSolveFor("/physics/cir", true);
    model.study("std2").feature("time").set("tunit", "ns");
    model.study("std2").feature("time").set("tlist", "range(0,0.5,2.5) range(5,5,50) 100");
    ...
    model.result("pg1").setIndex("looplevel", new int[]{1, 3, 8, 16, 17}, 0);
    model.result("pg1").run();
    ...
    model
         .description("\u672c\u6a21\u578b\u6f14\u793a\u5982\u4f55\u6a21\u62df\u9759\u7535\u653e\u7535 (ESD) \u80cc\u540e\u7684\u590d\u6742\u653e\u7535\u7269\u7406\u8fc7\u7a0b\uff0c\u5176\u4e2d\u5c06\u201c\u653e\u7535\u201d\u4e0e\u201c\u7535\u8def\u201d\u63a5\u53e3\u76f8\u7ed3\u5408\uff0c\u4ee5\u6a21\u62df\u4eba\u624b\u63a5\u89e6\u91d1\u5c5e\u65f6 ESD \u7535\u6d41\u7684\u4ea7\u751f\u8fc7\u7a0b\u3002");
