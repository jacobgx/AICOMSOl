...
public class transient_arc_2d {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").feature("r1").set("size", new String[]{"L", "r0+gap+r0"});
    model.component("comp1").geom("geom1").feature("r1").setIndex("layer", "r0", 0);
    model.component("comp1").geom("geom1").feature("r1").setIndex("layer", "gap", 1);
    model.component("comp1").geom("geom1").run("r1");
    model.component("comp1").geom("geom1").create("c1", "Circle");
    model.component("comp1").geom("geom1").feature("c1").set("r", "L*2");
    model.component("comp1").geom("geom1").feature("c1").set("pos", new String[]{"L/2", "(r0+gap+r0)/2"});
    model.component("comp1").geom("geom1").runPre("fin");
    model.component("comp1").geom("geom1").run();

    model.component("comp1").physics("mef").prop("d").set("d", "d");
    model.component("comp1").physics("mef").create("alcf2", "ElectromagneticModelFluid", 2);
    model.component("comp1").physics("mef").feature("alcf1").selection().set(2, 3, 4);
    model.component("comp1").physics("mef").create("al1", "AmperesLaw", 2);
    model.component("comp1").physics("mef").feature("al1").selection().set(1);
    ...
    model.component("comp1").physics("mef").create("mi2", "MagneticInsulation", 1);
    model.component("comp1").physics("mef").feature("mi2").selection().set(1, 3, 5);
    model.component("comp1").physics("mef").feature("mi2").create("term1", "Terminal", 1);
    model.component("comp1").physics("mef").feature("mi2").feature("term1").selection().set(5);
    model.component("comp1").physics("mef").feature("mi2").feature("term1").set("I0", "ic(t)");
    model.component("comp1").physics("mef").feature("mi2").create("ein1", "ElectricInsulation", 1);
    model.component("comp1").physics("mef").feature("mi2").feature("ein1").selection().set(3);
    model.component("comp1").physics("mef").create("gfa1", "GaugeFixingA", 2);

    model.component("comp1").variable().create("var1");
    model.component("comp1").variable("var1").set("T0", "12000[K]*exp(-((x-L_wire)/d)^2)+293.15[K]");
    ...
    model.component("comp1").physics("ht").feature("ofl1").selection().set(11, 12, 13, 14);
    model.component("comp1").physics("ht").create("hf1", "HeatFluxBoundary", 1);
    model.component("comp1").physics("ht").feature("hf1").selection().set(1, 2, 4, 5, 6, 7, 8, 10);
    model.component("comp1").physics("ht").feature("hf1").set("HeatFluxType", "ConvectiveHeatFlux");
    model.component("comp1").physics("ht").feature("hf1").set("h", 600);
    model.component("comp1").physics("ht").create("sar1", "SurfaceToAmbientRadiation", 1);
    model.component("comp1").physics("ht").feature("sar1").selection().set(4, 6);
    model.component("comp1").physics("ht").feature("sar1").set("epsilon_rad_mat", "userdef");
    model.component("comp1").physics("ht").feature("sar1").set("epsilon_rad", 0.5);
    model.component("comp1").physics("spf").create("out1", "OutletBoundary", 1);
    model.component("comp1").physics("spf").feature("out1").selection().set(11, 12, 13, 14);

    model.component("comp1").multiphysics("phs1").selection().set(1, 3);
    ...
    model.component("comp1").material("mat1").label("Air (1[atm])");
    ...
    model.component("comp1").material("mat1").propertyGroup("def").set("ratioofspecificheat", "1.40");
    ...
    model.study("std1").feature("time").set("tlist", "range(ts_ms,0.1,4.5)");
    model.study("std1").showAutoSequences("all");

    model.sol("sol1").feature("s1").feature("dDef").set("linsolver", "pardiso");
    model.sol("sol1").feature("t1").create("se1", "Segregated");
    model.sol("sol1").feature("t1").feature("se1").create("ss1", "SegregatedStep");
    model.sol("sol1").feature("t1").feature("se1").feature("ssDef")
         .set("segvar", new String[]{"comp1_A", "comp1_mef_psi", "comp1_V", "comp1_mef_mi2_term1_V0_ode"});
    model.sol("sol1").feature("t1").feature("se1").feature("ssDef").set("subjtech", "once");
    ...
    model.sol("sol1").feature("t1").feature("se1").feature("ss1")
         .set("segvar", new String[]{"comp1_p", "comp1_T", "comp1_u"});
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg2").feature("surf1").set("expr", "mef.normE");
    ...
    model.result("pg2").feature("str1").set("expr", new String[]{"mef.Ex", "mef.Ey"});
    ...
    model.result("pg2").feature("str1").feature("col1").set("expr", "mef.normE");
    ...
    model.title("\u4e8c\u7ef4\u77ac\u6001\u7535\u5f27\u653e\u7535\u4eff\u771f");

    model
         .description("\u672c\u6a21\u578b\u5c55\u793a\u6cbf\u94dc\u5bfc\u8f68\u79fb\u52a8\u7684\u77ac\u6001\u7535\u5f27\u653e\u7535\u7684\u4e8c\u7ef4\u4eff\u771f\u3002\u5c3d\u7ba1\u7cbe\u786e\u6a21\u62df\u77ac\u6001\u7535\u5f27\u5f80\u5f80\u9700\u8981\u4e09\u7ef4\u4eff\u771f\uff0c\u4f46\u4e8c\u7ef4\u65b9\u6cd5\u66f4\u52a0\u9ad8\u6548\uff0c\u5bf9\u4e8e\u521d\u6b65\u7814\u7a76\u548c\u6f14\u793a\u76ee\u7684\u4ecd\u7136\u5f88\u6709\u4ef7\u503c\u3002");
    ...
    model.label("transient_arc_2d.mph");
