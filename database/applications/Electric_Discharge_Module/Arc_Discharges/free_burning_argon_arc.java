...
public class free_burning_argon_arc {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("mef").feature("mi1").create("term1", "Terminal", 1);
    model.component("comp1").physics("mef").feature("mi1").feature("term1").selection().set(7);
    model.component("comp1").physics("mef").feature("mi1").feature("term1").set("I0", "I0");
    ...
    model.component("comp1").physics("ht").feature("sar1").selection().set(4, 6, 8, 9, 14);
    ...
    model.study("std1").feature("stat").setIndex("pname", "I0", 0);
  ...
  public static Model run2(Model model) {
    model.study("std1").feature("stat").setIndex("punit", "A", 0);
    model.study("std1").feature("stat").setIndex("plistarr", "100 200 300", 0);
    ...
    model.result("pg5").feature("vol1").set("colortable", "HeatCamera");
    model.result("pg5").run();
    model.result().create("pg6", "PlotGroup1D");
    model.result("pg6").run();
    model.result("pg6").label("VI \u66f2\u7ebf");
    model.result("pg6").create("glob1", "Global");
    model.result("pg6").feature("glob1").set("markerpos", "datapoints");
    model.result("pg6").feature("glob1").set("linewidth", "preference");
    model.result("pg6").feature("glob1").setIndex("expr", "mef.V0_1", 0);
    ...
    model.title("\u81ea\u7531\u71c3\u70e7\u6c29\u5f27\u7684\u4eff\u771f");

    model
         .description("\u672c\u4f8b\u7814\u7a76\u5728\u70b9\u5bf9\u9762\u914d\u7f6e\u4e0b\u4ea7\u751f\u7684\u710a\u63a5\u6c29\u5f27\u7684\u7535\u6c14\u548c\u70ed\u7279\u6027\u3002\u5176\u4e2d\u5047\u8bbe\u653e\u7535\u5904\u4e8e\u5c40\u90e8\u70ed\u529b\u5b66\u5e73\u8861\u72b6\u6001\uff0c\u5c06\u7535\u5f27\u89c6\u4e3a\u4e00\u79cd\u5bfc\u7535\u6d41\u4f53\u4ecb\u8d28\uff0c\u5e76\u91c7\u7528\u78c1\u6d41\u4f53\u52a8\u529b\u5b66\u65b9\u6cd5\u8fdb\u884c\u5efa\u6a21\u3002\u672c\u6a21\u578b\u6f14\u793a\u5982\u4f55\u4f7f\u7528\u201c\u7535\u5f27\u653e\u7535\u201d\u591a\u7269\u7406\u573a\u63a5\u53e3\u6765\u6a21\u62df\u76f4\u6d41\u7535\u5f27\uff0c\u5f97\u5230\u7684\u7535\u5f27\u6e29\u5ea6\u4e0e\u6587\u732e\u4e2d\u53d1\u8868\u7684\u5b9e\u9a8c\u7ed3\u679c\u9ad8\u5ea6\u4e00\u81f4\u3002");

    model.mesh().clearMeshes();

    model.sol("sol1").clearSolutionData();

    model.label("free_burning_argon_arc.mph");
