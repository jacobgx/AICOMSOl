...
public class modular_mixer_kw {
  ...
  public static Model run() {
    ...
    model.component("comp1").view("view5").light().create("lgt1", "DirectionalLight");
    model.component("comp1").view("view5").light("lgt1").set("lightdirection", new double[]{4, 3.7, -5});
    model.component("comp1").view("view5").light("lgt1").set("intensity", 0.8);
    model.component("comp1").view("view5").light("lgt1").set("cameracoord", true);
    model.component("comp1").view("view5").light().create("lgt2", "DirectionalLight");
    model.component("comp1").view("view5").light("lgt2").set("lightdirection", new double[]{-4, -2, -1});
    model.component("comp1").view("view5").light("lgt2").set("intensity", 0.4);
    model.component("comp1").view("view5").light("lgt2").set("cameracoord", true);
    model.component("comp1").view("view5").light().create("lgt3", "DirectionalLight");
    model.component("comp1").view("view5").light("lgt3").set("lightdirection", new double[]{0.5, -5, 4});
    model.component("comp1").view("view5").light("lgt3").set("intensity", 0.55);
    model.component("comp1").view("view5").light("lgt3").set("cameracoord", true);
    model.component("comp1").view("view5").light("lgt3").set("castshadowsonfloor", true);
    model.component("comp1").view("view5").camera().set("position", new double[]{-3, -4, 3});
    model.component("comp1").view("view5").camera().set("up", new double[]{0, 0, 1});
    model.component("comp1").view("view5").set("isx", true);
    ...
    model.component("comp1").view("view6").light().create("lgt1", "DirectionalLight");
    model.component("comp1").view("view6").light("lgt1").set("lightdirection", new double[]{4, 3.7, -5});
    model.component("comp1").view("view6").light("lgt1").set("intensity", 0.8);
    model.component("comp1").view("view6").light("lgt1").set("cameracoord", true);
    model.component("comp1").view("view6").light().create("lgt2", "DirectionalLight");
    model.component("comp1").view("view6").light("lgt2").set("lightdirection", new double[]{-4, -2, -1});
    model.component("comp1").view("view6").light("lgt2").set("intensity", 0.4);
    model.component("comp1").view("view6").light("lgt2").set("cameracoord", true);
    model.component("comp1").view("view6").light().create("lgt3", "DirectionalLight");
    model.component("comp1").view("view6").light("lgt3").set("lightdirection", new double[]{0.5, -5, 4});
    model.component("comp1").view("view6").light("lgt3").set("intensity", 0.55);
    model.component("comp1").view("view6").light("lgt3").set("cameracoord", true);
    model.component("comp1").view("view6").light("lgt3").set("castshadowsonfloor", true);
    model.component("comp1").view("view6").camera().set("position", new double[]{-3, -4, 3});
    model.component("comp1").view("view6").camera().set("up", new double[]{0, 0, 1});
    model.component("comp1").view("view6").set("isx", true);
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").physics("spf").feature("nturb1").set("TurbulenceModelInterface", "TurbulentFlowkomega");
    model.component("comp1").physics().create("spf2", "TurbulentFlowkomega", "geom1");
    model.component("comp1").physics("spf2").selection().geom("geom1", 3);
    model.component("comp1").physics("spf2").selection().set(1, 2);
    ...
    model.component("comp1").physics("spf2").prop("PhysicalModelProperty")
         .set("PressurePoissonEquation", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").prop("PhysicalModelProperty")
    ...
    model.component("comp1").physics("spf2").prop("TurbulenceModelProperty")
         .set("WallTreatment", new String[][]{{"WallFunctions"}});
    model.component("comp1").physics("spf2").prop("TurbulenceModelProperty")
    ...
    model.component("comp1").physics("spf2").feature().copy("iwbc1", "spf/iwbc1");
    model.component("comp1").physics("spf2").feature().copy("iwbc2", "spf/iwbc2");
    model.component("comp1").physics("spf2").feature().copy("sym1", "spf/sym1");
    model.component("comp1").physics("spf2").feature().copy("pfc1", "spf/pfc1");
    model.component("comp1").physics("spf2").feature().copy("prpc1", "spf/prpc1");
    ...
    model.component("comp1").physics("spf2").feature("iwbc1").set("BoundaryCondition", new String[][]{{"NoSlip"}});
    model.component("comp1").physics("spf2").feature("iwbc1").set("ApplyWallRoughness", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").feature("iwbc1")
         .set("TranslationalVelocityOption", new String[][]{{"AutomaticFromFrame"}});
    model.component("comp1").physics("spf2").feature("iwbc1").set("constraintOptions", new String[][]{{"auto"}});
    model.component("comp1").physics("spf2").feature("iwbc1")
         .set("constraintType", new String[][]{{"unidirectionalConstraint"}});
    model.component("comp1").physics("spf2").feature("iwbc1").set("constraintMethod", new String[][]{{"elemental"}});
    model.component("comp1").physics("spf2").feature("iwbc1").set("StudyStep", new String[][]{{"std1/frrot"}});
    model.component("comp1").physics("spf2").feature("iwbc2").set("BoundaryCondition", new String[][]{{"NoSlip"}});
    model.component("comp1").physics("spf2").feature("iwbc2").set("ApplyWallRoughness", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").feature("iwbc2")
         .set("TranslationalVelocityOption", new String[][]{{"AutomaticFromFrame"}});
    model.component("comp1").physics("spf2").feature("iwbc2").set("constraintOptions", new String[][]{{"auto"}});
    model.component("comp1").physics("spf2").feature("iwbc2")
         .set("constraintType", new String[][]{{"unidirectionalConstraint"}});
    model.component("comp1").physics("spf2").feature("iwbc2").set("constraintMethod", new String[][]{{"elemental"}});
    model.component("comp1").physics("spf2").feature("iwbc2").set("StudyStep", new String[][]{{"std1/frrot"}});
    model.component("comp1").physics("spf2").feature("sym1")
         .set("constraintOptions", new String[][]{{"pointwiseConstraints"}});
    model.component("comp1").physics("spf2").feature("sym1").set("constraintMethod", new String[][]{{"elemental"}});
    model.component("comp1").physics("spf2").feature("sym1")
         .set("constraintType", new String[][]{{"unidirectionalConstraint"}});
    model.component("comp1").physics("spf2").feature("sym1").set("StudyStep", new String[][]{{"std1/frrot"}});
    model.component("comp1").physics("spf2").feature("pfc1")
         .set("PeriodicFlowConditionUserInput", new String[][]{{"PressureDifference"}});
    model.component("comp1").physics("spf2").feature("pfc1").set("pdiff", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").feature("pfc1")
         .set("constraintOptions", new String[][]{{"nitscheConstraints"}});
    model.component("comp1").physics("spf2").feature("pfc1")
         .set("TransformationMethod", new String[][]{{"automatic"}});
    model.component("comp1").physics("spf2").feature("pfc1")
         .set("manualDestinationSelection", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").feature("pfc1")
         .set("splitPeriodicConditionSelections", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").feature("pfc1").set("nonlinearEntities", new String[][]{{}});
    model.component("comp1").physics("spf2").feature("pfc1").set("meshSimilarity", new String[][]{{"off"}});
    model.component("comp1").physics("spf2").feature("pfc1").set("StudyStep", new String[][]{{"std1/frrot"}});
    model.component("comp1").physics("spf2").feature("prpc1").set("p0", new String[][]{{"0"}});
    model.component("comp1").physics("spf2").feature("prpc1")
         .set("constraintOptions", new String[][]{{"pointwiseConstraints"}});
    model.component("comp1").physics("spf2").feature("prpc1")
         .set("constraintType", new String[][]{{"unidirectionalConstraint"}});
    model.component("comp1").physics("spf2").feature("prpc1").set("constraintMethod", new String[][]{{"elemental"}});
    model.component("comp1").physics("spf2").feature("prpc1").set("StudyStep", new String[][]{{"std1/frrot"}});

    model.disableUpdates(false);

    model.component("comp1").variable().duplicate("var2", "var1");
    model.component("comp1").variable("var2").rename("tau_riw", "tau_riw2");
    model.component("comp1").variable("var2")
         .set("tau_riw2", "x*(spf2.T_trac_uy+spf2.T_trac_dy)-y*(spf2.T_trac_ux+spf2.T_trac_dx)");
    model.component("comp1").variable("var2").rename("tau_rw", "tau_rw2");
    model.component("comp1").variable("var2").set("tau_rw2", "x*(spf2.T_tracy)-y*(spf2.T_tracx)");
    model.component("comp1").variable("var2").rename("P_riw", "P_riw2");
    model.component("comp1").variable("var2").set("P_riw2", "tau_riw2*rot1.alphat");
    model.component("comp1").variable("var2")
         .descr("P_riw2", "\u5355\u4f4d\u9762\u79ef\u6d88\u8017\uff08\u65cb\u8f6c\u5185\u58c1\uff09");
    model.component("comp1").variable("var2").rename("P_rw", "P_rw2");
    model.component("comp1").variable("var2").set("P_rw2", "tau_rw2*rot1.alphat");
    model.component("comp1").variable("var2")
         .descr("P_rw2", "\u5355\u4f4d\u9762\u79ef\u6d88\u8017\uff08\u65cb\u8f6c\u58c1\uff09");
    ...
    model.result("pg4").label("\u901f\u5ea6 (spf2)");
    ...
    model.result().dataset("surf4").label("\u5185\u58c1 1");
    ...
    model.result("pg5").label("\u538b\u529b (spf2)");
    ...
    model.result("pg6").label("\u58c1\u5206\u8fa8\u7387 (spf2)");
    model.result("pg6").set("data", "dset2");
    model.result("pg6").set("frametype", "spatial");
    model.result("pg6").feature().create("surf1", "Surface");
    model.result("pg6").feature("surf1").label("\u58c1\u5206\u8fa8\u7387");
    ...
    model.result("pg6").feature("slit1").label("\u58c1\u5206\u8fa8\u7387\uff0c\u5185\u58c1");
    ...
    model.result("pg7").feature("arws1").set("expr", new String[]{"0", "v2", "w2"});
    model.result("pg7").run();
    model.result("pg4").run();
    ...
    model.nodeGroup("grp3").label("\u529f\u7387/\u626d\u77e9\uff0ck-omega");
    ...
    model.nodeGroup("grp4").label("\u529f\u7387/\u626d\u77e9\uff0ck-epsilon");

    model.title("\u6a21\u5757\u5316\u6405\u62cc\u5668 - \u6e4d\u6d41\u6df7\u5408 (k-\u03c9)");

    model
         .description("\u672c\u4f8b\u57fa\u4e8e\u4e00\u4e2a\u73b0\u6709\u7684\u51e0\u4f55\u6a21\u578b\u6587\u4ef6\u8fdb\u884c\u6784\u5efa\uff0c\u5176\u4e2d\u5305\u542b\u7684\u51e0\u4f55\u96f6\u4ef6\u7528\u4e8e\u6784\u5efa\u5e26\u659c\u53f6\u7247\u53f6\u8f6e\u6216 Rushton \u6da1\u8f6e\u7684\u6321\u677f\u5f0f\u5e73\u5e95\u6405\u62cc\u5668\u548c\u789f\u5f62\u5e95\u6405\u62cc\u5668\u3002\u8be5\u6a21\u578b\u7684\u7279\u70b9\u662f\u4f7f\u7528 k-\u03c9 \u6a21\u578b\u6765\u6a21\u62df\u5e26\u659c\u53f6\u7247\u53f6\u8f6e\u7684\u789f\u5f62\u5e95\u5bb9\u5668\u4e2d\u7684\u6e4d\u6d41\u3002\n\n\u672c\u4f8b\u4f7f\u7528\u201c\u51bb\u7ed3\u8f6c\u5b50\u201d\u4eff\u771f\u65b9\u6cd5\uff0c\u65cb\u8f6c\u90e8\u4ef6\u3001\u5bb9\u5668\u58c1\u548c\u6321\u677f\u5747\u4fdd\u6301\u5728\u539f\u4f4d\uff0c\u901a\u8fc7\u5f15\u5165\u79bb\u5fc3\u529b\u548c\u79d1\u91cc\u5965\u5229\u529b\u6765\u5206\u6790\u65cb\u8f6c\u3002");
