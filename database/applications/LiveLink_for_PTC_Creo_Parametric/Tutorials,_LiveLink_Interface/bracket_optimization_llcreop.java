/*
 * bracket_optimization_llcreop.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Apr 30 2026, 10:44 by COMSOL 6.3.0.290. */
public class bracket_optimization_llcreop {
...
//    model.param().loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.param("default").paramCase("case1").set("LL_ZOO", "0.019476[m]");
    model.param("default").paramCase("case1").set("LL_YOO", "0.0063892[m]");
    model.param("default").paramCase("case1").set("LL_RC", "0.0066383[m]");
    model.param("default").paramCase("case1").set("LL_ZCO", "0.0048044[m]");
    model.param("default").paramCase("case1").set("LL_RO", "0.010309[m]");
    ...
    model.label("bracket_optimization_llcreop.mph");
