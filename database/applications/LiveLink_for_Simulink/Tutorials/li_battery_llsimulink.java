...
public class li_battery_llsimulink {
...
//    model.param().loadFile("FILENAME");
    ...
    model.param().set("E_cell_0SOC", "2.5[V]", "Cell voltage at 0% SOC");
    ...
    model.param().set("t_factor", "100", "Time acceleration factor");
    model.param().set("no_cycles", "2000", "Number of cycles");
    model.param().set("t_cycling", "no_cycles*10000/t_factor", "Approximative total cycling time");
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").selection("sel2").label("Separator");
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    model.component("comp1").variable("var1")
         .set("I_SEI", "-(1-H*(liion.iloc_per1<0)*liion.iloc_per1/i1C_loc*K(liion.cs_average/liion.csmax))*J*i1C_loc/(exp(alpha*eta_SEI*F_const/(R_const*T))+Q_SEI/Av_neg*f*J/i1C_loc)", "Parasitic reaction current");
    model.component("comp1").variable("var1")
         .set("Q_SEI", "liion.c_pce1_sei*F_const", "Parasitic reaction capacity");
    model.component("comp1").variable("var1")
         .set("eta_SEI", "liion.eta_per2", "Overpotential for parasitic reaction");
    model.component("comp1").variable("var1")
         .set("cycle_no", "comp1.liion.cdc1.cycle_counter*t_factor", "Number of cycles");
    model.component("comp1").variable("var1")
         .set("dch_filter", "comp1.liion.cdc1.CC_DCH", "Discharge filter (for plotting)");
    model.component("comp1").variable("var1")
         .set("dch_start_filter", "comp1.liion.cdc1.CC_DCH&& ((t-1)<comp1.liion.cdc1.t_dch_start)", "Discharge onset filter (for plotting)");
    model.component("comp1").variable("var1")
         .set("ch_start_filter", "comp1.liion.cdc1.CC_CH && ((t-1)<comp1.liion.cdc1.t_ch_start)", "Charge onset filter (for plotting)");
    model.component("comp1").variable("var1")
         .set("ch_start_filter_cycled_once", "comp1.liion.cdc1.CC_CH && ((t-1)<comp1.liion.cdc1.t_ch_start && cycle_no>0)", "Charge onset filter, excluding first cycle (for plotting)");
    model.component("comp1").variable("var1")
         .set("first_cycle_filter", "round(comp1.liion.cdc1.cycle_counter)==0", "First cycle filter (for plotting)");
    model.component("comp1").variable("var1")
         .set("last_cycle_filter", "round((comp1.liion.cdc1.cycle_counter+1)*t_factor)==no_cycles", "Last cycle filter (for plotting)");
    model.component("comp1").variable("var1")
         .set("I_upper", "liion.I_1C_cell/20", "Upper cutoff current for charge-discharge cycling");
    model.component("comp1").variable("var1").set("I_cell", "liion.cdc1.Icell", "Cell current");
    model.component("comp1").variable("var1").set("E_cell", "liion.cdc1.phis0", "Cell voltage");
    ...
    model.param().set("E_cell_100SOC", "4[V]");
    model.param().set("E_cell_0SOC", "3[V]");
    model.param().set("E_max", "4[V]");
    model.param().set("E_min", "3[V]");
    model.param().rename("C_rate", "I");
    model.param().set("I", "1.621[A]");
    model.param().descr("I", "Input current");
    model.param().set("Ac", "0.1[m^2]");
    model.param().descr("Ac", "Cross-sectional area");
    ...
    model.component("comp1").physics("liion").feature("ec1").set("Its", "I");
    model.component("comp1").physics("liion").feature("ec1").set("phis0init", "E_min");
    ...
    model.component("comp1").variable("var1").set("I_cell", "intop1(reacf(phil))*1[A]");
    model.component("comp1").variable("var1").set("E_cell", "liion.phis0_ec1");

    model.component("comp1").probe().create("var1", "GlobalVariable");
    model.component("comp1").probe("var1").set("probename", "voltage");
    model.component("comp1").probe("var1").set("expr", "E_cell");
    ...
    model.result("pg1").feature("lngr1").set("expr", new String[]{"cl"});
    model.result("pg1").label("\u7535\u89e3\u8d28\u76d0\u6d53\u5ea6 (liion)");
    model.result("pg1").run();

    model.study().create("std2");
    model.study("std2").create("time", "Transient");
    model.study("std2").feature("time").setSolveFor("/physics/liion", true);
    model.study("std2").feature("time").set("tlist", "range(0,180,3800)");
    ...
    model.result("pg4").feature("glob1").set("expr", new String[]{"liion.SOC_cell"});
    ...
    model.result("pg4").feature("glob2")
         .set("descr", new String[]{"\u5e73\u5747 SOC\uff0cPorous Electrode 1", "\u5e73\u5747 SOC\uff0cPorous Electrode 2"});
    model.result("pg4").feature("glob2").set("linestyle", "dashed");
    model.result("pg4").feature("glob2").set("xdatasolnumtype", "level1");
    model.result("pg4")
         .label("\u7535\u6c60\u548c\u5e73\u5747\u7535\u6781\u7535\u6c60\u7684\u8377\u7535\u72b6\u6001 (liion)");
    model.result("pg4").set("ylabel", "SOC (1)");
    ...
    model.result("pg7").label("\u7535\u89e3\u8d28\u76d0\u6d53\u5ea6 (liion) 1");
    ...
    model.externalInterface("sim1").set("filename", "li_battery_llsimulink");
    model.externalInterface("sim1").setIndex("inputname", "rp_neg", 0);
    model.externalInterface("sim1").setIndex("inputvalue", "2.50e-6[m]", 0);
    model.externalInterface("sim1").setIndex("inputunit", "m", 0);
    model.externalInterface("sim1").setIndex("inputname", "rp_neg", 0);
    model.externalInterface("sim1").setIndex("inputvalue", "2.50e-6[m]", 0);
    model.externalInterface("sim1").setIndex("inputunit", "m", 0);
    model.externalInterface("sim1").setIndex("inputname", "I", 0);
    model.externalInterface("sim1").setIndex("outputexpr", "comp1.voltage", 0);
    model.externalInterface("sim1").setIndex("outputdescr", "Voltage", 0);
    model.externalInterface("sim1").run();
    model.externalInterface("sim1").set("filename", "li_battery_llsimulink");

    model.title("\u9502\u79bb\u5b50\u7535\u6c60\u6a21\u578b\u5145\u7535\u63a7\u5236 - \u4e00\u7ef4");

    model
         .description("\u672c\u6a21\u578b\u901a\u8fc7 Simulink\u00ae \u4eff\u771f\u6f14\u793a\u9502\u79bb\u5b50\u7535\u6c60\u7684\u5145\u653e\u7535\u63a7\u5236\u3002");

    model.label("li_battery_llsimulink.mph");
