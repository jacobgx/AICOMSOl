/*
 * magnetic_brake_llsimulink.java
 */
...
public class magnetic_brake_llsimulink {
  ...
  public static Model run() {
    ...
    model.param().set("W0", "2*pi*dV0");
    model.param().descr("W0", "Angular velocity");

    model.component("comp1").physics("mef").feature().duplicate("vlt2", "vlt1");
    model.component("comp1").physics("mef").feature("vlt2").set("v", new String[]{"-y*W0", "x*W0", "0"});
    model.component("comp1").physics("mef").feature().move("vlt2", 6);

    model.component("comp1").probe().create("var4", "GlobalVariable");
    model.component("comp1").probe("var4").set("probename", "omega_tt");
    model.component("comp1").probe("var4").set("expr", "-axialTorque/mass1.Izz");
    ...
    model.study("std2").feature("stat").set("disabledphysics", new String[]{"mef/vlt1"});
    model.study("std2").feature("stat").setSolveFor("/physics/ge", false);
    model.study("std2").feature("stat").set("disabledphysics", new String[]{"mef/vlt1", "ge"});
    model.study("std2").setGenPlots(false);
    model.study("std2").showAutoSequences("all");

    model.sol("sol3").feature("s1").feature("i1").set("rhob", 1);
    ...
    model.externalInterface("sim1").set("filename", "magnetic_brake_llsimulink");
    model.externalInterface("sim1").setIndex("inputname", "dt", 0);
    model.externalInterface("sim1").setIndex("inputvalue", "1[cm]", 0);
    model.externalInterface("sim1").setIndex("inputunit", "m", 0);
    model.externalInterface("sim1").setIndex("inputname", "dt", 0);
    model.externalInterface("sim1").setIndex("inputvalue", "1[cm]", 0);
    model.externalInterface("sim1").setIndex("inputunit", "m", 0);
    model.externalInterface("sim1").setIndex("inputname", "W0", 0);
    model.externalInterface("sim1").setIndex("blockname", "dt", 0);
    model.externalInterface("sim1").setIndex("blockvalue", "1[cm]", 0);
    model.externalInterface("sim1").setIndex("blockunit", "m", 0);
    model.externalInterface("sim1").setIndex("blockname", "dt", 0);
    model.externalInterface("sim1").setIndex("blockvalue", "1[cm]", 0);
    model.externalInterface("sim1").setIndex("blockunit", "m", 0);
    model.externalInterface("sim1").setIndex("blockname", "mB", 0);
    model.externalInterface("sim1").setIndex("outputexpr", "comp1.omega_tt", 0);
    model.externalInterface("sim1").setIndex("outputdescr", "omega_tt", 0);
    model.externalInterface("sim1")
         .set("image", "C:\\Users\\parttestusr\\AppData\\Local\\Temp\\csjavabridge11934\\cosimulationimage.png");
    model.externalInterface("sim1").importImage();
    model.externalInterface("sim1").run();
    model.externalInterface("sim1").set("filename", "magnetic_brake_llsimulink");

    model.title("\u7535\u78c1\u5236\u52a8\u5668 - LiveLink\u2122 for Simulink\u00ae \u4eff\u771f");

    model
         .description("\u7535\u78c1\u5236\u52a8\u5668\u7531\u6c38\u78c1\u4f53\u7ec4\u6210\uff0c\u540e\u8005\u5728\u65cb\u8f6c\u7684\u94dc\u76d8\u4e2d\u4ea7\u751f\u611f\u5e94\u7535\u6d41\uff1b\u7531\u6b64\u4ea7\u751f\u7684\u6da1\u6d41\u4e0e\u78c1\u901a\u91cf\u76f8\u4e92\u4f5c\u7528\uff0c\u4ea7\u751f\u6d1b\u4f26\u5179\u529b\uff0c\u8fdb\u800c\u4ea7\u751f\u5236\u52a8\u529b\u77e9\u3002\u5706\u76d8\u89d2\u901f\u5ea6\u901a\u8fc7 Simulink\u00ae \u8fdb\u884c\u8ba1\u7b97\u3002");
    ...
    model.label("magnetic_brake_llsimulink.mph");
