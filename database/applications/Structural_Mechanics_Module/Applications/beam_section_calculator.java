...
public class beam_section_calculator {
  ...
  public static Model run() {
    ...
    model.geom()
         .load(new String[]{"part1"}, "Structural_Mechanics_Module/Beams/European_Standard/HEA_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part2"}, "Structural_Mechanics_Module/Beams/European_Standard/HEB_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part3"}, "Structural_Mechanics_Module/Beams/European_Standard/HEM_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part4"}, "Structural_Mechanics_Module/Beams/European_Standard/IPE_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part5"}, "Structural_Mechanics_Module/Beams/European_Standard/IPN_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part6"}, "Structural_Mechanics_Module/Beams/European_Standard/L_EN_equal_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part7"}, "Structural_Mechanics_Module/Beams/European_Standard/L_EN_unequal_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part8"}, "Structural_Mechanics_Module/Beams/European_Standard/UPE_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part9"}, "Structural_Mechanics_Module/Beams/European_Standard/UPN_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part10"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/C_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part11"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/HP_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part12"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/L_US_equal_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part13"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/L_US_unequal_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part14"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/M_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part15"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/MC_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part16"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/MT_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part17"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/S_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part18"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/ST_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part19"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/W_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part20"}, "Structural_Mechanics_Module/Beams/US_Standard/Imperial/WT_imperial_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part21"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/C_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part22"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/HP_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part23"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/L_US_equal_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part24"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/L_US_unequal_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part25"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/M_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part26"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/MC_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part27"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/MT_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part28"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/S_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part29"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/ST_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part30"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/W_metric_beam.mph", new String[]{"part1"});
    model.geom()
         .load(new String[]{"part31"}, "Structural_Mechanics_Module/Beams/US_Standard/Metric/WT_metric_beam.mph", new String[]{"part1"});
    model.component("comp1").geom("geom1").lengthUnit("in");
    model.component("comp1").geom("geom1").create("pi1", "PartInstance");
    model.component("comp1").geom("geom1").feature("pi1").set("selkeepnoncontr", false);
    model.component("comp1").geom("geom1").feature("pi1").set("part", "part19");
    model.component("comp1").geom("geom1").feature("pi1").setEntry("inputexpr", "h0", 4);
    model.component("comp1").geom("geom1").feature("pi1").setEntry("inputexpr", "W0", 13);
    ...
    model.view("view37").camera().set("position", new double[]{14.6, 10.7, 32.7});
    model.view("view37").camera().setIndex("up", -0.11, 0);
    model.view("view37").camera().setIndex("up", 0.96, 1);
    model.view("view37").camera().set("up", new double[]{-0.11, 0.96, -0.26});
    model.view("view37").camera().setIndex("viewoffset", "-5.48e-2", 0);
    model.view("view37").camera().set("viewoffset", new String[]{"-5.48e-2", "2.72e-2"});
    ...
    model
         .description("\u672c App \u6f14\u793a\u4ee5\u4e0b\u5185\u5bb9\uff1a\n\n\u2022 \u6d45\u8272\u4e3b\u9898\n\n\u8be5 App \u7528\u4e8e\u8ba1\u7b97\u5404\u79cd\u7f8e\u56fd\u548c\u6b27\u6d32\u6807\u51c6\u6881\u7684\u622a\u9762\u6570\u636e\u3002\u5982\u679c\u7ed9\u5b9a\u4e00\u7ec4\u4f5c\u7528\u5728\u622a\u9762\u4e0a\u7684\u529b\u548c\u529b\u77e9\uff0c\u60a8\u4e5f\u53ef\u4ee5\u8ba1\u7b97\u8be6\u7ec6\u7684\u5e94\u529b\u5206\u5e03\u3002\n\n\u6b64\u5916\uff0c\u60a8\u8fd8\u53ef\u4ee5\u8f7b\u677e\u63d0\u53d6\u8ba1\u7b97\u5f97\u5230\u7684\u622a\u9762\u6570\u636e\uff0c\u5e76\u5728 COMSOL Multiphysics \u4e2d\u8fdb\u884c\u6881\u5206\u6790\u65f6\u5c06\u5176\u7528\u4f5c\u8f93\u5165\u6570\u636e\u3002");
