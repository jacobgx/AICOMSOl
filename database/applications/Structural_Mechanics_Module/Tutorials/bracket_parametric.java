...
public class bracket_parametric {
  ...
  public static Model run2(Model model) {
    ...
    model.param().descr("tArm", "\u8f7d\u8377\u65b9\u5411\u89d2");

    model.component("comp1").coordSystem().create("sys2", "Cylindrical");
    model.component("comp1").coordSystem("sys2").setIndex("origin", "PinHoleY", 1);
    model.component("comp1").coordSystem("sys2").setIndex("axis", 1, 0);
    model.component("comp1").coordSystem("sys2").setIndex("axis", 0, 2);
    model.component("comp1").coordSystem("sys2").setIndex("radialbasevector", 0, 0);
    model.component("comp1").coordSystem("sys2").setIndex("radialbasevector", "sin(theta0)", 1);
    model.component("comp1").coordSystem("sys2").setIndex("radialbasevector", "cos(theta0)", 2);

    model.component("comp1").func("an1").set("expr", "F*abs(cos(p))");
    model.component("comp1").func("an1").set("args", "F, p");
    ...
    model.component("comp1").physics("solid").feature("bndl1")
         .set("forceReferenceArea", new String[]{"load(p0,sys2.phi)*(sign(X)*(abs(sys2.phi)-pi/2)<0)", "0", "0"});
    ...
    model.result("pg7").feature("tblp1").set("evaluationgroup", "eg1");
    model.result("pg7").feature("tblp1").set("linewidth", "preference");
    model.result("pg7").feature("tblp1").set("markerpos", "datapoints");
    model.result("pg7").run();
    model.result("pg7").run();
    model.result("pg7").label("\u53cd\u4f5c\u7528\u529b\uff0cX \u5206\u91cf");
    model.result("pg7").set("ylabelactive", true);
    model.result("pg7").set("ylabel", "\u53cd\u4f5c\u7528\u529b (N)");
    model.result("pg7").run();
    model.result("pg7").feature("tblp1").set("plotcolumninput", "manual");
    model.result("pg7").feature("tblp1").set("plotcolumns", new int[]{2, 5, 8, 11});
    ...
    model.result("pg8").label("\u53cd\u4f5c\u7528\u529b\uff0cY \u5206\u91cf");
    model.result("pg8").run();
    model.result("pg8").feature("tblp1").set("plotcolumns", new int[]{3, 6, 9, 12});
    model.result("pg8").run();
    model.result("pg8").run();
    model.result().duplicate("pg9", "pg8");
    model.result("pg9").run();
    model.result("pg9").label("\u53cd\u4f5c\u7528\u529b\uff0cZ \u5206\u91cf");
    model.result("pg9").run();
    model.result("pg9").feature("tblp1").set("plotcolumns", new int[]{4, 7, 10, 13});
    model.result("pg9").run();
    model.result().create("pg10", "PlotGroup1D");
    model.result("pg10").run();
    model.result("pg10").label("\u5e94\u529b\u968f\u8f7d\u8377\u89d2\u5ea6\u7684\u53d8\u5316\u51fd\u6570");
    ...
    model.result("pg10").feature("ptgr1").selection().set(86, 88, 103);
    model.result("pg10").feature("ptgr1").set("expr", "solid.mises");
    ...
    model.result("pg10").feature("ptgr1").set("legendpattern", "(eval(X,mm), eval(Y,mm), eval(Z,mm))");
    model.result("pg10").run();
    model.result("pg10").run();
    ...
    model.title("\u652f\u67b6 - \u53c2\u6570\u5316\u5206\u6790");

    model
         .description("\u672c\u4f8b\u9610\u8ff0\u5982\u4f55\u5efa\u7acb\u591a\u4e2a\u7ed3\u6784\u8f7d\u8377\u5de5\u51b5\u5e76\u5bf9\u7ed3\u679c\u8fdb\u884c\u6bd4\u8f83\u3002\u8be5\u6a21\u578b\u5bf9 bracket_static.mph \u8fdb\u884c\u4e86\u6269\u5c55\u3002");
