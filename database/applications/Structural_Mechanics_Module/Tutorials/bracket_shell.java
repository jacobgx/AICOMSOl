...
public class bracket_shell {
  ...
  public static Model run() {
    ...
    model.param().set("elSize", "6[mm]", "\u5355\u5143\u5927\u5c0f");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg5").feature("lngr1").set("descr", "\u7b2c\u4e00\u4e3b\u5e94\u529b");
    model.result("pg5").run();
    ...
    model.result("pg6").label("\u5931\u6548\u6307\u6570 (solid)");
    model.result("pg6").label("\u5931\u6548\u6307\u6570 (\u5b89\u5168\u6027 1)");
    ...
    model.result().evaluationGroup("eg1").feature("int1").setIndex("descr", "\u87ba\u6813 1\uff0cX", 0);
    model.result().evaluationGroup("eg1").feature("int1").setIndex("descr", "\u87ba\u6813 1\uff0cY", 1);
    model.result().evaluationGroup("eg1").feature("int1").setIndex("descr", "\u87ba\u6813 1\uff0cZ", 2);
    model.result().evaluationGroup("eg1").feature().duplicate("int2", "int1");
    model.result().evaluationGroup("eg1").feature("int2").label("\u87ba\u6813 2");
    model.result().evaluationGroup("eg1").feature("int2").selection().named("sel2");
    model.result().evaluationGroup("eg1").feature("int2").setIndex("descr", "\u87ba\u6813 2\uff0cX", 0);
    model.result().evaluationGroup("eg1").feature("int2").setIndex("descr", "\u87ba\u6813 2\uff0cY", 1);
    model.result().evaluationGroup("eg1").feature("int2").setIndex("descr", "\u87ba\u6813 2\uff0cZ", 2);
    model.result().evaluationGroup("eg1").feature().duplicate("int3", "int2");
    model.result().evaluationGroup("eg1").feature("int3").label("\u87ba\u6813 3");
    model.result().evaluationGroup("eg1").feature("int3").selection().named("sel3");
    model.result().evaluationGroup("eg1").feature("int3").setIndex("descr", "\u87ba\u6813 3\uff0cX", 0);
    model.result().evaluationGroup("eg1").feature("int3").setIndex("descr", "\u87ba\u6813 3\uff0cY", 1);
    model.result().evaluationGroup("eg1").feature("int3").setIndex("descr", "\u87ba\u6813 3\uff0cZ", 2);
    model.result().evaluationGroup("eg1").feature().duplicate("int4", "int3");
    model.result().evaluationGroup("eg1").feature("int4").label("\u87ba\u6813 4");
    model.result().evaluationGroup("eg1").feature("int4").selection().named("sel4");
    model.result().evaluationGroup("eg1").feature("int4").setIndex("descr", "\u87ba\u6813 4\uff0cX", 0);
    model.result().evaluationGroup("eg1").feature("int4").setIndex("descr", "\u87ba\u6813 4\uff0cY", 1);
    model.result().evaluationGroup("eg1").feature("int4").setIndex("descr", "\u87ba\u6813 4\uff0cZ", 2);
    ...
    model.component("comp1").selection("sel7").label("\u5b9e\u4f53");
    model.component("comp1").selection("sel7").set(2, 3, 7, 8);

    model.component("comp1").view("view1").set("renderwireframe", true);

    model.component("comp1").selection().create("sel8", "Explicit");
    model.component("comp1").selection("sel8").label("\u58f3");
    model.component("comp1").selection("sel8").geom(2);
    model.component("comp1").selection("sel8").set(1, 32, 37, 50, 86);

    model.component("comp1").view("view1").set("renderwireframe", false);

    model.component("comp1").physics("solid").selection().named("sel7");
    ...
    model.nodeGroup("grp1").label("\u672a\u4f7f\u7528\uff1b\u5e94\u7528\u4e8e\u201c\u58f3\u201d\u63a5\u53e3");
    model.nodeGroup("grp1").active(false);

    model.component("comp1").view("view1").set("renderwireframe", true);

    model.component("comp1").physics("shell").selection().named("sel8");
    model.component("comp1").physics("shell").feature("to1").set("d", "8[mm]");
    ...
    model.component("comp1").physics("shell").feature("el1").set("coordinateSystem", "LocalEdgeSystem");
    model.component("comp1").physics("shell").feature("el1").selection().set(4, 188);
    model.component("comp1").physics("shell").feature("el1").set("forceType", "ForceArea");
    ...
    model.component("comp1").physics("shell").feature("el1")
         .set("forceReferenceArea", new String[]{"0", "load(p0*sign(X),Y-PinHoleY,Z)", "0"});
    ...
    model.component("comp1").multiphysics("sshc1").selection("edgBndSolidSelection")
         .set(9, 11, 13, 14, 30, 34, 58, 62, 80, 81, 83, 84);
    model.component("comp1").multiphysics("sshc1").set("connectionType", "Flexible");

    model.component("comp1").view("view1").set("renderwireframe", false);

    model.component("comp1").material().duplicate("mat2", "mat1");
    model.component("comp1").material("mat2").selection().geom("geom1", 2);
    model.component("comp1").material("mat2").selection().named("sel8");
    ...
    model.result("pg1").run();
    model.result("pg2").run();
    model.result("pg2").label("\u5e94\u529b\uff0c\u5b9e\u4f53+\u58f3");
    ...
    model.result().create("pg3", "PlotGroup3D");
    model.result("pg3").set("data", "dset1");
    model.result("pg3").label("\u58f3\u51e0\u4f55\u7ed3\u6784 (shell)");
    model.result("pg3").set("titletype", "label");
    model.result("pg3").set("showlegends", false);
    model.result("pg3").set("edgecolor", "cyan");
    model.result("pg3").create("surf1", "Surface");
    model.result("pg3").feature("surf1").set("expr", new String[]{"if(abs(shell.z)==1,shell.z, NaN)"});
    ...
    model.result("pg3").feature("surf1").label("\u9876\u90e8\u548c\u5e95\u90e8");
    model.result("pg3").label("\u58f3\u51e0\u4f55\u7ed3\u6784 (shell)");
    model.result("pg3").run();
    model.result().create("pg4", "PlotGroup3D");
    model.result("pg4").set("data", "dset1");
    model.result("pg4").label("\u539a\u5ea6\u548c\u65b9\u5411 (shell)");
    model.result("pg4").set("titletype", "label");
    model.result("pg4").set("showlegendsunit", true);
    model.result("pg4").create("surf1", "Surface");
    model.result("pg4").feature("surf1").set("expr", new String[]{"shell.d"});
    ...
    model.result("pg4").feature("surf1").label("\u539a\u5ea6");
    model.result("pg4").create("syss", "CoordSysSurface");
    model.result("pg4").feature("syss").set("sys", "shellsys");
    model.result("pg4").feature("syss").label("\u58f3\u5c40\u90e8\u5750\u6807\u7cfb");
    model.result("pg4").label("\u539a\u5ea6\u548c\u65b9\u5411 (shell)");
    model.result("pg4").run();
    model.result().create("pg5", "PlotGroup3D");
    model.result("pg5").label("\u8fde\u63a5\u533a\u57df\u6307\u793a\u5668 (sshc1)");
    model.result("pg5").set("titletype", "manual");
    model.result("pg5").set("title", "Connected region indicator");
    model.result("pg5").feature().create("surf1", "Surface");
    model.result("pg5").feature("surf1").set("expr", "sshc1.i_conn");
    ...
    model.result("pg5").feature("surf1").set("colorcalibration", -1.5);
    model.result("pg5").feature("surf1").set("colortabletype", "discrete");
    model.result("pg5").feature("surf1").set("bandcount", 2);
    model.result("pg5").feature("surf1").set("topcolor", "red");
    model.result("pg5").feature("surf1").set("bottomcolor", "gray");
    ...
    model.result("pg6").run();
    model.result("pg6").label("\u4e3b\u5e94\u53d8");
    model.result("pg6").run();
    model.result("pg6").feature("surf1").set("expr", "shell.ep1");
    model.result("pg6").feature("surf1").set("rangecolormax", 2.0E-4);
    model.result("pg6").feature("surf1").set("colortabletype", "discrete");
    model.result("pg6").run();
    model.result("pg6").feature("vol1").set("expr", "solid.ep1");
    model.result("pg6").run();
    model.result().dataset().create("cln1", "CutLine3D");
    model.result().dataset("cln1").setIndex("genpoints", "-0.215/2", 0, 0);
    model.result().dataset("cln1").setIndex("genpoints", "-0.215/2", 1, 0);
    model.result().dataset("cln1").setIndex("genpoints", -0.2, 0, 1);
    model.result().dataset("cln1").setIndex("genpoints", -0.2, 1, 1);
    ...
    model.result("pg7").feature("lngr1").set("expr", "shell.Nl11");
    model.result("pg7").feature("lngr1").set("descr", "\u5c40\u90e8\u9762\u5185\u529b\uff0c11 \u5206\u91cf");
    model.result("pg7").feature("lngr1").set("unit", "kN/m");
    model.result("pg7").feature("lngr1").set("legend", true);
    model.result("pg7").feature("lngr1").set("legendmethod", "manual");
    model.result("pg7").feature("lngr1").setIndex("legends", "Axial force, Nl11", 0);
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("lngr2", "lngr1");
    model.result("pg7").run();
    model.result("pg7").feature("lngr2").set("expr", "shell.Nl12");
    model.result("pg7").feature("lngr2").setIndex("legends", "Shear force, Nl12", 0);
    model.result("pg7").run();
    model.result("pg7").run();
    ...
    model
         .description("\u672c\u4f8b\u4f7f\u7528\u201c\u58f3\u201d\u63a5\u53e3\u8ba1\u7b97\u53d7\u5916\u8f7d\u8377\u4f5c\u7528\u7684\u652f\u67b6\u5185\u7684\u5e94\u529b\u3002");
