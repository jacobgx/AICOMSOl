...
public class bracket_rigid_connector {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("solid").feature("rig1").set("xc", new String[]{"0", "-0.40", "-0.10"});
    ...
    model.component("comp1").physics("solid").feature("rig1").set("Omega", new int[]{0, 1, 0});
    model.component("comp1").physics("solid").feature("rig1").set("phi0", "0.05[deg]");
    ...
    model.title("\u652f\u67b6 - \u521a\u6027\u8fde\u63a5\u4ef6\u5206\u6790");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u4e3a\u8fde\u63a5\u5230\u5f39\u6027\u96f6\u4ef6\u7684\u521a\u6027\u7ed3\u6784\u8fdb\u884c\u5efa\u6a21\u3002");
