...
public class bracket_frequency {
  ...
  public static Model run() {
    ...
    model.component("comp1").material("mat1").propertyGroup("def").set("lossfactor", new String[]{"0.05"});
    ...
    model.component("comp1").physics("solid").feature("bndl1").set("force", new String[]{"25[N]", "0", "0"});
    ...
    model.study("std1").feature("frmod").set("outputmap", new String[]{});
    ...
    model.study("std1").feature("frmod").set("plist", "range(50,10,90) range(91,1,149) range(150,10,750)");
    ...
    model.result("pg2").label("\u4f4d\u79fb\u5747\u65b9\u6839");
    model.result("pg2").set("xlabelactive", true);
    model.result("pg2").set("xlabel", "\u9891\u7387 (Hz)");
    ...
    model.result("pg2").feature("ptgr1").set("markers", 20);
    model.result("pg2").feature("ptgr1").set("legend", true);
    model.result("pg2").feature("ptgr1").set("legendmethod", "manual");
    model.result("pg2").feature("ptgr1").setIndex("legends", "\u5de6\u81c2\uff0c\u65e0\u8f7d\u8377", 0);
    model.result("pg2").run();
    ...
    model.result("pg2").feature("ptgr2").setIndex("legends", "\u53f3\u81c2\uff0c\u65e0\u8f7d\u8377", 0);
    model.result("pg2").run();
    model.result("pg2").run();
    ...
    model.result("pg2").feature("ptgr1").feature("gmrk1").set("anchorpoint", "middleleft");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg3").label("\u901f\u5ea6\uff0cX \u5206\u91cf\u5747\u65b9\u6839 1/3 \u500d\u9891\u7a0b");
    model.result("pg3").set("titletype", "manual");
    model.result("pg3")
         .set("title", "1/3 \u500d\u9891\u5e26\uff1a\u5747\u65b9\u6839\u901f\u5ea6\uff08\u53c2\u8003\u503c 1[m/s]\uff09");
    ...
    model.component("comp1").physics("solid").feature("bndl2").set("coordinateSystem", "sys1");
    model.component("comp1").physics("solid").feature("bndl2")
         .set("forceReferenceArea", new String[]{"0", "0", "load(-p0,Z,Y-PinHoleY)*(X*(Y-PinHoleY)<0)"});

    model.component("comp1").coordSystem("sys1").set("frametype", "material");

    model.study("std2").feature("frlin").set("plist", "range(50,10,90) range(91,1,149) range(150,10,200)");
    ...
    model.result("pg2").feature("ptgr3").set("linecolor", "cyclereset");
    model.result("pg2").feature("ptgr3").set("linestyle", "dashed");
    model.result("pg2").feature("ptgr3").set("linemarker", "none");
    model.result("pg2").feature("ptgr3").setIndex("legends", "\u5de6\u81c2\uff0c\u9884\u5e94\u529b", 0);
    model.result("pg2").run();
    ...
    model.result("pg2").feature("ptgr3").feature("gmrk1").set("color", "blue");
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").feature("ptgr4").set("data", "dset3");
    model.result("pg2").feature("ptgr4").set("linestyle", "dashed");
    model.result("pg2").feature("ptgr4").setIndex("legends", "\u53f3\u81c2\uff0c\u9884\u5e94\u529b", 0);
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").set("axislimits", true);
    model.result("pg2").set("xmin", 49);
    model.result("pg2").set("xmax", 220);
    model.result("pg2").set("ymin", 0.02);
    model.result("pg2").set("ymax", 1.1);
    ...
    model.result("pg4").feature("vol1").set("colortable", "Rainbow");
    model.result("pg4").run();
    model.result("pg4").label("\u5e94\u529b\uff08\u5b9e\u4f53\uff09\uff0c\u9884\u5e94\u529b");
    ...
    model.result("pg5").label("\u4f4d\u79fb\u76f8\u4f4d\uff0cX \u5206\u91cf");
    ...
    model.result("pg6").feature("ptgr1").set("xdata", "phase");
    ...
    model.result("pg6").feature("ptgr1").setIndex("legends", "Left arm, 105 Hz", 0);
    model.result("pg6").feature().duplicate("ptgr2", "ptgr1");
    model.result("pg6").run();
    model.result("pg6").feature("ptgr2").selection().set(109);
    model.result("pg6").feature("ptgr2").setIndex("legends", "Right arm, 105 Hz", 0);
    model.result("pg6").run();
    model.result("pg6").run();
    model.result("pg6").feature().duplicate("ptgr3", "ptgr1");
    model.result("pg6").feature().duplicate("ptgr4", "ptgr2");
    model.result("pg6").run();
    model.result("pg6").feature("ptgr3").set("data", "dset3");
    model.result("pg6").feature("ptgr3").setIndex("looplevelinput", "manual", 0);
    model.result("pg6").feature("ptgr3").setIndex("looplevel", new int[]{43}, 0);
    model.result("pg6").feature("ptgr3").set("linestyle", "dashed");
    model.result("pg6").feature("ptgr3").set("linecolor", "cyclereset");
    model.result("pg6").feature("ptgr3").setIndex("legends", "Left arm, 128 Hz", 0);
    model.result("pg6").run();
    model.result("pg6").run();
    model.result("pg6").feature("ptgr4").set("data", "dset3");
    model.result("pg6").feature("ptgr4").setIndex("looplevelinput", "manual", 0);
    model.result("pg6").feature("ptgr4").setIndex("looplevel", new int[]{43}, 0);
    model.result("pg6").feature("ptgr4").set("linestyle", "dashed");
    model.result("pg6").feature("ptgr4").setIndex("legends", "Right arm, 128 Hz", 0);
    model.result("pg6").run();
    model.result().create("pg7", "PlotGroup1D");
    model.result("pg7").run();
    model.result("pg7").setIndex("looplevelinput", "manual", 0);
    model.result("pg7").setIndex("looplevel", new int[]{29}, 0);
    ...
    model.result("pg7").feature("ptgr1").selection().set(34);
    model.result("pg7").feature("ptgr1").set("expr", "solid.mises");
    model.result("pg7").feature("ptgr1").set("xdata", "phase");
    model.result("pg7").feature("ptgr1").set("xdataphaserange", "(pi/20)*range(0,1,40)");
    model.result("pg7").feature("ptgr1").set("legend", true);
    model.result("pg7").feature("ptgr1").set("legendmethod", "manual");
    model.result("pg7").feature("ptgr1").setIndex("legends", "Without prestress", 0);
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("ptgr2", "ptgr1");
    model.result("pg7").run();
    model.result("pg7").feature("ptgr2").set("data", "dset3");
    model.result("pg7").feature("ptgr2").setIndex("looplevelinput", "manual", 0);
    model.result("pg7").feature("ptgr2").setIndex("looplevel", new int[]{22}, 0);
    model.result("pg7").feature("ptgr2").setIndex("legends", "With prestress", 0);
    model.result("pg7").feature("ptgr2").set("evalmethod", "lintotal");
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("ptgr3", "ptgr2");
    model.result("pg7").run();
    model.result("pg7").feature("ptgr3").set("evalmethod", "linpoint");
    model.result("pg7").feature("ptgr3").setIndex("legends", "Static solution", 0);
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("ptgr4", "ptgr3");
    model.result("pg7").run();
    model.result("pg7").feature("ptgr4").set("evalmethod", "harmonic");
    model.result("pg7").feature("ptgr4").set("differential", true);
    model.result("pg7").feature("ptgr4").setIndex("legends", "Perturbation from prestress", 0);
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("ptgr5", "ptgr4");
    model.result("pg7").run();
    model.result("pg7").feature("ptgr5").set("expr", "solid.mises_peak");
    model.result("pg7").feature("ptgr5").setIndex("legends", "Peak value for perturbation", 0);
    model.result("pg7").feature("ptgr5").set("differential", false);
    model.result("pg7").feature("ptgr5").set("linestyle", "dashed");
    model.result("pg7").run();
    model.result("pg7").run();
    model.result("pg7").feature("ptgr3").set("linestyle", "dashed");
    model.result("pg7").run();
    ...
    model.title("\u652f\u67b6 - \u9891\u7387\u54cd\u5e94\u5206\u6790");

    model
         .description("\u672c\u4f8b\u8ba1\u7b97\u53d7\u7b80\u8c10\u8377\u8f7d\u4f5c\u7528\u7684\u4e09\u7ef4\u652f\u67b6\u7684\u9891\u57df\u4e2d\u7684\u54cd\u5e94\uff0c\u5176\u4e2d\u7b2c\u4e8c\u4e2a\u7814\u7a76\u6267\u884c\u9884\u5e94\u529b\u9891\u57df\u5206\u6790\uff0c\u5305\u542b\u9759\u8f7d\u8377\u548c\u8c10\u6ce2\u6270\u52a8\u3002");
