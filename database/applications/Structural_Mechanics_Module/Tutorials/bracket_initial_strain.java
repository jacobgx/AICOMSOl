...
public class bracket_initial_strain {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("solid").feature("lemm1").feature("iss1").selection().set(2);
    model.component("comp1").physics("solid").feature("lemm1").feature("iss1")
         .set("eil", new String[]{"InitStrain", "0", "0", "0", "0", "0", "0", "0", "0"});

    model.component("comp1").mesh("mesh1").feature("ftet1").feature("size1").selection().geom("geom1", 3);
    model.component("comp1").mesh("mesh1").feature("ftet1").feature("size1").selection().set(5, 6, 10, 11);
    model.component("comp1").mesh("mesh1").run();
    ...
    model.result("pg2").label("\u7b2c\u4e09\u4e3b\u5e94\u53d8");
    model.result("pg2").create("surf1", "Surface");
    model.result("pg2").feature("surf1").set("expr", "solid.ep3");
    model.result("pg2").feature("surf1").set("descr", "\u7b2c\u4e09\u4e3b\u5e94\u53d8");
    model.result("pg2").run();
    ...
    model.component("comp1").view("view1").clip("plane1").set("position", new double[]{0, -0.17499999701976773, 0});
    model.component("comp1").view("view1").clip("plane1").set("translationamount", 0.010700000137090684);
    model.component("comp1").view("view1").set("clipshowgizmos", false);

    model.title("\u652f\u67b6 - \u521d\u59cb\u5e94\u53d8\u5206\u6790");

    model
         .description("\u672c\u4f8b\u8ba1\u7b97\u4e00\u4e2a\u8fde\u63a5\u5230\u9884\u5e94\u53d8\u9500\u7684\u7ed3\u6784\u652f\u67b6\u4e2d\u7684\u5e94\u529b\u5206\u5e03\u3002");
