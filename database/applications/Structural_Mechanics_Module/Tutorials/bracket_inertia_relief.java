...
public class bracket_inertia_relief {
  ...
  public static Model run() {
    ...
    model.param().set("Fh", "65[N]");
    model.param().descr("dHole", "\u6bcf\u4e2a\u5b54\u7684\u529b");
    ...
    model.component("comp1").physics("solid").create("ire1", "InertiaRelief", 3);
    model.component("comp1").physics("solid").feature("ire1").runCommand("createLoadGroupsandStudy");

    model.component("comp1").massProp().create("mass1", "MassProperties");

    model.study("InertiaRelief_std").createAutoSequences("all");
    ...
    model.result("pg2").label("\u60ef\u6027\u91ca\u653e\u52a0\u901f\u5ea6 (solid)");
    model.result("pg2").run();
    model.result("pg2").feature("vol1").set("expr", "solid.air");
    model.result("pg2").feature("vol1").set("descr", "\u60ef\u6027\u91ca\u653e\u52a0\u901f\u5ea6\u5927\u5c0f");
    model.result("pg2").feature("vol1").set("colortable", "RainbowLight");
    model.result("pg2").run();
    model.result("pg2").create("arws1", "ArrowSurface");
    model.result("pg2").feature("arws1").set("expr", new String[]{"solid.airX", "solid.airY", "solid.airZ"});
    model.result("pg2").feature("arws1").set("descr", "\u60ef\u6027\u91ca\u653e\u52a0\u901f\u5ea6");
    ...
    model.result("pg2").feature("pttraj1").set("expr", new String[]{"mass1.CMX", "mass1.CMY", "mass1.CMZ"});
    ...
    model.title("\u652f\u67b6 - \u60ef\u6027\u91ca\u653e\u5206\u6790");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u60ef\u6027\u91ca\u653e\u5206\u6790\u6765\u8ba1\u7b97\u65e0\u7ea6\u675f\u652f\u67b6\u5728\u9759\u8f7d\u8377\u4e0b\u7684\u7ed3\u6784\u5e94\u529b\u3002");
