...
public class bracket_linear_buckling {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("solid").feature("bndl1").selection().named("sel5");
    model.component("comp1").physics("solid").feature("bndl1").set("coordinateSystem", "sys1");
    model.component("comp1").physics("solid").feature("bndl1")
         .set("forceReferenceArea", new String[]{"0", "0", "load(-p0,Z,Y-PinHoleY)*(Y>PinHoleY)"});
    ...
    model.study("std2").feature("stat")
         .setIndex("plistarr", "1 1e3 5e3 1e4 2e4 5.924e4*log10(({range(2,1,10)}+1)/1.1)^(1/5)", 0);
    ...
    model.sol("sol3").feature("s1").feature("p1").feature("st1")
         .setIndex("stopconddesc", "\u505c\u6b62\u8868\u8fbe\u5f0f 1", 0);
    model.sol("sol3").feature("s1").feature("p1").feature("st1")
         .setIndex("stopcondarr", "comp1.intop1(comp1.v)/(Fh*1.12E-8)/1.2", 0);
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg3").set("xlabel", "\u4f5c\u7528\u529b [N]");
    model.result("pg3").set("ylabelactive", true);
    model.result("pg3").set("ylabel", "y \u4f4d\u79fb [mm]");
    ...
    model.result("pg3").feature("ptgr2").set("expr", "Fh*1.12E-8[m/N]");
    ...
    model.component("comp1").physics("solid").feature("lemm1").feature("sf1").set("sigmat", "350[MPa]");
    ...
    model.result("pg4").label("\u5931\u6548\u6307\u6570 (solid)");
    model.result("pg4").label("\u5931\u6548\u6307\u6570 (\u5b89\u5168\u6027 1)");
    model.result("pg4").set("showlegends", true);
    model.result("pg4").create("surf1", "Surface");
    model.result("pg4").feature("surf1").set("expr", new String[]{"solid.lemm1.sf1.f_i"});
    ...
    model.result("pg4").feature("surf1").set("descr", "von Mises \u635f\u4f24\u6307\u6570");
    model.result("pg4").run();
    model.result("pg4").run();
    model.result("pg4").label("\u635f\u4f24\u56e0\u5b50");
    model.result("pg1").run();

    model.title("\u652f\u67b6 - \u7ebf\u6027\u5c48\u66f2\u5206\u6790");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u8ba1\u7b97\u4e09\u7ef4\u652f\u67b6\u7684\u4e34\u754c\u5c48\u66f2\u529b\u3002");
