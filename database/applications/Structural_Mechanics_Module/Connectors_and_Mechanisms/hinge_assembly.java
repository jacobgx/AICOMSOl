...
public class hinge_assembly {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model
         .modelPath("D:\\Program Files\\COMSOL\\COMSOL63\\Multiphysics\\applications\\Structural_Mechanics_Module\\Connectors_and_Mechanisms");
    ...
    model.param().descr("F", "\u5916\u52a0\u8f7d\u8377");

    model.component("comp1").geom("geom1").create("imp1", "Import");
    model.component("comp1").geom("geom1").feature("imp1").set("filename", "hinge_assembly.mphbin");
    ...
    model.component("comp1").physics("solid").feature("fix1").selection().set(133, 134, 135, 136);
    model.component("comp1").physics("solid").create("rig1", "RigidConnector", 2);
    model.component("comp1").physics("solid").feature("rig1").selection().set(67, 68);
    ...
    model.component("comp1").physics("solid").feature("rig1").feature("rf1").set("Include_offset", true);
    model.component("comp1").physics("solid").feature("rig1").feature("rf1").set("x_off", new double[]{0, -0.1, 0});
    model.component("comp1").physics("solid").feature("rig1").feature("rf1").set("Ft", new String[]{"0", "0", "F"});
    model.component("comp1").physics("solid").create("rig2", "RigidConnector", 2);
    model.component("comp1").physics("solid").feature("rig2").selection().set(75, 76);
    model.component("comp1").physics("solid").create("rig3", "RigidConnector", 2);
    model.component("comp1").physics("solid").feature("rig3").selection().set(16, 17, 18, 19);
    model.component("comp1").physics("solid").feature("rig3").setIndex("Direction", true, 0);
    model.component("comp1").physics("solid").feature("rig3").setIndex("U0", "solid.rig2.u", 0);
    model.component("comp1").physics("solid").feature("rig3").setIndex("Direction", true, 1);
    model.component("comp1").physics("solid").feature("rig3").setIndex("U0", "solid.rig2.v", 1);
    model.component("comp1").physics("solid").feature("rig3").setIndex("Direction", true, 2);
    model.component("comp1").physics("solid").feature("rig3").setIndex("U0", "solid.rig2.w", 2);
    model.component("comp1").physics("solid").create("gconstr1", "GlobalConstraint", -1);
    model.component("comp1").physics("solid").feature("gconstr1")
         .set("constraintExpression", "comp1.solid.rig2.b-comp1.solid.rig3.b");
    model.component("comp1").physics("solid").create("gconstr2", "GlobalConstraint", -1);
    model.component("comp1").physics("solid").feature("gconstr2")
         .set("constraintExpression", "comp1.solid.rig2.d-comp1.solid.rig3.d");

    model.component("comp1").mesh("mesh1").create("ftet1", "FreeTet");
    model.component("comp1").mesh("mesh1").feature("ftet1").create("size1", "Size");
    model.component("comp1").mesh("mesh1").feature("ftet1").feature("size1").selection().geom("geom1", 2);
    model.component("comp1").mesh("mesh1").feature("ftet1").feature("size1").selection().set(41, 42, 53);
    ...
    model.result("pg2").feature("vol1").set("descr", "\u4f4d\u79fb\u573a\uff0cX \u5206\u91cf");
    model.result("pg2").run();
    model.result("pg2").run();
    model.result("pg2").label("x \u4f4d\u79fb");

    model.title("\u4f7f\u7528\u94f0\u94fe\u7684\u88c5\u914d");

    model
         .description("\u4e24\u4e2a\u673a\u68b0\u90e8\u4ef6\u4e4b\u95f4\u7684\u94f0\u94fe\u901a\u8fc7\u8026\u5408\u4e24\u4e2a\u521a\u6027\u8fde\u63a5\u4ef6\u8fdb\u884c\u5efa\u6a21\u3002\u6b64\u65b9\u6cd5\u53ef\u7528\u4e8e\u6a21\u62df\u591a\u79cd\u7c7b\u578b\u7684\u673a\u68b0\u3002");
