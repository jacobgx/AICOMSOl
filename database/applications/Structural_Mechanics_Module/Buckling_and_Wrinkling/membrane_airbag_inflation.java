/*
 * membrane_airbag_inflation.java
 */
...
public class membrane_airbag_inflation {
...
//    model.param().loadFile("FILENAME");
    ...
    model.param().set("th", "0.06[cm]", "\u539a\u5ea6");
    model.param()
         .set("Ld", "1.2[m]", "\u672a\u5145\u6c14\u5b89\u5168\u6c14\u56ca\u7684\u5bf9\u89d2\u7ebf\u957f\u5ea6");
    model.param().set("L", "Ld/sqrt(2)", "\u957f\u5ea6\u53c2\u6570");
    model.param().set("Ey", "588[MPa]", "\u6768\u6c0f\u6a21\u91cf");
    ...
    model.component("comp1").variable("var1").set("wmax_ref", "21.75[cm]");
    model.component("comp1").variable("var1")
         .descr("wmax_ref", "\u4e2d\u70b9\u7684\u6a2a\u5411\u4f4d\u79fb\uff0c\u53c2\u8003");
    model.component("comp1").variable("var1").set("vmax_ref", "12.03[cm]");
    model.component("comp1").variable("var1")
         .descr("vmax_ref", "\u4fa7\u8fb9\u4e2d\u70b9\u7684\u6a2a\u5411\u4f4d\u79fb\uff0c\u53c2\u8003");
    model.component("comp1").variable("var1").set("dispmax_ref", "4.94[cm]");
    model.component("comp1").variable("var1")
         .descr("dispmax_ref", "\u89d2\u70b9\u7684\u603b\u4f4d\u79fb\uff0c\u53c2\u8003");
    model.component("comp1").variable("var1").set("sp1max_ref", "0.39[kN/cm^2]");
    model.component("comp1").variable("var1")
         .descr("sp1max_ref", "\u4e2d\u70b9\u7684\u7b2c\u4e00\u4e3b\u5e94\u529b\uff0c\u53c2\u8003");
    ...
    model.component("comp1").material("mat1").propertyGroup("Enu").set("E", new String[]{"Ey"});
    ...
    model.result().configuration("prfu1").setIndex("quantityunits", "cm", 0, 3);
    ...
    model.result("pg5").feature("ptgr3").setIndex("legends", "\u89d2\u70b9\u7684\u603b\u4f4d\u79fb", 0);
    model.result("pg5").run();
    ...
    model.result("pg6").feature("glob1").setIndex("legends", "\u6700\u540e\u4e00\u6b65\u7684\u53c2\u8003\u503c", 0);
    model.result("pg6").run();
    model.result("pg6").run();
    model.result("pg1").run();
    model.result("pg4").run();

    model.title("\u65b9\u5f62\u5b89\u5168\u6c14\u56ca\u7684\u81a8\u80c0");

    model
         .description("\u672c\u4f8b\u7814\u7a76\u4e00\u4e2a\u4f7f\u7528\u6052\u5b9a\u6c14\u538b\u5145\u6c14\u7684\u65b9\u5f62\u5b89\u5168\u6c14\u56ca\u3002\u5728\u5145\u6c14\u81a8\u80c0\u8fc7\u7a0b\u4e2d\uff0c\u6c14\u56ca\u7684\u67d0\u4e9b\u533a\u57df\u4f1a\u968f\u7740\u8d1f\u4e3b\u5e94\u529b\u7684\u4ea7\u751f\u800c\u51fa\u73b0\u8936\u76b1\u3002\u5f20\u529b\u573a\u7406\u8bba\u4e2d\u7684\u8936\u76b1\u819c\u6a21\u578b\u53ef\u4ee5\u6b63\u786e\u5730\u63cf\u8ff0\u5145\u6c14\u819c\u7684\u5e94\u529b\u5206\u5e03\u548c\u8936\u76b1\u6a21\u5f0f\u3002");
