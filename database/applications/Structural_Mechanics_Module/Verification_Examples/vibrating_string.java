...
public class vibrating_string {
  ...
  public static Model run() {
    ...
    model.param().descr("L", "\u632f\u5f26\u957f\u5ea6");
    model.param().set("D", "1[mm]");
    model.param().descr("D", "\u632f\u5f26\u76f4\u5f84");
    model.param().set("A", "pi/4*D^2");
    model.param().descr("A", "\u632f\u5f26\u6a2a\u622a\u9762\u79ef");
    ...
    model.component("comp1").material("mat1").propertyGroup("ElasticWire").set("k_A", new String[]{"A*E"});
    model.component("comp1").material("mat1").propertyGroup("ElasticWire").set("rho_L", new String[]{"rho*A"});

    model.component("comp1").physics("wire").feature("elw1").set("area", "A");
    model.component("comp1").physics("wire").create("pin1", "Pinned", 0);
    model.component("comp1").physics("wire").feature("pin1").selection().all();
    model.component("comp1").physics("wire").feature("elw1").create("iss1", "InitialStressandStrain", 1);
    model.component("comp1").physics("wire").feature("elw1").feature("iss1").set("Nxi", "S0*A");
    ...
    model.result("pg1").feature("line1").set("expr", new String[]{"wire.disp"});
    ...
    model.result("pg1").label("\u632f\u578b (wire)");
    ...
    model.component("comp1").physics("wire").create("pin2", "Pinned", 0);
    model.component("comp1").physics("wire").feature("pin2").selection().set(1);
    model.component("comp1").physics("wire").create("disp1", "Displacement0", 0);
    model.component("comp1").physics("wire").feature("disp1").selection().set(2);
    ...
    model.component("comp1").physics("wire").feature("pl1").selection().set(2);
    model.component("comp1").physics("wire").feature("pl1").set("forcePoint", new String[]{"S0*A", "0", "0"});
    model.component("comp1").physics("wire").create("spf1", "SpringFoundation1", 1);
    model.component("comp1").physics("wire").feature("spf1").selection().set(1);
    model.component("comp1").physics("wire").feature("spf1")
         .set("kPerLine", new String[]{"0", "0", "0", "0", "k", "0", "0", "0", "0"});
    ...
    model.study("std2").feature("stat").set("disabledphysics", new String[]{"wire/elw1/iss1", "wire/pin1"});
    model.study("std2").feature("eig").set("useadvanceddisable", true);
    model.study("std2").feature("eig")
         .set("disabledphysics", new String[]{"wire/elw1/iss1", "wire/pin1", "wire/spf1"});
    ...
    model.result("pg2").label("\u632f\u578b (wire) 1");
    ...
    model.study("std1").feature("eig")
         .set("disabledphysics", new String[]{"wire/pin2", "wire/disp1", "wire/pl1", "wire/spf1"});
    ...
    model
         .description("\u672c\u4f8b\u7814\u7a76\u8868\u73b0\u51fa\u5e94\u529b\u521a\u5316\u7684\u9884\u5f20\u5f26\u7684\u56fa\u6709\u9891\u7387\u3002\u6a21\u578b\u7ed3\u679c\u4e0e\u89e3\u6790\u89e3\u8fdb\u884c\u4e86\u6bd4\u8f83\u3002\u672c\u4f8b\u63a2\u7d22\u4e86\u91c7\u7528\u4e24\u79cd\u4e0d\u540c\u7684\u6280\u672f\u6765\u4ea7\u751f\u9884\u5e94\u529b\u3002");
