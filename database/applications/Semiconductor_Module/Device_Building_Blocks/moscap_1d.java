...
public class moscap_1d {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").feature("i1").setIndex("coord", 1000, 2);
...
//    model.param().loadFile("FILENAME");
    ...
    model.param().set("V0", "-2[V]", "\u521d\u59cb\u7535\u538b");
    model.param().set("dVdt", "1[V/s]", "\u7535\u538b\u659c\u7387");
    model.param().set("V1", "3[V]", "\u6700\u7ec8\u7535\u538b");
    model.param().set("t", "0[s]", "\u65f6\u95f4\u53c2\u6570");
    model.param().set("tmax", "V1/dVdt", "\u6700\u7ec8\u65f6\u95f4");
    model.param().set("dt", "tmax/50", "\u65f6\u6b65");
    ...
    model.component("comp1").physics("semi").feature("gc1").set("V0", "V0+dVdt*t");
    ...
    model.component("comp1").physics("semi").create("ge1", "GlobalEquations", -1);
    model.component("comp1").physics("semi").feature("ge1").setIndex("name", "Q1", 0, 0);
    model.component("comp1").physics("semi").feature("ge1").setIndex("equation", "Q1t-semi.I0_1", 0, 0);
    model.component("comp1").physics("semi").feature("ge1").set("CustomDependentVariableUnit", "1");
    model.component("comp1").physics("semi").feature("ge1").set("DependentVariableQuantity", "none");
    model.component("comp1").physics("semi").feature("ge1").setIndex("CustomDependentVariableUnit", "C", 0, 0);
    model.component("comp1").physics("semi").feature("ge1").set("CustomSourceTermUnit", "1");
    model.component("comp1").physics("semi").feature("ge1").set("SourceTermQuantity", "none");
    model.component("comp1").physics("semi").feature("ge1").setIndex("CustomSourceTermUnit", "A", 0, 0);
    ...
    model.component("comp1").mesh("mesh1").feature("edg1").feature("dis2").set("elemratio", 5000);
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg4").feature("glob2")
         .setIndex("expr", "-(Q1-withsol('sol3',Q1,setval(dVdt,dVdt),setval(t,t-dt)))/dt/dVdt/C0", 0);
    ...
    model.result("pg4").feature("glob2").set("xdatadescr", "\u7ec8\u7aef\u7535\u538b");
    model.result("pg4").feature("glob2").set("linestyle", "dotted");
    model.result("pg4").feature("glob2").set("linewidth", 2);
    model.result("pg4").run();

    model.title("MOSCAP \u4e00\u7ef4\u6a21\u578b");

    model
         .description("\u91d1\u5c5e-\u7845-\u6c27\u5316\u7269 (MOS) \u7ed3\u6784\u662f\u8bb8\u591a\u7845\u5e73\u9762\u5668\u4ef6\u7684\u57fa\u672c\u6784\u5efa\u5757\uff0c\u5176\u7535\u5bb9\u6d4b\u91cf\u53ef\u4ee5\u5e2e\u52a9\u7528\u6237\u6df1\u5165\u4e86\u89e3\u6b64\u7c7b\u5668\u4ef6\u7684\u5de5\u4f5c\u539f\u7406\u3002\u672c\u6559\u7a0b\u6784\u5efa\u4e00\u4e2a\u7b80\u5355\u7684 MOS \u7535\u5bb9\u5668 (MOSCAP) \u4e00\u7ef4\u6a21\u578b\uff0c\u5e76\u4f7f\u7528\u77ac\u6001\u7814\u7a76\u65b9\u6cd5\uff08\u76f8\u5173\u6a21\u578b moscap_1d_small_signal \u663e\u793a\u5c0f\u4fe1\u53f7\u65b9\u6cd5\uff09\u8ba1\u7b97\u4f4e\u9891\u548c\u9ad8\u9891 C-V \u66f2\u7ebf\u3002\u5176\u4e2d\u5206\u522b\u4f7f\u7528\u6805\u6781\u7ec8\u7aef\u548c\u91d1\u5c5e\u63a5\u89e6\u7ec8\u7aef\uff0c\u6f14\u793a\u4e24\u79cd\u8ba1\u7b97\u5dee\u52a8\u7535\u5bb9\u7684\u65b9\u6cd5\u3002");
