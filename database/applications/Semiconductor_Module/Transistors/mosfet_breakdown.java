...
public class mosfet_breakdown {
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").func("rm1").set("smoothzoneloc", "0.0001");
    model.component("comp1").func("rm1").set("smoothzonecutoff", "0.0001");

    model.component("comp1").variable().create("var1");
    model.component("comp1").variable("var1").set("Vds", "Vbreak*(rm1(t[1/s]))");

    model.component("comp1").physics("semi").create("mc4", "MetalContact", 1);
    model.component("comp1").physics("semi").feature("mc4").selection().set(7);
    ...
    model.study("std3").feature("stat").set("disabledphysics", new String[]{"semi/mc2", "semi/iig1"});
    model.study("std3").create("time", "Transient");
    model.study("std3").feature("time")
         .set("tlist", "range(0,0.2/15,0.18)*1e-3 range(0.2,0.6/5,0.8)*1e-3 range(0.85,0.15/5,1)*1e-3");
    model.study("std3").feature("time").set("useadvanceddisable", true);
    model.study("std3").feature("time").set("disabledphysics", new String[]{"semi/mc4"});
    ...
    model.result("pg8").set("xlabel", "\u6f0f\u6781\u7535\u538b\uff0cVds (V)");
    model.result("pg8").set("ylabelactive", true);
    model.result("pg8").set("ylabel", "\u7ec8\u7aef\u7535\u6d41 (uA)");
    model.result("pg8").set("titletype", "none");
    model.result("pg8").set("legendpos", "upperleft");
    model.result("pg8").label("\u78b0\u649e\u7535\u79bb\u4e0b Id \u4e0e Vd \u7684\u5173\u7cfb");
    model.result("pg8").create("glob1", "Global");
    model.result("pg8").feature("glob1").set("markerpos", "datapoints");
    model.result("pg8").feature("glob1").set("linewidth", "preference");
    model.result("pg8").feature("glob1").set("expr", new String[]{"semi.I0_2"});
    model.result("pg8").feature("glob1").set("descr", new String[]{"\u7ec8\u7aef\u7535\u6d41"});
    ...
    model.result("pg9").run();
    model.result("pg9").label("\u78b0\u649e\u7535\u79bb\u5bf9\u6570\u523b\u5ea6");
    model.result("pg9").run();
    ...
    model.title("MOSFET \u51fb\u7a7f");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u4f7f\u7528\u77ac\u6001\u6c42\u89e3\u5668\u6765\u6a21\u62df\u7531\u78b0\u649e\u7535\u79bb\u5f15\u8d77\u7684 MOSFET \u51fb\u7a7f\u3002MOSFET \u5728\u7ed9\u5b9a\u7684\u6805\u6781\u7535\u538b\u4e0b\uff0c\u6839\u636e\u6f0f\u6e90\u7535\u538b\u7684\u4e0d\u540c\uff0c\u901a\u5e38\u5728\u4e09\u4e2a\u533a\u57df\u4e2d\u5de5\u4f5c\u3002\u6700\u521d\uff0c\u7535\u6d41-\u7535\u538b\u5448\u7ebf\u6027\u5173\u7cfb\uff0c\u5c5e\u4e8e\u6b27\u59c6\u533a\u3002\u968f\u7740\u6f0f\u6e90\u7535\u538b\u7684\u5347\u9ad8\uff0c\u63d0\u53d6\u7684\u7535\u6d41\u5f00\u59cb\u8d8b\u4e8e\u9971\u548c\uff0c\u8fdb\u5165\u9971\u548c\u533a\u3002\u968f\u7740\u6f0f\u6e90\u7535\u538b\u8fdb\u4e00\u6b65\u589e\u5927\uff0c\u5c31\u4f1a\u8fdb\u5165\u51fb\u7a7f\u533a\uff0c\u6b64\u5904\u7684\u7535\u6d41\u4f1a\u56e0\u5916\u52a0\u7535\u538b\u7684\u5c0f\u5e45\u589e\u52a0\u800c\u5448\u6307\u6570\u589e\u957f\uff0c\u8fd9\u4e00\u73b0\u8c61\u662f\u7531\u78b0\u649e\u7535\u79bb\u5f15\u8d77\u7684\u3002");
