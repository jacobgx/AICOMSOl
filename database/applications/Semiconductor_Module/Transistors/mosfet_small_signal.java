...
public class mosfet_small_signal {
  ...
  public static Model run2(Model model) {
    ...
    model.param().descr("Vac", "\u5c0f\u4fe1\u53f7\u7535\u538b");
    model.param().set("freq", "10[MHz]");
    model.param().descr("freq", "\u5c0f\u4fe1\u53f7\u9891\u7387");
    ...
    model.result("pg8").set("xlabel", "\u6f0f\u6781\u7535\u6d41 (uA)");
    model.result("pg8").set("ylabelactive", true);
    model.result("pg8").set("ylabel", "\u8de8\u5bfc (uS)");
    ...
    model.result("pg8").feature("glob1").set("xdatadescr", "\u7ec8\u7aef\u7535\u6d41");
    ...
    model.result("pg9").set("xlabel", "\u6f0f\u6781\u7535\u6d41 (uA)");
    model.result("pg9").set("ylabelactive", true);
    model.result("pg9").set("ylabel", "\u8f93\u51fa\u7535\u5bfc (uS)");
    ...
    model.result("pg9").feature("glob1").set("xdatadescr", "\u7ec8\u7aef\u7535\u6d41");
    ...
    model.title("MOSFET \u5c0f\u4fe1\u53f7\u5206\u6790");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u8ba1\u7b97\u91d1\u5c5e\u6c27\u5316\u7269\u534a\u5bfc\u4f53\u573a\u6548\u5e94\u6676\u4f53\u7ba1 (MOSFET) \u7684\u4ea4\u6d41\u7279\u6027\uff0c\u5e76\u8ba1\u7b97\u8f93\u51fa\u7535\u5bfc\u548c\u8de8\u5bfc\u968f\u6f0f\u6781\u7535\u6d41\u7684\u53d8\u5316\u60c5\u51b5\u3002");
