...
public class finfet {
  ...
  public static Model run() {
    ...
    model.param().set("w_finfet", "3[um]");
    model.param().descr("w_finfet", "FinFET width");
    model.param().set("d_finfet", "0.7[um]");
    model.param().descr("d_finfet", "FinFET depth");
    model.param().set("h_finfet", "0.7[um]");
    model.param().descr("h_finfet", "FinFET height");
    model.param().set("h_gate", "0.1[um]");
    model.param().descr("h_gate", "Gate height");
    model.param().set("w_source", "0.5[um]");
    model.param().descr("w_source", "Source width");
    model.param().set("w_drain", "0.5[um]");
    model.param().descr("w_drain", "Drain width");
    model.param().set("w_gate", "1.6[um]");
    model.param().descr("w_gate", "Gate width");
    model.param().set("w_ins", "(w_finfet-w_gate-w_source-w_drain)/2");
    model.param().descr("w_ins", "Insulator width");
    model.param().set("d_channel", "0.2[um]");
    model.param().descr("d_channel", "Channel depth");

    model.component("comp1").geom("geom1").lengthUnit("\u00b5m");
    model.component("comp1").geom("geom1").create("blk1", "Block");
    model.component("comp1").geom("geom1").feature("blk1").set("size", new String[]{"w_finfet", "d_finfet", "1"});
    model.component("comp1").geom("geom1").feature("blk1").setIndex("size", "h_finfet", 2);
    model.component("comp1").geom("geom1").feature().duplicate("blk2", "blk1");
    model.component("comp1").geom("geom1").feature("blk2").setIndex("size", "w_source", 0);
    model.component("comp1").geom("geom1").feature("blk2").setIndex("size", "h_gate", 2);
    model.component("comp1").geom("geom1").feature("blk2").set("pos", new String[]{"0", "0", "h_finfet-h_gate"});
    model.component("comp1").geom("geom1").feature().duplicate("blk3", "blk2");
    model.component("comp1").geom("geom1").feature("blk3").setIndex("size", "w_ins", 0);
    model.component("comp1").geom("geom1").feature("blk3").setIndex("pos", "w_source", 0);
    model.component("comp1").geom("geom1").feature().duplicate("blk4", "blk3");
    model.component("comp1").geom("geom1").feature("blk4").setIndex("size", "w_gate", 0);
    model.component("comp1").geom("geom1").feature("blk4").setIndex("size", "d_channel", 1);
    model.component("comp1").geom("geom1").feature("blk4").setIndex("pos", "w_source+w_ins", 0);
    model.component("comp1").geom("geom1").feature("blk4").setIndex("pos", "(d_finfet-d_channel)/2", 1);
    model.component("comp1").geom("geom1").feature().duplicate("blk5", "blk4");
    model.component("comp1").geom("geom1").feature("blk5").setIndex("size", "w_ins", 0);
    model.component("comp1").geom("geom1").feature("blk5").setIndex("size", "d_finfet", 1);
    model.component("comp1").geom("geom1").feature("blk5").setIndex("pos", "w_source+w_ins+w_gate", 0);
    model.component("comp1").geom("geom1").feature("blk5").setIndex("pos", 0, 1);
    model.component("comp1").geom("geom1").feature().duplicate("blk6", "blk5");
    model.component("comp1").geom("geom1").feature("blk6").setIndex("size", "w_drain", 0);
    model.component("comp1").geom("geom1").feature("blk6").setIndex("pos", "w_source+2*w_ins+w_gate", 0);
    model.component("comp1").geom("geom1").feature().duplicate("blk7", "blk6");
    model.component("comp1").geom("geom1").feature("blk7").setIndex("size", "w_gate", 0);
    model.component("comp1").geom("geom1").feature("blk7").setIndex("size", "(d_finfet-d_channel)/2", 1);
    model.component("comp1").geom("geom1").feature("blk7").setIndex("pos", "w_source+w_ins", 0);
    model.component("comp1").geom("geom1").feature().duplicate("blk8", "blk7");
    model.component("comp1").geom("geom1").feature("blk8").setIndex("pos", "(d_finfet+d_channel)/2", 1);
    ...
    model.component("comp1").geom("geom1").feature("dif1").selection("input2").set("blk7", "blk8");
    ...
    model.component("comp1").physics("semi").feature("adm2").set("rb", new String[]{"0[um]", "0[um]", "0.6[um]"});
    model.component("comp1").physics("semi").feature("adm2").set("jwidth", "0.6[um]");
    model.component("comp1").physics("semi").feature("adm2").set("jdepth", "0.7[um]");
    model.component("comp1").physics("semi").feature("adm2").set("jheight", "0.1[um]");
    ...
    model.component("comp1").physics("semi").feature("adm2")
         .set("jda", new String[]{"0.2[um]", "0.2[um]", "0.25[um]"});
    ...
    model.component("comp1").physics("semi").feature("adm3").set("rb", new String[]{"2.4[um]", "0[um]", "0.6[um]"});
    model.component("comp1").physics("semi").create("mc1", "MetalContact", 2);
    model.component("comp1").physics("semi").feature("mc1").selection().set(7);
    model.component("comp1").physics("semi").feature().duplicate("mc2", "mc1");
    model.component("comp1").physics("semi").feature("mc2").selection().set(34);
    ...
    model.component("comp1").physics("semi").feature("mc3").set("V0", 0);
    model.component("comp1").physics("semi").create("gc1", "GateContact", 2);
    model.component("comp1").physics("semi").feature("gc1").selection().set(16, 18, 20, 22, 23);
    ...
    model.component("comp1").mesh("mesh1").feature("ftri1").selection().set(7, 13, 16, 20, 23, 27, 34);
    model.component("comp1").mesh("mesh1").feature("size").set("hauto", 3);
    model.component("comp1").mesh("mesh1").create("swe1", "Sweep");
    model.component("comp1").mesh("mesh1").feature("swe1").selection().geom("geom1", 3);
    model.component("comp1").mesh("mesh1").feature("swe1").selection().set(2, 3, 4, 5, 6);
    ...
    model.component("comp1").mesh("mesh1").feature("swe2").feature("dis1").set("elemcount", 20);
    model.component("comp1").mesh("mesh1").feature("swe2").feature("dis1").set("elemratio", 0.1);
    ...
    model.study("std1").feature("stat").setIndex("plistarr", "", 0);
    model.study("std1").feature("stat").setIndex("punit", "V", 0);
    model.study("std1").feature("stat").setIndex("plistarr", "range(0,0.01,0.02)", 0);
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg5").feature("glob1").setIndex("unit", "uA", 0);
    ...
    model.title("\u7fc5\u7247\u573a\u6548\u5e94\u6676\u4f53\u7ba1");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u5bf9\u7fc5\u7247\u573a\u6548\u5e94\u6676\u4f53\u7ba1 (FinFET) \u8fdb\u884c\u5efa\u6a21\uff0c\u5e76\u6a21\u62df\u8be5\u5668\u4ef6\u7684 I-V \u7279\u6027\u3002\u9996\u5148\uff0c\u901a\u8fc7\u626b\u63cf\u6805\u6781\u7535\u538b\u6765\u83b7\u53d6\u6f0f\u6781\u7535\u6d41\u4e0e\u6805\u6781\u7535\u538b\u7684\u5173\u7cfb\u56fe\u3002\u63a5\u7740\uff0c\u5728\u56fa\u5b9a\u6805\u6781\u7535\u538b\u4e0b\u8ba1\u7b97\u6f0f\u6781\u7535\u6d41\u4e0e\u6f0f\u6781\u7535\u538b\u4e4b\u95f4\u7684\u5173\u7cfb\u3002");
