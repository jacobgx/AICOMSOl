...
public class mosfet_mobility {
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").physics("semi").feature("smm1").feature("mmls1")
         .set("mun_in_src", "root.comp1.semi.mun_ar");
    model.component("comp1").physics("semi").feature("smm1").feature("mmls1")
         .set("mup_in_src", "root.comp1.semi.mup_ar");
    ...
    model.component("comp1").physics("semi").feature("smm1").feature("mmct1")
         .set("mun_in_src", "root.comp1.semi.mun_ls");
    model.component("comp1").physics("semi").feature("smm1").feature("mmct1")
         .set("mup_in_src", "root.comp1.semi.mup_ls");
    ...
    model.study("std3").label("\u7814\u7a76 3 - \u8fc1\u79fb\u7387\u6a21\u578b");
    ...
    model.result("pg8").label("\u7535\u5b50\u6d53\u5ea6 (semi)");
    ...
    model.result("pg9").label("\u7a7a\u7a74\u6d53\u5ea6 (semi)");
    ...
    model.result("pg10").label("\u7535\u52bf (semi)");
    ...
    model.result("pg11").feature("surf2").set("custombottomcolor", new double[]{1, 0.8, 0.8});
    ...
    model.result("pg11").feature("surf1").set("custombottomcolor", new double[]{0.8, 0.8, 1});
    ...
    model.result("pg11").feature("surf2").label("P \u578b");
    model.result("pg11").feature("surf1").label("N \u578b");
    model.result("pg11").label("\u51c0\u63ba\u6742\u5242\u6d53\u5ea6 (semi)");
    ...
    model.result("pg12").feature("glob2").setIndex("legends", "Vg=2\uff0c\u8fc1\u79fb\u7387\u6a21\u578b", 0);
    model.result("pg12").run();
    model.result("pg12").feature("glob1").set("legendmethod", "manual");
    model.result("pg12").feature("glob1").setIndex("legends", "Vg=2\uff0c\u6052\u5b9a\u8fc1\u79fb\u7387", 0);
    model.result("pg12").run();

    model.title("MOSFET \u8fc1\u79fb\u7387\u6a21\u578b");

    model
         .description("\u672c\u6559\u7a0b\u6f14\u793a\u5982\u4f55\u5728\u57fa\u672c MOSFET \u793a\u4f8b\u4e2d\u6dfb\u52a0\u591a\u4e2a\u94fe\u63a5\u7684\u8fc1\u79fb\u7387\u6a21\u578b\uff0c\u5305\u62ec\u4e24\u4e2a\u573a\u76f8\u5173\u7684\u8fc1\u79fb\u7387\u6a21\u578b\uff0c\u5b83\u4eec\u5177\u6709\u9ad8\u5ea6\u975e\u7ebf\u6027\uff0c\u5f88\u96be\u4ee5\u5168\u8026\u5408\u7684\u65b9\u5f0f\u8fdb\u884c\u6c42\u89e3\u3002\u5728\u4f7f\u7528\u8fd9\u79cd\u5185\u7f6e\u7684\u573a\u76f8\u5173\u8fc1\u79fb\u7387\u6a21\u578b\u65f6\uff0c\u201c\u534a\u5bfc\u4f53\u201d\u7269\u7406\u573a\u63a5\u53e3\u53ef\u4ee5\u81ea\u52a8\u521b\u5efa\u4e00\u4e2a\u5efa\u8bae\u7684\u6c42\u89e3\u5668\u5e8f\u5217\u3002\u8fd9\u79cd\u81ea\u52a8\u751f\u6210\u7684\u6c42\u89e3\u5668\u5e8f\u5217\u5728\u7535\u573a\u53d8\u91cf\u56fa\u5b9a\u7684\u60c5\u51b5\u4e0b\uff0c\u4f7f\u7528\u5206\u79bb\u5f0f\u6c42\u89e3\u5668\u4ea4\u66ff\u6c42\u89e3\u4e3b\u56e0\u53d8\u91cf\uff0c\u7136\u540e\u66f4\u65b0\u7535\u573a\u53d8\u91cf\uff0c\u4ece\u800c\u53ef\u4ee5\u8f7b\u677e\u5b9e\u73b0\u6536\u655b\u3002");
