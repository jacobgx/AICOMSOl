...
//    model.param().loadFile("FILENAME");
    ...
    model.component("comp1").physics("dl").feature("hh1").set("H0", "delta_H_dLx*3[m]");
    model.component("comp1").physics("dl").create("hh2", "HydraulicHead", 1);
    model.component("comp1").physics("dl").feature("hh2").selection().set(9);
