...
public class localized_corrosion {
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    model.component("comp1").variable("var1").set("beta_phase", "intop1(micro(x,y))", "Beta \u76f8\u79ef\u5206");
    model.component("comp1").variable("var1").set("alpha_phase", "intop1(1-micro(x,y))", "Alpha \u76f8\u79ef\u5206");
    model.component("comp1").variable("var1")
         .set("i_alpha_phase", "intop1((i_alpha(-phil))*(1-micro(x,y)))", "Alpha \u76f8\u7535\u6d41\u79ef\u5206");
    model.component("comp1").variable("var1")
         .set("beta_phase_fraction", "beta_phase/(beta_phase+alpha_phase)", "Beta \u76f8\u5206\u6570");
    ...
    model.component("comp1").physics("cd").feature("es1").feature("er1").set("nm", "z_charge");
    ...
    model.component("comp1").physics("cd").feature("es1").feature("er1")
         .set("ilocmat", "(i_alpha(-phil))*(1-micro(x,y))");
    model.component("comp1").physics("cd").feature("es1").create("er2", "ElectrodeReaction", 1);
    model.component("comp1").physics("cd").feature("es1").feature("er2").set("ilocmat_mat", "userdef");
    model.component("comp1").physics("cd").feature("es1").feature("er2")
         .set("ilocmat", "(i_beta(-phil))*micro(x,y)");
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg6").set("title", "\u8868\u9762 beta \u76f8\u5206\u6570\u968f\u65f6\u95f4\u7684\u53d8\u5316");
    model.result("pg6").set("ylabelactive", true);
    model.result("pg6").set("ylabel", "\u8868\u9762 beta \u76f8\u5206\u6570");
    ...
    model.result("pg6").run();
    model.result("pg6")
         .label("\u4e00\u7ef4\u7ed8\u56fe\u7ec4\uff1a\u8868\u9762 beta \u76f8\u5206\u6570\u7684\u6f14\u5316");
    model.result().duplicate("pg7", "pg6");
    model.result("pg7").run();
    model.result("pg7")
         .set("title", "\u9633\u6781\u5e73\u5747\u7535\u6d41\u5bc6\u5ea6\u968f\u65f6\u95f4\u7684\u53d8\u5316");
    model.result("pg7").set("ylabel", "\u9633\u6781\u5e73\u5747\u7535\u6d41\u5bc6\u5ea6\uff0cA/m<sup>2</sup>");
    model.result("pg7").run();
    model.result("pg7").feature("glob1").setIndex("expr", "i_alpha_phase/alpha_phase", 0);
    model.result("pg7").feature("glob1").setIndex("unit", 1, 0);
    model.result("pg7").run();
    model.result("pg7")
         .label("\u4e00\u7ef4\u7ed8\u56fe\u7ec4\uff1a\u9633\u6781\u5e73\u5747\u7535\u6d41\u5bc6\u5ea6\u7684\u6f14\u5316");

    model.title("\u5c40\u90e8\u8150\u8680");

    model
         .description("\u672c\u4f8b\u5bf9\u9541\u5408\u91d1\u4e2d\u4e24\u76f8\u4e4b\u95f4\u7684\u7535\u5076\u8150\u8680\u5efa\u6a21\uff0c\u5206\u6790\u6a2a\u622a\u9762\u5fae\u89c2\u7ed3\u6784\u3002\u6a21\u578b\u516c\u5f0f\u4e2d\u7684\u4e00\u4e2a\u91cd\u8981\u7279\u5f81\u662f\u4f7f\u7528\u4e00\u4e2a\u8fb9\u754c\u8868\u793a\u6c34\u5e73\u96c6\u51fd\u6570\u9879\u6765\u63cf\u8ff0\u7535\u6781\u8868\u9762\u7684\u9633\u6781\u533a\u548c\u9634\u6781\u533a\u3002");
