...
public class tuning_fork_llac {
  ...
  public static Model run() {
    ...
    model.param().set("LL_L", "78[mm]");

    model.component("comp1").geom("geom1").feature("cad1").updateCadParamTable(false, false);
    model.component("comp1").geom("geom1").feature("cad1").importData();
    model.component("comp1").geom("geom1").create("knit1", "Knit");
    model.component("comp1").geom("geom1").feature("knit1").selection("input")
         .set("cad1(2)", "cad1(3)", "cad1(4)", "cad1(5)", "cad1(6)", "cad1(7)");
    ...
    model.study("std1").feature("opt").setIndex("pname", "LL_L", 0);
    ...
    model.result().numerical("gev1").set("expr", new String[]{"LL_L"});
    model.result().numerical("gev1").set("descr", new String[]{"\u63a7\u5236\u53c2\u6570 LL_L"});
    ...
    model
         .description("\u672c\u4f8b\u8ba1\u7b97\u97f3\u53c9\u7684\u57fa\u672c\u7279\u5f81\u9891\u7387\u548c\u7279\u5f81\u6a21\u6001\uff0c\u5e76\u901a\u8fc7 LiveLink\u2122 \u63a5\u53e3\u4e0e AutoCAD\u00ae \u540c\u6b65\u3002\u7136\u540e\u4f18\u5316\u97f3\u53c9\u957f\u5ea6\uff0c\u4f7f\u97f3\u53c9\u53d1\u51fa\u97f3\u7b26 A (440\u00a0Hz)\u3002");

    model.label("tuning_fork_llac.mph");
