...
public class shaft_submodeling {
  ...
  public static Model run() {
    ...
    model.geom("part1").label("\u5168\u51e0\u4f55");

    model.component("comp1").label("\u5168\u6a21\u578b");
    ...
    model.result("pg2").label("\u622a\u9762\u5e94\u529b - \u5168\u6a21\u578b");
    ...
    model.geom("part2").feature("int1").label("\u5b50\u6a21\u578b\u5207\u5272");
    ...
    model.result("pg4").label("\u622a\u9762\u5e94\u529b - \u5b50\u6a21\u578b");
