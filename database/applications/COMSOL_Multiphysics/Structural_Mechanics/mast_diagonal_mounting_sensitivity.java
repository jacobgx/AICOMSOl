/*
 * mast_diagonal_mounting_sensitivity.java
 */
...
public class mast_diagonal_mounting_sensitivity {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").insertFile("mast_diagonal_mounting_geom_sequence.mph", "geom1");
    ...
    model.component("comp1").cpl("aveop1").label("\u5e95\u5ea7\uff0c\u4e2d\u9762");
    model.component("comp1").cpl("aveop1").selection().geom("geom1", 0);
    model.component("comp1").cpl("aveop1").selection().set(9, 13, 18, 22, 55, 59, 64, 68);

    model.component("comp1").selection().create("sel1", "Explicit");
    model.component("comp1").selection("sel1").geom(0);
    model.component("comp1").selection("sel1").label("\u5e95\u5ea7\uff0c\u4e2d\u9762");
    model.component("comp1").selection("sel1").set(9, 13, 18, 22, 55, 59, 64, 68);

    model.component("comp1").cpl("aveop1").selection().named("sel1");

    model.component("comp1").variable().create("var1");
    model.component("comp1").variable("var1").set("p", "-(3/2)*F/(2*Axy_mh)*(1-(Y/r_mh)^2)");
    model.component("comp1").variable("var1").descr("p", "\u5e95\u5ea7\u5b54\u5e94\u529b");
    model.component("comp1").variable("var1").set("fy_mh", "p*nY");
    model.component("comp1").variable("var1").descr("fy_mh", "\u5e95\u5ea7\u5b54\u529b\uff0cy \u5206\u91cf");
    model.component("comp1").variable("var1").set("fz_mh", "p*nZ");
    model.component("comp1").variable("var1").descr("fz_mh", "\u5e95\u5ea7\u5b54\u529b\uff0cz \u5206\u91cf");
    model.component("comp1").variable("var1").set("d_mh", "aveop1(w)");
    model.component("comp1").variable("var1").descr("d_mh", "\u5e95\u5ea7\u5b54\u4f4d\u79fb");
    model.component("comp1").variable("var1").set("L_t", "h_t+t_p+o_mh");
    model.component("comp1").variable("var1").descr("L_t", "\u7b49\u6548\u7ba1\u957f");
    model.component("comp1").variable("var1").set("Axy_mh", "2*r_mh*t_m");
    model.component("comp1").variable("var1").descr("Axy_mh", "\u5e95\u5ea7\u5b54 xy \u6295\u5f71\u9762\u79ef");
    model.component("comp1").variable("var1").set("A_t", "pi*(r_t^2-(r_t-t_t)^2)");
    model.component("comp1").variable("var1").descr("A_t", "\u7ba1\u6a2a\u622a\u9762\u79ef");
    model.component("comp1").variable("var1").set("S", "F/d_mh");
    model.component("comp1").variable("var1").descr("S", "\u88c5\u914d\u7684\u521a\u5ea6");
    model.component("comp1").variable("var1").set("S_i", "200e9[Pa]*A_t/L_t");
    model.component("comp1").variable("var1").descr("S_i", "\u7406\u60f3\u521a\u5ea6");
    model.component("comp1").variable("var1").set("S_R", "S/S_i");
    model.component("comp1").variable("var1").descr("S_R", "\u521a\u5ea6\u6bd4");
    ...
    model.component("comp1").physics("solid").feature("fix1").selection().set(8, 9, 33, 42);
    model.component("comp1").physics("solid").create("bndl1", "BoundaryLoad", 2);
    model.component("comp1").physics("solid").feature("bndl1").selection().set(20, 22, 51, 53);
    model.component("comp1").physics("solid").feature("bndl1")
         .set("forceReferenceArea", new String[]{"0", "fy_mh", "fz_mh"});

    model.component("comp1").mesh("mesh1").create("ftet1", "FreeTet");
    model.component("comp1").mesh("mesh1").feature("ftet1").selection().geom("geom1", 3);
    model.component("comp1").mesh("mesh1").feature("ftet1").selection().set(4, 7);
    ...
    model.component("comp1").mesh("mesh1").feature("swe1").selection("sourceface").set(4);
    ...
    model.component("comp1").mesh("mesh1").feature("swe1").feature("size1").set("hauto", 4);
    ...
    model.result("pg1").feature("vol1").set("unit", "\u00b5m");
    model.result("pg1").run();
    model.result().numerical().create("gev1", "EvalGlobal");
    model.result().numerical("gev1").set("expr", new String[]{"S_R"});
    model.result().numerical("gev1").set("descr", new String[]{"\u521a\u5ea6\u6bd4"});
    ...
    model.result().numerical("gev2").set("expr", new String[]{"S_R"});
    model.result().numerical("gev2").set("descr", new String[]{"\u521a\u5ea6\u6bd4"});
    ...
    model.title("\u901a\u4fe1\u5854\u6845\u659c\u6491\u652f\u67b6\u7684\u521a\u5ea6\u5206\u6790");

    model
         .description("\u672c\u4f8b\u5206\u6790\u901a\u4fe1\u5854\u6845\u652f\u67b6\u7684\u521a\u5ea6\uff0c\u5e76\u5c06\u7ed3\u679c\u4e0e\u7406\u60f3\u60c5\u51b5\u8fdb\u884c\u6bd4\u8f83\uff1b\u5176\u4e2d\u6f14\u793a\u5982\u4f55\u5728\u53c2\u6570\u5316\u626b\u63cf\u4e2d\u4f7f\u7528\u53c2\u6570\u5316\u51e0\u4f55\u3002");
    ...
    model.param().descr("t_p", "\u677f\u539a");
    model.param().set("t_m", "15[mm]");
    model.param().set("dm_p", "0");
    model.param().descr("dm_p", "\u9644\u52a0\u8d28\u91cf\uff0c\u677f");
    model.param().set("dm_m", "0");
    model.param().descr("dm_m", "\u9644\u52a0\u8d28\u91cf\uff0c\u5e95\u5ea7");

    model.component("comp1").selection().create("uni1", "Union");

    model.component("comp1").geom("geom1").run();

    model.component("comp1").selection("uni1").set("input", new String[]{"geom1_sel1", "geom1_sel2"});
    model.component("comp1").selection("uni1").label("\u53d8\u5f62\u7f51\u683c\u57df");

    model.component("comp1").view("view1").set("renderwireframe", true);

    model.component("comp1").cpl().create("intop1", "Integration");
    model.component("comp1").cpl("intop1").set("axisym", true);
    model.component("comp1").cpl("intop1").set("opname", "dA_mt");
    model.component("comp1").cpl("intop1").selection().geom("geom1", 2);
    model.component("comp1").cpl("intop1").selection().set(15, 56);

    model.component("comp1").selection().create("sel2", "Explicit");
    model.component("comp1").selection("sel2").geom(2);
    model.component("comp1").selection("sel2").label("\u5916\u5e95\u5ea7\u9762");
    model.component("comp1").selection("sel2").set(15, 56);

    model.component("comp1").cpl("intop1").selection().named("sel2");
    model.component("comp1").cpl("intop1").label("\u5916\u5e95\u5ea7\u9762");
    model.component("comp1").cpl().create("intop2", "Integration");
    model.component("comp1").cpl("intop2").set("axisym", true);
    model.component("comp1").cpl("intop2").set("opname", "dA_pl");
    ...
    model.component("comp1").selection("sel3").label("\u677f\u8868\u9762");
    model.component("comp1").selection("sel3").set(4);

    model.component("comp1").cpl("intop2").selection().named("sel3");
    model.component("comp1").cpl("intop2").label("\u677f\u8868\u9762");

    model.component("comp1").view("view1").set("renderwireframe", false);

    model.component("comp1").variable().create("var2");
    model.component("comp1").variable("var2").set("mA_pl", "dA_pl(solid.rho)");
    model.component("comp1").variable("var2")
         .descr("mA_pl", "\u5355\u4f4d\u539a\u5ea6\u7684\u8d28\u91cf\uff0c\u677f");
    model.component("comp1").variable("var2").set("mA_mt", "dA_mt(solid.rho)");
    model.component("comp1").variable("var2")
         .descr("mA_mt", "\u5355\u4f4d\u539a\u5ea6\u7684\u8d28\u91cf\uff0c\u5e95\u5ea7");
    model.component("comp1").variable("var2").set("dt_p", "dm_p[kg]/mA_pl");
    model.component("comp1").variable("var2").descr("dt_p", "\u4f4d\u79fb\uff0c\u677f\u7aef\u9762");
    model.component("comp1").variable("var2").set("dt_m", "dm_m[kg]/mA_mt");
    model.component("comp1").variable("var2").descr("dt_m", "\u4f4d\u79fb\uff0c\u5916\u5e95\u5ea7\u9762");
    model.component("comp1").variable("var2").label("\u7075\u654f\u5ea6\u53d8\u91cf");
    model.component("comp1").variable("var1").set("Axy_mh", "2*r_mh*(t_m+dt_m)");

    model.component("comp1").physics("dg").create("free1", "FreeDeformation", 3);
    model.component("comp1").physics("dg").feature("free1").selection().named("uni1");

    model.component("comp1").coordSystem("sys1").set("frametype", "geometry");

    model.component("comp1").physics("dg").feature("disp1").setIndex("coordinateSystem", "sys1", 0);
    model.component("comp1").physics("dg").feature("disp1").setIndex("useDx", 0, 0);
    model.component("comp1").physics("dg").feature("disp1").setIndex("useDx", 0, 1);
    model.component("comp1").physics("dg").create("disp2", "PrescribedMeshDisplacement", 2);
    model.component("comp1").physics("dg").feature("disp2").selection().named("sel2");
    model.component("comp1").physics("dg").feature("disp2").setIndex("coordinateSystem", "sys1", 0);
    model.component("comp1").physics("dg").feature("disp2").setIndex("useDx", 0, 0);
    model.component("comp1").physics("dg").feature("disp2").setIndex("useDx", 0, 1);
    model.component("comp1").physics("dg").feature("disp2").setIndex("dx", "dt_m", 2);
    model.component("comp1").physics("dg").create("disp3", "PrescribedMeshDisplacement", 2);
    model.component("comp1").physics("dg").feature("disp3").selection().named("sel3");
    model.component("comp1").physics("dg").feature("disp3").setIndex("coordinateSystem", "sys1", 0);
    model.component("comp1").physics("dg").feature("disp3").setIndex("useDx", 0, 0);
    model.component("comp1").physics("dg").feature("disp3").setIndex("useDx", 0, 1);
    model.component("comp1").physics("dg").feature("disp3").setIndex("dx", "dt_p", 2);

    model.study("std2").create("sens", "Sensitivity");
    model.study("std2").feature("sens").set("gradientMethod", "forward");
    model.study("std2").feature("sens").set("optobj", new String[]{"comp1.S_R"});
    model.study("std2").feature("sens").set("descr", new String[]{"\u521a\u5ea6\u6bd4"});
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg4").feature("surf1").feature("def1")
         .set("expr", new String[]{"u+1[mm]*mA_pl*sens(u,dm_p)", "v", "w"});
    ...
    model.result("pg4")
         .set("title", "\u8868\u9762\uff1aw \u5bf9\u9644\u52a0\u677f\u8d28\u91cf\u7684\u7075\u654f\u5ea6");
    model.result("pg4").run();

    model.title("\u901a\u4fe1\u5854\u6845\u96f6\u4ef6\u7684\u7075\u654f\u5ea6\u5206\u6790");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u7075\u654f\u5ea6\u5206\u6790\u6765\u9884\u6d4b\u66f4\u6539\u901a\u4fe1\u5854\u6845\u96f6\u4ef6\u7684\u4e00\u4e9b\u51e0\u4f55\u53c2\u6570\u5bf9\u5176\u6574\u4f53\u521a\u5ea6\u7684\u5f71\u54cd\u3002\u4e3a\u6b64\uff0c\u9700\u8981\u4f7f\u7528\u201c\u53d8\u5f62\u51e0\u4f55\u201d\u63a5\u53e3\u548c\u201c\u7075\u654f\u5ea6\u5206\u6790\u201d\u63a5\u53e3\u6765\u589e\u5f3a\u539f\u59cb\u7ed3\u6784\u6a21\u578b\u3002");
