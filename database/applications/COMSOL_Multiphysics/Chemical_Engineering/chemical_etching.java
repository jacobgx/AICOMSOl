...
//    model.param().loadFile("FILENAME");
    model.param().set("cCuCl2_bulk", "1[mol/dm^3]", "\u672c\u4f53\u6d53\u5ea6\uff0ccCuCl2");
    model.param().set("kf", "100[m/s]", "\u6b63\u53cd\u5e94\u901f\u7387\u5e38\u6570");
    model.param().set("M_Cu", "65[g/mol]", "\u6469\u5c14\u8d28\u91cf\uff0cCu");
    model.param().set("rho_Cu", "9000[kg/m^3]", "\u5bc6\u5ea6\uff0cCu");
    model.param().set("h_mask", "0.1[mm]", "\u63a9\u819c\u9ad8\u5ea6");
    model.param().set("h_seed_cavity", "0.1[mm]", "\u6676\u79cd\u8154\u9ad8\u5ea6");
    model.param().set("d_mask", "1[mm]", "\u63a9\u819c\u957f\u5ea6");
    model.param().set("h_boundary_layer", "1[mm]+2*h_seed_cavity", "\u8fb9\u754c\u5c42\u5bbd\u5ea6");
    model.param().set("D", "1e-9[m^2/s]", "\u53cd\u5e94\u7269\u7684\u6269\u6563\u7cfb\u6570");
    model.param().set("tmax", "3[h]", "\u523b\u8680\u65f6\u95f4");
    ...
    model.component("comp1").variable("var1").descr("v_surface", "\u8868\u9762\u6cd5\u5411\u901f\u5ea6");
