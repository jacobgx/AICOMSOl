...
public class busbar_assembly_geometry {
  ...
  public static Model run() {
    ...
    model.geom("part1").feature("blk1").set("size", new String[]{"c_g_w_part", "1", "1"});
    ...
    model.geom("part1").feature("blk1").set("pos", new String[]{"0", "0", "c_g_h_part/2"});
    ...
    model.geom("part1").feature("wp1").set("displ", new String[]{"-c_g_w_part/2+s_di_part", "0"});
    ...
    model.geom("part5").feature("wp1").geom().feature("r1").set("size", new String[]{"a_c_w_part", "r_c_w_part"});
    model.geom("part5").feature("wp1").geom().feature("r1").set("base", "center");
    model.geom("part5").feature("wp1").geom().feature("r1")
         .set("pos", new String[]{"0", "r_c_w_part/2-2*s_di_part"});
    ...
    model.geom("part5").feature("wp1").geom().feature("c2").set("pos", new String[]{"a_c_w_part/4", "0"});
    ...
    model.geom("part5").feature("wp2").set("transdispl", new String[]{"a_c_w_part/4", "0", "0"});
    ...
    model.geom("part6").localParam().descr("e_c_lx_part", "Elbow connector length, x\u00a0direction");
    model.geom("part6").localParam().set("e_c_lz_part", "80[mm]");
    model.geom("part6").localParam().descr("e_c_lz_part", "Elbow connector length, z\u00a0direction");
    ...
    model.geom("part6").feature("wp1").geom().feature("r1").set("size", new String[]{"e_c_lx_part", "1"});
    ...
    model.geom("part6").feature("wp1").geom().feature("c1").set("pos", new String[]{"b_di_part", "a_c_w_part/4"});
    ...
    model.geom("part6").feature("wp1").geom().feature("c2").set("pos", new String[]{"b_di_part", "a_c_w_part*3/4"});
    ...
    model.geom("part6").feature("wp2").set("displ", new String[]{"0", "2*e_c_h_part"});
    model.geom("part6").feature("wp2").set("showworkplane", false);
    model.geom("part6").feature("wp2").geom().create("r1", "Rectangle");
    model.geom("part6").feature("wp2").geom().feature("r1").set("size", new String[]{"a_c_w_part", "e_c_lz_part"});
    ...
    model.geom("part6").feature("wp2").geom().feature("c1").set("pos", new String[]{"a_c_w_part/4", "0"});
    ...
    model.geom("part6").feature("wp2").geom().feature("arr1").set("fullsize", new int[]{2, 2});
    model.geom("part6").feature("wp2").geom().feature("arr1").set("displ", new String[]{"a_c_w_part/2", "0"});
    ...
    model.geom("part6").feature("wp3").set("displ", new String[]{"0", "-2*e_c_h_part"});
    ...
    model.geom("part6").feature("wp4").set("transdispl", new String[]{"b_di_part", "a_c_w_part/4", "0"});
    ...
    model.geom("part6").feature("wp5").set("transdispl", new String[]{"a_c_w_part/4", "0", "0"});
    ...
    model.geom("part6").feature("wp6").set("displ", new String[]{"b_di_part", "a_c_w_part/4"});
    ...
    model.geom("part7").feature("blk1").set("size", new String[]{"i_b_h_part", "1", "1"});
    ...
    model.geom("part7").feature("wp1").geom().feature("c1")
         .set("pos", new String[]{"c_g_l_part/4-a_c_w_part/4", "0"});
    ...
    model.geom("part7").feature("wp1").geom().feature("arr1").set("fullsize", new int[]{2, 2});
    model.geom("part7").feature("wp1").geom().feature("arr1").set("displ", new String[]{"a_c_w_part/2", "0"});
  ...
  public static Model run2(Model model) {
    ...
    model.geom("part7").feature("wp2").set("displ", new String[]{"c_g_l_part/4-a_c_w_part/4", "0"});
    ...
    model.geom("part8").localParam()
         .set("l_part", "if(size==2,r_c_h_part+a_c_h_part+e_c_h_part,if(size==1,e_c_h_part+i_b_h_part,r_c_h_part+a_c_h_part))");
    ...
    model.geom("part9").feature("wp2").geom().feature("r1").set("size", new String[]{"200[mm]", "80[mm]"});
    model.geom("part9").feature("wp2").geom().feature("r1").set("pos", new String[]{"10[mm]", "5[mm]"});
    model.geom("part9").feature("wp2").geom().run("r1");
    model.geom("part9").feature("wp2").geom().feature("r1")
         .set("size", new String[]{"c_g_w_part/2+b_di_part*2", "80[mm]"});
    model.geom("part9").feature("wp2").geom().feature("r1").setIndex("size", "a_c_w_part", 1);
    model.geom("part9").feature("wp2").geom().feature("r1").set("pos", new int[]{0, 0});
    model.geom("part9").feature("wp2").geom().run("r1");
    ...
    model.geom("part9").feature("wp2").geom().feature("c1").set("pos", new String[]{"b_di_part", "a_c_w_part/4"});
    ...
    model.geom("part9").feature("wp2").geom().feature("arr1").set("fullsize", new int[]{2, 2});
    model.geom("part9").feature("wp2").geom().feature("arr1").set("displ", new String[]{"c_g_w_part/2", "0"});
    ...
    model.geom("part10").selection("csel1").label("\u949b");
    ...
    model.geom("part10").selection("csel2").label("\u94dc");
    ...
    model.geom("part10").feature("pi7").label("\u5c0f\u87ba\u6813");
    model.geom("part10").feature("pi7").set("workplanesrc", "pi6");
    model.geom("part10").feature("pi7").set("workplane", "wp4");
    model.geom("part10").feature("pi7").set("displ", new String[]{"0", "0", "-r_c_h_asm"});
    ...
    model.geom("part10").feature("pi8").label("\u5927\u87ba\u6813");
    ...
    model.geom("part10").feature("pi8").set("displ", new String[]{"0", "0", "-r_c_h_asm"});
    ...
    model.geom("part10").feature("mir1").set("pos", new String[]{"0", "190[mm]", "0"});
    model.geom("part10").feature("mir1").set("axis", new int[]{0, 1, 0});
    model.geom("part10").run("mir1");
    model.geom("part10").create("wp1", "WorkPlane");
    model.geom("part10").feature("wp1").set("unite", true);
    model.geom("part10").feature("wp1").label("\u5355\u5143\u95f4\u6bcd\u7ebf\u4f4d\u7f6e");
    ...
    model.component("comp1").geom("geom1").selection("csel2").label("\u94dc");
    model.component("comp1").geom("geom1").feature("pi1").setEntry("selcontributetodom", "pi1_blk1.dom", "csel1");
    ...
    model.component("comp1").geom("geom1").feature("pi2").set("part", "part10");
    model.component("comp1").geom("geom1").feature("pi2").setEntry("inputexpr", "a_c_w_asm", "a_c_w");
    model.component("comp1").geom("geom1").feature("pi2").setEntry("inputexpr", "r_d_asm", "r_d");
    ...
    model.component("comp1").geom("geom1").feature("pi2").setEntry("selkeepobj", "pi2_boxsel1", true);
    model.component("comp1").geom("geom1").feature("pi2").setEntry("selcontributetodom", "pi2_csel1.dom", "csel1");
    model.component("comp1").geom("geom1").feature("pi2").setEntry("selcontributetodom", "pi2_csel2.dom", "csel2");
    model.component("comp1").geom("geom1").feature("pi2").setEntry("selkeeppnt", "pi2_pi5_sel1", true);
    model.component("comp1").geom("geom1").feature("pi2").setEntry("selshowpnt", "pi2_pi5_sel1", false);
    model.component("comp1").geom("geom1").run("pi2");
    model.component("comp1").geom("geom1").create("mov1", "Move");
    model.component("comp1").geom("geom1").feature("mov1").selection("input").named("pi2_boxsel1");
    model.component("comp1").geom("geom1").feature("mov1").set("disply", "0 -400[mm]");
    ...
    model.component("comp1").geom("geom1").feature("pi3").set("part", "part7");
    model.component("comp1").geom("geom1").feature("pi3").setEntry("inputexpr", "a_c_w_part", "a_c_w");
    model.component("comp1").geom("geom1").feature("pi3").set("workplanepart", "wp2");
    ...
    model.component("comp1").geom("geom1").feature("pi4").set("part", "part8");
    model.component("comp1").geom("geom1").feature("pi4").label("\u4e2d\u87ba\u6813");
    model.component("comp1").geom("geom1").feature("pi4").setEntry("inputexpr", "size", 1);
    model.component("comp1").geom("geom1").feature("pi4").set("axistype", "y");
    model.component("comp1").geom("geom1").feature("pi4").set("rot", 90);
    model.component("comp1").geom("geom1").feature("pi4").setEntry("selcontributetodom", "pi4_cyl1.dom", "csel1");
    model.component("comp1").geom("geom1").run("pi4");
    model.component("comp1").geom("geom1").create("mov2", "Move");
    model.component("comp1").geom("geom1").feature("mov2").selection("input").set("pi4");
    model.component("comp1").geom("geom1").feature("mov2").set("specify", "pos");
    model.component("comp1").geom("geom1").feature("mov2").selection("oldposvertex").set("pi4", 1);
    model.component("comp1").geom("geom1").feature("mov2").selection("newposvertices").named("pi2_pi5_sel1");
    model.component("comp1").geom("geom1").run("mov2");
    model.component("comp1").geom("geom1").run("fin");
    model.component("comp1").geom("geom1").feature().createAfter("adjsel1", "AdjacentSelection", "fin");
    model.component("comp1").geom("geom1").feature("adjsel1").set("entitydim", 3);
    model.component("comp1").geom("geom1").feature("adjsel1").label("\u76f8\u90bb\u9009\u62e9 1");
    model.component("comp1").geom("geom1").feature("adjsel1").set("input", new String[]{"csel1.dom", "csel2.dom"});
    ...
    model.component("comp1").geom("geom1").feature("difsel1").set("subtract", new String[]{"pi1_sel1", "pi3_sel1"});
