...
public class busbar_assembly_geom_subsequence {
  ...
  public static Model run() {
    ...
    model.geom("part1").feature("wp1").label("\u810a\u7ebf\u4f4d\u7f6e");
    ...
    model.geom("part1").feature("sel1").label("\u7535\u89e3\u6db2\u8fb9\u754c");
    ...
    model.geom("part2").feature("wp2").label("\u4e2d\u5fc3\u67f1\u4f4d\u7f6e");
    ...
    model.geom("part3").label("\u4e2d\u5fc3\u67f1");
    model.geom("part3").inputParam().set("r_d_part", "20[mm]");
    model.geom("part3").inputParam().descr("r_d_part", "\u6746\u76f4\u5f84");
    ...
    model.geom("part3").localParam().descr("c_c_d_part", "\u4e2d\u5fc3\u67f1\u4e2d\u5fc3\u5b54\u6df1\u5ea6");
    ...
    model.geom("part3").feature("wp2").label("\u6746\u4f4d\u7f6e");
    ...
    model.geom("part4").label("\u6746");
    model.geom("part4").inputParam().set("r_d_part", "20[mm]");
    model.geom("part4").inputParam().descr("r_d_part", "\u6746\u76f4\u5f84");
    model.geom("part4").inputParam().set("r_l_part", "160[mm]");
    model.geom("part4").inputParam().descr("r_l_part", "\u6746\u957f\u5ea6");
    ...
    model.geom("part4").feature("wp1").label("\u6746\u8fde\u63a5\u5668\u4f4d\u7f6e");
    ...
    model.geom("part5").label("\u6746\u8fde\u63a5\u5668");
    model.geom("part5").inputParam().set("a_c_w_part", "90[mm]");
    model.geom("part5").inputParam().descr("a_c_w_part", "\u89d2\u5f62\u8fde\u63a5\u5668\u5bbd\u5ea6");
    model.geom("part5").inputParam().set("r_d_part", "20[mm]");
    model.geom("part5").inputParam().descr("r_d_part", "\u6746\u76f4\u5f84");
    model.geom("part5").inputParam().set("r_c_h_part", "6[mm]");
    model.geom("part5").inputParam().descr("r_c_h_part", "\u6746\u8fde\u63a5\u5668\u9ad8\u5ea6");
    ...
    model.geom("part5").localParam().descr("r_c_w_part", "\u6746\u8fde\u63a5\u5668\u5bbd\u5ea6");
    ...
    model.geom("part5").feature("wp2").label("\u5f2f\u5934\u8fde\u63a5\u5668\u4f4d\u7f6e");
    ...
    model.geom("part6").label("\u5f2f\u5934\u8fde\u63a5\u5668");
    model.geom("part6").inputParam().set("a_c_w_part", "90[mm]");
    model.geom("part6").inputParam().descr("a_c_w_part", "\u89d2\u5f62\u8fde\u63a5\u5668\u5bbd\u5ea6");
    ...
    model.geom("part6").localParam().descr("e_c_h_part", "\u5f2f\u5934\u8fde\u63a5\u5668\u9ad8\u5ea6");
    ...
    model.geom("part6").localParam()
         .descr("e_c_lx_part", "\u5f2f\u5934\u8fde\u63a5\u5668\u957f\u5ea6\uff0cx \u65b9\u5411");
    ...
    model.geom("part6").feature("wp4").label("\u6746\u8fde\u63a5\u5668\u4f4d\u7f6e");
    ...
    model.geom("part6").feature("wp5").label("\u5355\u5143\u95f4\u6bcd\u7ebf\u4f4d\u7f6e");
    ...
    model.geom("part6").feature("wp6").label("\u89d2\u5f62\u8fde\u63a5\u5668\u4f4d\u7f6e");
    ...
    model.geom("part6").feature("sel1").label("\u4e2d\u87ba\u6813\u4f4d\u7f6e");
    ...
    model.geom("part7").label("\u5355\u5143\u95f4\u6bcd\u7ebf");
    model.geom("part7").inputParam().set("a_c_w_part", "90[mm]");
    model.geom("part7").inputParam().descr("a_c_w_part", "\u89d2\u5f62\u8fde\u63a5\u5668\u5bbd\u5ea6");
  ...
  public static Model run2(Model model) {
    ...
    model.geom("part7").feature("sel1").label("\u63a5\u5730\u8fb9\u754c");
    ...
    model.geom("part7").feature("wp2").label("\u5f2f\u5934\u8fde\u63a5\u5668\u4f4d\u7f6e");
    ...
    model.geom("part8").label("\u87ba\u6813");
    model.geom("part8").inputParam().set("size", "0");
    model.geom("part8").inputParam()
         .descr("size", "\u5927\u5c0f\u9009\u62e9 0 = \u5c0f\uff0c1 = \u4e2d\uff0c2 = \u5927");
