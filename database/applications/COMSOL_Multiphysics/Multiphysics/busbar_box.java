...
public class busbar_box {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").feature("blk1").set("size", new String[]{"L+5*tbb", "3*L", "L+6*tbb"});
    model.component("comp1").geom("geom1").feature("blk1").set("pos", new String[]{"-2*tbb", "-L", "-tbb"});
    ...
    model
         .description("\u672c\u4f8b\u662f\u4e00\u4e2a\u6a21\u677f MPH \u6587\u4ef6\uff0c\u60a8\u53ef\u4ee5\u57fa\u4e8e\u6b64\u6587\u4ef6\u5bf9\u201c\u6bcd\u7ebf\u677f\u7126\u8033\u70ed\u201d\u793a\u4f8b\u8fdb\u884c\u6269\u5c55\uff0c\u7814\u7a76\u6bcd\u7ebf\u677f\u5728\u6c14\u6d41\u4f5c\u7528\u4e0b\u4ea7\u751f\u7684\u5bf9\u6d41\u51b7\u5374\u3002");
