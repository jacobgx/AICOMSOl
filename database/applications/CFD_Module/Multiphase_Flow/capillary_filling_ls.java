...
public class capillary_filling_ls {
  ...
  public static Model run() {
    ...
    model.component("comp1").variable("var1").descr("theta", "\u63a5\u89e6\u89d2\u8868\u8fbe\u5f0f");
    ...
    model.result("pg5").label("\u6d41\u4f53 1 \u7684\u4f53\u79ef\u5206\u6570 (ls)");
    ...
    model.result("pg6").label("\u6d41\u4f53 1 \u7684\u4f53\u79ef\u5206\u6570 (ls) 1");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg7").feature("con1").feature("col1").set("descr", "\u63a5\u89e6\u89d2\u8868\u8fbe\u5f0f");
    model.result("pg7").run();
    model.result("pg7").label("\u51f9\u5f62\u9762\u89d2\u5ea6");
    model.result("pg7").set("showlegendsmaxmin", true);
    model.result("pg7").run();
    model.result("pg6").run();

    model.title("\u6bdb\u7ec6\u7ba1\u586b\u5145 - \u6c34\u5e73\u96c6\u65b9\u6cd5");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u77ac\u6001\u6a21\u578b\u6a21\u62df\u7531\u8868\u9762\u5f20\u529b\u548c\u58c1\u9644\u7740\u529b\u5f15\u8d77\u7684\u7a84\u901a\u9053\u586b\u5145\u3002\u6bdb\u7ec6\u7ba1\u901a\u9053\u6700\u521d\u5145\u6ee1\u7a7a\u6c14\uff0c\u7531\u4e8e\u8fde\u63a5\u5230\u84c4\u6c34\u6c60\uff0c\u6bdb\u7ec6\u529b\u4f1a\u4f7f\u6c34\u901a\u8fc7\u901a\u9053\u4e0a\u5347\u3002\u63a5\u89e6\u89d2\uff08\u5373\u6c34\u9762\u4e0e\u58c1\u4e4b\u95f4\u7684\u5939\u89d2\uff09\u56fa\u5b9a\u4e3a 67.5 \u5ea6\u3002\u8be5\u6a21\u578b\u53ef\u4ee5\u901a\u8fc7\u6c34\u5e73\u96c6\u65b9\u6cd5\u6216\u76f8\u573a\u6cd5\u8ffd\u8e2a\u6d41\u4f53\u754c\u9762\u8fdb\u884c\u6c42\u89e3\uff0c\u672c\u4f8b\u4f7f\u7528\u6c34\u5e73\u96c6\u65b9\u6cd5\u3002");
