...
public class jelly_roll_flattened {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1").insertFile("jelly_roll_flattened_geom_sequence.mph", "geom1");
    model.component("comp1").geom("geom1").run("sel11");
    model.component("comp1").geom("geom1").run("sel11");

    model.component("comp1").view().create("view5", "geom1");
    model.component("comp1").view("view5").camera().set("viewscaletype", "manual");
    model.component("comp1").view("view5").camera().set("yscale", 100);
...
//    model.param("par2").loadFile("FILENAME");
    ...
    model.param("par2").set("H_mesh", "H_jr/10", "\u6700\u5927\u7f51\u683c\u5927\u5c0f");
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").material("mat4").selection().named("geom1_difsel2");
    model.component("comp1").material("mat5").selection().named("geom1_ext3_dom");
    model.component("comp1").material().create("mat6", "Common");
    model.component("comp1").material("mat6").label("\u954d");
    model.component("comp1").material("mat6").selection().named("geom1_ext5_dom");
    ...
    model.component("comp1").physics("cd").feature("cc1").selection().named("geom1_unisel5");
    model.component("comp1").physics("cd").create("pce1", "PorousElectrode", 3);
    model.component("comp1").physics("cd").feature("pce1").selection().named("geom1_unisel6");
    ...
    model.component("comp1").cpl("linext1").selection().named("geom1_sel9");
    model.component("comp1").cpl("linext1").selection("srcvertex1").set(31);
    model.component("comp1").cpl("linext1").selection("dstvertex1").set(33);
    model.component("comp1").cpl("linext1").selection("srcvertex2").set(30);
    model.component("comp1").cpl("linext1").selection("dstvertex2").set(32);
    model.component("comp1").cpl("linext1").selection("srcvertex3").set(55);
    model.component("comp1").cpl("linext1").selection("dstvertex3").set(57);
    model.component("comp1").cpl("linext1").selection("srcvertex4").set(54);
    model.component("comp1").cpl("linext1").selection("dstvertex4").set(56);
    model.component("comp1").cpl().create("linext2", "LinearExtrusion");
    model.component("comp1").cpl("linext2").selection().geom("geom1", 2);
    model.component("comp1").cpl("linext2").selection().named("geom1_sel10");
    model.component("comp1").cpl("linext2").selection("srcvertex1").set(47);
    model.component("comp1").cpl("linext2").selection("srcvertex2").set(46);
    model.component("comp1").cpl("linext2").selection("srcvertex3").set(38);
    model.component("comp1").cpl("linext2").selection("srcvertex4").set(39);
    model.component("comp1").cpl("linext2").selection("dstvertex1").set(49);
    model.component("comp1").cpl("linext2").selection("dstvertex2").set(48);
    model.component("comp1").cpl("linext2").selection("dstvertex3").set(40);
    model.component("comp1").cpl("linext2").selection("dstvertex4").set(41);

    model.component("comp1").physics("cd").create("eip1", "ElectrolytePotential", 2);
    model.component("comp1").physics("cd").feature("eip1").label("\u7535\u89e3\u8d28\u7535\u4f4d\u8026\u5408 1");
    model.component("comp1").physics("cd").feature("eip1").selection().named("geom1_sel7");
    model.component("comp1").physics("cd").feature("eip1").set("philbnd", "linext1(phil)");
    model.component("comp1").physics("cd").feature().duplicate("eip2", "eip1");
    model.component("comp1").physics("cd").feature("eip2").label("\u7535\u89e3\u8d28\u7535\u4f4d\u8026\u5408 2");
    model.component("comp1").physics("cd").feature("eip2").selection().named("geom1_sel8");
    model.component("comp1").physics("cd").feature("eip2").set("philbnd", "linext2(phil)");
    model.component("comp1").physics("ht").create("temp1", "TemperatureBoundary", 2);
    model.component("comp1").physics("ht").feature("temp1").label("\u6e29\u5ea6\u8026\u5408 1");
    model.component("comp1").physics("ht").feature("temp1").selection().named("geom1_sel7");
    model.component("comp1").physics("ht").feature("temp1").set("T0", "linext1(T)");
    model.component("comp1").physics("ht").feature().duplicate("temp2", "temp1");
    model.component("comp1").physics("ht").feature("temp2").label("\u6e29\u5ea6\u8026\u5408 2");
    model.component("comp1").physics("ht").feature("temp2").selection().named("geom1_sel8");
    model.component("comp1").physics("ht").feature("temp2").set("T0", "linext2(T)");

    model.component("comp1").mesh("mesh1").create("size1", "Size");
    model.component("comp1").mesh("mesh1").feature("size1").selection().geom("geom1", 1);
    model.component("comp1").mesh("mesh1").feature("size1").selection().named("geom1_sel11");
    ...
    model.component("comp1").mesh("mesh1").feature("fq1").selection().named("geom1_sel5");
    model.component("comp1").mesh("mesh1").run("fq1");
    model.component("comp1").mesh("mesh1").create("map1", "Map");
    model.component("comp1").mesh("mesh1").feature("map1").selection().named("geom1_unisel7");
    model.component("comp1").mesh("mesh1").feature("map1").create("dis1", "Distribution");
    model.component("comp1").mesh("mesh1").feature("map1").feature("dis1").selection().named("geom1_unisel8");
    model.component("comp1").mesh("mesh1").feature("map1").feature("dis1").set("numelem", "round(L_cc_neg/H_mesh)");
    model.component("comp1").mesh("mesh1").feature("map1").create("dis2", "Distribution");
    model.component("comp1").mesh("mesh1").feature("map1").feature("dis2").selection().named("geom1_difsel3");
    model.component("comp1").mesh("mesh1").feature("map1").feature("dis2").set("numelem", "round(H_jr/H_mesh)");
    model.component("comp1").mesh("mesh1").run("map1");
    model.component("comp1").mesh("mesh1").create("swe1", "Sweep");
    model.component("comp1").mesh("mesh1").feature("swe1").create("dis1", "Distribution");
    model.component("comp1").mesh("mesh1").feature("swe1").feature("dis1").selection().named("geom1_ext3_dom");
    ...
    model.component("comp1").mesh("mesh1").feature("swe1").feature("dis2").selection().named("geom1_unisel6");
    model.component("comp1").mesh("mesh1").feature("swe1").create("dis3", "Distribution");
    model.component("comp1").mesh("mesh1").feature("swe1").feature("dis3").selection().named("geom1_unisel5");
    ...
    model.result("pg2").label("\u7535\u6781\u7535\u4f4d\u4e0e\u8d1f\u6781\u7aef\u5b50\u7684\u5173\u7cfb");
    ...
    model.result("pg2").feature("vol1").set("descr", "\u7535\u52bf");
    model.result("pg2").feature("vol1").set("unit", "mV");
    model.result("pg2").run();
    model.result("pg2").run();
    model.result().duplicate("pg3", "pg2");
    model.result("pg3").run();
    model.result("pg3").label("\u7535\u6781\u7535\u4f4d\u4e0e\u6b63\u6781\u7aef\u5b50\u7684\u5173\u7cfb");
    model.result("pg3").selection().named("geom1_unisel4");
    model.result("pg3").run();
    model.result("pg3").feature("vol1").set("descr", "\u7535\u52bf \u8fb9\u754c\u7535\u4f4d");
    model.result("pg3").feature("vol1").set("expr", "cd.phis-cd.phis0_ec1");
    model.result("pg3").feature("vol1").set("unit", "mV");
    model.result("pg3").run();
    model.result().create("pg4", "PlotGroup3D");
    model.result("pg4").run();
    model.result("pg4").label("\u7535\u89e3\u8d28\u7535\u6d41\u5bc6\u5ea6\uff0c\u9694\u819c 1");
    model.result("pg4").selection().geom("geom1", 2);
    model.result("pg4").selection().named("geom1_sel7");
    model.result("pg4").create("surf1", "Surface");
    model.result("pg4").feature("surf1").set("expr", "cd.nIl");
    model.result("pg4").feature("surf1").set("descr", "\u6cd5\u5411\u7535\u89e3\u8d28\u7535\u6d41\u5bc6\u5ea6");
    model.result("pg4").feature("surf1").set("expr", "abs(cd.nIl)");
    model.result("pg4").run();
    model.result("pg4").set("titletype", "manual");
    model.result("pg4").set("title", "\u7535\u6d41\u5bc6\u5ea6 (A/m<sup>2</sup>)");
    model.result("pg4").run();
    model.result().duplicate("pg5", "pg4");
    model.result("pg5").run();
    model.result("pg5").label("\u7535\u89e3\u8d28\u7535\u6d41\u5bc6\u5ea6\uff0c\u9694\u819c 2");
    model.result("pg5").selection().named("geom1_sel8");
    model.result("pg5").run();

    model.title("\u4f7f\u7528\u6241\u5e73\u51e0\u4f55\u6a21\u62df\u5706\u67f1\u5377\u7ed5\u5f0f\u7535\u6c60");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u57fa\u4e8e\u7f20\u7ed5\u87ba\u65cb\u7684\u51e0\u4f55\u7684\u6241\u5e73\u5316\u8868\u793a\u6765\u91cd\u73b0\u201c\u5706\u67f1\u5377\u7ed5\u5f0f\u7535\u6c60\u201d\u6559\u7a0b\u793a\u4f8b\u7684\u7ed3\u679c\u3002\n\n\u5c06\u539f\u59cb\u95ee\u9898\u6620\u5c04\u5230\u6241\u5e73\u4e09\u7ef4\u51e0\u4f55\u6709\u591a\u4e2a\u4f18\u52bf\uff1a\u65e0\u9700\u5728\u7f51\u683c\u4e2d\u89e3\u6790\u7f20\u7ed5\u5c42\u7684\u66f2\u7387\uff0c\u4ece\u800c\u53ef\u4ee5\u51cf\u5c0f\u95ee\u9898\u7684\u5927\u5c0f\uff0c\u5e76\u4e14\u4fbf\u4e8e\u5c06\u6cbf\u87ba\u65cb\u65b9\u5411\u7684\u7ed3\u679c\u53ef\u89c6\u5316\u3002");
