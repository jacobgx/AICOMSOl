...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    ...
    model.component("comp1").variable("var1").set("I_app", "(-I_1C*4)*step1((t-750)[1/s])");
    ...
    model.func("int1").label("\u76f8\u5bf9\u4f53\u79ef\u53d8\u5316 vs. soc");
    ...
    model.result("pg1").set("window", "window1");
    model.result("pg1").run();
    model.result("pg1").label("\u7535\u6c60\u5355\u5143\u7535\u538b");
    model.result("pg1").set("titletype", "label");
    model.result("pg1").set("ylabelactive", true);
    model.result("pg1").set("ylabel", "\u7535\u6c60\u5355\u5143\u7535\u538b (V)");
    ...
    model.result("pg2").set("xlabel", "\u5f52\u4e00\u5316\u9897\u7c92\u5c3a\u5bf8 (1)");
    model.result("pg2").set("ylabelactive", true);
    model.result("pg2").set("ylabel", "\u5f52\u4e00\u5316\u9502\u6d53\u5ea6 (1)");
    model.result("pg2").run();
    model.result().duplicate("pg3", "pg2");
    model.result("pg3").run();
    model.result("pg3").label("\u6269\u6563\u8bf1\u5bfc\u5e94\u529b\uff0c\u5f84\u5411\u5206\u91cf");
    model.result("pg3").set("ylabel", "\u6269\u6563\u8bf1\u5bfc\u5e94\u529b\uff0c\u5f84\u5411\u5206\u91cf (Pa)");
    model.result("pg3").run();
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg4").label("\u6269\u6563\u8bf1\u5bfc\u5e94\u529b\uff0c\u5207\u5411\u5206\u91cf");
    model.result("pg4").set("ylabel", "\u6269\u6563\u8bf1\u5bfc\u5e94\u529b\uff0c\u5207\u5411\u5206\u91cf (Pa)");
    model.result("pg4").run();
    ...
    model.result("pg5").label("von Mises \u5e94\u529b");
    model.result("pg5").set("ylabel", "von Mises \u5e94\u529b (Pa)");
    model.result("pg5").run();
    ...
    model.result("pg8").label("\u603b\u5f39\u6027\u5e94\u53d8\u80fd\u5bc6\u5ea6");
    ...
    model.result("pg9").feature("ptgr1").set("descr", "\u8868\u9762 von Mises \u5e94\u529b");
    model.result("pg9").feature("ptgr1").set("legend", true);
    model.result("pg9").feature("ptgr1").set("legendmethod", "manual");
    model.result("pg9").feature("ptgr1").setIndex("legends", "\u96c6\u6d41\u4f53\u7aef", 0);
    model.result("pg9").feature("ptgr1").setIndex("legends", "\u9694\u819c\u7aef", 1);
    model.result("pg9").run();
    model.result("pg9").create("glob1", "Global");
    model.result("pg9").feature("glob1").set("markerpos", "datapoints");
    model.result("pg9").feature("glob1").set("linewidth", "preference");
    model.result("pg9").feature("glob1").set("expr", new String[]{"I_app"});
    model.result("pg9").feature("glob1")
         .set("descr", new String[]{"\u5916\u52a0\u7535\u6c60\u7535\u6d41\u5bc6\u5ea6"});
    model.result("pg9").feature("glob1").set("unit", new String[]{"A/m^2"});
    model.result("pg9").run();
    model.result("pg9").set("twoyaxes", true);
    model.result("pg9").setIndex("plotonsecyaxis", true, 1, 1);
    model.result("pg9").set("titletype", "manual");
    model.result("pg9").set("title", "\u8868\u9762 von Mises \u5e94\u529b\u548c\u5916\u52a0\u7535\u6d41");
    model.result("pg9").set("legendpos", "upperleft");
    model.result("pg9").run();

    model.title("\u9502\u79bb\u5b50\u7535\u6c60\u4e2d\u7684\u6269\u6563\u8bf1\u5bfc\u5e94\u529b");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u201c\u9502\u79bb\u5b50\u7535\u6c60\u201d\u63a5\u53e3\u5206\u6790\u9502\u79bb\u5b50\u7535\u6c60\u653e\u7535\u548c\u5f1b\u8c6b\u8fc7\u7a0b\u4e2d\uff0c\u8d1f\u6781\u57fa\u8d28\u6750\u6599\u7535\u6781\u9897\u7c92\u4e2d\u7684\u6269\u6563\u8bf1\u5bfc\u5e94\u529b\u3002\u5728\u57fa\u8d28\u6750\u6599\u9897\u7c92\u4e2d\u5d4c\u9502\u65f6\uff0c\u7531\u4e8e\u6210\u5206\u4e0d\u5747\u5300\uff0c\u4ece\u800c\u4ea7\u751f\u6269\u6563\u8bf1\u5bfc\u5e94\u529b\u548c\u5e94\u53d8\u3002\u5176\u4e2d\u91c7\u7528\u4e00\u7ef4\u51e0\u4f55\u7ed3\u6784\u548c\u7b49\u6e29\u6a21\u578b\u3002");
