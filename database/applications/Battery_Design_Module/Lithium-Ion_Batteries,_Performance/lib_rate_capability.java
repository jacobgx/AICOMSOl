...
public class lib_rate_capability {
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    ...
    model.param().descr("C_rate", "\u653e\u7535\u500d\u7387");

    model.component("comp1").geom("geom1").run();

    model.component("comp1").variable("var1").set("I_app", "-C_rate*I_1C");
    model.component("comp1").variable("var1").descr("I_app", "\u5916\u52a0\u7535\u6c60\u7535\u6d41\u5bc6\u5ea6");
    model.component("comp1").variable("var1").set("E_stop", "2.6[V]");
    model.component("comp1").variable("var1").descr("E_stop", "\u505c\u6b62\uff08\u9608\u503c\uff09\u7535\u538b");
    ...
    model.component("comp1").physics("ge").label("\u7d2f\u79ef\u80fd\u91cf");
  ...
  public static Model run3(Model model) {
    ...
    model.result().numerical("gev1").set("expr", new String[]{"W"});
    model.result().numerical("gev1").set("descr", new String[]{"\u72b6\u6001\u53d8\u91cf W"});
    model.result().create("pg7", "PlotGroup1D");
    model.result("pg7").set("data", "dset3");
    model.result("pg7").create("glob1", "Global");
    model.result("pg7").feature("glob1").set("expr", new String[]{"W"});
    model.result("pg7").feature("glob1").set("descr", new String[]{"\u72b6\u6001\u53d8\u91cf W"});
    model.result("pg2").run();
    model.result().create("pg8", "PlotGroup1D");
    model.result("pg8").run();
    model.result("pg8").label("\u7535\u6c60\u7535\u538b vs. SOC");
    model.result("pg8").set("data", "dset3");
    model.result("pg8").create("glob1", "Global");
    model.result("pg8").feature("glob1").set("markerpos", "datapoints");
    model.result("pg8").feature("glob1").set("linewidth", "preference");
    model.result("pg8").feature("glob1").set("expr", new String[]{"E_cell"});
    model.result("pg8").feature("glob1").set("descr", new String[]{"\u70b9\u63a2\u9488 1"});
    model.result("pg8").feature("glob1").set("unit", new String[]{"V"});
    model.result("pg8").feature("glob1").setIndex("descr", "\u7535\u6c60\u7535\u538b", 0);
    ...
    model.result("pg8").feature("glob2").set("expr", new String[]{"E_ocv_cell"});
    model.result("pg8").feature("glob2").set("descr", new String[]{"\u5f00\u8def\u7535\u6c60\u7535\u538b"});
    model.result("pg8").feature("glob2").set("unit", new String[]{"V"});
    ...
    model.result("pg8").set("ylabel", "\u7535\u6c60\u7535\u538b (V)");
    model.result("pg8").set("legendpos", "upperleft");
    model.result("pg8").run();
    model.result().numerical().create("gev2", "EvalGlobal");
    model.result().numerical("gev1").label("\u62c9\u8d21\u56fe\u6570\u636e\u8ba1\u7b97");
    ...
    model.result().numerical("gev1").setIndex("descr", "\u4f53\u79ef\u80fd\u91cf", 0);
    model.result().numerical("gev1").setIndex("expr", "W/t/(L_neg+L_sep+L_pos+L_ccs/2)", 1);
    model.result().numerical("gev1").setIndex("descr", "\u5e73\u5747\u4f53\u79ef\u529f\u7387", 1);
    model.result().table().create("tbl2", "Table");
    model.result().table("tbl2").comments("\u62c9\u8d21\u56fe\u6570\u636e\u8ba1\u7b97");
    model.result().numerical("gev1").set("table", "tbl2");
    model.result().numerical("gev1").setResult();
    model.result().table("tbl2").label("\u62c9\u8d21\u56fe\u6570\u636e\uff0c\u80fd\u91cf\u4f18\u5316\u7535\u6c60");
    model.result().create("pg9", "PlotGroup1D");
    model.result("pg9").run();
    model.result("pg9").label("\u62c9\u8d21\u56fe");
    ...
    model.result("pg9").feature("tblp1").set("plotcolumns", new int[]{3});
    model.result("pg9").feature("tblp1").set("legend", true);
    model.result("pg9").feature("tblp1").set("legendmethod", "manual");
    model.result("pg9").feature("tblp1").setIndex("legends", "\u80fd\u91cf\u4f18\u5316", 0);
    model.result("pg9").run();
    ...
    model.sol("sol10").label("\u53c2\u6570\u5316\u89e3 - \u80fd\u91cf\u4f18\u5316\u7535\u6c60");
    ...
    model.result().table("tbl3").comments("\u62c9\u8d21\u56fe\u6570\u636e\u8ba1\u7b97");
    model.result().numerical("gev1").set("table", "tbl3");
    model.result().numerical("gev1").setResult();
    model.result().table("tbl3").label("\u529f\u7387\u4f18\u5316\u7535\u6c60\u7684\u62c9\u8d21\u56fe\u6570\u636e");
    model.result("pg9").run();
    model.result("pg9").feature().duplicate("tblp2", "tblp1");
    model.result("pg9").run();
    model.result("pg9").feature("tblp2").set("table", "tbl3");
    model.result("pg9").feature("tblp2").setIndex("legends", "\u529f\u7387\u4f18\u5316", 0);
    model.result("pg9").run();
    model.result("pg6").run();
    model.result("pg6").run();
    model.result("pg4").run();
    ...
    model.title("\u9502\u79bb\u5b50\u7535\u6c60\u7684\u500d\u7387\u6027\u80fd");

    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u4f7f\u7528\u201c\u9502\u79bb\u5b50\u7535\u6c60\u201d\u63a5\u53e3\u5bf9\u7279\u5b9a\u7535\u6c60\u8bbe\u8ba1\u7684\u500d\u7387\u6027\u80fd\u8fdb\u884c\u7814\u7a76\uff0c\u8ba1\u7b97\u548c\u5206\u6790\u4e86\u201c\u80fd\u91cf\u548c\u529f\u7387\u201d\u8f93\u51fa\u3002");
