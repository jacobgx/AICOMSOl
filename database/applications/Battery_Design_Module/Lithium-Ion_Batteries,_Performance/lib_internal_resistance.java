...
public class lib_internal_resistance {
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    ...
    model.param("par2").label("\u53c2\u6570 - \u8109\u51b2");

//    To import content from file, use:
//    model.param("par2").loadFile("FILENAME");
    model.param("par2").set("t_pulse", "10[s]", "\u8109\u51b2\u65f6\u95f4");
    model.param("par2").set("t_rest", "20[s]", "\u8109\u51b2\u4e4b\u95f4\u7684\u4f11\u606f\u65f6\u95f4");
    model.param("par2").set("I_pulse", "10[A]", "\u8109\u51b2\u671f\u95f4\u7684\u7535\u6c60\u7535\u6d41");
    ...
    model.component("comp1").physics("ev").feature("ds1").setIndex("dim", "CH_DCH", 0, 0);
    ...
    model.component("comp1").physics("ev").feature("ds1")
         .setIndex("dimDescr", "State variable (=-1 for discharge, =0 for rest, =+1 for charge)", 0, 0);
    model.component("comp1").physics("ev").create("es1", "EventSequence", -1);
    model.component("comp1").physics("ev").feature("es1").feature("sm1").set("stateName", "DCH");
    model.component("comp1").physics("ev").feature("es1").feature("sm1").set("endConditionOptions", "duration");
    model.component("comp1").physics("ev").feature("es1").feature("sm1").set("duration", "t_pulse");
    model.component("comp1").physics("ev").feature("es1").feature("sm1").setIndex("reInitName", "CH_DCH", 0, 0);
    model.component("comp1").physics("ev").feature("es1").feature("sm1").setIndex("reInitValue", 0, 0, 0);
    model.component("comp1").physics("ev").feature("es1").create("sm2", "SequenceMember", -1);
    model.component("comp1").physics("ev").feature("es1").feature("sm2").set("stateName", "REST");
    model.component("comp1").physics("ev").feature("es1").feature("sm2").set("endConditionOptions", "duration");
    model.component("comp1").physics("ev").feature("es1").feature("sm2").set("duration", "t_rest");
    model.component("comp1").physics("ev").feature("es1").feature("sm2").setIndex("reInitName", "CH_DCH", 0, 0);
    model.component("comp1").physics("ev").feature("es1").feature("sm2").setIndex("reInitValue", 0, 0, 0);
    model.component("comp1").physics("ev").feature("es1").feature("sm2").setIndex("reInitValue", 1, 0, 0);

    model.component("comp1").variable("var1").set("I_app", "I_pulse/A_cell*CH_DCH");
    model.component("comp1").variable("var1").descr("I_app", "\u5916\u52a0\u7535\u6d41\u5bc6\u5ea6");
    model.component("comp1").variable("var1").set("R_internal", "E_pol_tot/(I_app*A_cell)");
    model.component("comp1").variable("var1").descr("R_internal", "\u5185\u963b");
    model.component("comp1").variable("var1").set("C_rate", "I_app/I_1C");
    model.component("comp1").variable("var1").descr("C_rate", "\u500d\u7387");
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg6").label("\u7535\u89e3\u8d28\u76d0\u6d53\u5ea6 (liion)");
    model.result("pg2").run();
    model.result("pg2").label("\u7535\u6c60\u7535\u538b\u548c\u7535\u6d41");
    model.result("pg2").create("glob1", "Global");
    model.result("pg2").feature("glob1").set("markerpos", "datapoints");
    model.result("pg2").feature("glob1").set("linewidth", "preference");
    model.result("pg2").feature("glob1").set("expr", new String[]{"C_rate"});
    model.result("pg2").feature("glob1").set("descr", new String[]{"\u500d\u7387"});
    ...
    model.result("pg7").label("\u5185\u963b");
    model.result("pg7").set("data", "dset3");
    model.result("pg7").create("glob1", "Global");
    model.result("pg7").feature("glob1").set("markerpos", "datapoints");
    model.result("pg7").feature("glob1").set("linewidth", "preference");
    model.result("pg7").feature("glob1").set("expr", new String[]{"R_internal"});
    model.result("pg7").feature("glob1").set("descr", new String[]{"\u5185\u963b"});
    model.result("pg7").feature("glob1").set("unit", new String[]{"\u03a9"});
...
//    model.component("comp1").variable("var2").loadFile("FILENAME");
    model.component("comp1").variable("var2")
         .set("E_act_neg", "intop_neg(liion.eta_per1*liion.iv_per1)/I_app", "\u7535\u6781\u6d3b\u5316\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_l_neg", "intop_neg(-philx*liion.Ilx)/I_app", "\u7535\u89e3\u8d28\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_s_neg", "intop_neg(-phisx*liion.Isx)/I_app", "\u7535\u6781\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_ocp_loc_neg", "mat2.def.Eeq(liion.socloc_average)", "\u9897\u7c92\u5e73\u5747\u5f00\u8def\u7535\u4f4d\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_conc_particle_neg", "intop_neg((liion.Eeq_per1-E_ocp_loc_neg)*liion.iv_per1)/I_app", "\u9897\u7c92\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_conc_electrode_neg", "intop_neg((E_ocp_loc_neg-E_ocp_neg)*liion.iv_per1)/I_app", "\u7535\u6781\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_conc_neg", "E_conc_electrode_neg+E_conc_particle_neg", "\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2")
         .set("E_l_sep", "intop_sep(-philx*liion.Ilx)/I_app", "\u7535\u89e3\u8d28\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u9694\u819c");
    model.component("comp1").variable("var2")
         .set("E_act_pos", "intop_pos(liion.eta_per1*liion.iv_per1)/I_app", "\u7535\u6781\u6d3b\u5316\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_l_pos", "intop_pos(-philx*liion.Ilx)/I_app", "\u7535\u89e3\u8d28\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_s_pos", "intop_pos(-phisx*liion.Isx)/I_app", "\u7535\u6781\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_ocp_loc_pos", "mat3.def.Eeq(liion.socloc_average)", "\u9897\u7c92\u5e73\u5747\u5f00\u8def\u7535\u4f4d\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_conc_particle_pos", "intop_pos((liion.Eeq_per1-E_ocp_loc_pos)*liion.iv_per1)/I_app", "\u9897\u7c92\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_conc_electrode_pos", "intop_pos((E_ocp_loc_pos-E_ocp_pos)*liion.iv_per1)/I_app", "\u7535\u6781\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_conc_pos", "E_conc_electrode_pos+E_conc_particle_pos", "\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.component("comp1").variable("var2")
         .set("E_neg", "E_act_neg+E_l_neg+E_s_neg+E_conc_particle_neg+E_conc_electrode_neg", "\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    model.component("comp1").variable("var2").set("E_sep", "E_l_sep", "\u7535\u538b\u635f\u5931\uff0c\u9694\u819c");
    model.component("comp1").variable("var2")
         .set("E_pos", "E_act_pos+E_l_pos+E_s_pos+E_conc_particle_pos+E_conc_electrode_pos", "\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");

    model.component("comp1").cpl().create("intop1", "Integration");
    model.component("comp1").cpl("intop1").set("axisym", true);
    model.component("comp1").cpl("intop1").set("opname", "intop_neg");
    ...
    model.component("comp1").cpl("intop3").set("opname", "intop_pos");
    ...
    model.result("pg8").label("\u7535\u538b\u635f\u5931\uff0c\u6240\u6709\u57df");
    ...
    model.result("pg8").feature("glob1").setIndex("looplevel", new int[]{1}, 1);
    model.result("pg8").feature("glob1").set("expr", new String[]{"E_neg"});
    model.result("pg8").feature("glob1").set("descr", new String[]{"\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781"});
    model.result("pg8").feature("glob1").set("expr", new String[]{"E_neg", "E_sep"});
    model.result("pg8").feature("glob1")
         .set("descr", new String[]{"\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u538b\u635f\u5931\uff0c\u9694\u819c"});
    model.result("pg8").feature("glob1").set("expr", new String[]{"E_neg", "E_sep", "E_pos"});
    model.result("pg8").feature("glob1")
         .set("descr", new String[]{"\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u538b\u635f\u5931\uff0c\u9694\u819c", "\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781"});
    ...
    model.result("pg8").run();
    model.result("pg8").feature("glob2").setIndex("looplevel", new int[]{2}, 1);
    ...
    model.result("pg9").label("\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781");
    ...
    model.result("pg9").feature("glob1").setIndex("looplevel", new int[]{1}, 1);
    model.result("pg9").feature("glob1").set("expr", new String[]{"E_s_neg"});
    model.result("pg9").feature("glob1")
         .set("descr", new String[]{"\u7535\u6781\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781"});
    model.result("pg9").feature("glob1").set("unit", new String[]{"V"});
    model.result("pg9").feature("glob1").set("expr", new String[]{"E_s_neg", "E_l_neg"});
    model.result("pg9").feature("glob1")
         .set("descr", new String[]{"\u7535\u6781\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u89e3\u8d28\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781"});
    model.result("pg9").feature("glob1").set("expr", new String[]{"E_s_neg", "E_l_neg", "E_act_neg"});
    model.result("pg9").feature("glob1")
         .set("descr", new String[]{"\u7535\u6781\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u89e3\u8d28\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u6781\u6d3b\u5316\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781"});
    model.result("pg9").feature("glob1").set("expr", new String[]{"E_s_neg", "E_l_neg", "E_act_neg", "E_conc_neg"});
    model.result("pg9").feature("glob1")
         .set("descr", new String[]{"\u7535\u6781\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u89e3\u8d28\u6b27\u59c6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u7535\u6781\u6d3b\u5316\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781", "\u6d53\u5ea6\u7535\u538b\u635f\u5931\uff0c\u8d1f\u6781"});
    model.result("pg9").run();
    ...
    model.result("pg9").run();
    model.result("pg9").feature("glob2").setIndex("looplevel", new int[]{2}, 1);
    ...
    model.result("pg9").set("ylabel", "\u7535\u538b (V)");
    ...
    model.result("pg10").label("\u7535\u538b\u635f\u5931\uff0c\u6b63\u6781");
    model.result("pg10").run();
    ...
    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u4f7f\u7528\u201c\u9502\u79bb\u5b50\u7535\u6c60\u201d\u63a5\u53e3\u6765\u6a21\u62df\u5728\u6df7\u5408\u8109\u51b2\u529f\u7387\u7279\u6027 (HPPC) \u6d4b\u8bd5\u4e2d\u65bd\u52a0\u5927\u7535\u6d41\u8109\u51b2\u65f6\u7684\u5185\u963b\u548c\u7535\u538b\u635f\u5931\u3002\u6b64\u5916\uff0c\u8fd8\u901a\u8fc7\u6539\u53d8\u4e0d\u540c\u7684\u8bbe\u8ba1\u53c2\u6570\uff0c\u5206\u6790\u4e86\u7535\u6c60\u5404\u90e8\u5206\u5bf9\u635f\u8017\u7684\u5f71\u54cd\u3002");
