...
public class li_ion_battery_impedance {
...
//    model.param().loadFile("FILENAME");
    ...
    model.param().set("sigmas_pos", "91[S/m]", "Electric conductivity, positive electrode");
    ...
    model.param()
         .set("soc0_neg", "0.326[1]", "Initial state of charge negative electrode equal to 1.55V vs Li+/Li(s)");
    model.param()
         .set("soc0_pos", "0.588[1]", "Initial state of charge positive electrode equal to 3.85V vs Li+/Li(s)");
    ...
    model.param()
         .set("cdlvol_cs_pos", "5e5", "Volumetric capacitance of electronic conductor in positive electrode");
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    model.component("comp1").variable("var1")
         .set("Z_ground", "-lindev(phis)/lindev(liion.nIs)+linpoint(R_curr)", "Impedance vs ground");
    model.component("comp1").variable("var1")
         .set("Z_ref_NCA", "-(lindev(phis)-lindev(RE_phi))/lindev(liion.nIs)+linpoint(R_curr)", "Impedance (NCA) positive electrode vs reference");
    model.component("comp1").variable("var1")
         .set("Z_ref_LTO", "Z_ground-Z_ref_NCA+linpoint(R_curr)", "Impedance (LTO) negative electrode vs reference");
    model.component("comp1").variable("var1")
         .set("E_cell_init", "mat3.def.Eeq(soc0_pos)-mat1.def.Eeq(soc0_neg)", "Initial cell voltage");
    ...
    model.component("comp1").geom("geom1").feature("i2").setIndex("coord", "L_neg", 0);
    model.component("comp1").geom("geom1").feature("i2").setIndex("coord", "L_neg+L_sep", 1);
    model.component("comp1").geom("geom1").run("i2");
    model.component("comp1").geom("geom1").create("i3", "Interval");
    model.component("comp1").geom("geom1").feature("i3").setIndex("coord", "L_neg+L_sep", 0);
    model.component("comp1").geom("geom1").feature("i3").setIndex("coord", "L_neg+L_sep+L_pos", 1);
    ...
    model.component("comp1").material("mat1").label("LTO, Li4Ti5O12 (Negative, Li-ion Battery)");
    ...
    model.component("comp1").material("mat1").propertyGroup("def").set("density", "3400[kg/m^3]");
    model.component("comp1").material("mat1").propertyGroup("def")
         .setPropertyInfo("density", "N. Nitta, F. Wu, J. Tae Lee, and G. Yushin, Materials Today, Volume 18, Number 5, June 2015");
    model.component("comp1").material("mat1").propertyGroup("def").set("csmax", "22852[mol/m^3]");
    ...
    model.component("comp1").material("mat1").propertyGroup("OperationalSOC").set("E_max", "1.8[V]");
    model.component("comp1").material("mat1").propertyGroup("OperationalSOC").set("E_min", "1.2[V]");
    model.component("comp1").material("mat1").propertyGroup("ic").identifier("is");
    model.component("comp1").material("mat1").propertyGroup("ic").set("dvol", "0");
  ...
  public static Model run2(Model model) {
    ...
    model.component("comp1").probe("pdom1").label("Reference Electrode (RE) Probe");
    model.component("comp1").probe("pdom1").setIndex("coords1", "L_neg+L_sep/2", 0);
    model.component("comp1").probe("pdom1").feature("ppb1").set("probename", "RE_phi");
    ...
    model.component("comp1").physics("liion").feature("pce1").feature("pin1")
         .set("csinit", "mat1.def.csmax*soc0_neg");
    ...
    model.component("comp1").physics("liion").feature("init1").set("phil", "-mat1.def.Eeq(soc0_neg)");
    ...
    model.component("comp1").physics("liion").feature("init2").set("phil", "-mat1.def.Eeq(soc0_neg)");
    model.component("comp1").physics("liion").feature("init2").set("cl", "cl_init");
    model.component("comp1").physics("liion").feature("init2")
         .set("phis", "mat3.def.Eeq(soc0_pos)-mat1.def.Eeq(soc0_neg)");
    ...
    model.result("pg2").feature("nyq1").set("unit", new String[]{""});
    model.result("pg2").feature("nyq1").set("expr", new String[]{"conj(liion.Zvsgrnd_pot1) "});
    model.result("pg2").feature("nyq1").set("descr", new String[]{""});
    ...
    model.result("pg3").feature("glob1").set("expr", new String[]{"real(conj(liion.Zvsgrnd_pot1)) "});
    ...
    model.result("pg3").feature("glob1").setIndex("descr", "Impedance_vs_ground_real_part", 0);
    ...
    model.result("pg4").feature("glob1").set("expr", new String[]{"imag(conj(liion.Zvsgrnd_pot1)) "});
    ...
    model.result("pg4").feature("glob1").setIndex("descr", "Impedance_vs_ground_imaginary_part", 0);
    ...
    model.result("pg5").set("xlabel", "Real Impedance [\u03a9m<sup>2</sup>]");
    model.result("pg5").set("ylabelactive", true);
    model.result("pg5").set("ylabel", "Imaginary Impedance [\u03a9m<sup>2</sup>]");
    ...
    model.result("pg6").set("xlabel", "Real Impedance [\u03a9m<sup>2</sup>]");
    model.result("pg6").set("ylabelactive", true);
    model.result("pg6").set("ylabel", "Imaginary Impedance [\u03a9m<sup>2</sup>]");
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg6").feature("tblp1").set("plotcolumns", new int[]{3});
    ...
    model.result("pg7").set("ylabel", "Impedance [\u03a9m<sup>2</sup>]");
    ...
    model.result("pg7").feature("tblp1").set("plotcolumns", new int[]{4});
    ...
    model.result("pg8").set("ylabel", "Impedance [\u03a9m<sup>2</sup>]");
    ...
    model.result("pg8").feature("tblp1").set("plotcolumns", new int[]{4});
    ...
    model.setExpectedComputationTime("52 \u79d2");
    ...
    model.result().report("rpt1").feature("tp1")
         .set("summary", "\u8fd9\u4e2a App \u63cf\u8ff0\u4e86 LTO/NCA \u76f8\u5bf9\u4e8e\u53c2\u8003\u7535\u6781\u7684\u9502\u79bb\u5b50\u7535\u6c60\u7684\u963b\u6297\uff0c\u5176\u4e2d\u4f7f\u7528\u4e86\u4e00\u4e2a\u5168\u5c40\u6700\u5c0f\u4e8c\u4e58\u76ee\u6807\u7684\u4f18\u5316\u63a5\u53e3\u62df\u5408\u5b9e\u9a8c\u6d4b\u5b9a\u503c\u3002\n\n\u9700\u8981\u7535\u6c60\u6a21\u5757\u548c\u4f18\u5316\u6a21\u5757\u3002");
    ...
    model.result().report("rpt1").feature("sec3").feature("pg1")
         .label("\u8ba1\u7b97\u53c2\u6570\u7684 Nyquist \u56fe");
    ...
    model.result().report("rpt1").feature("sec3").feature("pg2").label("\u8ba1\u7b97\u53c2\u6570\u7684 Bode \u56fe");
    ...
    model.result().report("rpt1").feature("sec3").feature("mtbl1")
         .label("\u7528\u6237\u8bbe\u5b9a\u548c\u8ba1\u7b97\u7684\u53c2\u6570\u503c");
    model.result().report("rpt1").feature("sec3").feature("mtbl1").set("noderef", "tbl5");
    model.result().report("rpt1").feature("sec2").feature("param1")
         .label("\u53c2\u6570\uff0c\u5185\u5d4c\u6a21\u578b");
    model.result().report("rpt1").feature("sec2").feature("mtbl1").label("\u5b9e\u9a8c\u6570\u636e");

    model.title("\u9502\u79bb\u5b50\u7535\u6c60\u963b\u6297");

    model
         .description("\u672c App \u7684\u76ee\u7684\u662f\u89e3\u91ca\u5b9e\u9a8c\u7535\u5316\u5b66\u963b\u6297\u8c31 (EIS) \u6d4b\u91cf\uff0c\u5e76\u6f14\u793a\u5982\u4f55\u7ed3\u5408\u4f7f\u7528\u4eff\u771f App \u548c\u6d4b\u91cf\u6570\u636e\u6765\u8bc4\u4f30\u9502\u79bb\u5b50\u7535\u6c60\u7684\u5c5e\u6027\u3002\n\n\u8be5 App \u4ece EIS \u5b9e\u9a8c\u4e2d\u83b7\u53d6\u6d4b\u91cf\u6570\u636e\u5e76\u5c06\u5176\u7528\u4f5c\u8f93\u5165\u3002\u7136\u540e\uff0c\u5bf9\u8fd9\u4e9b\u6d4b\u91cf\u503c\u8fdb\u884c\u6a21\u62df\uff0c\u5e76\u57fa\u4e8e\u5b9e\u9a8c\u6570\u636e\u8fdb\u884c\u53c2\u6570\u4f30\u8ba1\u3002\n\n\u63a7\u5236\u53c2\u6570\u5305\u62ec\uff1a\u4ea4\u6362\u7535\u6d41\u5bc6\u5ea6\u3001\u56fa\u4f53\u7535\u89e3\u8d28\u754c\u9762\u5bf9\u9897\u7c92\u7684\u7535\u963b\u7387\u3001NCA \u7684\u53cc\u7535\u5c42\u7535\u5bb9\u3001\u6b63\u6781\u4e2d\u78b3\u8f7d\u4f53\u7684\u53cc\u7535\u5c42\u7535\u5bb9\u4ee5\u53ca\u6b63\u6781\u4e2d\u9502\u79bb\u5b50\u7684\u6269\u6563\u7cfb\u6570\u3002\u672c\u4f8b\u5728 10\u00a0mHz \u5230 1\u00a0kHz \u7684\u9891\u7387\u8303\u56f4\u5185\u5bf9\u6d4b\u5f97\u7684\u6b63\u6781\u963b\u6297\u8fdb\u884c\u62df\u5408\u3002");
