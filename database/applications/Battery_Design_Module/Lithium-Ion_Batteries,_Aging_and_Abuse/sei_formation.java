...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
    ...
    model.component("comp1").physics("liion").feature("cdc1").set("Vmin", "E_min");
    ...
    model.component("comp1").physics("liion").feature("cdc1").set("Vmax", "E_max");
    model.component("comp1").physics("liion").feature("cdc1").set("item.CVCH", true);
    model.component("comp1").physics("liion").feature("cdc1").set("iupper", "I_upper");
    model.component("comp1").physics("liion").feature("cdc1").set("StartWith", "Charge_first");

    model.study("std1").feature("time").set("tlist", "range(0,180,10000)");
    ...
    model.result("pg1").feature("glob2").setIndex("descr", "\u7535\u6c60\u7535\u4f4d", 0);
    model.result("pg1").run();
    model.result("pg1").run();
    ...
    model.component("comp1").physics("liion").feature("pce1").setIndex("rhos", 8960, 0, 0);
    model.component("comp1").physics("liion").feature("pce1").setIndex("Ms", 0.06355, 0, 0);
    model.component("comp1").physics("liion").feature("pce1").setIndex("Species", "sei", 0, 0);
    model.component("comp1").physics("liion").feature("pce1").setIndex("rhos", "rho_sei", 0, 0);
    model.component("comp1").physics("liion").feature("pce1").setIndex("Ms", "M_sei", 0, 0);
    model.component("comp1").physics("liion").feature("pce1").set("AddVolumeChangeToElectrodeVolumeFraction", false);
    model.component("comp1").physics("liion").feature("pce1").set("FilmResistanceType", "ThicknessAndConductivity");
    model.component("comp1").physics("liion").feature("pce1").set("sf0", "dfilm_0");
    model.component("comp1").physics("liion").feature("pce1").set("dsf_src", "root.comp1.liion.sbtot_pce1");
    model.component("comp1").physics("liion").feature("pce1").set("sigmaf", "kappa_film");
    ...
    model.component("comp1").physics("liion").feature("pce1").feature("per2").set("ilocmat_mat", "userdef");
    model.component("comp1").physics("liion").feature("pce1").feature("per2").set("ilocmat", "I_SEI");
    model.component("comp1").physics("liion").feature("pce1").feature("per2").set("VLiTheta", "-(t_factor-1)");
    model.component("comp1").physics("liion").feature("pce1").feature("per2").setIndex("Vib", "t_factor", 0, 0);
    ...
    model.study("std1").feature("cdi").set("disabledphysics", new String[]{"liion/pce1/per2"});
    model.study("std1").feature("time").set("tlist", "range(0,180,t_cycling)");
    ...
    model.sol("sol1").feature("t1").feature("st1").setIndex("stopcondActive", true, 0);
    model.sol("sol1").feature("t1").feature("st1").setIndex("stopconddesc", "\u505c\u6b62\u8868\u8fbe\u5f0f 1", 0);
    model.sol("sol1").feature("t1").feature("st1").setIndex("stopcondarr", "comp1.cycle_no>(no_cycles-0.5)", 0);
    ...
    model.result("pg2").label("\u653e\u7535\u66f2\u7ebf\u5bf9\u6bd4");
    model.result("pg2").set("titletype", "manual");
    model.result("pg2").set("title", "\u989c\u8272\u56fe\u4f8b\uff1a\u5faa\u73af\u6b21\u6570");
  ...
  public static Model run3(Model model) {
    ...
    model.result("pg2").feature("glob1").setIndex("descr", "\u653e\u7535\u7535\u538b", 0);
    ...
    model.result("pg3").label("1C \u65f6\u7684 SEI \u5c42\u7535\u4f4d\u964d");
    model.result("pg3").set("titletype", "label");
    model.result("pg3").set("ylabelactive", true);
    model.result("pg3").set("ylabel", "\u6cbf SEI \u5c42\u7684\u7535\u4f4d\u964d (V)");
    ...
    model.result("pg3").feature("ptgr1").setIndex("legends", "\u8d1f\u6781-\u96c6\u6d41\u4f53\u5904", 0);
    ...
    model.result("pg3").feature("ptgr2").setIndex("legends", "\u8d1f\u6781-\u9694\u819c\u5904", 0);
    model.result("pg3").run();
    model.result("pg3").run();
    model.result().duplicate("pg4", "pg3");
    model.result("pg4").run();
    model.result("pg4").label("\u7535\u89e3\u8d28\u4f53\u79ef\u5206\u6570");
    model.result("pg4").set("ylabel", "\u7535\u89e3\u8d28\u4f53\u79ef\u5206\u6570 (1)");
    model.result("pg4").run();
    ...
    model.result("pg5").label("\u5bb9\u91cf vs. \u65f6\u95f4");
    model.result("pg5").set("titletype", "none");
    model.result("pg5").set("xlabelactive", true);
    model.result("pg5").set("xlabel", "\u65f6\u95f4\uff08\u5929\uff09 (d)");
    model.result("pg5").set("ylabelactive", true);
    model.result("pg5").set("ylabel", "\u76f8\u5bf9\u5bb9\u91cf (1)");
    model.result("pg5").create("glob1", "Global");
    model.result("pg5").feature("glob1").set("markerpos", "datapoints");
    model.result("pg5").feature("glob1").set("linewidth", "preference");
    model.result("pg5").feature("glob1").set("expr", new String[]{"liion.SOH_cell"});
    model.result("pg5").feature("glob1").set("descr", new String[]{"\u7535\u6c60\u5065\u5eb7\u72b6\u6001"});
    ...
    model.result("pg5").feature("glob1").set("xdatadescr", "\u65f6\u95f4\uff08\u5929\uff09");
    model.result("pg5").feature("glob1").set("legendmethod", "manual");
    model.result("pg5").feature("glob1").setIndex("legends", "\u57fa\u4e8e\u53ef\u5faa\u73af\u9502", 0);
    ...
    model.result("pg5").feature("glob2").setIndex("legends", "\u6807\u79f0 1C \u653e\u7535\u5bb9\u91cf", 0);
    model.result("pg5").run();
    model.result("pg5").feature("glob2").feature("filt1").set("expr", "ch_start_filter_cycled_once");
    model.result("pg5").run();
    model.result("pg5").run();
    model.result().duplicate("pg6", "pg5");
    model.result("pg6").run();
    model.result("pg6").label("\u5bb9\u91cf vs. \u5faa\u73af\u6b21\u6570");
    model.result("pg6").set("xlabel", "\u5faa\u73af\u6b21\u6570 (1)");
    model.result("pg6").run();
    ...
    model.result("pg7").label("\u9694\u819c-\u7535\u6781\u754c\u9762\u7684\u5c40\u90e8\u8377\u7535\u72b6\u6001");
    ...
    model.result("pg7").feature("ptgr1").setIndex("legends", "\u8d1f\u6781 - \u7b2c\u4e00\u4e2a\u5faa\u73af", 0);
    ...
    model.result("pg7").feature("ptgr2").setIndex("legends", "\u6b63\u6781 - \u7b2c\u4e00\u4e2a\u5faa\u73af", 0);
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("ptgr3", "ptgr1");
    model.result("pg7").run();
    model.result("pg7").feature("ptgr3")
         .setIndex("legends", "\u8d1f\u6781 - \u6700\u540e\u4e00\u4e2a\u5faa\u73af", 0);
    model.result("pg7").run();
    model.result("pg7").feature("ptgr3").feature("filt1").set("expr", "last_cycle_filter");
    model.result("pg7").run();
    model.result("pg7").feature().duplicate("ptgr4", "ptgr2");
    model.result("pg7").run();
    model.result("pg7").feature("ptgr4")
         .setIndex("legends", "\u6b63\u6781 - \u6700\u540e\u4e00\u4e2a\u5faa\u73af", 0);
    model.result("pg7").run();
    model.result("pg7").feature("ptgr4").feature("filt1").set("expr", "last_cycle_filter");
    model.result("pg7").run();

    model.title("\u9502\u79bb\u5b50\u7535\u6c60\u4e2d SEI \u7684\u5f62\u6210");

    model
         .description("\u8fd9\u4e2a\u4e00\u7ef4\u6a21\u578b\u6f14\u793a\u5982\u4f55\u6a21\u62df\u9502\u79bb\u5b50\u7535\u6c60\u7684\u77f3\u58a8\u7535\u6781\u56e0 SEI\uff08\u56fa\u4f53-\u7535\u89e3\u8d28\u754c\u9762\uff09\u7684\u5f62\u6210\u5bfc\u81f4\u7684\u7535\u6c60\u8001\u5316\u3002\u5176\u4e2d\u4f7f\u7528\u201c\u5145\u653e\u7535\u5faa\u73af\u201d\u7279\u5f81\u5b9e\u73b0\u6052\u538b\u4e0e\u6052\u6d41\u64cd\u4f5c\u7684\u5207\u6362\uff0c\u4ee5\u53ca\u5145\u7535\u4e0e\u653e\u7535\u7684\u5207\u6362\u3002\n\n\u7531\u4e8e\u5bc4\u751f\u9502/\u6eb6\u5242 SEI \u5f62\u6210\u8fd8\u539f\u53cd\u5e94\uff0c\u4f7f\u5f97\u8d1f\u6781\u7684\u53ef\u5faa\u73af\u9502\u4ea7\u751f\u635f\u8017\uff0c\u540c\u65f6 SEI \u5c42\u7684\u7535\u963b\u4e5f\u968f\u4e4b\u589e\u52a0\u3002");

    model.label("sei_formation.mph");
