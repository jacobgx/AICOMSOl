...
public class nmc_electrode_geometry {
...
//    model.param().loadFile("FILENAME");
    ...
    model.result().table("tbl1")
         .importData("H:\\hub\\root\\build\\patch\\daily\\locales\\zh_CN\\applications.compact\\Battery_Design_Module\\Heterogeneous_Models\\nmc_electrode_particle_data.txt");
...
//    Started method call GenerateGeometryFromTable
  ...
  public static Model run3(Model model) {
    ...
    model.param().set("Vp", "2.256304358567483E-14[m^3]");
    ...
    model.param().set("Ap", "1.1896260680820355E-8[m^2]");
