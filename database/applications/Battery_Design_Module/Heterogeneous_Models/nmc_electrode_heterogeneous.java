/*
 * nmc_electrode_heterogeneous.java
 */
...
public class nmc_electrode_heterogeneous {
...
//    model.param("par2").loadFile("FILENAME");
  ...
  public static Model run4(Model model) {
    ...
    model.component("comp1").material("mat1").selection().named("geom1_boxsel2");
    ...
    model.component("comp1").physics("liion").selection().named("geom1_unisel1");
    ...
    model.component("comp1").physics("liion").feature("sep1").set("ElectrolyteMaterial", "mat3");
    model.component("comp1").physics("liion").create("pcb1", "PorousConductiveBinder", 3);
    model.component("comp1").physics("liion").feature("pcb1").selection().named("geom1_comsel2");
    model.component("comp1").physics("liion").feature("pcb1").set("ElectrolyteMaterial", "mat3");
    model.component("comp1").physics("liion").feature("pcb1")
         .set("sigma", new String[]{"sigma_s", "0", "0", "0", "sigma_s", "0", "0", "0", "sigma_s"});
    model.component("comp1").physics("liion").feature("pcb1").set("epss", "eps_s_b");
    model.component("comp1").physics("liion").feature("pcb1").set("epsl", "eps_l_b");
    ...
    model.component("comp1").physics("liion").feature("bei1").selection().named("geom1_intsel1");
    ...
    model.component("comp1").physics("liion").feature("bei1").feature("er1").set("i0_ref", "i0_ref_NMC");
    model.component("comp1").physics("liion").create("es1", "ElectrodeSurface", 2);
    model.component("comp1").physics("liion").feature("es1").selection().named("geom1_boxsel2");
    model.component("comp1").physics("liion").feature("es1").feature("er1").set("i0_ref", "i0_ref_Li");
    ...
    model.component("comp1").physics("liion").feature("ec1").set("phis0init", "mat2.def.Eeq(cs0/csmax)");
    model.component("comp1").physics("liion").feature("init1").set("phis", "mat2.def.Eeq(cs0/csmax)");
    ...
    model.component("comp1").physics("tds").feature("init1").setIndex("initc", "cs0", 0);
    model.component("comp1").physics("tds").create("eeic1", "ElectrodeElectrolyteInterfaceCoupling", 2);
    model.component("comp1").physics("tds").feature("eeic1").selection().named("geom1_intsel1");
    ...
    model.component("comp1").probe("var1").label("\u5168\u5c40\u53d8\u91cf\u63a2\u9488 - E \u7535\u6c60");
    ...
    model.study("std1").label("\u7814\u7a76 1 - \u7535\u6c60\u653e\u7535");
    ...
    model.sol("sol1").feature("t1").feature("se1").feature("ss1")
         .set("segvar", new String[]{"comp1_phil", "comp1_phis", "comp1_liion_ec1_phis0"});
    model.sol("sol1").feature("t1").feature("se1").feature("ss3").set("segvar", new String[]{"comp1_cl"});
    ...
    model.result("pg1").label("\u653e\u7535\u7535\u538b");
    model.result("pg1").set("window", "window1");
    model.result("pg1").run();
    model.result().create("pg2", "PlotGroup3D");
    model.result("pg2").run();
    model.result("pg2").label("\u56fa\u6001\u9502\u6d53\u5ea6\u548c\u9502\u79bb\u5b50\u901a\u91cf");
    ...
    model.component("comp1").physics("liion").feature("ec1").create("hp1", "HarmonicPerturbation", 2);
    model.component("comp1").physics("liion").feature("ec1").feature("hp1").set("deltaIts", "I_1C/100");
    model.component("comp1").physics("liion").feature("bei1").create("dlc1", "DoubleLayerCapacitance", 2);
    model.component("comp1").physics("liion").feature("bei1").feature("dlc1").set("Cdl", "C_dl_NMC");
    model.component("comp1").physics("liion").feature("bei1").feature("dlc1").set("VLiPlus", -1);

    model.param("par2").set("socinit", "socmin*0+0.5");

    model.study().create("std2");
    model.study("std2").label("\u7814\u7a76 2 - EIS");
    ...
    model.result("pg3").feature("nyq1").set("unit", new String[]{""});
    model.result("pg3").feature("nyq1").set("expr", new String[]{"conj(liion.Zvsgrnd_ec1) "});
    model.result("pg3").feature("nyq1").set("descr", new String[]{""});
    model.result("pg3").label("\u5bf9\u5730\u963b\u6297\uff0c\u5948\u594e\u65af\u7279 (liion)");
    model.result("pg3").feature("nyq1").setIndex("descr", "\u5bf9\u5730\u963b\u6297", 0);
    ...
    model.result("pg4").feature("glob1").set("expr", new String[]{"real(conj(liion.Zvsgrnd_ec1)) "});
    model.result("pg4").feature("glob1").set("descr", new String[]{""});
    model.result("pg4").label("\u5bf9\u5730\u963b\u6297\uff0c\u5b9e\u90e8 (liion)");
    model.result("pg4").feature("glob1").setIndex("descr", "Impedance_vs_ground_real_part", 0);
    ...
    model.result("pg5").feature("glob1").set("expr", new String[]{"imag(conj(liion.Zvsgrnd_ec1)) "});
    model.result("pg5").feature("glob1").set("descr", new String[]{""});
    model.result("pg5").label("\u5bf9\u5730\u963b\u6297\uff0c\u865a\u90e8 (liion)");
    model.result("pg5").feature("glob1").setIndex("descr", "Impedance_vs_ground_imaginary_part", 0);
    ...
    model.result("pg6").label("\u6d53\u5ea6, \u6d41\u7ebf (tds)");
    model.result("pg6").set("titletype", "custom");
    model.result("pg6").set("typeintitle", true);
    model.result("pg6").set("prefixintitle", "");
    model.result("pg6").create("str1", "Streamline");
    model.result("pg6").feature("str1").set("expr", new String[]{"tds.tflux_cx", "tds.tflux_cy", "tds.tflux_cz"});
    ...
    model.result("pg7").label("\u6d53\u5ea6, \u8868\u9762 (tds)");
    ...
    model.result("pg7").feature("surf1").set("expr", new String[]{"c"});
    model.result("pg7").feature("surf1").set("colortable", "Prism");
    model.result("pg3").run();
    model.result("pg3").run();

    model.param().create("par3");
    model.param("par3").label("\u56fa\u4f53\u529b\u5b66\u53c2\u6570");

//    To import content from file, use:
//    model.param("par3").loadFile("FILENAME");
    model.param("par3").set("rho_NMC", "4.53[g/cm^3]", "\u5bc6\u5ea6");
    model.param("par3").set("E_binder", "5[GPa]", "\u6768\u6c0f\u6a21\u91cf");
    model.param("par3").set("nu_binder", "0.25", "\u6cca\u677e\u6bd4");
    model.param("par3").set("rho_binder", "1000[kg/m^3]", "\u5bc6\u5ea6");
    model.param("par3").set("E_separator", "1[GPa]", "\u6768\u6c0f\u6a21\u91cf");
    model.param("par3").set("nu_separator", "0.25", "\u6cca\u677e\u6bd4");
    model.param("par3").set("rho_separator", "1000[kg/m^3]", "\u5bc6\u5ea6");
    model.param("par3")
         .set("t_param", "1", "\u56fa\u4f53\u529b\u5b66\u5206\u6790\u7684\u65f6\u95f4\u53c2\u6570\uff08\u5355\u4f4d\uff1a\u5c0f\u65f6\uff09");
    ...
    model.component("comp1").physics("solid").feature("lemm1").set("E", "E_separator");
  ...
  public static Model run5(Model model) {
    model.component("comp1").physics("solid").feature("lemm1").set("nu", "nu_separator");
    model.component("comp1").physics("solid").feature("lemm1").set("rho_mat", "userdef");
    model.component("comp1").physics("solid").feature("lemm1").set("rho", "rho_separator");
    model.component("comp1").physics("solid").create("lemm2", "LinearElasticModel", 3);
    model.component("comp1").physics("solid").feature("lemm2")
         .label("\u7ebf\u5f39\u6027\u6750\u6599 - \u9ecf\u5408\u5242");
    model.component("comp1").physics("solid").feature("lemm2").selection().named("geom1_comsel2");
    model.component("comp1").physics("solid").feature("lemm2").set("E_mat", "userdef");
    model.component("comp1").physics("solid").feature("lemm2").set("E", "E_binder");
    model.component("comp1").physics("solid").feature("lemm2").set("nu_mat", "userdef");
    model.component("comp1").physics("solid").feature("lemm2").set("nu", "nu_binder");
    model.component("comp1").physics("solid").feature("lemm2").set("rho_mat", "userdef");
    model.component("comp1").physics("solid").feature("lemm2").set("rho", "rho_binder");
    model.component("comp1").physics("solid").create("lemm3", "LinearElasticModel", 3);
    model.component("comp1").physics("solid").feature("lemm3")
         .label("\u7ebf\u5f39\u6027\u6750\u6599 - \u9897\u7c92");
    model.component("comp1").physics("solid").feature("lemm3").selection().named("geom1_uni1_dom");
    model.component("comp1").physics("solid").feature("lemm3").set("rho_mat", "userdef");
    model.component("comp1").physics("solid").feature("lemm3").set("rho", "rho_NMC");
    model.component("comp1").physics("solid").feature("lemm3").create("ic1", "IntercalationStrain", 3);
    model.component("comp1").physics("solid").feature("lemm3").feature("ic1")
         .set("minput_concentration_src", "root.comp1.c");
    model.component("comp1").physics("solid").create("roll1", "Roller", 2);
    model.component("comp1").physics("solid").feature("roll1").selection().named("geom1_adjsel3");
    ...
    model.study("std3").label("\u7814\u7a76 3 - \u56fa\u4f53\u529b\u5b66");
    ...
    model.study("std3").feature("stat").label("\u7a33\u6001 - \u56fa\u4f53\u529b\u5b66");
    ...
    model.study("std2").feature("frlin").setSolveFor("/physics/solid", false);
    ...
    model.title("\u5f02\u8d28 NMC \u7535\u6781");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u201c\u6a21\u578b\u65b9\u6cd5\u201d\uff0c\u6839\u636e\u65ad\u5c42\u626b\u63cf\u6570\u636e\u751f\u6210\u5f02\u8d28 NMC\uff08\u954d-\u9530-\u94b4\uff09\u7535\u6781\u7ed3\u6784\u3002\n\n\u968f\u540e\uff0c\u5728\u5168\u4e09\u7ef4\u51e0\u4f55\u4e2d\u8fdb\u884c\u77ac\u6001\u653e\u7535\u548c\u7535\u5316\u5b66\u963b\u6297\u8c31 (EIS) \u4eff\u771f\u3002\n\n\u6b64\u5916\uff0c\u8fd8\u901a\u8fc7\u56fa\u4f53\u529b\u5b66\u4eff\u771f\u6765\u7814\u7a76\u7535\u6781\u81a8\u80c0/\u6536\u7f29\u5bf9\u9897\u7c92\u548c\u9ecf\u5408\u5242\u5e94\u529b\u7684\u5f71\u54cd\u3002");
