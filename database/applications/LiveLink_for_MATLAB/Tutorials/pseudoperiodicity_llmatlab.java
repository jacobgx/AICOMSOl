/*
 * pseudoperiodicity_llmatlab.java
 */
...
public class pseudoperiodicity_llmatlab {
  ...
  public static Model run() {
    ...
    model.param().descr("R", "Pipe radius");
    model.param().set("u0", "1[cm/s]");
    model.param().descr("u0", "Maximum velocity");
    model.param().set("T0", "283.15[K]");
    model.param().descr("T0", "Inlet temperature");
    model.param().set("q0", "100[W/m^2]");
    model.param().descr("q0", "Inward heat flux");
    ...
    model.component("comp1").variable("var1").descr("r", "Radius parameter");

    model.component("comp1").geom("geom1").create("cyl1", "Cylinder");
    model.component("comp1").geom("geom1").feature("cyl1").set("r", "R");
    model.component("comp1").geom("geom1").feature("cyl1").set("h", "10*R");
    ...
    model.component("comp1").physics("ht").feature("fluid1").set("u", new String[]{"(1-r/R)^2*u0", "0", "0"});
    ...
    model.component("comp1").physics("ht").feature("hf1").selection().set(2, 3, 4, 5);
    ...
    model.component("comp1").mesh("mesh1").feature("ftri1").feature("dis1").selection().set(1, 4);
    model.component("comp1").mesh("mesh1").feature("ftri1").feature("dis1").set("numelem", 15);
    model.component("comp1").mesh("mesh1").feature("size").set("hauto", 1);
    model.component("comp1").mesh("mesh1").create("swe1", "Sweep");
    model.component("comp1").mesh("mesh1").run();

    model.title("\u4f2a\u5468\u671f\u6027\u5bf9\u6d41\u4f20\u70ed");

    model
         .description("\u672c\u4f8b\u6a21\u62df\u5145\u6ee1\u6c34\u7684\u901a\u9053\u4e2d\u7684\u5bf9\u6d41\u4f20\u70ed\u8fc7\u7a0b\u3002\u4e3a\u51cf\u5c11\u5185\u5b58\u9700\u6c42\uff0c\u8be5\u6a21\u578b\u5728\u901a\u9053\u7684\u4e00\u4e2a\u4f2a\u5468\u671f\u6bb5\u4e0a\u8fdb\u884c\u591a\u6b21\u6c42\u89e3\u3002\u6bcf\u4e2a\u89e3\u5bf9\u5e94\u4e8e\u4e0d\u540c\u7684\u6bb5\uff0c\u800c\u5728\u6bcf\u4e2a\u6c42\u89e3\u6b65\u9aa4\u5f00\u59cb\u524d\uff0c\u90fd\u4f1a\u5c06\u4e0a\u4e00\u4e2a\u89e3\u7684\u51fa\u53e3\u8fb9\u754c\u6e29\u5ea6\u6620\u5c04\u5230\u5165\u53e3\u8fb9\u754c\u3002");

    model.label("pseudoperiodicity_llmatlab.mph");
