/*
 * domain_activation_llmatlab.java
 */
...
public class domain_activation_llmatlab {
  ...
  public static Model run() {
    ...
    model.param().descr("L", "Side length of the base");
    model.param().set("l", "15[cm]");
    model.param().descr("l", "Side length of the plates");
    model.param().set("T0", "500[K]");
    model.param().descr("T0", "Initial temperature of the plates");
    model.param().set("h0", "50[W/(m^2*K)]");
    model.param().descr("h0", "Heat transfer coefficient");
    model.param().set("ds", "10[um]");
    model.param().descr("ds", "Contact gap thickness");
    model.param().set("ks", "2e-2[W/(m*K)]");
    model.param().descr("ks", "Thermal conductivity of air");
    model.param().set("period", "2[min]");
    model.param().descr("period", "Applied time per plate");
    model.param().set("t0", "0");
    model.param().descr("t0", "Initial time");
    model.param().set("dt", "5[s]");
    model.param().descr("dt", "Output time step");
    model.param().set("tf", "t0+period");
    model.param().descr("tf", "Final time");

    model.component("comp1").geom("geom1").create("blk1", "Block");
    model.component("comp1").geom("geom1").feature("blk1").set("size", new String[]{"L", "L", "L/10"});
    model.component("comp1").geom("geom1").run("blk1");
    model.component("comp1").geom("geom1").create("blk2", "Block");
    model.component("comp1").geom("geom1").feature("blk2").set("size", new String[]{"l", "l", "l/10"});
    model.component("comp1").geom("geom1").feature("blk2").set("pos", new String[]{"L/10", "L/10", "L/10"});
    ...
    model.component("comp1").geom("geom1").feature("arr1").set("displ", new String[]{"L/2", "L/2", "0"});
    ...
    model.component("comp1").selection("box1").set("xmin", "-1e-3");
    model.component("comp1").selection("box1").set("xmax", "L+1e-3");
    model.component("comp1").selection("box1").set("ymin", "-1e-3");
    model.component("comp1").selection("box1").set("ymax", "L+1e-3");
    model.component("comp1").selection("box1").set("zmin", "L/10-1e-3");
    model.component("comp1").selection("box1").set("zmax", "L/10+1e-3");
    ...
    model.component("comp1").selection("int1").set("input", new String[]{"adj1", "box1"});
    ...
    model.component("comp1").physics("ht").feature("sls1").selection().named("int1");

    model.component("comp1").material().create("mat3", "Common");
    model.component("comp1").material("mat3").selection().geom("geom1", 2);
    model.component("comp1").material("mat3").selection().named("box1");
    model.component("comp1").material("mat3").propertyGroup("def").set("thermalconductivity", new String[]{"ks"});
    model.component("comp1").material("mat3").propertyGroup("def").set("density", new String[]{"0"});
    model.component("comp1").material("mat3").propertyGroup("def").set("heatcapacity", new String[]{"0"});
    model.component("comp1").material("mat3").propertyGroup().create("shell", "shell", "Shell");
    model.component("comp1").material("mat3").propertyGroup("shell").set("lth", new String[]{"ds"});

    model.component("comp1").mesh("mesh1").create("fq1", "FreeQuad");
    model.component("comp1").mesh("mesh1").feature("fq1").selection().named("box1");
    model.component("comp1").mesh("mesh1").create("swe1", "Sweep");
    model.component("comp1").mesh("mesh1").feature("swe1").create("dis1", "Distribution");
    model.component("comp1").mesh("mesh1").feature("swe1").feature("dis1").selection().set(2, 3, 4, 5);
    ...
    model.title("\u6c42\u89e3\u57df\u6fc0\u6d3b\u548c\u5931\u6d3b");

    model
         .description("\u8fd9\u4e2a\u77ac\u6001\u4f20\u70ed\u95ee\u9898\u793a\u4f8b\u901a\u8fc7\u4f7f\u7528\u57df\u6fc0\u6d3b\u548c\u5931\u6d3b\u5b9e\u73b0\u4e86\u4ea4\u53d8\u533a\u7684\u4f20\u70ed\u3002");

    model.label("domain_activation_llmatlab.mph");
