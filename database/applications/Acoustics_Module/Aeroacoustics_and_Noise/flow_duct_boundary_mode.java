...
public class flow_duct_boundary_mode {
...
//    model.param().loadFile("FILENAME");
    ...
    model.param().set("M", "-0.5", "\u5e73\u5747\u9a6c\u8d6b\u6570");
    model.param().set("m", "10", "\u65b9\u4f4d\u89d2\u6a21\u5f0f\u6570");
    ...
    model.param().set("zi", "1.86393", "\u5165\u53e3\u5e73\u9762\u8f74\u5411\u5750\u6807");
    model.param().set("ri", "0.91705", "\u5165\u53e3\u5e73\u9762\u5f84\u5411\u5750\u6807");
    ...
    model.component("comp1").cpl("intop2").set("opname", "intop_tp");
    ...
    model.result("pg4").run();
    model.result("pg4").run();
    model.result("pg4").set("looplevel", new int[]{2, 2});
    model.result("pg4").run();
    model.result("pg4").set("looplevel", new int[]{3, 2});
    model.result("pg4").run();
    model.result("pg4").set("looplevel", new int[]{4, 2});
    model.result("pg4").run();
    ...
    model.study("std3").feature("mode").setIndex("filtereigexpression", "comp1.intop_tp(comp1.lpfbm2.Iz)", 0);
    model.study("std3").feature("mode").setIndex("filtereigdescription", "Outgoing modes only", 0);
    ...
    model.result("pg8").label("\u58f0\u538b (lpfbm2)");
    ...
    model.result("pg8").feature("line1").label("\u7ebf");
    ...
    model.result("pg9").label("\u58f0\u538b\uff0c\u4e09\u7ef4 (lpfbm2)");
    ...
    model.result("pg8").label("\u7ec8\u7aef\u5e73\u9762\uff1a\u58f0\u538b\u548c\u8f74\u5411\u5f3a\u5ea6");
    ...
    model.result("pg8").feature("arwl1").set("expr", new String[]{"lpfbm2.Ir", "lpfbm2.Iz"});
    model.result("pg8").feature("arwl1").set("descr", "\u5f3a\u5ea6");
    model.result("pg8").feature("arwl1").set("expr", new String[]{"0", "lpfbm2.Iz"});
    model.result("pg8").feature("arwl1").set("arrowcount", 30);
    model.result("pg8").feature("arwl1").set("arrowlength", "logarithmic");
    model.result("pg8").run();
    model.result("pg8").run();
    model.result("pg8").set("looplevel", new int[]{2, 2});
    model.result("pg8").run();
    model.result().dataset("rev3").set("hasspacevars", true);
    model.result().dataset("rev3").set("layermethod", "fine");
    model.result("pg9").run();
    model.result("pg9").label("\u7ec8\u7aef\u5e73\u9762\uff1a\u58f0\u538b\uff0c\u4e09\u7ef4 (lpfbm2)");
    ...
    model.result("pg9").run();
    model.result("pg9").feature("surf1").set("expr", "lpfbm2.p*exp(-i*m*rev3phi)");
    model.result("pg9").run();
    model.result().create("pg10", "PlotGroup1D");
    model.result("pg10").run();
    model.result("pg10").label("\u7ec8\u7aef\u5e73\u9762\uff1a\u632f\u578b\uff0cM = 0");
  ...
  public static Model run2(Model model) {
    ...
    model.result("pg11").label("\u7ec8\u7aef\u5e73\u9762\uff1a\u632f\u578b\uff0cM = -0.5");
    ...
    model.component("comp1").physics("lpff").feature("port1").label("\u7aef\u53e3 1 (M = 0)");
    model.component("comp1").physics("lpff").feature("port1")
         .set("phi_o", "withsol('sol3',phi_sp,setval(M,0),setind(lambda,2))");
    model.component("comp1").physics("lpff").feature("port1")
         .set("kn_o", "withsol('sol3',lpfbm.kn,setval(M,0),setind(lambda,2))");
    model.component("comp1").physics("lpff").feature("port1").set("PortExcitation", "on");
    model.component("comp1").physics("lpff").feature("port1")
         .set("phi_i", "withsol('sol3',phi_sp,setval(M,0),setind(lambda,1))");
    model.component("comp1").physics("lpff").feature("port1")
         .set("kn_i", "withsol('sol3',lpfbm.kn,setval(M,0),setind(lambda,1))");
    ...
    model.component("comp1").physics("lpff").feature("port2").label("\u7aef\u53e3 2 (M = -0.5)");
    ...
    model.component("comp1").physics("lpff").feature("port2").set("PortExcitation", "on");
    model.component("comp1").physics("lpff").feature("port2")
         .set("phi_i", "withsol('sol3',phi_sp,setval(M,-0.5),setind(lambda,1))");
    model.component("comp1").physics("lpff").feature("port2")
         .set("kn_i", "withsol('sol3',lpfbm.kn,setval(M,-0.5),setind(lambda,1))");
    model.component("comp1").physics("lpff").feature("port2").set("IncidentWave", "ModeScale");
    model.component("comp1").physics("lpff").feature("port2").set("Sin", 1);
    model.component("comp1").physics("lpff").create("port3", "Port", 1);

    model.nodeGroup("grp1").add("port3");

    model.component("comp1").physics("lpff").feature("port3").selection().named("sel1");
    model.component("comp1").physics("lpff").feature("port3").label("\u7aef\u53e3 3 (M = -0.5)");
    model.component("comp1").physics("lpff").feature("port3")
         .set("phi_o", "withsol('sol3',phi_sp,setval(M,-0.5),setind(lambda,3))");
    model.component("comp1").physics("lpff").feature("port3")
         .set("kn_o", "withsol('sol3',lpfbm.kn,setval(M,-0.5),setind(lambda,3))");
    ...
    model.component("comp1").physics("lpff").feature("port4").label("\u7aef\u53e3 4 (M = 0)");
    model.component("comp1").physics("lpff").feature("port4").selection().named("sel3");
    model.component("comp1").physics("lpff").feature("port4")
         .set("phi_o", "withsol('sol7',phi_tp,setval(M,0),setind(lambda,1))");
    model.component("comp1").physics("lpff").feature("port4")
         .set("kn_o", "withsol('sol7',lpfbm2.kn,setval(M,0),setind(lambda,1))");
    model.component("comp1").physics("lpff").create("port5", "Port", 1);

    model.nodeGroup("grp2").add("port5");

    model.component("comp1").physics("lpff").feature("port5").selection().named("sel3");
    model.component("comp1").physics("lpff").feature("port5").label("\u7aef\u53e3 5 (M = -0.5)");
    model.component("comp1").physics("lpff").feature("port5")
         .set("phi_o", "withsol('sol7',phi_tp,setval(M,-0.5),setind(lambda,1))");
    model.component("comp1").physics("lpff").feature("port5")
         .set("kn_o", "withsol('sol7',lpfbm2.kn,setval(M,-0.5),setind(lambda,1))");
    model.component("comp1").physics("lpff").create("port6", "Port", 1);

    model.nodeGroup("grp2").add("port6");

    model.component("comp1").physics("lpff").feature("port6").selection().named("sel3");
    model.component("comp1").physics("lpff").feature("port6").label("\u7aef\u53e3 6 (M = -0.5)");
    model.component("comp1").physics("lpff").feature("port6")
         .set("phi_o", "withsol('sol7',phi_tp,setval(M,-0.5),setind(lambda,2))");
    model.component("comp1").physics("lpff").feature("port6")
         .set("kn_o", "withsol('sol7',lpfbm2.kn,setval(M,-0.5),setind(lambda,2))");
    ...
    model.study("std4").label("\u7814\u7a76 4 - \u9891\u57df\uff08M = 0\uff0c\u5e26\u886c\u57ab\uff09");
    ...
    model.study("std4").feature("freq")
         .set("disabledphysics", new String[]{"lpff/port2", "lpff/port3", "lpff/port5", "lpff/port6"});
    ...
    model.study("std5").label("\u7814\u7a76 5 - \u9891\u57df\uff08M = 0\uff0c\u786c\u58c1\uff09");
    ...
    model.study("std5").feature("freq")
         .set("disabledphysics", new String[]{"lpff/imp1", "lpff/port2", "lpff/port3", "lpff/port5", "lpff/port6"});
    ...
    model.study("std6").label("\u7814\u7a76 6 - \u9891\u57df\uff08M = -0.5\uff0c\u5e26\u886c\u57ab\uff09");
    model.study("std6").feature("freq").set("plist", "f");
    model.study("std6").feature("freq").set("useadvanceddisable", true);
    model.study("std6").feature("freq").set("disabledphysics", new String[]{"lpff/port1", "lpff/port4"});
    ...
    model.study("std7").label("\u7814\u7a76 7 - \u9891\u57df\uff08M = -0.5\uff0c\u786c\u58c1\uff09");
    model.study("std7").feature("freq").set("plist", "f");
    model.study("std7").feature("freq").set("useadvanceddisable", true);
    model.study("std7").feature("freq")
         .set("disabledphysics", new String[]{"lpff/imp1", "lpff/port1", "lpff/port4"});
    ...
    model.result("pg12").label("\u5f52\u4e00\u5316\u538b\u529b\uff1aM = 0\uff0c\u5e26\u886c\u57ab");
    ...
    model.result("pg12").feature("con1")
    ...
    model.result("pg13").label("\u5f52\u4e00\u5316\u538b\u529b\uff1aM = 0\uff0c\u786c\u58c1");
    ...
    model.result("pg15").label("\u5f52\u4e00\u5316\u538b\u529b\uff1aM = -0.5\uff0c\u786c\u58c1");
    ...
    model.result().evaluationGroup("eg1").feature("gev2")
         .setIndex("expr", "10*log10(lpff.port2.P_in/intop_ip(lpff.Iz))", 0);
    ...
    model.result().evaluationGroup("eg2").label("\u6e90\u5e73\u9762\uff1a\u6a21\u5f0f\u89e3\u7d22\u5f15");
    ...
    model.result().evaluationGroup("eg3").label("\u7ec8\u7aef\u5e73\u9762\uff1a\u6a21\u5f0f\u89e3\u7d22\u5f15");
    ...
    model.title("\u6d41\u7ba1 - \u8fb9\u754c\u6a21\u5f0f\u5206\u6790");

    model
         .description("\u672c\u4f8b\u5206\u6790\u57fa\u4e8e\u6a21\u6001\u58f0\u4f20\u8f93\u7684\u3001\u5e26\u6709\u5185\u886c\u7684\u8f74\u5bf9\u79f0\u822a\u7a7a\u53d1\u52a8\u673a\u5bfc\u7ba1\u6a21\u578b\u4e2d\u7684\u58f0\u573a\u3002\u5176\u4e2d\u901a\u8fc7\u8fb9\u754c\u5904\u7684\u5355\u6a21\u6001\u6fc0\u52b1\u4ea7\u751f\u58f0\u6e90\uff0c\u5e76\u4f7f\u7528\u7aef\u53e3\u8fb9\u754c\u6761\u4ef6\u6765\u5e94\u7528\u58f0\u6e90\u548c\u65e0\u53cd\u5c04\u6761\u4ef6\u3002\u6a21\u578b\u5206\u6790\u5305\u542b\u4e09\u4e2a\u6b65\u9aa4\uff1a\u9996\u5148\u8ba1\u7b97\u80cc\u666f\u5e73\u5747\u6d41\uff08\u53ef\u538b\u7f29\u65e0\u65cb\u52bf\u6d41\uff09\uff0c\u7136\u540e\u5229\u7528\u8fb9\u754c\u6a21\u5f0f\u5206\u6790\u6765\u5206\u6790\u4f20\u64ad\u6a21\u5f0f\uff0c\u6700\u540e\u4f7f\u7528\u7ebf\u6027\u52bf\u6d41\u65b9\u7a0b\u6c42\u89e3\u6d41\u7ba1\u4e2d\u7684\u58f0\u573a\u3002\u7ed3\u679c\u5c55\u793a\u4e86\u5728\u6709/\u65e0\u80cc\u666f\u6d41\u4ee5\u53ca\u786c\u58c1\u548c\u5185\u886c\u7ba1\u58c1\u60c5\u51b5\u4e0b\u7684\u8868\u73b0\u3002");
    ...
    model.label("flow_duct_boundary_mode.mph");
