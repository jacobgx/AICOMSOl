...
public class coupled_vibrations {
  ...
  public static Model run() {
    ...
    model.component("comp1").material("mat1").label("\u58f0\u5b66\u6750\u6599");
    ...
    model.component("comp1").material("mat2").label("\u7ed3\u6784\u6750\u6599");
    ...
    model.result("pg7").label("\u58f0\u538b\uff0c\u7b49\u503c\u9762 (acpr)");
    ...
    model.result("pg8").label("\u632f\u578b\uff0c\u8026\u5408\u5206\u6790");
    model.result("pg8").run();
    ...
    model.result("pg5").run();
    model.result("pg5").label("\u58f0\u538b\uff0c\u8026\u5408\u5206\u6790");
    model.result("pg6").run();
    model.result("pg6").label("\u58f0\u538b\u7ea7\uff0c\u8026\u5408\u5206\u6790");
    model.result("pg7").run();
    model.result("pg7").label("\u58f0\u538b\uff0c\u8026\u5408\u5206\u6790\uff0c\u7b49\u503c\u9762");
    model.result("pg8").run();
