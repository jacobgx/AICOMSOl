/*
 * porous_microchannel_heat_sink_optimization.java
 */
...
public class porous_microchannel_heat_sink_optimization {
...
//    model.component("comp1").variable("var1").loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.result().numerical("gev2").setIndex("descr", "\u54c1\u8d28\u56e0\u6570", 0);
    ...
    model.study("std3").feature("stat2").set("outputmap", new String[]{});
    ...
    model.result("pg13").label("\u6e29\u5ea6 (ht) 2");
    ...
    model.result("pg14").label("\u901f\u5ea6 (spf) 2");
    ...
    model.result("pg15").label("\u538b\u529b (spf) 2");
    ...
    model.result("pg16").label("\u6e29\u5ea6\u548c\u6d41\u4f53\u6d41\u52a8 (nitf1) 2");
    ...
    model.result("pg16").feature("surf1").label("\u58c1\u6e29");
    ...
    model.result("pg16").feature("vol1").label("\u56fa\u4f53\u6e29\u5ea6");
    ...
    model.result("pg16").feature("arwv1").label("\u6d41\u4f53\u6d41\u52a8");
    model.result("pg16").feature("arwv1").set("showsolutionparams", "on");
    model.result("pg16").feature("arwv1").set("solutionparams", "parent");
    model.result("pg16").feature("arwv1").set("expr", new String[]{"nitf1.ux", "nitf1.uy", "nitf1.uz"});
    ...
    model.result().table("tbl5").comments("\u5168\u5c40\u8ba1\u7b97 3");
    ...
    model.result("pg9").feature("tblp3").set("plotcolumns", new int[]{2});
    ...
    model.result("pg9").run();
    model.result("pg9").feature("tblp4").set("plotcolumns", new int[]{4});
    ...
    model.result("pg10").feature("tblp3").set("plotcolumns", new int[]{6});
    ...
    model.result("pg10").run();
    model.result("pg10").feature("tblp4").set("plotcolumns", new int[]{5});
    ...
    model.nodeGroup("grp3").label("\u4f18\u5316");

    model.result("pg11").run();

    model.title("\u591a\u5b54\u5fae\u901a\u9053\u6563\u70ed\u5668\u7684\u4f18\u5316");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u201c\u4f18\u5316\u6a21\u5757\u201d\u4f18\u5316\u591a\u5b54\u5fae\u901a\u9053\u6563\u70ed\u5668\u7684\u6027\u80fd\uff0c\u8ba1\u7b97\u4e86\u591a\u5b54\u57fa\u6750\u539a\u5ea6\u7684\u6700\u4f73\u503c\u3002\u672c\u4f8b\u5bf9\u201c\u5fae\u901a\u9053\u6563\u70ed\u5668\u7684\u6027\u80fd\u201d\u6a21\u578b\u8fdb\u884c\u6269\u5c55\uff0c\u5e76\u5c06\u7ed3\u679c\u4e0e\u539f\u59cb\u6a21\u578b\u7684\u53c2\u6570\u7814\u7a76\u7ed3\u679c\u8fdb\u884c\u6bd4\u8f83\u3002");
