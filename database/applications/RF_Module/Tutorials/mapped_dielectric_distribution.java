...
public class mapped_dielectric_distribution {
  ...
  public static Model run() {
    ...
    model.component("comp1").physics("emw").feature("wee2").selection().named("sel1");
    ...
    model.component("comp1").physics("emw").create("scu1", "SurfaceCurrent", 1);
    model.component("comp1").physics("emw").feature("scu1").selection().set(10);
    model.component("comp1").physics("emw").feature("scu1").set("Js0", new String[]{"0", "0", "exp(-(y/w0)^2)"});
    ...
    model
         .description("\u672c\u4f8b\u6f14\u793a\u5982\u4f55\u8bbe\u7f6e\u7a7a\u95f4\u53d8\u5316\u7684\u7535\u4ecb\u8d28\u5206\u5e03\u3002\u8fd9\u91cc\uff0c\u901a\u8fc7\u77e9\u5f62\u57df\u7684\u5df2\u77e5\u53d8\u5f62\u6765\u5b9a\u4e49\u51f8\u900f\u955c\u5f62\u72b6\u3002\u7535\u4ecb\u8d28\u5206\u5e03\u5b9a\u4e49\u5728\u672a\u53d8\u5f62\u7684\u539f\u59cb\u77e9\u5f62\u57df\u4e0a\uff0c\u5e76\u6620\u5c04\u5230\u900f\u955c\u5df2\u53d8\u5f62\u7684\u533a\u57df\u3002\u867d\u7136\u8fd9\u91cc\u5b9a\u4e49\u7684\u662f\u51f8\u900f\u955c\uff0c\u4f46\u7535\u4ecb\u8d28\u5206\u5e03\u4ecd\u4f1a\u4f7f\u5165\u5c04\u5149\u675f\u53d1\u6563\u3002");
