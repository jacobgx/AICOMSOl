/*
 * waveguide_filter_optimization_transformation.java
 */
...
public class waveguide_filter_optimization_transformation {
  ...
  public static Model run() {
    ...
    model.component("comp1").geom("geom1")
         .insertFile("waveguide_filter_optimization_transformation_geom_sequence.mph", "geom1");
    ...
    model.component("comp1").physics("emw").feature("port1").selection().named("geom1_boxsel3");
    ...
    model.component("comp1").physics("emw").feature("port2").selection().named("geom1_boxsel4");
    ...
    model.component("comp1").common("tsf1").selection().geom("geom1", 1);
    model.component("comp1").common("tsf1").selection().named("geom1_boxsel2");
    model.component("comp1").common("tsf1").setIndex("move_lock", false, 0);
    model.component("comp1").common("tsf1").setIndex("move_lBound", "-w_wg/6", 0);
    model.component("comp1").common("tsf1").setIndex("move_uBound", "w_wg/6", 0);
    model.component("comp1").common("tsf1").set("scalingType", "Anisotropic");
    model.component("comp1").common("tsf1").setIndex("scale_lockVector", false, 0);
    model.component("comp1").common("tsf1").setIndex("scale_lBoundVector", 0.5, 0);
    model.component("comp1").common("tsf1").setIndex("scale_uBoundVector", 2, 0);
    model.component("comp1").common("tsf1").setIndex("scale_lockVector", false, 1);
    model.component("comp1").common("tsf1").setIndex("scale_lBoundVector", 0.7, 1);
    model.component("comp1").common("tsf1").setIndex("scale_uBoundVector", 1.3, 1);
    model.component("comp1").common("tsf1").setIndex("xCenterType", "Custom", 1);
    model.component("comp1").common("tsf1").setIndex("x_center", "w_wg/2", 1);
    ...
    model
         .title("\u6ce2\u5bfc\u8679\u819c\u5e26\u901a\u6ee4\u6ce2\u5668\u7684\u4f18\u5316 - \u53d8\u6362\u7248\u672c");

    model
         .description("\u672c\u4f8b\u4f7f\u7528\u5f62\u72b6\u4f18\u5316\u6765\u8bbe\u8ba1\u6ce2\u5bfc\u6ee4\u6ce2\u5668\uff0c\u901a\u8fc7\u79fb\u52a8\u548c\u7f29\u653e\u51e0\u4f55\u4e2d\u7684\u77e9\u5f62\u6765\u8fdb\u884c\u4f18\u5316\u3002\u5176\u4e2d\u5bf9\u521d\u59cb\u51e0\u4f55\u7684\u8679\u819c\u8fdb\u884c\u4f18\u5316\uff0c\u4ee5\u786e\u4fdd\u826f\u597d\u7684\u5e26\u901a\u54cd\u5e94\u548c\u5e26\u5916\u6291\u5236\uff0c\u540c\u65f6\u4fdd\u6301\u7ed3\u6784\u7684\u53cc\u955c\u5bf9\u79f0\u3002");
