/*
 * petzval_lens_stop_analysis_isothermal_sweep.java
 */
...
public class petzval_lens_stop_analysis_isothermal_sweep {
...
//    model.param("par3").loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.result().dataset("ip1").setIndex("looplevel", new int[]{1}, 1);
    model.result().dataset().duplicate("ip3", "ip1");
    model.result().dataset("ip3").setIndex("looplevel", new int[]{2}, 1);
    model.result().dataset().duplicate("ip4", "ip3");
    model.result().dataset("ip4").setIndex("looplevel", new int[]{3}, 1);
    model.result().dataset().duplicate("ip5", "ip4");
    model.result().dataset("ip5").setIndex("looplevel", new int[]{4}, 1);
    ...
    model.result("pg5").feature("spot2").set("posexpr", new String[]{"0.1", "0"});
    ...
    model.result("pg5").feature("spot3").set("posexpr", new String[]{"0.2", "0"});
    model.result("pg5").feature().duplicate("spot4", "spot3");
    model.result("pg5").feature("spot4").set("data", "ip5");
    model.result("pg5").feature("spot4").set("posexpr", new String[]{"0.3", "0"});
    ...
    model.result("pg5").feature("ann1")
         .set("text", "$T = eval(T0-0[degC])^\\circ$C \\\\ $\\Delta z = eval((aveop1(z)-z_image)/1[um])\\,\\textrm{\\textmu}$m");
  ...
  public static Model run3(Model model) {
    ...
    model.result().dataset("ip2").setIndex("looplevel", new int[]{1}, 1);
    model.result().dataset().duplicate("ip6", "ip2");
    model.result().dataset("ip6").setIndex("looplevel", new int[]{2}, 1);
    model.result().dataset().duplicate("ip7", "ip6");
    model.result().dataset("ip7").setIndex("looplevel", new int[]{3}, 1);
    model.result().dataset().duplicate("ip8", "ip7");
    model.result().dataset("ip8").setIndex("looplevel", new int[]{4}, 1);
    ...
    model.result("pg6").run();
    model.result().dataset("ip2").set("genmethod", "threepoint");
    model.result().dataset("ip2").setIndex("genpoints", "1.0388910599048204E-5[mm]", 0, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.7634697722593363E-5[mm]", 0, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.7677468427926[mm]", 0, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.1388910599048205E-5[mm]", 1, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.7634697722593363E-5[mm]", 1, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.7677468427926[mm]", 1, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.0388910599048204E-5[mm]", 2, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.6634697722593362E-5[mm]", 2, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.7677468427926[mm]", 2, 2);
    model.result("pg6").feature("spot1").run();
    model.result().dataset("ip2").set("genmethod", "threepoint");
    model.result().dataset("ip2").setIndex("genpoints", "1.1207263442148946E-5[mm]", 0, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.798908216570838E-5[mm]", 0, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.792433717893[mm]", 0, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.2207263442148947E-5[mm]", 1, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.798908216570838E-5[mm]", 1, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.792433717893[mm]", 1, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.1207263442148946E-5[mm]", 2, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.698908216570838E-5[mm]", 2, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.792433717893[mm]", 2, 2);
    model.result("pg6").feature("spot1").run();
    model.result("pg6").set("ispendingzoom", true);
    model.result("pg6").feature("spot1").set("filterreleaseactive", false);
    ...
    model.result().dataset("ip6").setIndex("genpoints", "5.902291389702947E-6[mm]", 0, 0);
    model.result().dataset("ip6").setIndex("genpoints", "-6.490048988054835E-6[mm]", 0, 1);
    model.result().dataset("ip6").setIndex("genpoints", "161.7623979365217[mm]", 0, 2);
    model.result().dataset("ip6").setIndex("genpoints", "6.902291389702947E-6[mm]", 1, 0);
    model.result().dataset("ip6").setIndex("genpoints", "-6.490048988054835E-6[mm]", 1, 1);
    model.result().dataset("ip6").setIndex("genpoints", "161.7623979365217[mm]", 1, 2);
    model.result().dataset("ip6").setIndex("genpoints", "5.902291389702947E-6[mm]", 2, 0);
    model.result().dataset("ip6").setIndex("genpoints", "-5.490048988054835E-6[mm]", 2, 1);
    model.result().dataset("ip6").setIndex("genpoints", "161.7623979365217[mm]", 2, 2);
    model.result("pg6").feature("spot2").run();
    model.result().dataset("ip6").set("genmethod", "threepoint");
    model.result().dataset("ip6").setIndex("genpoints", "6.4114882178575974E-6[mm]", 0, 0);
    model.result().dataset("ip6").setIndex("genpoints", "-6.403904353648563E-6[mm]", 0, 1);
    model.result().dataset("ip6").setIndex("genpoints", "162.78304185535671[mm]", 0, 2);
    model.result().dataset("ip6").setIndex("genpoints", "7.411488217857597E-6[mm]", 1, 0);
    model.result().dataset("ip6").setIndex("genpoints", "-6.403904353648563E-6[mm]", 1, 1);
    model.result().dataset("ip6").setIndex("genpoints", "162.78304185535671[mm]", 1, 2);
    model.result().dataset("ip6").setIndex("genpoints", "6.4114882178575974E-6[mm]", 2, 0);
    model.result().dataset("ip6").setIndex("genpoints", "-5.403904353648563E-6[mm]", 2, 1);
    model.result().dataset("ip6").setIndex("genpoints", "162.78304185535671[mm]", 2, 2);
    model.result("pg6").feature("spot2").run();
    model.result("pg6").set("ispendingzoom", true);
    model.result("pg6").feature("spot2").set("filterreleaseactive", false);
    model.result("pg6").feature("spot2").set("posexpr", new String[]{"0.1", "0"});
    ...
    model.result().dataset("ip7").setIndex("genpoints", "8.364593424008292E-7[mm]", 0, 0);
    model.result().dataset("ip7").setIndex("genpoints", "4.674931179175473E-6[mm]", 0, 1);
    model.result().dataset("ip7").setIndex("genpoints", "161.75717257603762[mm]", 0, 2);
    model.result().dataset("ip7").setIndex("genpoints", "1.8364593424008291E-6[mm]", 1, 0);
    model.result().dataset("ip7").setIndex("genpoints", "4.674931179175473E-6[mm]", 1, 1);
    model.result().dataset("ip7").setIndex("genpoints", "161.75717257603762[mm]", 1, 2);
    model.result().dataset("ip7").setIndex("genpoints", "8.364593424008292E-7[mm]", 2, 0);
    model.result().dataset("ip7").setIndex("genpoints", "5.674931179175472E-6[mm]", 2, 1);
    model.result().dataset("ip7").setIndex("genpoints", "161.75717257603762[mm]", 2, 2);
    model.result("pg6").feature("spot3").run();
    model.result().dataset("ip7").set("genmethod", "threepoint");
    model.result().dataset("ip7").setIndex("genpoints", "9.73873886050524E-7[mm]", 0, 0);
    model.result().dataset("ip7").setIndex("genpoints", "5.220155986638767E-6[mm]", 0, 1);
    model.result().dataset("ip7").setIndex("genpoints", "162.77385189337966[mm]", 0, 2);
    model.result().dataset("ip7").setIndex("genpoints", "1.973873886050524E-6[mm]", 1, 0);
    model.result().dataset("ip7").setIndex("genpoints", "5.220155986638767E-6[mm]", 1, 1);
    model.result().dataset("ip7").setIndex("genpoints", "162.77385189337966[mm]", 1, 2);
    model.result().dataset("ip7").setIndex("genpoints", "9.73873886050524E-7[mm]", 2, 0);
    model.result().dataset("ip7").setIndex("genpoints", "6.2201559866387666E-6[mm]", 2, 1);
    model.result().dataset("ip7").setIndex("genpoints", "162.77385189337966[mm]", 2, 2);
    model.result("pg6").feature("spot3").run();
    model.result("pg6").set("ispendingzoom", true);
    model.result("pg6").feature("spot3").set("filterreleaseactive", false);
    model.result("pg6").feature("spot3").set("posexpr", new String[]{"0.2", "0"});
    ...
    model.result().dataset("ip8").setIndex("genpoints", "-3.915497680492386E-6[mm]", 0, 0);
    model.result().dataset("ip8").setIndex("genpoints", "1.5746429185838566E-5[mm]", 0, 1);
    model.result().dataset("ip8").setIndex("genpoints", "161.75175441901925[mm]", 0, 2);
    model.result().dataset("ip8").setIndex("genpoints", "-2.9154976804923865E-6[mm]", 1, 0);
    model.result().dataset("ip8").setIndex("genpoints", "1.5746429185838566E-5[mm]", 1, 1);
    model.result().dataset("ip8").setIndex("genpoints", "161.75175441901925[mm]", 1, 2);
    model.result().dataset("ip8").setIndex("genpoints", "-3.915497680492386E-6[mm]", 2, 0);
    model.result().dataset("ip8").setIndex("genpoints", "1.6746429185838567E-5[mm]", 2, 1);
    model.result().dataset("ip8").setIndex("genpoints", "161.75175441901925[mm]", 2, 2);
    model.result("pg6").feature("spot4").run();
    model.result().dataset("ip8").set("genmethod", "threepoint");
    model.result().dataset("ip8").setIndex("genpoints", "-4.117975308155083E-6[mm]", 0, 0);
    model.result().dataset("ip8").setIndex("genpoints", "1.6725366578288137E-5[mm]", 0, 1);
    model.result().dataset("ip8").setIndex("genpoints", "162.76450882475726[mm]", 0, 2);
    model.result().dataset("ip8").setIndex("genpoints", "-3.1179753081550835E-6[mm]", 1, 0);
    model.result().dataset("ip8").setIndex("genpoints", "1.6725366578288137E-5[mm]", 1, 1);
    model.result().dataset("ip8").setIndex("genpoints", "162.76450882475726[mm]", 1, 2);
    model.result().dataset("ip8").setIndex("genpoints", "-4.117975308155083E-6[mm]", 2, 0);
    model.result().dataset("ip8").setIndex("genpoints", "1.7725366578288138E-5[mm]", 2, 1);
    model.result().dataset("ip8").setIndex("genpoints", "162.76450882475726[mm]", 2, 2);
    model.result("pg6").feature("spot4").run();
    model.result("pg6").set("ispendingzoom", true);
    model.result("pg6").feature("spot4").set("filterreleaseactive", false);
    model.result("pg6").feature("spot4").set("posexpr", new String[]{"0.3", "0"});
    ...
    model.result("pg6").feature("ann1")
         .set("text", "$T = eval(T0-0[degC])^\\circ$C \\\\ $\\Delta z = eval((162.79248823021723[mm]-aveop1(z))/1[um])\\,\\textrm{\\textmu}$m");
    ...
    model.result("pg6").feature("ann2")
         .set("text", "$T = eval(T0-0[degC])^\\circ$C \\\\ $\\Delta z = eval((162.78305987604173[mm]-aveop1(z))/1[um])\\,\\textrm{\\textmu}$m");
    ...
    model.result("pg6").feature("ann3")
         .set("text", "$T = eval(T0-0[degC])^\\circ$C \\\\ $\\Delta z = eval((162.7738443879646[mm]-aveop1(z))/1[um])\\,\\textrm{\\textmu}$m");
    ...
    model.result("pg6").feature("ann4")
         .set("text", "$T = eval(T0-0[degC])^\\circ$C \\\\ $\\Delta z = eval((162.76447789300707[mm]-aveop1(z))/1[um])\\,\\textrm{\\textmu}$m");
    model.result("pg6").feature("ann4").setIndex("looplevel", 4, 1);
    model.result("pg6").feature("ann4").set("posxexpr", 0.3);
    model.result("pg6").run();

    model.title("\u901a\u8fc7\u7b49\u6e29\u626b\u63cf\u8fdb\u884c Petzval \u900f\u955c STOP \u5206\u6790");

    model
         .description("\u672c\u6a21\u578b\u6f14\u793a\u5bf9\u5149\u5b66\u7cfb\u7edf\u8fdb\u884c\u7ed3\u6784-\u70ed-\u5149\u5b66\u6027\u80fd (STOP) \u7efc\u5408\u5206\u6790\u7684\u8fc7\u7a0b\u3002\u6a21\u578b\u57fa\u4e8e\u201cPetzval \u900f\u955c STOP \u5206\u6790\u201d\u6559\u7a0b\uff0c\u5176\u4e2d\u900f\u955c\u548c\u955c\u7b52\u7ec4\u4ef6\u53d7\u5230\u5355\u4e00\u7b49\u6e29\u6e29\u5ea6\u7684\u5f71\u54cd\u3002\u901a\u8fc7\u5728\u4e00\u7cfb\u5217\u5747\u5300\u6e29\u5ea6\u4e0b\u6267\u884c\u53c2\u6570\u5316\u626b\u63cf\uff0c\u53ef\u4ee5\u786e\u5b9a\u6700\u4f73\u805a\u7126\u50cf\u5e73\u9762\u7684\u4f4d\u7f6e\u3002");
