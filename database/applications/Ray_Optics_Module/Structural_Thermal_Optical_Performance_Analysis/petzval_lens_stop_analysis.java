/*
 * petzval_lens_stop_analysis.java
 */
...
public class petzval_lens_stop_analysis {
...
//    model.param("par3").loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.result().dataset("ip2").setIndex("genpoints", "1.0388910639143032E-5[mm]", 0, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.76346978252913E-5[mm]", 0, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.76774684279076[mm]", 0, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.1388910639143033E-5[mm]", 1, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.76346978252913E-5[mm]", 1, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.76774684279076[mm]", 1, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.0388910639143032E-5[mm]", 2, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.66346978252913E-5[mm]", 2, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.76774684279076[mm]", 2, 2);
    model.result("pg6").feature("spot1").run();
    model.result().dataset("ip2").set("genmethod", "threepoint");
    model.result().dataset("ip2").setIndex("genpoints", "1.12072634999937E-5[mm]", 0, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.7989082259684307E-5[mm]", 0, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.79243371789013[mm]", 0, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.22072634999937E-5[mm]", 1, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.7989082259684307E-5[mm]", 1, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.79243371789013[mm]", 1, 2);
    model.result().dataset("ip2").setIndex("genpoints", "1.12072634999937E-5[mm]", 2, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.6989082259684307E-5[mm]", 2, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.79243371789013[mm]", 2, 2);
    model.result("pg6").feature("spot1").run();
