/*
 * petzval_lens_stop_analysis_with_surface_to_surface_radiation.java
 */
...
public class petzval_lens_stop_analysis_with_surface_to_surface_radiation {
...
//    model.param("par3").loadFile("FILENAME");
  ...
  public static Model run2(Model model) {
    ...
    model.param("par3").descr("T0", "\u9694\u70ed\u7f69\u6e29\u5ea6");
    model.param().create("par4");
    model.param().move(new String[]{"T0"}, "par4");
    model.param("par4").label("\u6e29\u5ea6");
    model.param("par4").set("T1", "22.5[degC]");
    model.param("par4").descr("T1", "\u73af\u5883\u6e29\u5ea6");

    model.component("comp1").geom("geom1").run("comsel1");
    model.component("comp1").geom("geom1").create("cyl3", "Cylinder");
    model.component("comp1").geom("geom1").feature("cyl3").label("\u771f\u7a7a\u7a97");
    model.component("comp1").geom("geom1").feature("cyl3").set("r", 40);
    model.component("comp1").geom("geom1").feature("cyl3").set("h", 5);
    model.component("comp1").geom("geom1").feature("cyl3").set("pos", new int[]{0, 0, -25});
    model.component("comp1").geom("geom1").feature("cyl3").set("workplanesrc", "pi1");
    model.component("comp1").geom("geom1").feature("cyl3").set("workplane", "wp1");
    model.component("comp1").geom("geom1").feature("cyl3").set("selresult", true);
    model.component("comp1").geom("geom1").feature("cyl3").set("selresultshow", "bnd");
    ...
    model.component("comp1").geom("geom1").feature("pi15").label("\u771f\u7a7a\u7a97\u524d\u73af");
    model.component("comp1").geom("geom1").feature("pi15").setEntry("inputexpr", "d0", "90.0[mm]");
    model.component("comp1").geom("geom1").feature("pi15").setEntry("inputexpr", "d1", "80.0[mm]");
    model.component("comp1").geom("geom1").feature("pi15").set("workplanesrc", "pi1");
    model.component("comp1").geom("geom1").feature("pi15").set("workplane", "wp1");
    model.component("comp1").geom("geom1").feature("pi15").set("displ", new int[]{0, 0, -25});
    model.component("comp1").geom("geom1").run("pi15");
    model.component("comp1").geom("geom1").feature().create("ext6", "Extrude");
    model.component("comp1").geom("geom1").feature("ext6").label("\u771f\u7a7a\u7a97\u524d\u4fa7");
    model.component("comp1").geom("geom1").feature("ext6").selection("inputface").set("pi15", 1);
    model.component("comp1").geom("geom1").feature("ext6").setIndex("distance", 15, 0);
    model.component("comp1").geom("geom1").selection().create("csel11", "CumulativeSelection");
    model.component("comp1").geom("geom1").selection("csel11").label("\u771f\u7a7a\u7a97 1");
    model.component("comp1").geom("geom1").feature("ext6").set("contributeto", "csel11");
    model.component("comp1").geom("geom1").run("ext6");
    model.component("comp1").geom("geom1").create("cyl4", "Cylinder");
    model.component("comp1").geom("geom1").feature("cyl4").label("\u70ed\u7a97");
    model.component("comp1").geom("geom1").feature("cyl4").set("r", 40);
    model.component("comp1").geom("geom1").feature("cyl4").set("h", 2);
    model.component("comp1").geom("geom1").feature("cyl4").set("pos", new int[]{0, 0, -10});
    model.component("comp1").geom("geom1").feature("cyl4").set("workplanesrc", "pi1");
    model.component("comp1").geom("geom1").feature("cyl4").set("workplane", "wp1");
    model.component("comp1").geom("geom1").feature("cyl4").set("selresult", true);
    model.component("comp1").geom("geom1").feature("cyl4").set("selresultshow", "bnd");
  ...
  public static Model run3(Model model) {
    ...
    model.component("comp1").geom("geom1").feature("pi16").label("\u9694\u70ed\u7f69\u524d\u73af");
    model.component("comp1").geom("geom1").feature("pi16").setEntry("inputexpr", "d0", "125.0[mm]");
    model.component("comp1").geom("geom1").feature("pi16").setEntry("inputexpr", "d1", "80.0[mm]");
    model.component("comp1").geom("geom1").feature("pi16").set("workplanesrc", "pi1");
    model.component("comp1").geom("geom1").feature("pi16").set("workplane", "wp1");
    model.component("comp1").geom("geom1").feature("pi16").set("displ", new int[]{0, 0, -10});
    model.component("comp1").geom("geom1").run("pi16");
    model.component("comp1").geom("geom1").feature().create("ext7", "Extrude");
    model.component("comp1").geom("geom1").feature("ext7").label("\u9694\u70ed\u7f69\u6b63\u9762");
    model.component("comp1").geom("geom1").feature("ext7").selection("inputface").set("pi16", 1);
    model.component("comp1").geom("geom1").feature("ext7").setIndex("distance", 2, 0);
    model.component("comp1").geom("geom1").selection().create("csel12", "CumulativeSelection");
    model.component("comp1").geom("geom1").selection("csel12").label("\u9694\u70ed\u7f69");
    model.component("comp1").geom("geom1").feature("ext7").set("contributeto", "csel12");
    model.component("comp1").geom("geom1").run("ext7");
    model.component("comp1").geom("geom1").create("cyl5", "Cylinder");
    model.component("comp1").geom("geom1").feature("cyl5").label("\u9694\u70ed\u7f69\u7aef");
    model.component("comp1").geom("geom1").feature("cyl5").set("r", 62.5);
    model.component("comp1").geom("geom1").feature("cyl5").set("h", 2);
    model.component("comp1").geom("geom1").feature("cyl5").set("workplanesrc", "pi1");
    model.component("comp1").geom("geom1").feature("cyl5").set("workplane", "wp1");
    model.component("comp1").geom("geom1").feature("cyl5").set("pos", new int[]{0, 0, 180});
    model.component("comp1").geom("geom1").feature("cyl5").set("contributeto", "csel12");
    ...
    model.component("comp1").geom("geom1").feature("pi17").label("\u9694\u70ed\u7f69\u73af");
    model.component("comp1").geom("geom1").feature("pi17").setEntry("inputexpr", "d0", "125.0[mm]");
    model.component("comp1").geom("geom1").feature("pi17").setEntry("inputexpr", "d1", "120.0[mm]");
    model.component("comp1").geom("geom1").feature("pi17").set("workplanesrc", "pi1");
    model.component("comp1").geom("geom1").feature("pi17").set("workplane", "wp1");
    model.component("comp1").geom("geom1").feature("pi17").set("displ", new int[]{0, 0, -8});
    model.component("comp1").geom("geom1").feature("pi17").setEntry("selkeepbnd", "pi17_sel1", true);
    model.component("comp1").geom("geom1").run("pi17");
    model.component("comp1").geom("geom1").feature().create("ext8", "Extrude");
    model.component("comp1").geom("geom1").feature("ext8").label("\u9694\u70ed\u7f69\u5916\u90e8");
    model.component("comp1").geom("geom1").feature("ext8").selection("inputface").set("pi17", 1);
    model.component("comp1").geom("geom1").feature("ext8").set("specify", "vertices");

    model.component("comp1").view("view1").set("renderwireframe", true);

    model.component("comp1").geom("geom1").feature("ext8").selection("vertex").set("cyl5", 5);
    ...
    model.component("comp1").geom("geom1").feature("ext8").set("contributeto", "csel12");
    model.component("comp1").geom("geom1").run("fin");
    ...
    model.component("comp1").selection("uni1")
         .label("\u900f\u955c\u7b52\u3001\u63a2\u6d4b\u5668\u548c\u9694\u70ed\u7f69");
    model.component("comp1").selection("uni1")
         .set("input", new String[]{"geom1_pi11_uni1_dom", "geom1_pi12_uni1_dom", "geom1_pi13_uni1_dom", "geom1_uni1_dom", "geom1_csel11_dom", "geom1_csel12_dom"});
    model.component("comp1").selection().create("uni3", "Union");
    model.component("comp1").selection("uni3").label("\u6240\u6709\u900f\u955c\u548c\u7a97");
    model.component("comp1").selection("uni3")
         .set("input", new String[]{"geom1_csel1_dom", "geom1_csel2_dom", "geom1_csel3_dom", "geom1_csel4_dom"});
    model.component("comp1").selection().create("uni4", "Union");
    model.component("comp1").selection("uni4").label("\u5b8c\u6574\u7684\u900f\u955c\u7ec4");
    model.component("comp1").selection("uni4")
         .set("input", new String[]{"geom1_csel10_dom", "geom1_sel1", "geom1_pi11_uni1_dom", "geom1_pi12_uni1_dom", "geom1_pi13_uni1_dom", "geom1_uni1_dom"});
    model.component("comp1").selection().create("uni5", "Union");
    model.component("comp1").selection("uni5").set("entitydim", 2);
    model.component("comp1").selection("uni5").label("\u900f\u955c\u548c\u7a97\u5916\u90e8");
    model.component("comp1").selection("uni5")
         .set("input", new String[]{"geom1_csel5_bnd", "geom1_cyl3_bnd", "geom1_cyl4_bnd"});
    model.component("comp1").selection().create("sel1", "Explicit");
    model.component("comp1").selection("sel1").label("\u6240\u6709\u57df");
    model.component("comp1").selection("sel1").all();
    model.component("comp1").selection().create("adj1", "Adjacent");
    model.component("comp1").selection("adj1").label("\u6240\u6709\u5916\u90e8");
    model.component("comp1").selection("adj1").set("input", new String[]{"sel1"});
    model.component("comp1").selection().create("sel2", "Explicit");
    model.component("comp1").selection("sel2").label("\u9694\u70ed\u7f69\u5916\u90e8");
    model.component("comp1").selection("sel2").geom(2);

    model.component("comp1").view("view1").set("hidestatus", "ignore");

    model.component("comp1").selection("sel2").set(1, 2, 3, 4, 5, 7, 8, 10, 18, 151, 152, 153, 236, 237, 238);

    model.component("comp1").view("view1").set("hidestatus", "hide");

    model.component("comp1").selection().create("sel3", "Explicit");
    model.component("comp1").selection("sel3").label("\u771f\u7a7a\u7a97\u5916\u90e8");
    model.component("comp1").selection("sel3").geom(2);
    model.component("comp1").selection("sel3").set(15, 16, 17, 155, 234);
    model.component("comp1").selection().create("sel4", "Explicit");
    model.component("comp1").selection("sel4").label("\u771f\u7a7a\u7a97\u548c\u70ed\u7a97\u5165\u53e3");
    model.component("comp1").selection("sel4").geom(2);
    model.component("comp1").selection("sel4").set(31, 32, 33, 34, 37, 160, 229);
    model.component("comp1").selection().create("sel5", "Explicit");
    model.component("comp1").selection("sel5").label("\u771f\u7a7a\u7a97\u8fb9\u7f18");
    model.component("comp1").selection("sel5").geom(2);
    model.component("comp1").selection("sel5").set(29, 30, 159, 228);
    model.component("comp1").selection().create("dif1", "Difference");
    model.component("comp1").selection("dif1").label("\u6240\u6709\u8868\u9762\u5bf9\u8868\u9762");
    model.component("comp1").selection("dif1").set("entitydim", 2);
    model.component("comp1").selection("dif1").set("add", new String[]{"adj1"});
    model.component("comp1").selection("dif1").set("subtract", new String[]{"sel2", "sel3", "sel5"});

    model.component("comp1").physics("gop").selection().named("uni3");
    model.component("comp1").physics("gop").prop("ExteriorUnmeshedProperties")
         .setIndex("DispersionModel", "AbsoluteVacuum", 0);
    model.component("comp1").physics("gop").feature("mp1").setIndex("minput_temperature_src", "root.comp1.T", 0);
    model.component("comp1").physics("solid").selection().named("uni4");
    model.component("comp1").physics("solid").feature("lemm1").feature("te1").active(false);

    model.component("comp1").multiphysics().create("te1", "ThermalExpansion", 3);
    model.component("comp1").multiphysics("te1").selection().named("uni4");

    model.component("comp1").physics("ht").prop("ShapeProperty").set("order_temperature", 1);
    model.component("comp1").physics("ht").create("temp1", "TemperatureBoundary", 2);
    model.component("comp1").physics("ht").feature("temp1").selection().named("sel2");
    ...
    model.component("comp1").physics("ht").feature("temp2").selection().named("sel5");
    model.component("comp1").physics("ht").feature("temp2").set("T0", "T1");
    model.component("comp1").physics("rad").selection().named("dif1");
    model.component("comp1").physics("rad").feature("dsurf1").set("Tamb", "T0");
    ...
    model.component("comp1").physics("rad").feature("dsurf2").selection().named("sel4");
    model.component("comp1").physics("rad").feature("dsurf2").set("Tamb", "T1");
    ...
    model.component("comp1").material("mat6").propertyGroup("def").set("thermalconductivity", new String[]{"k_RTV"});
    model.component("comp1").material("mat6").propertyGroup("def").set("heatcapacity", new String[]{"Cp_RTV"});

    model.component("comp1").mesh("mesh1").create("ftri2", "FreeTri");
    model.component("comp1").mesh("mesh1").feature("ftri2").selection().set(6, 42);
    model.component("comp1").mesh("mesh1").create("swe1", "Sweep");
    model.component("comp1").mesh("mesh1").feature("swe1").selection().geom("geom1", 3);
    model.component("comp1").mesh("mesh1").feature("swe1").selection().named("geom1_ext8_dom");
    ...
    model.result("pg6").feature("spot1").set("filterreleaseactive", true);
    model.result().dataset("ip2").set("genmethod", "threepoint");
    model.result().dataset("ip2").setIndex("genpoints", "-3.131838333060576E-5[mm]", 0, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.3121147051562247E-5[mm]", 0, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.69988541880042[mm]", 0, 2);
    model.result().dataset("ip2").setIndex("genpoints", "-3.0318383330605756E-5[mm]", 1, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.3121147051562247E-5[mm]", 1, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.69988541880042[mm]", 1, 2);
    model.result().dataset("ip2").setIndex("genpoints", "-3.131838333060576E-5[mm]", 2, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.2121147051562246E-5[mm]", 2, 1);
    model.result().dataset("ip2").setIndex("genpoints", "161.69988541880042[mm]", 2, 2);
    model.result("pg6").feature("spot1").run();
    model.result().dataset("ip2").set("genmethod", "threepoint");
    model.result().dataset("ip2").setIndex("genpoints", "-3.0376271274855113E-5[mm]", 0, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.6167105640243477E-5[mm]", 0, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.7110164927738[mm]", 0, 2);
    model.result().dataset("ip2").setIndex("genpoints", "-2.9376271274855113E-5[mm]", 1, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.6167105640243477E-5[mm]", 1, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.7110164927738[mm]", 1, 2);
    model.result().dataset("ip2").setIndex("genpoints", "-3.0376271274855113E-5[mm]", 2, 0);
    model.result().dataset("ip2").setIndex("genpoints", "-1.5167105640243476E-5[mm]", 2, 1);
    model.result().dataset("ip2").setIndex("genpoints", "162.7110164927738[mm]", 2, 2);
    model.result("pg6").feature("spot1").run();
    model.result("pg6").set("ispendingzoom", true);
    model.result("pg6").feature("spot1").set("filterreleaseactive", false);
    model.result("pg6").run();
    ...
    model.result("pg7").label("\u6e29\u5ea6\uff08\u70ed\u7a97\u548c\u771f\u7a7a\u7a97\uff09");
    model.result("pg7").run();
    model.result("pg7").run();
    ...
    model
         .title("\u5177\u6709\u8868\u9762\u5bf9\u8868\u9762\u8f90\u5c04\u7684 Petzval \u900f\u955c STOP \u5206\u6790");

    model
         .description("\u672c\u6a21\u578b\u6f14\u793a\u5b58\u5728\u70ed\u68af\u5ea6\u7684\u60c5\u51b5\u4e0b\uff0c\u5bf9\u5149\u5b66\u7cfb\u7edf\u8fdb\u884c\u7ed3\u6784-\u70ed-\u5149\u5b66\u6027\u80fd (STOP) \u7efc\u5408\u5206\u6790\u7684\u8fc7\u7a0b\u3002\u6a21\u578b\u57fa\u4e8e\u201cPetzval \u900f\u955c STOP \u5206\u6790\u201d\u6559\u7a0b\uff0c\u5e76\u7ed3\u5408\u4e86\u7b80\u5355\u7684\u955c\u7b52\u51e0\u4f55\u8bbe\u8ba1\u3002\u900f\u955c\u7ec4\u4ef6\u653e\u7f6e\u5728\u4e00\u4e2a\u70ed\u771f\u7a7a\u5916\u58f3\u5185\uff0c\u5176\u5916\u90e8\u6e29\u5ea6\u4e0e\u5185\u90e8\u6e29\u5ea6\u5b58\u5728\u663e\u8457\u5dee\u5f02\u3002\u8be5\u7ec4\u4ef6\u901a\u8fc7\u4e24\u6247\u7a97\u6237\u8fdb\u884c\u8868\u9762\u5bf9\u8868\u9762\u8f90\u5c04\uff0c\u4ece\u800c\u66b4\u9732\u4e8e\u5916\u90e8\u73af\u5883\u3002\u6a21\u578b\u5c55\u793a\u4e86\u5149\u5b66\u7cfb\u7edf\u5185\u90e8\u4ea7\u751f\u7684\u70ed\u68af\u5ea6\u548c\u4f4d\u79fb\u573a\uff0c\u5e76\u63ed\u793a\u4e86\u8fd9\u4e9b\u56e0\u7d20\u5bf9\u56fe\u50cf\u8d28\u91cf\u7684\u5f71\u54cd\u3002");
