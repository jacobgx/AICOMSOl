/*
 * schmidt_cassegrain_telescope.java
 */
...
public class schmidt_cassegrain_telescope {
...
//    model.param("par2").loadFile("FILENAME");
    model.param("par2").set("lam1", "486[nm]", "\u6ce2\u957f 1");
    model.param("par2").set("lam2", "546[nm]", "\u6ce2\u957f 2");
    model.param("par2").set("lam3", "656[nm]", "\u6ce2\u957f 3");
    ...
    model.param("par2").set("theta_x2", "0.125[deg]", "\u89c6\u573a\u89d2 2\uff0cx \u5206\u91cf");
    model.param("par2").set("theta_y2", "0.000[deg]", "\u89c6\u573a\u89d2 2\uff0cy \u5206\u91cf");
    model.param("par2").set("theta_x3", "0.250[deg]", "\u89c6\u573a\u89d2 3\uff0cx \u5206\u91cf");
    model.param("par2").set("theta_y3", "0.000[deg]", "\u89c6\u573a\u89d2 3\uff0cy \u5206\u91cf");
    model.param("par2").set("N_ring", "12", "\u516d\u8fb9\u73af\u6570");
    model.param("par2").set("P_nom", "203.2[mm]", "\u6807\u79f0\u5165\u5c04\u5149\u77b3\u76f4\u5f84");
    ...
    model.param("par2").set("dz", "20[mm]", "\u5149\u7ebf\u53d1\u5c04 z \u5750\u6807");
    model.param("par2")
    ...
    model.component("comp1").geom("geom1").label("\u65bd\u5bc6\u7279-\u5361\u585e\u683c\u6797\u671b\u8fdc\u955c");
    model.component("comp1").geom("geom1").insertFile("schmidt_cassegrain_telescope_geom_sequence.mph", "geom1");
    ...
    model.component("comp1").physics("gop").feature("mir1").selection().named("geom1_csel3_bnd");
    ...
    model.component("comp1").physics("gop").feature("wall2").selection().named("geom1_pi4_sel1");
    ...
    model.title("\u65bd\u5bc6\u7279-\u5361\u585e\u683c\u6797\u671b\u8fdc\u955c");

    model
         .description("\u672c\u6559\u7a0b\u6f14\u793a\u7684\u65bd\u5bc6\u7279-\u5361\u585e\u683c\u6797\u671b\u8fdc\u955c\u662f\u4f7f\u7528\u975e\u7403\u9762\u6821\u6b63\u900f\u955c\u548c\u4e24\u4e2a\u7403\u9762\u955c\u7684\u7ecf\u5178\u8bbe\u8ba1\u3002\u5176\u4e2d\u4f7f\u7528\u201c\u5c04\u7ebf\u5149\u5b66\u201d\u96f6\u4ef6\u5e93\u4e2d\u7684\u201c\u5076\u6b21\u975e\u7403\u9762\u900f\u955c\uff08\u4e09\u7ef4\uff09\u201d\u96f6\u4ef6\u521b\u5efa\u975e\u7403\u9762\u6821\u6b63\u955c\u3002");
