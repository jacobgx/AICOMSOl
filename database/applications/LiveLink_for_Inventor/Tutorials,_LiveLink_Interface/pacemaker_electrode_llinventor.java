/*
 * pacemaker_electrode_llinventor.java
 */
...
public class pacemaker_electrode_llinventor {
...
//    model.param().loadFile("FILENAME");
    ...
    model.study("std1").feature("param").setIndex("pname", "LL_d14", 0);
    ...
    model.label("pacemaker_electrode_llinventor.mph");
